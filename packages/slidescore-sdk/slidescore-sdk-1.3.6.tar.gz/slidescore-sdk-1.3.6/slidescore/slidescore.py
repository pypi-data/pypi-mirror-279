...
class APIClient(object):
    ...
    def convert_annotation_to_anno2(self, study_id, case_id, image_id, tma_core_id,
        ...
        case_id, tma_core_id, score_id, question and metadata are optional
        You have to specify one of score_id and question
        """
        
        response = self.perform_request("ConvertAnnotationToAnno2", {"studyId": study_id, "caseId": case_id, "caseId": image_id, 
