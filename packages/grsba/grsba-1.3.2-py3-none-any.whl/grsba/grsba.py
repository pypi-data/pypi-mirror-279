...
class GRSBA:
    def __init__(self, y, num_features=6, max_depth=5, units=256, activation='tanh', epochs=100, batch_size=32, patience=10, optimizer='adam', loss='mean_squared_error', verbose=1, t=None, learning_rate=0.0001, kernel_initializer='he_normal'):
    ...
    def create_model(self):
        ...
        hidden_layer = Dense(self.units, activation=self.activation, kernel_initializer=self.kernel_initializer)(input_layer)
        hidden_layer = Dense(self.units, activation=self.activation, kernel_initializer=self.kernel_initializer)(hidden_layer)
        hidden_layer = Dense(self.units, activation=self.activation, kernel_initializer=self.kernel_initializer)(hidden_layer)  # Adicionando mais uma camada densa
