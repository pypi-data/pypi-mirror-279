...
class GRSBA:
    def __init__(self, y, num_features=6, max_depth=5, units=128, activation='relu', epochs=100, batch_size=32, patience=10, optimizer='adam', loss='mean_absolute_error', verbose=1, t=None, learning_rate=0.001):
