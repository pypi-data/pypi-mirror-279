...
class GRSBA:
    def __init__(self, y, num_features=6, max_depth=3, units=64, activation='relu', epochs=100, batch_size=32, patience=10, optimizer='adam', loss='mse', verbose=1, t=None, learning_rate=0.001):
