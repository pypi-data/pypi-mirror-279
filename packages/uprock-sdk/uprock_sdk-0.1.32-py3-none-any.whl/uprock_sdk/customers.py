...
async def create(dto: BaseCustomer) -> CustomerRead:
    customer_data = dto.model_dump(exclude_unset=True)
...
async def list_all(filter_: Optional[CustomerFilter] = None, chunk_size: int = 500) -> List[CustomerRead]:
    customers = []
    ...
    for page in range(1, customer_page.pages):
