...
def plot_curve_comparison(reference, processed, start=None, finish=None, show=False, save=False, file_path=None, set_fontsize=12, loc='upper right'):
    """
    ...
    try:
        ...
        ax.legend(fontsize=set_fontsize, loc=loc)
...
def plot_multirun_metric_results(result_df, add_trendline=True, metric_list=['reduction_rate', 'ncc', 'cf_score'], show=True, save=False, file_path=None, arrow=True, set_fontsize=12):
    """
        ...
        for i, metric in enumerate(metric_list):
            ...
            if (metric == 'cf_score' and arrow):
                ...
                ax[i].annotate(f'Max: {y[max_x]}',
                    ...
                    weight='bold',
                    color='black',
                    arrowprops=dict(facecolor='#000000', edgecolor='grey', shrink=0.1),
                    horizontalalignment='right', 
                    verticalalignment='top',
                    fontsize=set_fontsize+5
                )
            ...
            ax[i].legend(fontsize=set_fontsize)
