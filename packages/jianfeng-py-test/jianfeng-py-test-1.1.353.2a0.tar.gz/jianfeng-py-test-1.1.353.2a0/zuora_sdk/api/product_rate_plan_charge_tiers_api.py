...
class ProductRatePlanChargeTiersApi:
    ...
    @validate_call
    def get_product_rate_plan_charge_tier(
        self,
        ...
        _param = self._get_product_rate_plan_charge_tier_serialize(
            id=id,
    ...
    def get_product_rate_plan_charge_tier_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProductRatePlanChargeTierResponse]:
        """CRUD: Retrieve a product rate plan charge tier
    ...
    @validate_call
    def get_product_rate_plan_charge_tier_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Object id")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        content_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. ")] = None,
    ...
    def _get_product_rate_plan_charge_tier_serialize(
        self,
        id,
        accept_encoding,
        content_encoding,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/object/product-rate-plan-charge-tier/{id}',
    ...
    def update_product_rate_plan_charge_tier(
        self,
        id: Annotated[StrictStr, Field(description="The unique ID of the product rate plan charge tier to be updated. For example, 2c92c0f86c85891e016c88d55a6e543b. ")],
        modify_request: UpdateProductRatePlanChargeTierRequest,
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        content_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. ")] = None,
        authorization: Annotated[Optional[StrictStr], Field(description="The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). ")] = None,
        ...
        _param = self._update_product_rate_plan_charge_tier_serialize(
            id=id,
    ...
    @validate_call
    def update_product_rate_plan_charge_tier_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique ID of the product rate plan charge tier to be updated. For example, 2c92c0f86c85891e016c88d55a6e543b. ")],
        modify_request: UpdateProductRatePlanChargeTierRequest,
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
    ...
    def _update_product_rate_plan_charge_tier_serialize(
        self,
        id,
        modify_request,
        accept_encoding,
