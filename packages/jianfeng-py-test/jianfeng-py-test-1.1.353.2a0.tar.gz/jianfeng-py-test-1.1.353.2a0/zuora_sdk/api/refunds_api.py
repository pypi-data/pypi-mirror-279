...
class RefundsApi:
    ...
    @validate_call
    def cancel_refund_without_preload_content(
        self,
        refund_key: Annotated[StrictStr, Field(description="The unique ID of a refund or the refund number. For example, 4028905f5a87c0ff015a889e590e00c9.       ")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        content_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. ")] = None,
    ...
    def get_refund_item_part(
        self,
        itempartid: Annotated[StrictStr, Field(description="The unique ID of a specific refund part item. You can get the refund part item ID from the response of [Get refund part items](https://www.zuora.com/developer/api-references/api/operation/Get_RefundItemParts). ")],
        refundpartid: Annotated[StrictStr, Field(description="The unique ID of a specific refund part. You can get the refund part ID from the response of [List all parts of a refund](https://www.zuora.com/developer/api-references/api/operation/Get_RefundParts). ")],
    ...
    @validate_call
    def get_refund_item_part_without_preload_content(
        self,
        itempartid: Annotated[StrictStr, Field(description="The unique ID of a specific refund part item. You can get the refund part item ID from the response of [Get refund part items](https://www.zuora.com/developer/api-references/api/operation/Get_RefundItemParts). ")],
        refundpartid: Annotated[StrictStr, Field(description="The unique ID of a specific refund part. You can get the refund part ID from the response of [List all parts of a refund](https://www.zuora.com/developer/api-references/api/operation/Get_RefundParts). ")],
        refund_key: Annotated[StrictStr, Field(description="The number or unique ID of a refund. For example, 4028905f5a87c0ff015a889e590e00c9. ")],
    ...
    def _get_refund_item_part_serialize(
        ...
        if refundpartid is not None:
            _path_params['refundpartid'] = refundpartid
        if refund_key is not None:
            _path_params['refundKey'] = refund_key
        # process the query parameters
        # process the header parameters
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/refunds/{refundKey}/parts/{refundpartid}/itemparts/{itempartid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_refund_item_parts_without_preload_content(
        self,
        refundpartid: Annotated[StrictStr, Field(description="The unique ID of a specific refund part. You can get the refund part ID from the response of [List all parts of a refund](https://www.zuora.com/developer/api-references/api/operation/Get_RefundParts). ")],
        refund_key: Annotated[StrictStr, Field(description="The number or unique ID of a refund. For example, 4028905f5a87c0ff015a889e590e00c9. ")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
    ...
    def _get_refund_item_parts_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/refunds/{refundKey}/parts/{refundpartid}/itemparts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_refund_part_without_preload_content(
        self,
        refundpartid: Annotated[StrictStr, Field(description="The unique ID of a specific refund part. You can get the refund part ID from the response of [List all parts of a refund](https://www.zuora.com/developer/api-references/api/operation/Get_RefundParts). ")],
        refund_key: Annotated[StrictStr, Field(description="The number or unique ID of a refund. For example, 4028905f5a87c0ff015a889e590e00c9. ")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
    ...
    @validate_call
    def get_refund_parts_without_preload_content(
        self,
        refund_key: Annotated[StrictStr, Field(description="The number or unique ID of a refund. For example, 4028905f5a87c0ff015a889e590e00c9. ")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        content_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. ")] = None,
