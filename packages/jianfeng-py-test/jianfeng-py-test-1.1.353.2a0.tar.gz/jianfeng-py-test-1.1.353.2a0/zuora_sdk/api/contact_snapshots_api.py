...
class ContactSnapshotsApi:
    ...
    @validate_call
    def get_contact_snapshot(
        self,
        contact_snapshot_id: Annotated[StrictStr, Field(description="The unique ID of the contact snapshot to be retrieved. For example, 2c92c8955bd63cc1015bd7c151af02ab. ")],
        ...
        _param = self._get_contact_snapshot_serialize(
            contact_snapshot_id=contact_snapshot_id,
    ...
    @validate_call
    def get_contact_snapshot_with_http_info(
        self,
        contact_snapshot_id: Annotated[StrictStr, Field(description="The unique ID of the contact snapshot to be retrieved. For example, 2c92c8955bd63cc1015bd7c151af02ab. ")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        content_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContactSnapshotResponse]:
        """Retrieve a contact snapshot
    ...
    @validate_call
    def get_contact_snapshot_without_preload_content(
        self,
        contact_snapshot_id: Annotated[StrictStr, Field(description="The unique ID of the contact snapshot to be retrieved. For example, 2c92c8955bd63cc1015bd7c151af02ab. ")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        content_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. ")] = None,
    ...
    def _get_contact_snapshot_serialize(
        self,
        contact_snapshot_id,
        accept_encoding,
        content_encoding,
        ...
        if contact_snapshot_id is not None:
            _path_params['contact-snapshot-id'] = contact_snapshot_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/contact-snapshots/{contact-snapshot-id}',
