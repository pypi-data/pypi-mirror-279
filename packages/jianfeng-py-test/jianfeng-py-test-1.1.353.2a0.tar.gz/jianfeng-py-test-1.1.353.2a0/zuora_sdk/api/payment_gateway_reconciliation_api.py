...
class PaymentGatewayReconciliationApi:
    ...
    def reconcile_refund(
        self,
        refund_key: Annotated[StrictStr, Field(description="The refund number starting with “R-” or the unique refund ID.")],
        request: ReconcileRefundRequest,
        ...
        _param = self._reconcile_refund_serialize(
    ...
    @validate_call
    def reconcile_refund_with_http_info(
        self,
        refund_key: Annotated[StrictStr, Field(description="The refund number starting with “R-” or the unique refund ID.")],
        request: ReconcileRefundRequest,
        idempotency_key: Annotated[Optional[Annotated[str, Field(strict=True, max_length=255)]], Field(description="Specify a unique idempotency key if you want to perform an idempotent POST or PATCH request. Do not use this header in other request types.   With this header specified, the Zuora server can identify subsequent retries of the same request using this value, which prevents the same operation from being performed multiple times by accident.  ")] = None,
    ...
    @validate_call
    def reconcile_refund_without_preload_content(
        self,
        refund_key: Annotated[StrictStr, Field(description="The refund number starting with “R-” or the unique refund ID.")],
        request: ReconcileRefundRequest,
        idempotency_key: Annotated[Optional[Annotated[str, Field(strict=True, max_length=255)]], Field(description="Specify a unique idempotency key if you want to perform an idempotent POST or PATCH request. Do not use this header in other request types.   With this header specified, the Zuora server can identify subsequent retries of the same request using this value, which prevents the same operation from being performed multiple times by accident.  ")] = None,
    ...
    def _reconcile_refund_serialize(
        self,
        refund_key,
        request,
        idempotency_key,
        ...
        if refund_key is not None:
            _path_params['refund-key'] = refund_key
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/refunds/{refund-key}/reconcile',
    ...
    def reject_payment(
        self,
        payment_key: Annotated[StrictStr, Field(description="The payment number starting with \"P-\" or the unique payment ID.")],
        ...
        _param = self._reject_payment_serialize(
    ...
    @validate_call
    def reject_payment_with_http_info(
        self,
        payment_key: Annotated[StrictStr, Field(description="The payment number starting with \"P-\" or the unique payment ID.")],
        request: RejectPaymentRequest,
        idempotency_key: Annotated[Optional[Annotated[str, Field(strict=True, max_length=255)]], Field(description="Specify a unique idempotency key if you want to perform an idempotent POST or PATCH request. Do not use this header in other request types.   With this header specified, the Zuora server can identify subsequent retries of the same request using this value, which prevents the same operation from being performed multiple times by accident.  ")] = None,
    ...
    @validate_call
    def reject_payment_without_preload_content(
        self,
        payment_key: Annotated[StrictStr, Field(description="The payment number starting with \"P-\" or the unique payment ID.")],
        request: RejectPaymentRequest,
        idempotency_key: Annotated[Optional[Annotated[str, Field(strict=True, max_length=255)]], Field(description="Specify a unique idempotency key if you want to perform an idempotent POST or PATCH request. Do not use this header in other request types.   With this header specified, the Zuora server can identify subsequent retries of the same request using this value, which prevents the same operation from being performed multiple times by accident.  ")] = None,
    ...
    def _reject_payment_serialize(
        ...
        if payment_key is not None:
            _path_params['payment-key'] = payment_key
        # process the query parameters
        # process the header parameters
        if idempotency_key is not None:
            _header_params['Idempotency-Key'] = idempotency_key
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/gateway-settlement/payments/{payment-key}/reject',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _reverse_payment_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/gateway-settlement/payments/{payment-key}/chargeback',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def settle_payment(
        ...
        _param = self._settle_payment_serialize(
            payment_key=payment_key,
            request=request,
            idempotency_key=idempotency_key,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def settle_payment_without_preload_content(
        self,
        payment_key: Annotated[StrictStr, Field(description="The payment number starting with \"P-\" or the unique payment ID.")],
        request: SettlePaymentRequest,
        idempotency_key: Annotated[Optional[Annotated[str, Field(strict=True, max_length=255)]], Field(description="Specify a unique idempotency key if you want to perform an idempotent POST or PATCH request. Do not use this header in other request types.   With this header specified, the Zuora server can identify subsequent retries of the same request using this value, which prevents the same operation from being performed multiple times by accident.  ")] = None,
    ...
    def _settle_payment_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/gateway-settlement/payments/{payment-key}/settle',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
