...
class OAuthApi:
    ...
    def create_token(
        self,
        client_id: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The Client ID of the OAuth client. ")],
        client_secret: Annotated[str, Field(strict=True, max_length=42, description="The Client Secret that was displayed when the OAuth client was created. ")],
