...
class CustomExchangeRatesApi:
    ...
    def get_custom_exchange_rates(
        self,
        currency: Annotated[StrictStr, Field(description="The target base currency of the tenant. The exchange rates in the response are calculated in relation to the target currency.  The value must be a three-letter currency code, for example, USD.  ")],
        start_date: Annotated[StrictStr, Field(description="Start date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-15. The start date cannot be later than the end date. ")],
        end_date: Annotated[StrictStr, Field(description="End date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-16. The end date can be a maximum of 90 days after the start date. ")],
        ...
        _param = self._get_custom_exchange_rates_serialize(
            currency=currency,
    ...
    @validate_call
    def get_custom_exchange_rates_with_http_info(
        self,
        currency: Annotated[StrictStr, Field(description="The target base currency of the tenant. The exchange rates in the response are calculated in relation to the target currency.  The value must be a three-letter currency code, for example, USD.  ")],
        start_date: Annotated[StrictStr, Field(description="Start date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-15. The start date cannot be later than the end date. ")],
        end_date: Annotated[StrictStr, Field(description="End date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-16. The end date can be a maximum of 90 days after the start date. ")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCustomExchangeRatesType]:
        """List custom exchange rates by currency
    ...
    @validate_call
    def get_custom_exchange_rates_without_preload_content(
        self,
        currency: Annotated[StrictStr, Field(description="The target base currency of the tenant. The exchange rates in the response are calculated in relation to the target currency.  The value must be a three-letter currency code, for example, USD.  ")],
        start_date: Annotated[StrictStr, Field(description="Start date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-15. The start date cannot be later than the end date. ")],
        end_date: Annotated[StrictStr, Field(description="End date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-16. The end date can be a maximum of 90 days after the start date. ")],
    ...
    def _get_custom_exchange_rates_serialize(
        self,
        currency,
        start_date,
        end_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/custom-exchange-rates/{currency}',
