...
class UpdateOpenPaymentMethodTypeRequest(BaseModel):
    ...
    """ # noqa: E501
    entity_id: Optional[StrictStr] = Field(default=None, description="If this custom payment method type is specific to one entity only, specify the entity ID in UUID format when creating the draft payment method type, such as `123e4567-e89b-12d3-a456-426614174000`.  You can only update this field to be empty, indicating that this custom payment method type is available to the global entity and all the sub entities in the tenant. ", alias="entityId")
