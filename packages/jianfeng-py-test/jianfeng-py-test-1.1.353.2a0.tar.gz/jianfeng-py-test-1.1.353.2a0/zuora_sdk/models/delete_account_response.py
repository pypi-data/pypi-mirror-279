...
class DeleteAccountResponse(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The ID of the deleted account.")
    job_id: Optional[StrictStr] = Field(default=None, description="The ID of the job that handles the account deletion operation.   You can specify the value of this field as the value of the `jobId` path parameter in the [Retrieve an operation job](https://www.zuora.com/developer/api-references/api/operation/Get_OperationJob/) API operation to query job information. ", alias="jobId")
    job_status: Optional[StrictStr] = Field(default=None, alias="jobStatus")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "id", "jobId", "jobStatus"]
