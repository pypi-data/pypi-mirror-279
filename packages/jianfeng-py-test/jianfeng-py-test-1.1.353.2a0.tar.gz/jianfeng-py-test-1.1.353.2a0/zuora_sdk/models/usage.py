...
class Usage(BaseModel):
    ...
    """ # noqa: E501
    var_date: Optional[StrictStr] = Field(default=None, description="The date when the usage record is created. ", alias="date")
    values: Optional[UsageValues] = None
    __properties: ClassVar[List[str]] = ["date", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "values": UsageValues.from_dict(obj["values"]) if obj.get("values") is not None else None
        })
        return _obj
