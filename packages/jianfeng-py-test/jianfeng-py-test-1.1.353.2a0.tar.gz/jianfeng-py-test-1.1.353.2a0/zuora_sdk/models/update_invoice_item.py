...
class UpdateInvoiceItem(BaseModel):
    ...
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount of the invoice item.   - For tax-inclusive invoice items, the amount indicates the invoice item amount including tax.  - For tax-exclusive invoice items, the amount indicates the invoice item amount excluding tax. ")
    ...
    charge_name: Optional[StrictStr] = Field(default=None, description="The name of the charge associated with the invoice item.   This field is required if the `productRatePlanChargeId` field is not specified in the request. ", alias="chargeName")
    ...
    discount_items: Optional[List[UpdateDiscountInvoiceItem]] = Field(default=None, description="Container for discount items. The maximum number of discount items is 10.", alias="discountItems")
    ...
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the invoice item.")
    item_type: Optional[StrictStr] = Field(default=None, description="The type of the invoice item.", alias="itemType")
    purchase_order_number: Optional[StrictStr] = Field(default=None, description="The purchase order number associated the invoice item.", alias="purchaseOrderNumber")
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of units for the invoice item.")
    ...
    revenue_recognition_rule_name: Optional[StrictStr] = Field(default=None, description="The name of the revenue recognition rule governing the revenueschedule. **Note:** This field is only available if you have Zuora Finance enabled.", alias="revenueRecognitionRuleName")
    service_end_date: Optional[date] = Field(default=None, description="The service end date of the invoice item.", alias="serviceEndDate")
    service_start_date: Optional[date] = Field(default=None, description="The service start date of the invoice item.", alias="serviceStartDate")
    sku: Optional[StrictStr] = Field(default=None, description="The SKU of the invoice item. The SKU of the invoice item must be different from the SKU of any existing product.")
    tax_code: Optional[StrictStr] = Field(default=None, description="The tax code identifies which tax rules and tax rates to apply to the invoice item.  **Note:**  - This field is only available if you have Taxation enabled. - If the values of both `taxCode` and `taxMode` fields are changed to `null` when updating a standalone invoice, the corresponding `invoiceItems` > `taxItems` field and its nested fields specified in the creation request will be removed. ", alias="taxCode")
    ...
    uom: Optional[StrictStr] = Field(default=None, description="The unit of measure.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "SyncDate__NS", "accountingCode", "adjustmentLiabilityAccountingCode", "adjustmentRevenueAccountingCode", "amount", "chargeDate", "chargeName", "contractAssetAccountingCode", "contractLiabilityAccountingCode", "contractRecognizedRevenueAccountingCode", "deferredRevenueAccountingCode", "description", "discountItems", "excludeItemBillingFromRevenueAccounting", "id", "itemType", "purchaseOrderNumber", "quantity", "recognizedRevenueAccountingCode", "revRecCode", "revRecTriggerCondition", "revenueRecognitionRuleName", "serviceEndDate", "serviceStartDate", "sku", "taxCode", "taxMode", "unbilledReceivablesAccountingCode", "unitPrice", "uom"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "discountItems": [UpdateDiscountInvoiceItem.from_dict(_item) for _item in obj["discountItems"]] if obj.get("discountItems") is not None else None,
