...
class ErrorResponse(BaseModel):
    ...
    ErrorResponse
    """ # noqa: E501
    reasons: Optional[List[ErrorResponseReasonsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reasons": [ErrorResponseReasonsInner.from_dict(_item) for _item in obj["reasons"]] if obj.get("reasons") is not None else None
        })
