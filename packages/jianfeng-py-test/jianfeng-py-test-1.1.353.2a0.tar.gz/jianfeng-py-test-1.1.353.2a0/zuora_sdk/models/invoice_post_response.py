...
class InvoicePostResponse(BaseModel):
    ...
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the invoice was posted successfully. ")
    id: Optional[StrictStr] = Field(default=None, description="The ID of the invoice that was posted. ")
