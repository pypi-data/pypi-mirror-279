...
class OrganizationLabel(BaseModel):
    ...
    cascading_down: Optional[StrictBool] = Field(default=None, description="Cascading down ", alias="cascadingDown")
    excluded: Optional[StrictBool] = Field(default=None, description="Excluded ")
    __properties: ClassVar[List[str]] = ["organizationId", "organizationName", "cascadingDown", "excluded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cascadingDown": obj.get("cascadingDown"),
