...
class GetAccountingCodesResponse(BaseModel):
    ...
    """ # noqa: E501
    accounting_codes: Optional[List[AccountingCodeItemResponse]] = Field(default=None, description="An array of all the accounting codes in your chart of accounts. Each accounting code has the following fields. ", alias="accountingCodes")
    ...
    __properties: ClassVar[List[str]] = ["accountingCodes", "nextPage", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accountingCodes": [AccountingCodeItemResponse.from_dict(_item) for _item in obj["accountingCodes"]] if obj.get("accountingCodes") is not None else None,
