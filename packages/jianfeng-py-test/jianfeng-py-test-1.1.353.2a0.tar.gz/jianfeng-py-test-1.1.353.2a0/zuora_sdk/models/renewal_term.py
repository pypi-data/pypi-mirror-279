...
class RenewalTerm(BaseModel):
    ...
    RenewalTerm
    """ # noqa: E501
    period: Optional[StrictInt] = Field(default=None, description="Duration of the renewal term in months, years, days, or weeks, depending on the value of the `periodType` field. ")
    period_type: Optional[StrictStr] = Field(default=None, alias="periodType")
    __properties: ClassVar[List[str]] = ["period", "periodType"]
