...
class SubscriptionCreditMemo(BaseModel):
    ...
    credit_memo_items: Optional[List[SubscriptionCreditMemoItem]] = Field(default=None, alias="creditMemoItems")
    tax_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax amount on the credit memo.", alias="taxAmount")
    __properties: ClassVar[List[str]] = ["amount", "amountWithoutTax", "creditMemoItems", "taxAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "creditMemoItems": [SubscriptionCreditMemoItem.from_dict(_item) for _item in obj["creditMemoItems"]] if obj.get("creditMemoItems") is not None else None,
