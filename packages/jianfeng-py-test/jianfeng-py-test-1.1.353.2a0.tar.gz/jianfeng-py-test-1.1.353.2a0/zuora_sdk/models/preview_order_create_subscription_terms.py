...
class PreviewOrderCreateSubscriptionTerms(BaseModel):
    ...
    renewal_terms: Optional[List[RenewalTerm]] = Field(default=None, description="List of renewal terms of the subscription. Only applicable if the type of the first term is `TERMED` and the value of the `renewalSetting` field is `RENEW_WITH_SPECIFIC_TERM`. ", alias="renewalTerms")
