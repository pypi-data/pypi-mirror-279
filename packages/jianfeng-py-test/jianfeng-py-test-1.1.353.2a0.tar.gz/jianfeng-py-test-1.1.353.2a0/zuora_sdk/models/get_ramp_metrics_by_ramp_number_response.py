...
class GetRampMetricsByRampNumberResponse(BaseModel):
    ...
    ramp_metrics: Optional[RampMetrics] = Field(default=None, alias="rampMetrics")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "rampMetrics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rampMetrics": RampMetrics.from_dict(obj["rampMetrics"]) if obj.get("rampMetrics") is not None else None
        })
        return _obj
