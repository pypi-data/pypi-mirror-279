...
class UpdateSubscriptionCustomFieldsOfASpecifiedVersionRequest(BaseModel):
    ...
    rate_plans: Optional[List[UpdateSubscriptionRatePlanCustomFieldsOfASpecifiedVersion]] = Field(default=None, alias="ratePlans")
    __properties: ClassVar[List[str]] = ["customFields", "ratePlans"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ratePlans": [UpdateSubscriptionRatePlanCustomFieldsOfASpecifiedVersion.from_dict(_item) for _item in obj["ratePlans"]] if obj.get("ratePlans") is not None else None
        })
        return _obj
