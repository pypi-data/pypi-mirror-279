...
class GetTaxationItemsResponse(BaseModel):
    ...
    taxation_items: Optional[List[TaxationItem]] = Field(default=None, description="Container for taxation items. ", alias="taxationItems")
    __properties: ClassVar[List[str]] = ["success", "taxationItems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxationItems": [TaxationItem.from_dict(_item) for _item in obj["taxationItems"]] if obj.get("taxationItems") is not None else None
        })
        return _obj
