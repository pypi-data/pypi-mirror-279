...
class GetPaymentRunDataArrayResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[GetPaymentRunDataElementResponse]] = Field(default=None, description="Container for payment run data. Each element in the array is a record processed by the payment run. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetPaymentRunDataElementResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
