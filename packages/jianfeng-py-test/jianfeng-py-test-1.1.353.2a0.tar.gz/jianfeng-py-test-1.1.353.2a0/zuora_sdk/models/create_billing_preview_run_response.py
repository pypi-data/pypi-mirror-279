...
class CreateBillingPreviewRunResponse(BaseModel):
    ...
    billing_preview_run_id: Optional[StrictStr] = Field(default=None, description="Id of the billing preview run. ", alias="billingPreviewRunId")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "billingPreviewRunId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "billingPreviewRunId": obj.get("billingPreviewRunId")
        })
        return _obj
