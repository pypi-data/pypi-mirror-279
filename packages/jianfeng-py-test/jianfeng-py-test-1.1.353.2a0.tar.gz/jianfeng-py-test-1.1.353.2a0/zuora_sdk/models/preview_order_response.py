...
class PreviewOrderResponse(BaseModel):
    ...
    preview_result: Optional[PreviewOrderResult] = Field(default=None, alias="previewResult")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "previewResult"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "previewResult": PreviewOrderResult.from_dict(obj["previewResult"]) if obj.get("previewResult") is not None else None
        })
        return _obj
