...
class CustomObjectRecordsThrottledResponse(BaseModel):
    ...
    details: Optional[List[CustomObjectRecordsWithError]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "details": [CustomObjectRecordsWithError.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
