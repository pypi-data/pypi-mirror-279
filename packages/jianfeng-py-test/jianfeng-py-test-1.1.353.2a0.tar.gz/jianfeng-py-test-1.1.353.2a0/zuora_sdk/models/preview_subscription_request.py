...
class PreviewSubscriptionRequest(BaseModel):
    ...
    initial_term: Optional[StrictInt] = Field(default=None, description="Duration of the first term of the subscription, in whole months. If `termType` is `TERMED`, then this field is required, and the value must be greater than `0`. If `termType` is `EVERGREEN`, this field is ignored.     ", alias="initialTerm")
