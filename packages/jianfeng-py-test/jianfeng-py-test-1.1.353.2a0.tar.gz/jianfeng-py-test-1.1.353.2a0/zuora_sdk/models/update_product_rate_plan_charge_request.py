...
class UpdateProductRatePlanChargeRequest(BaseModel):
    ...
    end_date_condition: Optional[EndDateConditionProductRatePlanChargeRest] = Field(default=None, alias="EndDateCondition")
    ...
    number_of_period: Optional[StrictInt] = Field(default=None, description="Specifies the number of periods to use when calculating charges in an overage smoothing charge model. The valid value must be a positive whole number. ", alias="NumberOfPeriod")
    ...
    price_change_option: Optional[PriceChangeOption] = Field(default=None, alias="PriceChangeOption")
    ...
    product_rate_plan_charge_tier_data: List[ProductRatePlanChargeTier] = Field(alias="ProductRatePlanChargeTierData")
    ...
    up_to_periods_type: Optional[UpToPeriodsTypeProductRatePlanChargeRest] = Field(default=None, alias="UpToPeriodsType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ProductRatePlanChargeTierData": [ProductRatePlanChargeTier.from_dict(_item) for _item in obj["ProductRatePlanChargeTierData"]] if obj.get("ProductRatePlanChargeTierData") is not None else None,
