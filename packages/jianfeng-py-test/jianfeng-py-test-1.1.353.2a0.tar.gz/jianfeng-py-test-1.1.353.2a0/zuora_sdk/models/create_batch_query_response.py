...
class CreateBatchQueryResponse(BaseModel):
    ...
    record_count: Optional[StrictStr] = Field(default=None, description="The number of records included in the query output file. ", alias="recordCount")
    localized_status: Optional[StrictStr] = Field(default=None, alias="localizedStatus")
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["apiVersion", "batchId", "batchType", "deleted", "full", "name", "query", "recordCount", "localizedStatus", "status"]
