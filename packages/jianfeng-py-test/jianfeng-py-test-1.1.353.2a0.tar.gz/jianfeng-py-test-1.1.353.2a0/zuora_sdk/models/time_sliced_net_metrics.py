...
class TimeSlicedNetMetrics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amount", "discountChargeNumber", "endDate", "generatedReason", "invoiceOwner", "orderItemId", "startDate", "subscriptionOwner", "termNumber", "type"]
