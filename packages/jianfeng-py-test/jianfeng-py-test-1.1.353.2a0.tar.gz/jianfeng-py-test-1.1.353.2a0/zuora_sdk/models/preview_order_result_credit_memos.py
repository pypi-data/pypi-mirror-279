...
class PreviewOrderResultCreditMemos(BaseModel):
    ...
    credit_memo_items: Optional[List[InvoiceItemPreviewResult]] = Field(default=None, alias="creditMemoItems")
    ...
    __properties: ClassVar[List[str]] = ["amount", "amountWithoutTax", "creditMemoItems", "targetDate", "taxAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "creditMemoItems": [InvoiceItemPreviewResult.from_dict(_item) for _item in obj["creditMemoItems"]] if obj.get("creditMemoItems") is not None else None,
