...
class CreateOrderResponseOrderAction(BaseModel):
    ...
    order_metrics: Optional[List[CreateOrderResponseOrderMetric]] = Field(default=None, description="subscription order metrics", alias="orderMetrics")
    __properties: ClassVar[List[str]] = ["id", "type", "orderMetrics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "orderMetrics": [CreateOrderResponseOrderMetric.from_dict(_item) for _item in obj["orderMetrics"]] if obj.get("orderMetrics") is not None else None
        })
        return _obj
