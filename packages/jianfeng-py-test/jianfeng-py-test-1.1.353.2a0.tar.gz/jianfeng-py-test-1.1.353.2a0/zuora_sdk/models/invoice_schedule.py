...
class InvoiceSchedule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountId", "actualAmount", "additionalSubscriptionsToBill", "billedAmount", "id", "invoiceSeparately", "nextRunDate", "notes", "number", "orders", "scheduleItems", "specificSubscriptions", "status", "totalAmount", "unbilledAmount"]
