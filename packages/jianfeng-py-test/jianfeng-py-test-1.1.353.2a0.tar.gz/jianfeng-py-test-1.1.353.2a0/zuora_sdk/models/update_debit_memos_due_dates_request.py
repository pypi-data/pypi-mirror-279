...
class UpdateDebitMemosDueDatesRequest(BaseModel):
    ...
    """ # noqa: E501
    debit_memos: Optional[List[DebitMemoDueDate]] = Field(default=None, description="Container for debit memo update details. ", alias="debitMemos")
    __properties: ClassVar[List[str]] = ["debitMemos"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "debitMemos": [DebitMemoDueDate.from_dict(_item) for _item in obj["debitMemos"]] if obj.get("debitMemos") is not None else None
        })
        return _obj
