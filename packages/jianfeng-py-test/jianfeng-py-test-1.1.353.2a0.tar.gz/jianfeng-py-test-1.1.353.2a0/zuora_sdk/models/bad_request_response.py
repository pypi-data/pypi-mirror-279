...
class BadRequestResponse(BaseModel):
    ...
    BadRequestResponse
    """ # noqa: E501
    errors: Optional[List[BadRequestErrors]] = Field(default=None, alias="Errors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Errors": [BadRequestErrors.from_dict(_item) for _item in obj["Errors"]] if obj.get("Errors") is not None else None
        })
