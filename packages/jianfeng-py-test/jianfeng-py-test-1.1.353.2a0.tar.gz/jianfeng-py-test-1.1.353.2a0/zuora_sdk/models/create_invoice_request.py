...
class CreateInvoiceRequest(BaseModel):
    ...
    sequence_set: Optional[StrictStr] = Field(default=None, description="The ID or name of the sequence set associated with the invoice.", alias="sequenceSet")
    ...
    template_id: Optional[StrictStr] = Field(default=None, description="The ID of the invoice template. **Note**: This field requires Flexible Billing Attribute.", alias="templateId")
