...
class RegenerateBookingRequest(BaseModel):
    ...
    subscription_version: Optional[StrictInt] = Field(default=None, alias="subscriptionVersion")
    ...
    __properties: ClassVar[List[str]] = ["type", "subscriptionId", "subscriptionNumber", "subscriptionVersion", "orderLineItemId", "orderNumber", "itemNumber"]
