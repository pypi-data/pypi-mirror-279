...
class GetPaymentPartsResponse(BaseModel):
    ...
    parts: Optional[List[PaymentPart]] = Field(default=None, description="Container for payment parts. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parts": [PaymentPart.from_dict(_item) for _item in obj["parts"]] if obj.get("parts") is not None else None,
