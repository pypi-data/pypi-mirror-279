...
class DocumentIdList(BaseModel):
    ...
    object_ids: Optional[List[StrictStr]] = Field(default=None, description="Collection of Billing Document Ids", alias="objectIds")
    __properties: ClassVar[List[str]] = ["docType", "objectIds"]
