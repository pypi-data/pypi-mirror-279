...
class UpdateRefundRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["comment", "financeInformation", "reasonCode", "referenceId", "gatewayReconciliationStatus", "gatewayReconciliationReason", "payoutId"]
