...
class GetSubscriptionsResponse(BaseModel):
    ...
    subscriptions: Optional[List[GetSubscriptionResponse]] = Field(default=None, description="Array of subscriptions. ")
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully. ")
    __properties: ClassVar[List[str]] = ["nextPage", "subscriptions", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptions": [GetSubscriptionResponse.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None,
