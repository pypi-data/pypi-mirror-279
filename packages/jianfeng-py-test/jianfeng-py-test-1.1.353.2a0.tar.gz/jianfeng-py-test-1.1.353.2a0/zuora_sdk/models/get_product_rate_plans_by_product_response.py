...
class GetProductRatePlansByProductResponse(BaseModel):
    ...
    product_rate_plans: Optional[List[ProductRatePlan]] = Field(default=None, description="Container for one or more product rate plans. ", alias="productRatePlans")
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully. ")
    __properties: ClassVar[List[str]] = ["nextPage", "productRatePlans", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productRatePlans": [ProductRatePlan.from_dict(_item) for _item in obj["productRatePlans"]] if obj.get("productRatePlans") is not None else None,
