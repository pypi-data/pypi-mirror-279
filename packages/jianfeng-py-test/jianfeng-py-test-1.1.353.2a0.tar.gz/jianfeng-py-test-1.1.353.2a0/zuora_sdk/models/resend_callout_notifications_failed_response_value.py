...
class ResendCalloutNotificationsFailedResponseValue(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The error code of response. ")
    message: Optional[StrictStr] = Field(default=None, description="The detail information of the error response")
