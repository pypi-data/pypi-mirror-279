...
class UsageOveragePricingUpdate(BaseModel):
    ...
    included_units: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="A certain quantity of units for free in the overage charge model. It cannot be negative. It must be 0 and above. Decimals are allowed. ", alias="includedUnits")
    overage_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="overagePrice")
    __properties: ClassVar[List[str]] = ["priceChangeOption", "priceIncreasePercentage", "includedUnits", "overagePrice"]
