...
class RenewSubscriptionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["applicationOrder", "applyCredit", "applyCreditBalance", "collect", "creditMemoReasonCode", "documentDate", "invoice", "invoiceCollect", "invoiceTargetDate", "orderDate", "runBilling", "targetDate"]
