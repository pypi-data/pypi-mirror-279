...
class UpdateSubscriptionRequest(BaseModel):
    ...
    current_term: Optional[StrictInt] = Field(default=None, description="The length of the period for the current subscription term. If `termType` is `TERMED`, this field is required and must be greater than `0`. If `termType` is `EVERGREEN`, this value is ignored. ", alias="currentTerm")
    ...
    notes: Optional[StrictStr] = Field(default=None, description="String of up to 500 characters. ")
    ...
    renewal_term: Optional[StrictInt] = Field(default=None, description="The length of the period for the subscription renewal term. Default is `0`. ", alias="renewalTerm")
