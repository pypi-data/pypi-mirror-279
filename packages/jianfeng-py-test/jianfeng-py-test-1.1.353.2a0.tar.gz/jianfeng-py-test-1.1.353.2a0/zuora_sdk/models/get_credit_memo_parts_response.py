...
class GetCreditMemoPartsResponse(BaseModel):
    ...
    parts: Optional[List[CreditMemoPart]] = Field(default=None, description="Container for credit memo parts. ")
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully.")
    __properties: ClassVar[List[str]] = ["nextPage", "parts", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parts": [CreditMemoPart.from_dict(_item) for _item in obj["parts"]] if obj.get("parts") is not None else None,
