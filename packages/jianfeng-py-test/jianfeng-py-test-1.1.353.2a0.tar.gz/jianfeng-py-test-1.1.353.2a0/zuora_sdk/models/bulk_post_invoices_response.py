...
class BulkPostInvoicesResponse(BaseModel):
    ...
    invoices: Optional[List[InvoicePostResponse]] = Field(default=None, description="The container for a list of posted invoices. ")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "invoices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoices": [InvoicePostResponse.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
