...
class RecurringPerUnitPricingUpdate(BaseModel):
    ...
    quantity: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = None
    original_list_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The original list price is the price of a product or service at which it is listed for sale by a manufacturer or retailer. ", alias="originalListPrice")
    __properties: ClassVar[List[str]] = ["priceChangeOption", "priceIncreasePercentage", "listPrice", "quantity", "originalListPrice"]
