...
class GetOrderLineItemResponse(BaseModel):
    ...
    order_line_item: Optional[GetOrderLineItem] = Field(default=None, alias="orderLineItem")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "orderLineItem"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderLineItem": GetOrderLineItem.from_dict(obj["orderLineItem"]) if obj.get("orderLineItem") is not None else None
        })
        return _obj
