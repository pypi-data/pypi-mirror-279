...
class OrderActionRatePlanPricingUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chargeModelData", "discount", "recurringDelivery", "recurringFlatFee", "recurringPerUnit", "recurringTiered", "recurringVolume", "usageFlatFee", "usageOverage", "usagePerUnit", "usageTiered", "usageTieredWithOverage", "usageVolume"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recurringDelivery": OrderActionRatePlanRecurringDeliveryPricingUpdate.from_dict(obj["recurringDelivery"]) if obj.get("recurringDelivery") is not None else None,
