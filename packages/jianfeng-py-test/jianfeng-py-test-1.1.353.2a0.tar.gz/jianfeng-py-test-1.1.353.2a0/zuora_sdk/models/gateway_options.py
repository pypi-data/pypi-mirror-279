...
class GatewayOptions(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The name of a gateway-specific parameter. ")
    value: Optional[StrictStr] = Field(default=None, description="The value of the gateway-specific parameter. ")
