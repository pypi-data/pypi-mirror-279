...
class CreateOrderCreateSubscription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billToContactId", "invoiceSeparately", "invoiceTemplateId", "newSubscriptionOwnerAccount", "notes", "paymentTerm", "sequenceSetId", "soldToContactId", "subscribeToProducts", "subscribeToRatePlans", "subscriptionNumber", "subscriptionOwnerAccountNumber", "terms", "currency", "invoiceGroupNumber"]
