...
class CreateInvoiceCollectInvoices(BaseModel):
    ...
    """ # noqa: E501
    invoice_amount: Optional[StrictStr] = Field(default=None, description="The amount of the invoice. ", alias="invoiceAmount")
    invoice_id: Optional[StrictStr] = Field(default=None, description="The ID of the invoice. ", alias="invoiceId")
    ...
    __properties: ClassVar[List[str]] = ["invoiceAmount", "invoiceId", "invoiceNumber"]
