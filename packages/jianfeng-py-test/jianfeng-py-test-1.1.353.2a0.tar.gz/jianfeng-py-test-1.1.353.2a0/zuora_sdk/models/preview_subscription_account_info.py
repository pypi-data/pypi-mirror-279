...
class PreviewSubscriptionAccountInfo(BaseModel):
    ...
    bill_cycle_day: StrictInt = Field(description="The account's bill cycle day (BCD), when bill runs generate invoices for the account. Specify any day of the month (`1`-`31`, where `31` = end-of-month), or `0` for auto-set. ", alias="billCycleDay")
    ...
    __properties: ClassVar[List[str]] = ["Class__NS", "CustomerType__NS", "Department__NS", "IntegrationId__NS", "IntegrationStatus__NS", "Location__NS", "Subsidiary__NS", "SyncDate__NS", "SynctoNetSuite__NS", "billCycleDay", "billToContact", "currency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "billToContact": PreviewSubscriptionBillToContact.from_dict(obj["billToContact"]) if obj.get("billToContact") is not None else None,
