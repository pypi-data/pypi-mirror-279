...
class AddSubscriptionRatePlan(BaseModel):
    ...
    charge_overrides: Optional[List[AddSubscriptionComponent]] = Field(default=None, description="This optional container is used to override the quantity of one or more product rate plan charges for this subscription. ", alias="chargeOverrides")
    ...
    service_activation_date: Optional[date] = Field(default=None, description="The date when the new product in the subscription is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the `serviceActivationDate` field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate <= serviceActivationDate <= contractAcceptanceDate ", alias="serviceActivationDate")
    __properties: ClassVar[List[str]] = ["bookingDate", "chargeOverrides", "contractEffectiveDate", "customerAcceptanceDate", "externalCatalogPlanId", "externalIdSourceSystem", "externallyManagedPlanId", "productRatePlanId", "productRatePlanNumber", "serviceActivationDate"]
