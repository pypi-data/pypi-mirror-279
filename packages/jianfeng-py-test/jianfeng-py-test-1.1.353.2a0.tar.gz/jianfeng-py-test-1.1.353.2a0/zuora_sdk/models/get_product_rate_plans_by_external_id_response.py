...
class GetProductRatePlansByExternalIdResponse(BaseModel):
    ...
    """ # noqa: E501
    product_rate_plans: Optional[List[ProductRatePlanWithExternalId]] = Field(default=None, description="Container for one or more product rate plans. ", alias="productRatePlans")
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully. ")
    __properties: ClassVar[List[str]] = ["productRatePlans", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "productRatePlans": [ProductRatePlanWithExternalId.from_dict(_item) for _item in obj["productRatePlans"]] if obj.get("productRatePlans") is not None else None,
