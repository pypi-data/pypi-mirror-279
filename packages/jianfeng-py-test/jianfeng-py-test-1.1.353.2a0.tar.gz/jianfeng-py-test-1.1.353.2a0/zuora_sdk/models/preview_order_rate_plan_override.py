...
class PreviewOrderRatePlanOverride(BaseModel):
    ...
    """ # noqa: E501
    charge_overrides: Optional[List[PreviewOrderChargeOverride]] = Field(default=None, description="List of charges associated with the rate plan. ", alias="chargeOverrides")
    ...
    __properties: ClassVar[List[str]] = ["chargeOverrides", "clearingExistingFeatures", "customFields", "productRatePlanId", "productRatePlanNumber", "subscriptionProductFeatures", "uniqueToken", "subscriptionRatePlanNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeOverrides": [PreviewOrderChargeOverride.from_dict(_item) for _item in obj["chargeOverrides"]] if obj.get("chargeOverrides") is not None else None,
