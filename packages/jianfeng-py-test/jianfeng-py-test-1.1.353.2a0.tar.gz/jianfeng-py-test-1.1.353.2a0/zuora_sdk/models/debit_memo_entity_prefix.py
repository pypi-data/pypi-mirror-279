...
class DebitMemoEntityPrefix(BaseModel):
    ...
    """ # noqa: E501
    prefix: Optional[StrictStr] = Field(default=None, description="The prefix of debit memos. ")
    start_number: Optional[StrictInt] = Field(default=None, description="The starting document number of debit memos. ", alias="startNumber")
