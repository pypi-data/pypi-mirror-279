...
class CreateOrderChangePlanRatePlanOverride(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chargeOverrides", "clearingExistingFeatures", "customFields", "externalCatalogPlanId", "externallyManagedPlanId", "productRatePlanId", "productRatePlanNumber", "subscriptionProductFeatures", "uniqueToken", "subscriptionRatePlanNumber", "isFromExternalCatalog", "ratePlanName"]
