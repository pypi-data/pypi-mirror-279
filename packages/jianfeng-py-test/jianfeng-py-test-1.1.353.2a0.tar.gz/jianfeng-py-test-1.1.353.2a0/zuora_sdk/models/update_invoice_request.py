...
class UpdateInvoiceRequest(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The ID of the invoice to be updated.")
    ...
    invoice_items: Optional[List[UpdateInvoiceItem]] = Field(default=None, description="Container for invoice items. The maximum number of items is 1,000.", alias="invoiceItems")
    transferred_to_accounting: Optional[StrictStr] = Field(default=None, alias="transferredToAccounting")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "SyncDate__NS", "autoPay", "comments", "dueDate", "id", "invoiceDate", "invoiceItems", "transferredToAccounting"]
