...
class BulkUpdateInvoicesRequest(BaseModel):
    ...
    """ # noqa: E501
    invoices: Optional[List[UpdateInvoiceRequest]] = Field(default=None, description="Container for invoice update details. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices": [UpdateInvoiceRequest.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
