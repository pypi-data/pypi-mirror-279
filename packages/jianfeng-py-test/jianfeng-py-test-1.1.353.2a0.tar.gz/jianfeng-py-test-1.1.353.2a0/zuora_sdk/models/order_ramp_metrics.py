...
class OrderRampMetrics(BaseModel):
    ...
    intervals: Optional[List[OrderRampIntervalMetrics]] = Field(default=None, description="The ramp metrics for each ramp intervals in its timeline.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intervals": [OrderRampIntervalMetrics.from_dict(_item) for _item in obj["intervals"]] if obj.get("intervals") is not None else None,
            "name": obj.get("name"),
