...
class GetChargeOverride(BaseModel):
    ...
    product_rateplan_charge_id: StrictStr = Field(description="Internal identifier of the product rate plan charge that the charge is based on. ", alias="productRateplanChargeId")
