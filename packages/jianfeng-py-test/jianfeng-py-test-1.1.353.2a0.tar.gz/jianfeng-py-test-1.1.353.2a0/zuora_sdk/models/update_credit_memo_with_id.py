...
class UpdateCreditMemoWithId(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="The ID of the credit memo. ")
    __properties: ClassVar[List[str]] = ["autoApplyUponPosting", "comment", "effectiveDate", "excludeFromAutoApplyRules", "items", "reasonCode", "transferredToAccounting", "IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "Transaction__NS", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [UpdateCreditMemoItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
