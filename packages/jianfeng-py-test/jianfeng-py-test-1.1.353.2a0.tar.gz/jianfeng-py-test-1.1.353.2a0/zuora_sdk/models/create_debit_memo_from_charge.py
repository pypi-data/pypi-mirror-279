...
class CreateDebitMemoFromCharge(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "SyncDate__NS", "accountId", "accountNumber", "autoPay", "autoPost", "charges", "comment", "customRates", "dueDate", "effectiveDate", "reasonCode", "currency", "number"]
