...
class ConfigTemplateErrorResponse(BaseModel):
    ...
    """ # noqa: E501
    reasons: Optional[List[ConfigTemplateErrorResponseReasonsInner]] = None
    __properties: ClassVar[List[str]] = ["reasons"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reasons": [ConfigTemplateErrorResponseReasonsInner.from_dict(_item) for _item in obj["reasons"]] if obj.get("reasons") is not None else None
        })
        return _obj
