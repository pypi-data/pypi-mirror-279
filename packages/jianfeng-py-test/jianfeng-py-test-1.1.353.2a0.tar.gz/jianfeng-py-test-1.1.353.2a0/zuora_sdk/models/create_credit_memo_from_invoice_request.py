...
class CreateCreditMemoFromInvoiceRequest(BaseModel):
    """
    ...
    auto_apply_to_invoice_upon_posting: Optional[StrictBool] = Field(default=None, description="Whether the credit memo automatically applies to the invoice upon posting.", alias="autoApplyToInvoiceUponPosting")
    ...
    comment: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="Comments about the credit memo.")
    ...
    exclude_from_auto_apply_rules: Optional[StrictBool] = Field(default=None, description="Whether the credit memo is excluded from the rule of automatically applying credit memos to invoices.", alias="excludeFromAutoApplyRules")
    invoice_id: Optional[StrictStr] = Field(default=None, description="The ID of the invoice that the credit memo is created from. * If this field is specified, its value must be the same as the value of the `invoiceId` path parameter. Otherwise, its value overrides the value of the `invoiceId` path parameter.  * If this field is not specified, the value of the `invoiceId` path parameter is used. ", alias="invoiceId")
    items: Optional[Annotated[List[CreditMemoItemFromInvoiceItem], Field(max_length=1000)]] = Field(default=None, description="Container for items. The maximum number of items is 1,000.")
    ...
    tax_auto_calculation: Optional[StrictBool] = Field(default=True, description="Whether to automatically calculate taxes in the credit memo.", alias="taxAutoCalculation")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "Transaction__NS", "autoApplyToInvoiceUponPosting", "autoPost", "comment", "effectiveDate", "excludeFromAutoApplyRules", "invoiceId", "items", "reasonCode", "taxAutoCalculation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "autoApplyToInvoiceUponPosting": obj.get("autoApplyToInvoiceUponPosting"),
            ...
            "items": [CreditMemoItemFromInvoiceItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
