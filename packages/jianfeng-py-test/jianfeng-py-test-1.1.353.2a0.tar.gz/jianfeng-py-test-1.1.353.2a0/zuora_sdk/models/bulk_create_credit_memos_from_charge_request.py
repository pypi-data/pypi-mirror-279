...
class BulkCreateCreditMemosFromChargeRequest(BaseModel):
    ...
    memos: Optional[Annotated[List[CreateCreditMemoFromCharge], Field(max_length=50)]] = Field(default=None, description="The container for a list of credit memos. The maximum number of credit memos is 50. ")
    __properties: ClassVar[List[str]] = ["sourceType", "memos"]

    @field_validator('source_type')
    def source_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Standalone']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sourceType": obj.get("sourceType") if obj.get("sourceType") is not None else 'Standalone',
            "memos": [CreateCreditMemoFromCharge.from_dict(_item) for _item in obj["memos"]] if obj.get("memos") is not None else None
        })
        return _obj
