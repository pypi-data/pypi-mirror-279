...
class PostCreateOrUpdateEmailTemplateRequestFormat(BaseModel):
    ...
    cc_email_type: Optional[StrictStr] = Field(default=None, alias="ccEmailType")
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID of an existing email template. Specify this field if you want to update an existing email template. ")
    ...
    __properties: ClassVar[List[str]] = ["active", "bccEmailAddress", "ccEmailAddress", "ccEmailType", "description", "emailBody", "emailSubject", "encodingType", "eventCategory", "eventTypeName", "eventTypeNamespace", "fromEmailAddress", "fromEmailType", "fromName", "id", "isHtml", "name", "replyToEmailAddress", "replyToEmailType", "toEmailAddress", "toEmailType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ccEmailType": obj.get("ccEmailType"),
