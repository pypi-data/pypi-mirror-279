...
class UpdateAccountRequest(BaseModel):
    ...
    default_payment_method_id: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="ID of the default payment method for the account.  Values: a valid ID for an existing payment method. ", alias="defaultPaymentMethodId")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Account name, up to 255 characters. ")
    ...
    __properties: ClassVar[List[str]] = ["Class__NS", "CustomerType__NS", "Department__NS", "IntegrationId__NS", "IntegrationStatus__NS", "Location__NS", "Subsidiary__NS", "SyncDate__NS", "SynctoNetSuite__NS", "additionalEmailAddresses", "autoPay", "batch", "billCycleDay", "billToContact", "communicationProfileId", "creditMemoTemplateId", "crmId", "customerServiceRepName", "debitMemoTemplateId", "defaultPaymentMethodId", "invoiceDeliveryPrefsEmail", "invoiceDeliveryPrefsPrint", "invoiceTemplateId", "name", "notes", "parentId", "partnerAccount", "paymentGateway", "paymentTerm", "profileNumber", "purchaseOrderNumber", "rollUpUsage", "salesRep", "sequenceSetId", "soldToContact", "tagging", "taxInfo", "paymentGatewayNumber", "summaryStatementTemplateId", "einvoiceProfile", "organizationLabel"]
