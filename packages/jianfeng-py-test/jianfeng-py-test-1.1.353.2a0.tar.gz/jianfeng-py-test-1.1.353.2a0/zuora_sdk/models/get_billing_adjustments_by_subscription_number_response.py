...
class GetBillingAdjustmentsBySubscriptionNumberResponse(BaseModel):
    ...
    adjustments: Optional[List[BillingAdjustment]] = Field(default=None, description="Container for all the adjustments of a subscription. ")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "adjustments"]
