...
class PostAttachmentResponse(BaseModel):
    ...
    file_id: Optional[StrictStr] = Field(default=None, description="ID to identify the attached file. Use this file ID with [Get files](https://www.zuora.com/developer/api-references/api/operation/Get_Files) to download the file. ", alias="fileId")
    id: Optional[StrictStr] = Field(default=None, description="Attachment id. ")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "fileId", "id"]
