...
class OrderDeltaTcb(BaseModel):
    ...
    order_line_item_id: Optional[StrictStr] = Field(default=None, description="The sytem generated Id for the Order Line Item. This field can be null if the metric is generated for a Rate Plan Charge. ", alias="orderLineItemId")
    __properties: ClassVar[List[str]] = ["chargeNumber", "currency", "endDate", "grossAmount", "netAmount", "orderActionId", "orderActionSequence", "orderActionType", "orderLineItemNumber", "productRatePlanChargeId", "ratePlanChargeId", "startDate", "subscriptionNumber", "orderLineItemId"]
