...
class CancelSubscriptionRequest(BaseModel):
    ...
    booking_date: Optional[date] = Field(default=None, description="The booking date that you want to set for the amendment contract when you cancel the subscription. The default value is the current date when you make the API call. ", alias="bookingDate")
    cancellation_effective_date: Optional[date] = Field(default=None, description="Date the cancellation takes effect, in the format yyyy-mm-dd.  Use only if `cancellationPolicy` is `SpecificDate`. Should not be earlier than the subscription contract-effective date, later than the subscription term-end date, or within a period for which the customer has been invoiced. ", alias="cancellationEffectiveDate")
    cancellation_policy: StrictStr = Field(description="Cancellation method. Possible values are: `EndOfCurrentTerm`, `EndOfLastInvoicePeriod`, `SpecificDate`. If using `SpecificDate`, the `cancellationEffectiveDate` field is required. ", alias="cancellationPolicy")
    ...
    contract_effective_date: Optional[date] = Field(default=None, description="The date when the customer notifies you that they want to cancel their subscription. ", alias="contractEffectiveDate")
    ...
    __properties: ClassVar[List[str]] = ["applicationOrder", "applyCredit", "applyCreditBalance", "bookingDate", "cancellationEffectiveDate", "cancellationPolicy", "collect", "contractEffectiveDate", "creditMemoReasonCode", "documentDate", "invoice", "invoiceCollect", "invoiceTargetDate", "orderDate", "runBilling", "targetDate"]
