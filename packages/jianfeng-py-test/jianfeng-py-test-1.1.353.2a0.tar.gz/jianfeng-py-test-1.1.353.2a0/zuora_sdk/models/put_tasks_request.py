...
class PutTasksRequest(BaseModel):
    ...
    PutTasksRequest
    """ # noqa: E501
    data: Optional[List[UpdateTask]] = Field(default=None, description="The list of tasks to update. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [UpdateTask.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
