...
class OrderDeltaTcv(BaseModel):
    ...
    order_line_item_id: Optional[StrictStr] = Field(default=None, description="The sytem generated Id for the Order Line Item. This field can be null if the metric is generated for subscriptions. ", alias="orderLineItemId")
