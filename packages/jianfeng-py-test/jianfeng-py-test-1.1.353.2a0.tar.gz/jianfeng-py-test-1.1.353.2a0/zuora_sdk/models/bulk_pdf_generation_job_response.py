...
class BulkPdfGenerationJobResponse(BaseModel):
    ...
    job_id: Optional[StrictStr] = Field(default=None, description="Unique Id for the Job Triggered. ", alias="jobId")
    invalid_ids: Optional[List[StrictStr]] = Field(default=None, description="Collection of Ids that are not valid.    Id is considered to be invalid if,      * Billing Document Id doesn't exist in the database for the corresponding Billing Document Type   * generateMissingPDF property is false in the Job Request and Valid PDF doesn't exist for the Billing Document Id ", alias="invalidIds")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "jobId", "invalidIds"]
