...
class CreateFulfillmentsRequest(BaseModel):
    ...
    """ # noqa: E501
    fulfillments: Optional[List[CreateFulfillment]] = None
    processing_options: Optional[ProcessingOptions] = Field(default=None, alias="processingOptions")
    __properties: ClassVar[List[str]] = ["fulfillments", "processingOptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fulfillments": [CreateFulfillment.from_dict(_item) for _item in obj["fulfillments"]] if obj.get("fulfillments") is not None else None,
