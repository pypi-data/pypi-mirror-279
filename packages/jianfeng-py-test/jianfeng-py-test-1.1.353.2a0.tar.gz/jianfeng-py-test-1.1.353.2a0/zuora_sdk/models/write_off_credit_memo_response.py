...
class WriteOffCreditMemoResponse(BaseModel):
    ...
    debit_memo: Optional[WriteOffCreditMemoResponseDebitMemo] = Field(default=None, alias="debitMemo")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "debitMemo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "debitMemo": WriteOffCreditMemoResponseDebitMemo.from_dict(obj["debitMemo"]) if obj.get("debitMemo") is not None else None
        })
        return _obj
