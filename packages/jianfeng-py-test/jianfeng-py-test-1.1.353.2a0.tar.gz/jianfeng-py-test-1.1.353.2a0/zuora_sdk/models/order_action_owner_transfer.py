...
class OrderActionOwnerTransfer(BaseModel):
    ...
    """ # noqa: E501
    bill_to_contact_id: Optional[StrictStr] = Field(default=None, description="The contact id of the bill to contact that the subscription is being transferred to.  **Note**:    - If you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Bill_customers_at_subscription_level/Flexible_Billing_Attributes\" target=\"_blank\">Flexible Billing Attributes</a> feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.    - If you have the Flexible Billing Attributes feature enabled, and you do not specify this field in the request or you select **Default Contact from Account** for this field during subscription creation, the value of this field is automatically set to `null` in the response body. ", alias="billToContactId")
    ...
    destination_account_number: Optional[StrictStr] = Field(default=None, description="The account number of the account that the subscription is being transferred to. ", alias="destinationAccountNumber")
    destination_invoice_account_number: Optional[StrictStr] = Field(default=None, description="The account number of the invoice owner account that the subscription is being transferred to. ", alias="destinationInvoiceAccountNumber")
    ...
    payment_term: Optional[StrictStr] = Field(default=None, description="Name of the payment term associated with the account. For example, \"Net 30\". The payment term determines the due dates of invoices.  **Note**:    - If you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Bill_customers_at_subscription_level/Flexible_Billing_Attributes\" target=\"_blank\">Flexible Billing Attributes</a> feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.    - If you have the Flexible Billing Attributes feature enabled, and you do not specify this field in the request or you select **Default Term from Account** for this field during subscription creation, the value of this field is automatically set to `null` in the response body. ", alias="paymentTerm")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "destinationAccountNumber": obj.get("destinationAccountNumber"),
            "destinationInvoiceAccountNumber": obj.get("destinationInvoiceAccountNumber"),
