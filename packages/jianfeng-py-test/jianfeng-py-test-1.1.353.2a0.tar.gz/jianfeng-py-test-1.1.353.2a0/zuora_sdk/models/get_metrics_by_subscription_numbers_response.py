...
class GetMetricsBySubscriptionNumbersResponse(BaseModel):
    ...
    subscription_metrics: Optional[List[SubscriptionMetrics]] = Field(default=None, alias="subscriptionMetrics")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "subscriptionMetrics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptionMetrics": [SubscriptionMetrics.from_dict(_item) for _item in obj["subscriptionMetrics"]] if obj.get("subscriptionMetrics") is not None else None
        })
        return _obj
