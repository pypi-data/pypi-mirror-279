...
class AsyncOperationResponse(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The ID of the business object which is being operated.")
    job_id: Optional[StrictStr] = Field(default=None, description="The ID of the operation job.", alias="jobId")
    job_status: Optional[OperationJobStatus] = Field(default=None, alias="jobStatus")
