...
class AccountSummaryPaymentInvoice(BaseModel):
    ...
    """ # noqa: E501
    applied_payment_amount: Optional[StrictStr] = Field(default=None, description="Amount of payment applied to the invoice. ", alias="appliedPaymentAmount")
    ...
    __properties: ClassVar[List[str]] = ["appliedPaymentAmount", "invoiceId", "invoiceNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appliedPaymentAmount": obj.get("appliedPaymentAmount"),
