...
class OperationJobResponse(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The ID of the operation job to retrieve information about.")
    object_id: Optional[StrictStr] = Field(default=None, description="The ID of the business object which is being operated.", alias="objectId")
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "id", "objectId", "objectType", "operationType", "status"]
