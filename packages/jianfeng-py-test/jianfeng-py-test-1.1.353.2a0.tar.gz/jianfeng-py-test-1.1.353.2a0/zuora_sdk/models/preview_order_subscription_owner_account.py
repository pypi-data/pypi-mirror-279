...
class PreviewOrderSubscriptionOwnerAccount(BaseModel):
    ...
    additional_email_addresses: Optional[Annotated[str, Field(strict=True, max_length=1200)]] = Field(default=None, description="List of additional email addresses to receive emailed invoices. Values should be a comma-separated list of email addresses. ", alias="additionalEmailAddresses")
    ...
    custom_fields: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Container for custom fields of an Account object. ", alias="customFields")
    ...
    name: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Account name. ")
    ...
    sales_rep: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="The name of the sales representative associated with this account, if applicable. ", alias="salesRep")
