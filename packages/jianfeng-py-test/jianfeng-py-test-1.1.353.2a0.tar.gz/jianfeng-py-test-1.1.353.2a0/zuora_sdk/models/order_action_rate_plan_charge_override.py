...
class OrderActionRatePlanChargeOverride(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billing", "chargeNumber", "customFields", "description", "endDate", "pricing", "productRatePlanChargeId", "revRecCode", "revRecTriggerCondition", "revenueRecognitionRuleName", "startDate", "uniqueToken"]
