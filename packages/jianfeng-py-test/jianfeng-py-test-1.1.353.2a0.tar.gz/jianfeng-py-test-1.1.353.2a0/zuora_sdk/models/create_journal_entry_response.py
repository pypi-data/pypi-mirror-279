...
class CreateJournalEntryResponse(BaseModel):
    ...
    """ # noqa: E501
    journal_entry_number: Optional[StrictStr] = Field(default=None, description="Journal entry number in the format JE-00000001. ", alias="journalEntryNumber")
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully. ")
    __properties: ClassVar[List[str]] = ["journalEntryNumber", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "journalEntryNumber": obj.get("journalEntryNumber"),
