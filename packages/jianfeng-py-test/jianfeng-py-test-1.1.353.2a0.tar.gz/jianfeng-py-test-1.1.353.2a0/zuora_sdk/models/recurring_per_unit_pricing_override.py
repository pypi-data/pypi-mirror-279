...
class RecurringPerUnitPricingOverride(BaseModel):
    ...
    list_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Per-unit price of the charge in each recurring period. ", alias="listPrice")
    ...
    __properties: ClassVar[List[str]] = ["priceChangeOption", "priceIncreasePercentage", "listPrice", "originalListPrice", "uom", "listPriceBase", "quantity", "specificListPriceBase"]
