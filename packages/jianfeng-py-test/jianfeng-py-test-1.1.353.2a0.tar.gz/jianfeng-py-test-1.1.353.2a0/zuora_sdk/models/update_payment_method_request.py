...
class UpdatePaymentMethodRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["expirationMonth", "expirationYear", "securityCode", "accountHolderInfo", "accountKey", "authGateway", "currencyCode", "gatewayOptions", "ipAddress", "mandateInfo", "processingOptions"]
