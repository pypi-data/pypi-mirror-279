...
class GetBatchQueryJobResponse(BaseModel):
    ...
    """ # noqa: E501
    batches: Optional[List[GetBatchQueryResponse]] = Field(default=None, description="A JSON array object that contains a list of batch objects. ")
    ...
    start_time: Optional[StrictStr] = Field(default=None, description="The start time of the query.  ", alias="startTime")
    ...
    __properties: ClassVar[List[str]] = ["batches", "encrypted", "format", "id", "name", "partner", "project", "offset", "useLastCompletedJobQueries", "startTime", "status", "localizedStatus", "version", "errorCode", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "batches": [GetBatchQueryResponse.from_dict(_item) for _item in obj["batches"]] if obj.get("batches") is not None else None,
