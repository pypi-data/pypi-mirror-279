...
class ApplyPaymentRequest(BaseModel):
    ...
    effective_date: Optional[StrictStr] = Field(default=None, description="The date when the payment application takes effect, in `yyyy-mm-dd` format. ", alias="effectiveDate")
