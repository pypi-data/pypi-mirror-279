...
class UpdateSubscriptionChargeCustomFieldsOfASpecifiedVersion(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chargeId", "chargeNumber", "customFields"]
