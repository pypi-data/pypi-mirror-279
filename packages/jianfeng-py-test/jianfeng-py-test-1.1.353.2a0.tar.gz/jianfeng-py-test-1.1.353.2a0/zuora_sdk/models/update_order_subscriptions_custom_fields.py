...
class UpdateOrderSubscriptionsCustomFields(BaseModel):
    ...
    """ # noqa: E501
    order_actions: Optional[List[UpdateOrderSubscriptionsOrderActionsCustomFields]] = Field(default=None, alias="orderActions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orderActions": [UpdateOrderSubscriptionsOrderActionsCustomFields.from_dict(_item) for _item in obj["orderActions"]] if obj.get("orderActions") is not None else None,
