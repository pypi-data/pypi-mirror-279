    ...
    def make_instance(self, include_optional) -> CreditMemoItemResponse:
        ...
        if include_optional:
            return CreditMemoItemResponse(
                ...
                finance_information = zuora_sdk.models.credit_memo_item_finance_information.CreditMemoItemFinanceInformation(
                ...
                taxation_items = zuora_sdk.models.get_credit_memo_item_taxation_items.GetCreditMemoItemTaxationItems(
                    data = [
                        { }
                        ], 
                    next_page = '', ),
