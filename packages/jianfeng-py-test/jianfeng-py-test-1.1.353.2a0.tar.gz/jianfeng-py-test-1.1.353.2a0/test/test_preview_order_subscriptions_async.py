...
class TestPreviewOrderSubscriptionsAsync(unittest.TestCase):
    """PreviewOrderSubscriptionsAsync unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreviewOrderSubscriptionsAsync:
        """Test PreviewOrderSubscriptionsAsync
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreviewOrderSubscriptionsAsync`
        """
        model = PreviewOrderSubscriptionsAsync()
        if include_optional:
            return PreviewOrderSubscriptionsAsync(
                custom_fields = {
                    'key' : None
                    },
                order_actions = [
    ...
    def testPreviewOrderSubscriptionsAsync(self):
        """Test PreviewOrderSubscriptionsAsync"""
