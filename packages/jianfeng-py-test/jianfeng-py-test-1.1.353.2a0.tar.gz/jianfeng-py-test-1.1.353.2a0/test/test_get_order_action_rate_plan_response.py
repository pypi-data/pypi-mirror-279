...
class TestGetOrderActionRatePlanResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetOrderActionRatePlanResponse:
        ...
        """
        model = GetOrderActionRatePlanResponse()
        if include_optional:
            return GetOrderActionRatePlanResponse(
                ...
                success = True,
                amendment = zuora_sdk.models.order_action_rate_plan_amendment.OrderActionRatePlanAmendment(
                    code = '', 
                ...
                id = '',
                last_change_type = '',
                order = zuora_sdk.models.order_action_rate_plan_order.OrderActionRatePlanOrder(
                    id = '', 
                    order_actions = [
