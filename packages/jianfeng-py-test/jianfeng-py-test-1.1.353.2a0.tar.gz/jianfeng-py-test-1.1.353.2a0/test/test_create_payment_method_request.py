    ...
    def make_instance(self, include_optional) -> CreatePaymentMethodRequest:
        ...
        if include_optional:
            return CreatePaymentMethodRequest(
                ...
                email = '',
                preapproval_key = '',
                card_holder_info = zuora_sdk.models.card_holder_info.cardHolderInfo(
                    address_line1 = '', 
                    address_line2 = '', 
                    card_holder_name = '', 
                    city = '', 
                ...
                zip_code = '',
                iban = '',
                account_holder_info = zuora_sdk.models.create_payment_method_bank_transfer_account_holder_info.CreatePaymentMethodBankTransfer_accountHolderInfo(
                    account_holder_name = '', 
                    address_line1 = '', 
                    address_line2 = '', 
                    city = '', 
