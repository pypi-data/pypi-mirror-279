...
class TestPreviewOrderCreateSubscription(unittest.TestCase):
    """PreviewOrderCreateSubscription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreviewOrderCreateSubscription:
        """Test PreviewOrderCreateSubscription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreviewOrderCreateSubscription`
        """
        model = PreviewOrderCreateSubscription()
        if include_optional:
    ...
    def testPreviewOrderCreateSubscription(self):
        """Test PreviewOrderCreateSubscription"""
