...
class CreateOrderChangePlanRatePlanOverride(BaseModel):
    """
    Information about the new product rate plan to add.    # noqa: E501
    """
    ...
    __properties = ["chargeOverrides", "clearingExistingFeatures", "customFields", "externalCatalogPlanId", "externallyManagedPlanId", "productRatePlanId", "productRatePlanNumber", "subscriptionProductFeatures", "uniqueToken", "subscriptionRatePlanNumber", "isFromExternalCatalog", "ratePlanName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOrderChangePlanRatePlanOverride:
        """Create an instance of CreateOrderChangePlanRatePlanOverride from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrderChangePlanRatePlanOverride:
        """Create an instance of CreateOrderChangePlanRatePlanOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOrderChangePlanRatePlanOverride.parse_obj(obj)

        _obj = CreateOrderChangePlanRatePlanOverride.parse_obj({
