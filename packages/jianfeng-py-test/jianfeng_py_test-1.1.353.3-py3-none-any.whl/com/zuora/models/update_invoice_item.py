...
class UpdateInvoiceItem(BaseModel):
    ...
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The amount of the invoice item.   - For tax-inclusive invoice items, the amount indicates the invoice item amount including tax.  - For tax-exclusive invoice items, the amount indicates the invoice item amount excluding tax. ")
    ...
    discount_items: Optional[conlist(UpdateDiscountInvoiceItem)] = Field(None, alias="discountItems", description="Container for discount items. The maximum number of discount items is 10.")
    ...
    id: Optional[StrictStr] = Field(None, description="The unique ID of the invoice item.")
    item_type: Optional[StrictStr] = Field(None, alias="itemType", description="The type of the invoice item.")
    purchase_order_number: Optional[StrictStr] = Field(None, alias="purchaseOrderNumber", description="The purchase order number associated the invoice item.")
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The number of units for the invoice item.")
    ...
    revenue_recognition_rule_name: Optional[StrictStr] = Field(None, alias="revenueRecognitionRuleName", description="The name of the revenue recognition rule governing the revenueschedule. **Note:** This field is only available if you have Zuora Finance enabled.")
    service_end_date: Optional[date] = Field(None, alias="serviceEndDate", description="The service end date of the invoice item.")
    service_start_date: Optional[date] = Field(None, alias="serviceStartDate", description="The service start date of the invoice item.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateInvoiceItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateInvoiceItem:
        """Create an instance of UpdateInvoiceItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateInvoiceItem.parse_obj(obj)

        _obj = UpdateInvoiceItem.parse_obj({
            ...
            "discount_items": [UpdateDiscountInvoiceItem.from_dict(_item) for _item in obj.get("discountItems")] if obj.get("discountItems") is not None else None,
