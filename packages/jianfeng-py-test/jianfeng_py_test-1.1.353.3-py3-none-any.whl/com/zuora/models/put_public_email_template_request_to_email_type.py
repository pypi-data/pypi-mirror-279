...
class PutPublicEmailTemplateRequestToEmailType(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PutPublicEmailTemplateRequestToEmailType:
        """Create an instance of PutPublicEmailTemplateRequestToEmailType from a JSON string"""
        return PutPublicEmailTemplateRequestToEmailType(json.loads(json_str))
