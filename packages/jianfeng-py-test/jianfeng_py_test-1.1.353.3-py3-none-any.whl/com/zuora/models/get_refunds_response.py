...
class GetRefundsResponse(BaseModel):
    ...
    refunds: Optional[conlist(Refund)] = Field(None, description="Container for refunds. ")
    success: Optional[StrictBool] = Field(None, description="Returns `true` if the request was processed successfully.")
    __properties = ["nextPage", "refunds", "success"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRefundsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRefundsResponse:
        """Create an instance of GetRefundsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRefundsResponse.parse_obj(obj)

        _obj = GetRefundsResponse.parse_obj({
            "next_page": obj.get("nextPage"),
            "refunds": [Refund.from_dict(_item) for _item in obj.get("refunds")] if obj.get("refunds") is not None else None,
