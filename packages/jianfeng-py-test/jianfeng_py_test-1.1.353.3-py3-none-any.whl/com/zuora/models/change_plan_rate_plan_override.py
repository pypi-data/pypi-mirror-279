...
class ChangePlanRatePlanOverride(BaseModel):
    """
    ...
    __properties = ["chargeOverrides", "clearingExistingFeatures", "customFields", "externallyManagedPlanId", "productRatePlanId", "productRatePlanNumber", "subscriptionProductFeatures", "uniqueToken"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChangePlanRatePlanOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChangePlanRatePlanOverride:
        """Create an instance of ChangePlanRatePlanOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChangePlanRatePlanOverride.parse_obj(obj)

        _obj = ChangePlanRatePlanOverride.parse_obj({
