...
class CreditMemoItemsResponse(BaseModel):
    """
    ...
    items: Optional[conlist(CreditMemoItem)] = Field(None, description="Container for credit memo items. ")
    ...
    __properties = ["processId", "requestId", "reasons", "success", "items", "nextPage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreditMemoItemsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreditMemoItemsResponse:
        """Create an instance of CreditMemoItemsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreditMemoItemsResponse.parse_obj(obj)

        _obj = CreditMemoItemsResponse.parse_obj({
            ...
            "items": [CreditMemoItem.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
