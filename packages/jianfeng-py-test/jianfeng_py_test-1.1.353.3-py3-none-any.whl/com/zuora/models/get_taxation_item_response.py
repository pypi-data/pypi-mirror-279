...
class GetTaxationItemResponse(BaseModel):
    ...
    __properties = ["createdById", "createdDate", "exemptAmount", "financeInformation", "id", "invoiceItemId", "jurisdiction", "locationCode", "memoItemId", "name", "sourceTaxItemId", "taxAmount", "applicableTaxUnRounded", "country", "taxCode", "taxCodeDescription", "taxDate", "taxMode", "taxRate", "taxRateDescription", "taxRateType", "updatedById", "updatedDate", "success"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTaxationItemResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTaxationItemResponse:
        """Create an instance of GetTaxationItemResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTaxationItemResponse.parse_obj(obj)

        _obj = GetTaxationItemResponse.parse_obj({
