...
class CreateSubscribeToProduct(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSubscribeToProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSubscribeToProduct:
        """Create an instance of CreateSubscribeToProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSubscribeToProduct.parse_obj(obj)

        _obj = CreateSubscribeToProduct.parse_obj({
