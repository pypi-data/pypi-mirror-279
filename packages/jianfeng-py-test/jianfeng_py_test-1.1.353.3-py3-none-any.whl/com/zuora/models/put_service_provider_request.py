...
class PutServiceProviderRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PutServiceProviderRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PutServiceProviderRequest:
        """Create an instance of PutServiceProviderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PutServiceProviderRequest.parse_obj(obj)

        _obj = PutServiceProviderRequest.parse_obj({
            "name": obj.get("name"),
            "test": obj.get("test"),
