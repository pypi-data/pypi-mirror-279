...
class UsagePerUnitPricingUpdate(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsagePerUnitPricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsagePerUnitPricingUpdate:
        """Create an instance of UsagePerUnitPricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsagePerUnitPricingUpdate.parse_obj(obj)

        _obj = UsagePerUnitPricingUpdate.parse_obj({
