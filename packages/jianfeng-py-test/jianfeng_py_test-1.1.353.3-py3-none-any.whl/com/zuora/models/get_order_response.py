...
class GetOrderResponse(BaseModel):
    ...
    __properties = ["processId", "requestId", "reasons", "success", "order"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOrderResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOrderResponse:
        """Create an instance of GetOrderResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOrderResponse.parse_obj(obj)

        _obj = GetOrderResponse.parse_obj({
