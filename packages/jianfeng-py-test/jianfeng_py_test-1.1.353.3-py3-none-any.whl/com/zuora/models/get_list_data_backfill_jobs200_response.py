...
class GETListDataBackfillJobs200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GETListDataBackfillJobs200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GETListDataBackfillJobs200Response:
        """Create an instance of GETListDataBackfillJobs200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GETListDataBackfillJobs200Response.parse_obj(obj)

        _obj = GETListDataBackfillJobs200Response.parse_obj({
