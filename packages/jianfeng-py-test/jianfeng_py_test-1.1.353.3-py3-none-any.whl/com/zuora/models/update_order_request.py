...
class UpdateOrderRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateOrderRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateOrderRequest:
        """Create an instance of UpdateOrderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateOrderRequest.parse_obj(obj)

        _obj = UpdateOrderRequest.parse_obj({
