...
class SubscriptionRatePlan(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionRatePlan:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionRatePlan:
        """Create an instance of SubscriptionRatePlan from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionRatePlan.parse_obj(obj)

        _obj = SubscriptionRatePlan.parse_obj({
            "id": obj.get("id"),
