...
class PaymentScheduleItemResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentScheduleItemResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentScheduleItemResponse:
        """Create an instance of PaymentScheduleItemResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentScheduleItemResponse.parse_obj(obj)

        _obj = PaymentScheduleItemResponse.parse_obj({
