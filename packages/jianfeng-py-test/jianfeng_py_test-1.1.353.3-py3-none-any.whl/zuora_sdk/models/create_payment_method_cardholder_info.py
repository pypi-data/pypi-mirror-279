...
class CreatePaymentMethodCardholderInfo(BaseModel):
    """
    Container for cardholder information. This container field is required for credit card payment methods. The nested `cardHolderName` field is required.   # noqa: E501
    """
    ...
    card_holder_name: Optional[StrictStr] = Field(None, alias="cardHolderName", description="The card holder's full name as it appears on the card, e.g., \"John J Smith\", 50 characters or less. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePaymentMethodCardholderInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePaymentMethodCardholderInfo:
        """Create an instance of CreatePaymentMethodCardholderInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePaymentMethodCardholderInfo.parse_obj(obj)

        _obj = CreatePaymentMethodCardholderInfo.parse_obj({
