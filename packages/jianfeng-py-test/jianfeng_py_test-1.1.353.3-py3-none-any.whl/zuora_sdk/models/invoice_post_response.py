...
class InvoicePostResponse(BaseModel):
    ...
    success: Optional[StrictBool] = Field(None, description="Returns `true` if the invoice was posted successfully. ")
    id: Optional[StrictStr] = Field(None, description="The ID of the invoice that was posted. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvoicePostResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvoicePostResponse:
        """Create an instance of InvoicePostResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvoicePostResponse.parse_obj(obj)

        _obj = InvoicePostResponse.parse_obj({
