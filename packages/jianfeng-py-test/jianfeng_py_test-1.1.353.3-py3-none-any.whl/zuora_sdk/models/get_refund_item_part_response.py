...
class GetRefundItemPartResponse(BaseModel):
    ...
    __properties = ["amount", "createdById", "createdDate", "creditMemoItemId", "creditTaxItemId", "id", "updatedById", "updatedDate", "organizationLabel", "processId", "requestId", "reasons", "success"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRefundItemPartResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRefundItemPartResponse:
        """Create an instance of GetRefundItemPartResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRefundItemPartResponse.parse_obj(obj)

        _obj = GetRefundItemPartResponse.parse_obj({
