...
class InvoiceItemObjectNSFields(BaseModel):
    """
    Container for Invoice Item fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvoiceItemObjectNSFields:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvoiceItemObjectNSFields:
        """Create an instance of InvoiceItemObjectNSFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvoiceItemObjectNSFields.parse_obj(obj)

        _obj = InvoiceItemObjectNSFields.parse_obj({
