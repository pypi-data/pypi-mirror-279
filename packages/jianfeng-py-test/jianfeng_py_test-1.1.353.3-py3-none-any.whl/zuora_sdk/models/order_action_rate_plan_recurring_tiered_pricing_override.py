...
class OrderActionRatePlanRecurringTieredPricingOverride(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderActionRatePlanRecurringTieredPricingOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderActionRatePlanRecurringTieredPricingOverride:
        """Create an instance of OrderActionRatePlanRecurringTieredPricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderActionRatePlanRecurringTieredPricingOverride.parse_obj(obj)

        _obj = OrderActionRatePlanRecurringTieredPricingOverride.parse_obj({
