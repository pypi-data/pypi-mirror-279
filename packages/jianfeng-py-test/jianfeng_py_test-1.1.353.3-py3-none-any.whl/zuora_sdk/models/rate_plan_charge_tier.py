...
class RatePlanChargeTier(BaseModel):
    ...
    __properties = ["tier", "startingUnit", "endingUnit", "price", "priceFormat"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RatePlanChargeTier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RatePlanChargeTier:
        """Create an instance of RatePlanChargeTier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RatePlanChargeTier.parse_obj(obj)

        _obj = RatePlanChargeTier.parse_obj({
            "tier": obj.get("tier"),
