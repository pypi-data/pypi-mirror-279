...
class UpdateProductRatePlanChargeTierRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateProductRatePlanChargeTierRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateProductRatePlanChargeTierRequest:
        """Create an instance of UpdateProductRatePlanChargeTierRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateProductRatePlanChargeTierRequest.parse_obj(obj)

        _obj = UpdateProductRatePlanChargeTierRequest.parse_obj({
            "price": obj.get("Price")
        })
        return _obj
