...
class PriceChangeParams(BaseModel):
    ...
    __properties = ["priceChangeOption", "priceIncreasePercentage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PriceChangeParams:
        """Create an instance of PriceChangeParams from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PriceChangeParams:
        """Create an instance of PriceChangeParams from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PriceChangeParams.parse_obj(obj)

        _obj = PriceChangeParams.parse_obj({
