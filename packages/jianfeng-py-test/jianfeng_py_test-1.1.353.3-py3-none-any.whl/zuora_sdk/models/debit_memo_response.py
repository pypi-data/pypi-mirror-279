...
class DebitMemoResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DebitMemoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DebitMemoResponse:
        """Create an instance of DebitMemoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DebitMemoResponse.parse_obj(obj)

        _obj = DebitMemoResponse.parse_obj({
