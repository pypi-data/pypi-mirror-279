...
class DeleteAttachmentResponse(BaseModel):
    ...
    __properties = ["processId", "requestId", "reasons", "success"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAttachmentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAttachmentResponse:
        """Create an instance of DeleteAttachmentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAttachmentResponse.parse_obj(obj)

        _obj = DeleteAttachmentResponse.parse_obj({
