...
class UsageVolumePricingOverride(BaseModel):
    """
    ...
    __properties = ["priceChangeOption", "priceIncreasePercentage", "ratingGroup", "tiers", "uom"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsageVolumePricingOverride:
        """Create an instance of UsageVolumePricingOverride from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsageVolumePricingOverride:
        """Create an instance of UsageVolumePricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsageVolumePricingOverride.parse_obj(obj)

        _obj = UsageVolumePricingOverride.parse_obj({
