...
class CustomObjectCustomFieldDefinition(BaseModel):
    ...
    __properties = ["displayName", "format", "label", "maxLength", "multiselect", "origin", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomObjectCustomFieldDefinition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomObjectCustomFieldDefinition:
        """Create an instance of CustomObjectCustomFieldDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomObjectCustomFieldDefinition.parse_obj(obj)

        _obj = CustomObjectCustomFieldDefinition.parse_obj({
