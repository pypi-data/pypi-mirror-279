...
class ProxyActionqueryMoreResponse(BaseModel):
    ...
    query_locator: Optional[StrictStr] = Field(None, alias="queryLocator", description="A marker passed to QueryMore to get the next set of results.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProxyActionqueryMoreResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProxyActionqueryMoreResponse:
        """Create an instance of ProxyActionqueryMoreResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProxyActionqueryMoreResponse.parse_obj(obj)

        _obj = ProxyActionqueryMoreResponse.parse_obj({
            "done": obj.get("done"),
