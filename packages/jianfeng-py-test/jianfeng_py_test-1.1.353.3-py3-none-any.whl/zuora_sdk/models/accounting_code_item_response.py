...
class AccountingCodeItemResponse(BaseModel):
    ...
    __properties = ["category", "createdBy", "createdOn", "glAccountName", "glAccountNumber", "id", "name", "notes", "status", "type", "updatedBy", "updatedOn"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountingCodeItemResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountingCodeItemResponse:
        """Create an instance of AccountingCodeItemResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountingCodeItemResponse.parse_obj(obj)

        _obj = AccountingCodeItemResponse.parse_obj({
