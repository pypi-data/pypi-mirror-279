...
class RatePlanUpdate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RatePlanUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RatePlanUpdate:
        """Create an instance of RatePlanUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RatePlanUpdate.parse_obj(obj)

        _obj = RatePlanUpdate.parse_obj({
