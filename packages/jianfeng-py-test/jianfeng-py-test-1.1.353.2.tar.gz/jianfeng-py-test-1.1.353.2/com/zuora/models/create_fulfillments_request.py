...
class CreateFulfillmentsRequest(BaseModel):
    """
    CreateFulfillmentsRequest
    """
    fulfillments: Optional[conlist(CreateFulfillment)] = None
    processing_options: Optional[ProcessingOptions] = Field(None, alias="processingOptions")
    __properties = ["fulfillments", "processingOptions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFulfillmentsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFulfillmentsRequest:
        """Create an instance of CreateFulfillmentsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFulfillmentsRequest.parse_obj(obj)

        _obj = CreateFulfillmentsRequest.parse_obj({
            "fulfillments": [CreateFulfillment.from_dict(_item) for _item in obj.get("fulfillments")] if obj.get("fulfillments") is not None else None,
