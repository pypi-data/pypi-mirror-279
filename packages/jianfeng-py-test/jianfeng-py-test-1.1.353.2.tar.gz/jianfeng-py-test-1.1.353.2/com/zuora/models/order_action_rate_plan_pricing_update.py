...
class OrderActionRatePlanPricingUpdate(BaseModel):
    """
    ...
    recurring_delivery: Optional[OrderActionRatePlanRecurringDeliveryPricingUpdate] = Field(None, alias="recurringDelivery")
    ...
    __properties = ["chargeModelData", "discount", "recurringDelivery", "recurringFlatFee", "recurringPerUnit", "recurringTiered", "recurringVolume", "usageFlatFee", "usageOverage", "usagePerUnit", "usageTiered", "usageTieredWithOverage", "usageVolume"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderActionRatePlanPricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderActionRatePlanPricingUpdate:
        """Create an instance of OrderActionRatePlanPricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderActionRatePlanPricingUpdate.parse_obj(obj)

        _obj = OrderActionRatePlanPricingUpdate.parse_obj({
            ...
            "recurring_delivery": OrderActionRatePlanRecurringDeliveryPricingUpdate.from_dict(obj.get("recurringDelivery")) if obj.get("recurringDelivery") is not None else None,
