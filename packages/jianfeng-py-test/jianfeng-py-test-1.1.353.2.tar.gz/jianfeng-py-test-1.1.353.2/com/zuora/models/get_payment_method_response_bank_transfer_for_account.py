...
class GetPaymentMethodResponseBankTransferForAccount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPaymentMethodResponseBankTransferForAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPaymentMethodResponseBankTransferForAccount:
        """Create an instance of GetPaymentMethodResponseBankTransferForAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPaymentMethodResponseBankTransferForAccount.parse_obj(obj)

        _obj = GetPaymentMethodResponseBankTransferForAccount.parse_obj({
            "iban": obj.get("IBAN"),
