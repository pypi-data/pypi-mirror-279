...
class GetPaymentMethodForAccountResponse(BaseModel):
    ...
    identity_number: Optional[StrictStr] = Field(None, alias="identityNumber", description="The identity number used for Bank Transfer.         ")
    ...
    account_holder_info: Optional[GetAccountPMAccountHolderInfo] = Field(None, alias="accountHolderInfo")
    ...
    credit_card_mask_number: Optional[StrictStr] = Field(None, alias="creditCardMaskNumber", description="The masked credit card number, such as: ``` *********1112 ``` **Note:** This field is only returned for Credit Card Reference Transaction payment type. ")
    ...
    existing_mandate: Optional[StrictStr] = Field(None, alias="existingMandate", description="Indicates whether the mandate is an existing mandate. ")
    ...
    mandate_info: Optional[AccountPMMandateInfo] = Field(None, alias="mandateInfo")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPaymentMethodForAccountResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPaymentMethodForAccountResponse:
        """Create an instance of GetPaymentMethodForAccountResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPaymentMethodForAccountResponse.parse_obj(obj)

        _obj = GetPaymentMethodForAccountResponse.parse_obj({
            "iban": obj.get("IBAN"),
            ...
            "account_holder_info": GetAccountPMAccountHolderInfo.from_dict(obj.get("accountHolderInfo")) if obj.get("accountHolderInfo") is not None else None,
            ...
            "mandate_info": AccountPMMandateInfo.from_dict(obj.get("mandateInfo")) if obj.get("mandateInfo") is not None else None,
