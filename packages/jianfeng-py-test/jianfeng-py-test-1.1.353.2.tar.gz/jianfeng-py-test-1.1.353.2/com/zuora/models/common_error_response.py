...
class CommonErrorResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommonErrorResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommonErrorResponse:
        """Create an instance of CommonErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommonErrorResponse.parse_obj(obj)

        _obj = CommonErrorResponse.parse_obj({
            "code": obj.get("code"),
