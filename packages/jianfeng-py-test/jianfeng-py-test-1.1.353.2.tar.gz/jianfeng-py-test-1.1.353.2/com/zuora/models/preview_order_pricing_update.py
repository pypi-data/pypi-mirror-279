...
class PreviewOrderPricingUpdate(BaseModel):
    """
    ...
    __properties = ["chargeModelData", "discount", "recurringFlatFee", "recurringPerUnit", "recurringTiered", "recurringVolume", "usageFlatFee", "usageOverage", "usagePerUnit", "usageTiered", "usageTieredWithOverage", "usageVolume"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreviewOrderPricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreviewOrderPricingUpdate:
        """Create an instance of PreviewOrderPricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreviewOrderPricingUpdate.parse_obj(obj)

        _obj = PreviewOrderPricingUpdate.parse_obj({
