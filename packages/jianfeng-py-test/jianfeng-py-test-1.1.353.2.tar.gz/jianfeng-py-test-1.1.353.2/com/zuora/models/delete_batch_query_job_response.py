...
class DeleteBatchQueryJobResponse(BaseModel):
    ...
    """
    batches: Optional[conlist(DeleteBatchQueryResponse)] = Field(None, description="A JSON array object that contains a list of batch objects. ")
    ...
    __properties = ["batches", "format", "id", "name", "encrypted", "useLastCompletedJobQueries", "offset", "partner", "status", "localizedStatus", "version", "errorCode", "message"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteBatchQueryJobResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteBatchQueryJobResponse:
        """Create an instance of DeleteBatchQueryJobResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteBatchQueryJobResponse.parse_obj(obj)

        _obj = DeleteBatchQueryJobResponse.parse_obj({
            "batches": [DeleteBatchQueryResponse.from_dict(_item) for _item in obj.get("batches")] if obj.get("batches") is not None else None,
