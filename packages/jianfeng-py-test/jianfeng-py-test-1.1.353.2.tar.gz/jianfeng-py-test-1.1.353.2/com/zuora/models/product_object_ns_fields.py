...
class ProductObjectNSFields(BaseModel):
    """
    Container for Product fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501
    """
    ...
    __properties = ["IntegrationId__NS", "IntegrationStatus__NS", "ItemType__NS", "SyncDate__NS"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductObjectNSFields:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductObjectNSFields:
        """Create an instance of ProductObjectNSFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductObjectNSFields.parse_obj(obj)

        _obj = ProductObjectNSFields.parse_obj({
