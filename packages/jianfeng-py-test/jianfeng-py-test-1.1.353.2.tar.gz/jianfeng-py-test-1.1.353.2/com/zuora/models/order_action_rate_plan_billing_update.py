...
class OrderActionRatePlanBillingUpdate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderActionRatePlanBillingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderActionRatePlanBillingUpdate:
        """Create an instance of OrderActionRatePlanBillingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderActionRatePlanBillingUpdate.parse_obj(obj)

        _obj = OrderActionRatePlanBillingUpdate.parse_obj({
