...
class CancelOrderResponse(BaseModel):
    ...
    cancel_reason: Optional[StrictStr] = Field(None, alias="cancelReason", description="The reason for cancelling the order.")
    order_number: Optional[StrictStr] = Field(None, alias="orderNumber", description="The order number of the order created.")
    status: Optional[StrictStr] = Field(None, description="Status of the order. `Cancelled` is only valid value.")
    __properties = ["processId", "requestId", "reasons", "success", "accountNumber", "cancelReason", "orderNumber", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancelOrderResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancelOrderResponse:
        """Create an instance of CancelOrderResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancelOrderResponse.parse_obj(obj)

        _obj = CancelOrderResponse.parse_obj({
