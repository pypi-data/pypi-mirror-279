...
class BillRunResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillRunResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillRunResponse:
        """Create an instance of BillRunResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillRunResponse.parse_obj(obj)

        _obj = BillRunResponse.parse_obj({
