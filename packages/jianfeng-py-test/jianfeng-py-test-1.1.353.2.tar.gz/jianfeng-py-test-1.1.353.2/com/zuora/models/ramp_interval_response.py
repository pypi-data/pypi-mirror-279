...
class RampIntervalResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RampIntervalResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RampIntervalResponse:
        """Create an instance of RampIntervalResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RampIntervalResponse.parse_obj(obj)

        _obj = RampIntervalResponse.parse_obj({
