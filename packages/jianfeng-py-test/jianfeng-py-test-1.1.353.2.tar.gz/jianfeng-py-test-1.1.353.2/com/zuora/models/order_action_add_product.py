...
class OrderActionAddProduct(BaseModel):
    ...
    """
    charge_overrides: Optional[conlist(GetChargeOverride)] = Field(None, alias="chargeOverrides", description="List of charges associated with the rate plan. ")
    ...
    __properties = ["chargeOverrides", "clearingExistingFeatures", "customFields", "externallyManagedPlanId", "newRatePlanId", "productRatePlanId", "productRatePlanNumber", "subscriptionProductFeatures", "uniqueToken", "subscriptionRatePlanNumber", "isFromExternalCatalog", "ratePlanName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderActionAddProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderActionAddProduct:
        """Create an instance of OrderActionAddProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderActionAddProduct.parse_obj(obj)

        _obj = OrderActionAddProduct.parse_obj({
            "charge_overrides": [GetChargeOverride.from_dict(_item) for _item in obj.get("chargeOverrides")] if obj.get("chargeOverrides") is not None else None,
