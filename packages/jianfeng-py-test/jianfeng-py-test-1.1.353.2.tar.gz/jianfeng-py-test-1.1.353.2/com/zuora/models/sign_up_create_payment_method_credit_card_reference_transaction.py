...
class SignUpCreatePaymentMethodCreditCardReferenceTransaction(BaseModel):
    """
    ...
    __properties = ["secondTokenId", "tokenId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignUpCreatePaymentMethodCreditCardReferenceTransaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignUpCreatePaymentMethodCreditCardReferenceTransaction:
        """Create an instance of SignUpCreatePaymentMethodCreditCardReferenceTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignUpCreatePaymentMethodCreditCardReferenceTransaction.parse_obj(obj)

        _obj = SignUpCreatePaymentMethodCreditCardReferenceTransaction.parse_obj({
