...
class RegenerateTransactionObjectResponse(BaseModel):
    """
    ...
    id_list: Optional[conlist(StrictStr)] = Field(None, alias="idList")
    __properties = ["success", "processId", "idList"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegenerateTransactionObjectResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegenerateTransactionObjectResponse:
        """Create an instance of RegenerateTransactionObjectResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegenerateTransactionObjectResponse.parse_obj(obj)

        _obj = RegenerateTransactionObjectResponse.parse_obj({
            "success": obj.get("success"),
            "process_id": obj.get("processId"),
            "id_list": obj.get("idList")
        })
        return _obj
