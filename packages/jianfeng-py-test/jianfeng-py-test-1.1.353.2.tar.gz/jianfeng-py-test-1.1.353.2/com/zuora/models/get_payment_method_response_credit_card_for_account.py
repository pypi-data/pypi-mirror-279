...
class GetPaymentMethodResponseCreditCardForAccount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPaymentMethodResponseCreditCardForAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPaymentMethodResponseCreditCardForAccount:
        """Create an instance of GetPaymentMethodResponseCreditCardForAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPaymentMethodResponseCreditCardForAccount.parse_obj(obj)

        _obj = GetPaymentMethodResponseCreditCardForAccount.parse_obj({
