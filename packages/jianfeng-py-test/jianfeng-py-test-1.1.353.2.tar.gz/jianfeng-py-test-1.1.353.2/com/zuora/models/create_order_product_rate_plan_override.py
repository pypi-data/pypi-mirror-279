...
class CreateOrderProductRatePlanOverride(BaseModel):
    """
    Information about an order action of type `addProduct`.    # noqa: E501
    """
    ...
    __properties = ["chargeOverrides", "clearingExistingFeatures", "customFields", "externalCatalogPlanId", "externallyManagedPlanId", "productRatePlanId", "productRatePlanNumber", "subscriptionProductFeatures", "uniqueToken"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOrderProductRatePlanOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrderProductRatePlanOverride:
        """Create an instance of CreateOrderProductRatePlanOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOrderProductRatePlanOverride.parse_obj(obj)

        _obj = CreateOrderProductRatePlanOverride.parse_obj({
