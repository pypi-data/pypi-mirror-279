...
with com.zuora.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = com.zuora.APIHealthApi(api_client)
