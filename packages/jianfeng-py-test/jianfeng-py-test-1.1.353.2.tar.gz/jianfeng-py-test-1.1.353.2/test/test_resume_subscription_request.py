...
from com.zuora.models.resume_subscription_request import ResumeSubscriptionRequest  # noqa: E501

class TestResumeSubscriptionRequest(unittest.TestCase):
    """ResumeSubscriptionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResumeSubscriptionRequest:
        """Test ResumeSubscriptionRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResumeSubscriptionRequest`
        """
        model = ResumeSubscriptionRequest()  # noqa: E501
        if include_optional:
    ...
    def testResumeSubscriptionRequest(self):
        """Test ResumeSubscriptionRequest"""
