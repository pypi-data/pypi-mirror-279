...
from com.zuora.models.suspend_subscription_response import SuspendSubscriptionResponse  # noqa: E501
...
class TestSuspendSubscriptionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SuspendSubscriptionResponse:
        """Test SuspendSubscriptionResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuspendSubscriptionResponse`
        """
        model = SuspendSubscriptionResponse()  # noqa: E501
        if include_optional:
