...
from com.zuora.models.preview_order_charge_override import PreviewOrderChargeOverride  # noqa: E501

class TestPreviewOrderChargeOverride(unittest.TestCase):
    """PreviewOrderChargeOverride unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreviewOrderChargeOverride:
        """Test PreviewOrderChargeOverride
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreviewOrderChargeOverride`
        """
        model = PreviewOrderChargeOverride()  # noqa: E501
        if include_optional:
    ...
    def testPreviewOrderChargeOverride(self):
        """Test PreviewOrderChargeOverride"""
