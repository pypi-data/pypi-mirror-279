...
from com.zuora.models.pricing_update import PricingUpdate  # noqa: E501

class TestPricingUpdate(unittest.TestCase):
    """PricingUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PricingUpdate:
        """Test PricingUpdate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PricingUpdate`
        """
        model = PricingUpdate()  # noqa: E501
        if include_optional:
