...
from com.zuora.models.get_subscription_rate_plan_charges_with_all_segments import GetSubscriptionRatePlanChargesWithAllSegments  # noqa: E501

class TestGetSubscriptionRatePlanChargesWithAllSegments(unittest.TestCase):
    """GetSubscriptionRatePlanChargesWithAllSegments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSubscriptionRatePlanChargesWithAllSegments:
        """Test GetSubscriptionRatePlanChargesWithAllSegments
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSubscriptionRatePlanChargesWithAllSegments`
        """
        model = GetSubscriptionRatePlanChargesWithAllSegments()  # noqa: E501
        if include_optional:
            return GetSubscriptionRatePlanChargesWithAllSegments(
                billing_day = '',
    ...
    def testGetSubscriptionRatePlanChargesWithAllSegments(self):
        """Test GetSubscriptionRatePlanChargesWithAllSegments"""
