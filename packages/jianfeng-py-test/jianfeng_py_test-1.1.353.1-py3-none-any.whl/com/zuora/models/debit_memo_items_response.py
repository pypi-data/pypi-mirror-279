...
class DebitMemoItemsResponse(BaseModel):
    """
    ...
    items: Optional[conlist(DebitMemoItem)] = Field(None, description="Container for debit memo items. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DebitMemoItemsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DebitMemoItemsResponse:
        """Create an instance of DebitMemoItemsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DebitMemoItemsResponse.parse_obj(obj)

        _obj = DebitMemoItemsResponse.parse_obj({
            ...
            "items": [DebitMemoItem.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
