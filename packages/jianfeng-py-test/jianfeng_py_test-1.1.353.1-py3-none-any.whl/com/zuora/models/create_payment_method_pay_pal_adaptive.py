...
class CreatePaymentMethodPayPalAdaptive(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePaymentMethodPayPalAdaptive:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePaymentMethodPayPalAdaptive:
        """Create an instance of CreatePaymentMethodPayPalAdaptive from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePaymentMethodPayPalAdaptive.parse_obj(obj)

        _obj = CreatePaymentMethodPayPalAdaptive.parse_obj({
