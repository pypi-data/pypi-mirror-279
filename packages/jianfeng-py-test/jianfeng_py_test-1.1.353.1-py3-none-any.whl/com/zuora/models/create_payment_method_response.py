...
class CreatePaymentMethodResponse(BaseModel):
    ...
    reasons: Optional[conlist(CreatePaymentMethodResponseReason)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePaymentMethodResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePaymentMethodResponse:
        """Create an instance of CreatePaymentMethodResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePaymentMethodResponse.parse_obj(obj)

        _obj = CreatePaymentMethodResponse.parse_obj({
            "process_id": obj.get("processId"),
            "request_id": obj.get("requestId"),
            "reasons": [CreatePaymentMethodResponseReason.from_dict(_item) for _item in obj.get("reasons")] if obj.get("reasons") is not None else None,
