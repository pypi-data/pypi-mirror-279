...
class RecurringVolumePricingUpdate(BaseModel):
    """
    ...
    __properties = ["priceChangeOption", "priceIncreasePercentage", "quantity", "tiers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecurringVolumePricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecurringVolumePricingUpdate:
        """Create an instance of RecurringVolumePricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecurringVolumePricingUpdate.parse_obj(obj)

        _obj = RecurringVolumePricingUpdate.parse_obj({
