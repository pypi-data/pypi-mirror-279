...
class GetChargeOverride(BaseModel):
    """
    ...
    product_rateplan_charge_id: StrictStr = Field(..., alias="productRateplanChargeId", description="Internal identifier of the product rate plan charge that the charge is based on. ")
    ...
    __properties = ["billing", "chargeNumber", "customFields", "description", "drawdownRate", "endDate", "excludeItemBillingFromRevenueAccounting", "excludeItemBookingFromRevenueAccounting", "isAllocationEligible", "isRollover", "isUnbilled", "prepaidQuantity", "prorationOption", "pricing", "productRatePlanChargeNumber", "productRateplanChargeId", "revRecCode", "revRecTriggerCondition", "revenueRecognitionRuleName", "rolloverApply", "rolloverPeriods", "startDate", "uniqueToken", "upsellOriginChargeNumber", "validityPeriodType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetChargeOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetChargeOverride:
        """Create an instance of GetChargeOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetChargeOverride.parse_obj(obj)

        _obj = GetChargeOverride.parse_obj({
            ...
            "product_rateplan_charge_id": obj.get("productRateplanChargeId"),
