...
class BulkDebitMemosResponse(BaseModel):
    """
    ...
    memos: Optional[conlist(DebitMemoResponse, max_items=50)] = Field(None, description="The container for a list of debit memos. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BulkDebitMemosResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BulkDebitMemosResponse:
        """Create an instance of BulkDebitMemosResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BulkDebitMemosResponse.parse_obj(obj)

        _obj = BulkDebitMemosResponse.parse_obj({
            ...
            "memos": [DebitMemoResponse.from_dict(_item) for _item in obj.get("memos")] if obj.get("memos") is not None else None
        })
        return _obj
