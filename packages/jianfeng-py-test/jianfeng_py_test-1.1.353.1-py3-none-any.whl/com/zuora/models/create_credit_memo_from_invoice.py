...
class CreateCreditMemoFromInvoice(BaseModel):
    """
    ...
    invoice_id: Optional[StrictStr] = Field(None, alias="invoiceId", description="The ID of the invoice that the credit memo is created from. ")
    ...
    __properties = ["autoApplyToInvoiceUponPosting", "autoPost", "comment", "effectiveDate", "excludeFromAutoApplyRules", "invoiceId", "items", "reasonCode", "taxAutoCalculation", "IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "Transaction__NS"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCreditMemoFromInvoice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCreditMemoFromInvoice:
        """Create an instance of CreateCreditMemoFromInvoice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCreditMemoFromInvoice.parse_obj(obj)

        _obj = CreateCreditMemoFromInvoice.parse_obj({
