...
class GetRampsBySubscriptionKeyResponse(BaseModel):
    """
    ...
    ramps: Optional[conlist(RampResponse)] = None
    __properties = ["processId", "requestId", "reasons", "success", "ramps"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRampsBySubscriptionKeyResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRampsBySubscriptionKeyResponse:
        """Create an instance of GetRampsBySubscriptionKeyResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRampsBySubscriptionKeyResponse.parse_obj(obj)

        _obj = GetRampsBySubscriptionKeyResponse.parse_obj({
            ...
            "ramps": [RampResponse.from_dict(_item) for _item in obj.get("ramps")] if obj.get("ramps") is not None else None
        })
        return _obj
