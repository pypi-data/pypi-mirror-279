...
class DebitMemoItemFromInvoiceItemRequest(BaseModel):
    """
    DebitMemoItemFromInvoiceItemRequest
    """
    amount: Union[StrictFloat, StrictInt] = Field(..., description="The amount of the debit memo item.")
    ...
    finance_information: Optional[DebitMemoItemFromInvoiceItemFinanceInformation] = Field(None, alias="financeInformation")
    ...
    service_end_date: Optional[date] = Field(None, alias="serviceEndDate", description="The service end date of the debit memo item.")
    service_start_date: Optional[date] = Field(None, alias="serviceStartDate", description="The service start date of the debit memo item.  ")
    sku_name: StrictStr = Field(..., alias="skuName", description="The name of the charge associated with the invoice.")
    tax_items: Optional[conlist(DebitMemoTaxItemFromInvoiceTaxItemRequest)] = Field(None, alias="taxItems", description="Container for taxation items.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DebitMemoItemFromInvoiceItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DebitMemoItemFromInvoiceItemRequest:
        """Create an instance of DebitMemoItemFromInvoiceItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DebitMemoItemFromInvoiceItemRequest.parse_obj(obj)

        _obj = DebitMemoItemFromInvoiceItemRequest.parse_obj({
            "amount": obj.get("amount"),
            "comment": obj.get("comment"),
            "description": obj.get("description"),
            "finance_information": DebitMemoItemFromInvoiceItemFinanceInformation.from_dict(obj.get("financeInformation")) if obj.get("financeInformation") is not None else None,
            ...
            "tax_items": [DebitMemoTaxItemFromInvoiceTaxItemRequest.from_dict(_item) for _item in obj.get("taxItems")] if obj.get("taxItems") is not None else None,
