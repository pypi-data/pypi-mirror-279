...
class CreateOrderAsyncRequest(BaseModel):
    """
    ...
    processing_options: Optional[AsyncOrderProcessingOptions] = Field(None, alias="processingOptions")
    ...
    __properties = ["category", "customFields", "description", "existingAccountNumber", "externallyManagedBy", "newAccount", "orderDate", "orderLineItems", "orderNumber", "processingOptions", "reasonCode", "subscriptions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOrderAsyncRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrderAsyncRequest:
        """Create an instance of CreateOrderAsyncRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOrderAsyncRequest.parse_obj(obj)

        _obj = CreateOrderAsyncRequest.parse_obj({
            ...
            "processing_options": AsyncOrderProcessingOptions.from_dict(obj.get("processingOptions")) if obj.get("processingOptions") is not None else None,
