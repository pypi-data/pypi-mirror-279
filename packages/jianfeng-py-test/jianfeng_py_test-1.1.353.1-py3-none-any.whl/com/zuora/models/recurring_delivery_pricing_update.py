...
class RecurringDeliveryPricingUpdate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecurringDeliveryPricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecurringDeliveryPricingUpdate:
        """Create an instance of RecurringDeliveryPricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecurringDeliveryPricingUpdate.parse_obj(obj)

        _obj = RecurringDeliveryPricingUpdate.parse_obj({
