...
class TimeSlicedNetMetricsGeneratedReason(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimeSlicedNetMetricsGeneratedReason:
        """Create an instance of TimeSlicedNetMetricsGeneratedReason from a JSON string"""
        return TimeSlicedNetMetricsGeneratedReason(json.loads(json_str))
