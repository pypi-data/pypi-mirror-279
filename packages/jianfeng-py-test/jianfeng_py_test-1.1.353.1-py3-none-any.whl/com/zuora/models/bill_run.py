...
class BillRun(BaseModel):
    ...
    __properties = ["id", "name", "billRunNumber", "batches", "billCycleDay", "billRunFilters", "chargeTypeToExclude", "autoEmail", "autoPost", "autoRenewal", "noEmailForZeroAmountInvoice", "schedule", "scheduledExecutionTime", "status", "invoiceDate", "invoiceDateOffset", "invoiceDateMonthOffset", "invoiceDateDayOfMonth", "targetDate", "targetDateOffset", "targetDateMonthOffset", "targetDateDayOfMonth", "createdById", "createdDate", "updatedById", "updatedDate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillRun:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillRun:
        """Create an instance of BillRun from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillRun.parse_obj(obj)

        _obj = BillRun.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
