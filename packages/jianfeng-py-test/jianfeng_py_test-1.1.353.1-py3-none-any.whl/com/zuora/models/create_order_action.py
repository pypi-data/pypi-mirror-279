...
class CreateOrderAction(BaseModel):
    ...
    CreateOrderAction
    """
    create_subscription: Optional[CreateOrderCreateSubscription] = Field(None, alias="createSubscription")
    add_product: Optional[CreateOrderAddProduct] = Field(None, alias="addProduct")
    update_product: Optional[CreateOrderUpdateProduct] = Field(None, alias="updateProduct")
    ...
    __properties = ["createSubscription", "addProduct", "updateProduct", "changePlan", "ownerTransfer", "removeProduct", "renewSubscription", "cancelSubscription", "resume", "suspend", "termsAndConditions", "changeReason", "triggerDates", "type", "customFields"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOrderAction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrderAction:
        """Create an instance of CreateOrderAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOrderAction.parse_obj(obj)

        _obj = CreateOrderAction.parse_obj({
            "create_subscription": CreateOrderCreateSubscription.from_dict(obj.get("createSubscription")) if obj.get("createSubscription") is not None else None,
            "add_product": CreateOrderAddProduct.from_dict(obj.get("addProduct")) if obj.get("addProduct") is not None else None,
            "update_product": CreateOrderUpdateProduct.from_dict(obj.get("updateProduct")) if obj.get("updateProduct") is not None else None,
