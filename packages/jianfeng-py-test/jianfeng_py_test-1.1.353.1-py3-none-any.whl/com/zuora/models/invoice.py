...
from pydantic import BaseModel, Field, StrictBool, StrictStr, condecimal, constr, validator
...
class Invoice(BaseModel):
    ...
    __properties = ["IntegrationId__NS", "IntegrationStatus__NS", "SyncDate__NS", "accountId", "adjustmentAmount", "amount", "amountWithoutTax", "autoPay", "balance", "billRunId", "billToContactId", "billToContactSnapshotId", "comments", "createdById", "createdDate", "creditBalanceAdjustmentAmount", "creditMemoAmount", "currency", "discount", "dueDate", "eInvoiceStatus", "eInvoiceErrorCode", "eInvoiceErrorMessage", "eInvoiceFileId", "id", "includesOneTime", "includesRecurring", "includesUsage", "invoiceDate", "invoiceGroupNumber", "invoiceNumber", "lastEmailSentDate", "paymentAmount", "paymentTerm", "postedBy", "postedDate", "refundAmount", "sequenceSetId", "soldToContactId", "soldToContactSnapshotId", "source", "sourceId", "sourceType", "status", "targetDate", "taxAmount", "taxExemptAmount", "taxMessage", "taxStatus", "templateId", "transferredToAccounting", "updatedById", "updatedDate"]
