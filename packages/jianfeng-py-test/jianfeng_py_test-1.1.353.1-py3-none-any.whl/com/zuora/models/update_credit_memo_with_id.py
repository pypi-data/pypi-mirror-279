...
class UpdateCreditMemoWithId(BaseModel):
    ...
    __properties = ["autoApplyUponPosting", "comment", "effectiveDate", "excludeFromAutoApplyRules", "items", "reasonCode", "transferredToAccounting", "IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "Transaction__NS", "id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateCreditMemoWithId:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateCreditMemoWithId:
        """Create an instance of UpdateCreditMemoWithId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateCreditMemoWithId.parse_obj(obj)

        _obj = UpdateCreditMemoWithId.parse_obj({
