...
class CreateOrderUpdateProduct(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOrderUpdateProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrderUpdateProduct:
        """Create an instance of CreateOrderUpdateProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOrderUpdateProduct.parse_obj(obj)

        _obj = CreateOrderUpdateProduct.parse_obj({
