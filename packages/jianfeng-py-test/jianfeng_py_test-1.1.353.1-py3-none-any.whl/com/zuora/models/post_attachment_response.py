...
class PostAttachmentResponse(BaseModel):
    ...
    file_id: Optional[StrictStr] = Field(None, alias="fileId", description="ID to identify the attached file. Use this file ID with [Get files](https://www.zuora.com/developer/api-references/api/operation/Get_Files) to download the file. ")
    id: Optional[StrictStr] = Field(None, description="Attachment id. ")
    __properties = ["processId", "requestId", "reasons", "success", "fileId", "id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostAttachmentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostAttachmentResponse:
        """Create an instance of PostAttachmentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostAttachmentResponse.parse_obj(obj)

        _obj = PostAttachmentResponse.parse_obj({
