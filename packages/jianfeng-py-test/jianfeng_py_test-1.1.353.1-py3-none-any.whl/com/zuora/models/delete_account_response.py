...
class DeleteAccountResponse(BaseModel):
    ...
    id: Optional[StrictStr] = Field(None, description="The ID of the deleted account.")
    job_id: Optional[StrictStr] = Field(None, alias="jobId", description="The ID of the job that handles the account deletion operation.   You can specify the value of this field as the value of the `jobId` path parameter in the [Retrieve an operation job](https://www.zuora.com/developer/api-references/api/operation/Get_OperationJob/) API operation to query job information. ")
    job_status: Optional[StrictStr] = Field(None, alias="jobStatus")
    __properties = ["processId", "requestId", "reasons", "success", "id", "jobId", "jobStatus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAccountResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAccountResponse:
        """Create an instance of DeleteAccountResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAccountResponse.parse_obj(obj)

        _obj = DeleteAccountResponse.parse_obj({
