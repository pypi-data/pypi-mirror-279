...
class OrderDeltaMrr(BaseModel):
    """
    Order Delta Mrr. This is a metric that reflects the change to the TCV on rate plan charge object as the result of the order.   # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderDeltaMrr:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderDeltaMrr:
        """Create an instance of OrderDeltaMrr from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderDeltaMrr.parse_obj(obj)

        _obj = OrderDeltaMrr.parse_obj({
