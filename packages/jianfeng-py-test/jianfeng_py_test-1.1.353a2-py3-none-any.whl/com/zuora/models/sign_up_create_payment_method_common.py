...
class SignUpCreatePaymentMethodCommon(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignUpCreatePaymentMethodCommon:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignUpCreatePaymentMethodCommon:
        """Create an instance of SignUpCreatePaymentMethodCommon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignUpCreatePaymentMethodCommon.parse_obj(obj)

        _obj = SignUpCreatePaymentMethodCommon.parse_obj({
