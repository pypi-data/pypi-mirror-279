...
class ProductRatePlanObjectNSFields(BaseModel):
    """
    Container for Product Rate Plan fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501
    """
    ...
    __properties = ["BillingPeriod__NS", "Class__NS", "Department__NS", "IncludeChildren__NS", "IntegrationId__NS", "IntegrationStatus__NS", "ItemType__NS", "Location__NS", "MultiCurrencyPrice__NS", "Price__NS", "Subsidiary__NS", "SyncDate__NS"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductRatePlanObjectNSFields:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductRatePlanObjectNSFields:
        """Create an instance of ProductRatePlanObjectNSFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductRatePlanObjectNSFields.parse_obj(obj)

        _obj = ProductRatePlanObjectNSFields.parse_obj({
