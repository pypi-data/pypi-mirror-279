...
class CreateDebitMemoFromChargeRequest(BaseModel):
    ...
    __properties = ["accountId", "accountNumber", "autoPay", "autoPost", "charges", "comment", "customRates", "dueDate", "effectiveDate", "reasonCode", "currency", "number", "IntegrationId__NS", "IntegrationStatus__NS", "SyncDate__NS"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDebitMemoFromChargeRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDebitMemoFromChargeRequest:
        """Create an instance of CreateDebitMemoFromChargeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDebitMemoFromChargeRequest.parse_obj(obj)

        _obj = CreateDebitMemoFromChargeRequest.parse_obj({
