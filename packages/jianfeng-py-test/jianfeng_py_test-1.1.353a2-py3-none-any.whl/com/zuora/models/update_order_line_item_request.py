...
class UpdateOrderLineItemRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateOrderLineItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateOrderLineItemRequest:
        """Create an instance of UpdateOrderLineItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateOrderLineItemRequest.parse_obj(obj)

        _obj = UpdateOrderLineItemRequest.parse_obj({
            "uom": obj.get("UOM"),
