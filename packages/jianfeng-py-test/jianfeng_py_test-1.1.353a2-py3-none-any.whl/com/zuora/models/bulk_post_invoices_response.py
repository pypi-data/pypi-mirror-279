...
class BulkPostInvoicesResponse(BaseModel):
    """
    ...
    invoices: Optional[conlist(InvoicePostResponse)] = Field(None, description="The container for a list of posted invoices. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BulkPostInvoicesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BulkPostInvoicesResponse:
        """Create an instance of BulkPostInvoicesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BulkPostInvoicesResponse.parse_obj(obj)

        _obj = BulkPostInvoicesResponse.parse_obj({
            ...
            "invoices": [InvoicePostResponse.from_dict(_item) for _item in obj.get("invoices")] if obj.get("invoices") is not None else None
        })
        return _obj
