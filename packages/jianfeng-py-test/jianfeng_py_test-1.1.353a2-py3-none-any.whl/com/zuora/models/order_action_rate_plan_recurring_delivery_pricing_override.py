...
class OrderActionRatePlanRecurringDeliveryPricingOverride(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderActionRatePlanRecurringDeliveryPricingOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderActionRatePlanRecurringDeliveryPricingOverride:
        """Create an instance of OrderActionRatePlanRecurringDeliveryPricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderActionRatePlanRecurringDeliveryPricingOverride.parse_obj(obj)

        _obj = OrderActionRatePlanRecurringDeliveryPricingOverride.parse_obj({
