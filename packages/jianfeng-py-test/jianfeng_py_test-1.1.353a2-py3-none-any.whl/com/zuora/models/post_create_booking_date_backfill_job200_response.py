...
class POSTCreateBookingDateBackfillJob200Response(BaseModel):
    """
    ...
    job_id: Optional[StrictStr] = Field(None, alias="jobId", description="String of 32 characters that identifies the BookingDate Backfill job.  The id is generated before the backfill job is processed.  You can use the id to get the BookingDate Backfill job result.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> POSTCreateBookingDateBackfillJob200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> POSTCreateBookingDateBackfillJob200Response:
        """Create an instance of POSTCreateBookingDateBackfillJob200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return POSTCreateBookingDateBackfillJob200Response.parse_obj(obj)

        _obj = POSTCreateBookingDateBackfillJob200Response.parse_obj({
