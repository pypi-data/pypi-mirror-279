...
class GetRampMetricsBySubscriptionKeyResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRampMetricsBySubscriptionKeyResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRampMetricsBySubscriptionKeyResponse:
        """Create an instance of GetRampMetricsBySubscriptionKeyResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRampMetricsBySubscriptionKeyResponse.parse_obj(obj)

        _obj = GetRampMetricsBySubscriptionKeyResponse.parse_obj({
