...
class PreviewExistingSubscriptionInvoiceItemResult(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreviewExistingSubscriptionInvoiceItemResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreviewExistingSubscriptionInvoiceItemResult:
        """Create an instance of PreviewExistingSubscriptionInvoiceItemResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreviewExistingSubscriptionInvoiceItemResult.parse_obj(obj)

        _obj = PreviewExistingSubscriptionInvoiceItemResult.parse_obj({
