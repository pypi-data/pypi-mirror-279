...
class WriteOffCreditMemoResponse(BaseModel):
    """
    ...
    debit_memo: Optional[WriteOffCreditMemoResponseDebitMemo] = Field(None, alias="debitMemo")
    __properties = ["processId", "requestId", "reasons", "success", "debitMemo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WriteOffCreditMemoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WriteOffCreditMemoResponse:
        """Create an instance of WriteOffCreditMemoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WriteOffCreditMemoResponse.parse_obj(obj)

        _obj = WriteOffCreditMemoResponse.parse_obj({
            ...
            "debit_memo": WriteOffCreditMemoResponseDebitMemo.from_dict(obj.get("debitMemo")) if obj.get("debitMemo") is not None else None
        })
        return _obj
