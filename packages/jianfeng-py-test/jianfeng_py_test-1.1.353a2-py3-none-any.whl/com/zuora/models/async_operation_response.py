...
class AsyncOperationResponse(BaseModel):
    ...
    id: Optional[StrictStr] = Field(None, description="The ID of the business object which is being operated.")
    job_id: Optional[StrictStr] = Field(None, alias="jobId", description="The ID of the operation job.")
    job_status: Optional[OperationJobStatus] = Field(None, alias="jobStatus")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AsyncOperationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AsyncOperationResponse:
        """Create an instance of AsyncOperationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AsyncOperationResponse.parse_obj(obj)

        _obj = AsyncOperationResponse.parse_obj({
