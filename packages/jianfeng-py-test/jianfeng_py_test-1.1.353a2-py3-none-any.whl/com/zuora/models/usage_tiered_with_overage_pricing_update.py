...
from pydantic import BaseModel, Field, StrictFloat, StrictInt, StrictStr, confloat, conint, conlist
from com.zuora.models.charge_tier import ChargeTier
from com.zuora.models.price_change_option import PriceChangeOption

class UsageTieredWithOveragePricingUpdate(BaseModel):
    """
    ...
    __properties = ["priceChangeOption", "priceIncreasePercentage", "overagePrice", "tiers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsageTieredWithOveragePricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsageTieredWithOveragePricingUpdate:
        """Create an instance of UsageTieredWithOveragePricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsageTieredWithOveragePricingUpdate.parse_obj(obj)

        _obj = UsageTieredWithOveragePricingUpdate.parse_obj({
