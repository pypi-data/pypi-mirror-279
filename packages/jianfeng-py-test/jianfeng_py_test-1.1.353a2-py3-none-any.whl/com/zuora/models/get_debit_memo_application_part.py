...
class GetDebitMemoApplicationPart(BaseModel):
    ...
    """
    applied_amount: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="appliedAmount", description="The amount that is applied to the debit memo. ")
    ...
    credit_memo_id: Optional[StrictStr] = Field(None, alias="creditMemoId", description="The ID of credit memo that is applied to the specified debit memo. ")
    payment_id: Optional[StrictStr] = Field(None, alias="paymentId", description="The ID of the payment that is applied to the specified debit memo. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDebitMemoApplicationPart:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDebitMemoApplicationPart:
        """Create an instance of GetDebitMemoApplicationPart from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDebitMemoApplicationPart.parse_obj(obj)

        _obj = GetDebitMemoApplicationPart.parse_obj({
