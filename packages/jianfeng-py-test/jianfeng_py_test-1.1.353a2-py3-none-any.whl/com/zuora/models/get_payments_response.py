...
class GetPaymentsResponse(BaseModel):
    ...
    payments: Optional[conlist(Payment)] = Field(None, description="Container for payments. ")
    success: Optional[StrictBool] = Field(None, description="Returns `true` if the request was processed successfully.")
    __properties = ["nextPage", "payments", "success"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPaymentsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPaymentsResponse:
        """Create an instance of GetPaymentsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPaymentsResponse.parse_obj(obj)

        _obj = GetPaymentsResponse.parse_obj({
