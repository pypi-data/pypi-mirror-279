...
class UsageOveragePricingOverride(BaseModel):
    ...
    included_units: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Number of free units that may be consumed. ", alias="includedUnits")
    ...
    __properties: ClassVar[List[str]] = ["priceChangeOption", "priceIncreasePercentage", "includedUnits", "numberOfPeriods", "overagePrice", "overageUnusedUnitsCreditOption", "unusedUnitsCreditRates"]
