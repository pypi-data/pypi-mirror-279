...
class ReverseInvoiceResponse(BaseModel):
    ...
    credit_memo: Optional[ReverseInvoiceResponseCreditMemo] = Field(default=None, alias="creditMemo")
    debit_memo: Optional[ReverseInvoiceResponseDebitMemo] = Field(default=None, alias="debitMemo")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "creditMemo", "debitMemo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "creditMemo": ReverseInvoiceResponseCreditMemo.from_dict(obj["creditMemo"]) if obj.get("creditMemo") is not None else None,
            "debitMemo": ReverseInvoiceResponseDebitMemo.from_dict(obj["debitMemo"]) if obj.get("debitMemo") is not None else None
        })
