...
class UpdatePaymentRequest(BaseModel):
    ...
    reference_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=100)]] = Field(default=None, description="The transaction ID returned by the payment gateway. Use this field to reconcile payments between your gateway and Zuora Payments.  You can only update the reference ID for external payments. ", alias="referenceId")
    gateway_reconciliation_status: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, alias="gatewayReconciliationStatus")
    gateway_reconciliation_reason: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, alias="gatewayReconciliationReason")
    payout_id: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, alias="payoutId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["comment", "financeInformation", "gatewayState", "paymentScheduleKey", "referenceId", "gatewayReconciliationStatus", "gatewayReconciliationReason", "payoutId"]

    @field_validator('gateway_state')
    def gateway_state_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['NotSubmitted', 'Submitted', 'Settled', 'FailedToSettle']):
