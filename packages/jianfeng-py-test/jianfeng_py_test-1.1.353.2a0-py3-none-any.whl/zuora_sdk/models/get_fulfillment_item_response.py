...
class GetFulfillmentItemResponse(BaseModel):
    ...
    fulfillment_item: Optional[GetFulfillmentItem] = Field(default=None, alias="fulfillmentItem")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "fulfillmentItem"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fulfillmentItem": GetFulfillmentItem.from_dict(obj["fulfillmentItem"]) if obj.get("fulfillmentItem") is not None else None
        })
        return _obj
