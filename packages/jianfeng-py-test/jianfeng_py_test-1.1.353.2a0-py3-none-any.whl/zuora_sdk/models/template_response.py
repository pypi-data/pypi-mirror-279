...
class TemplateResponse(BaseModel):
    ...
    """ # noqa: E501
    templates: Optional[List[TemplateDetailResponse]] = Field(default=None, description="Contains list of template details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "templates": [TemplateDetailResponse.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        })
        return _obj
