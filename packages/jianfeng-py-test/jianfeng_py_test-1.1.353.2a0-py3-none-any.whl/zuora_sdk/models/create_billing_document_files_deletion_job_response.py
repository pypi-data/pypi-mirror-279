...
class CreateBillingDocumentFilesDeletionJobResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the billing document file deletion job. ")
    status: Optional[StrictStr] = None
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully.")
    __properties: ClassVar[List[str]] = ["id", "status", "success"]
