...
class UsageVolumePricingOverride(BaseModel):
    ...
    tiers: Optional[List[ChargeTier]] = Field(default=None, description="List of variable pricing tiers in the charge. ")
    ...
    __properties: ClassVar[List[str]] = ["priceChangeOption", "priceIncreasePercentage", "ratingGroup", "tiers", "uom"]
