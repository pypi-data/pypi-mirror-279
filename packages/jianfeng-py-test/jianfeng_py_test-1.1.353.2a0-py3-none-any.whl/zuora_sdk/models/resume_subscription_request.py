...
class ResumeSubscriptionRequest(BaseModel):
    ...
    contract_effective_date: Optional[date] = Field(default=None, description="The date when the customer notifies you that they want to resume their subscription. ", alias="contractEffectiveDate")
