...
class CancelSubscriptionResponse(BaseModel):
    ...
    """ # noqa: E501
    cancelled_date: Optional[date] = Field(default=None, description="The date that the subscription was canceled. It is available for Orders Harmonization and Subscribe/Amend tenants. ", alias="cancelledDate")
    ...
    invoice_id: Optional[StrictStr] = Field(default=None, description="ID of the invoice, if one is generated. ", alias="invoiceId")
    paid_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount paid. ", alias="paidAmount")
    payment_id: Optional[StrictStr] = Field(default=None, description="ID of the payment, if a payment is collected. ", alias="paymentId")
    ...
    total_delta_mrr: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Change in the subscription monthly recurring revenue as a result of the update. It is available for Orders Harmonization and Subscribe/Amend tenants. ", alias="totalDeltaMrr")
    ...
    __properties: ClassVar[List[str]] = ["cancelledDate", "creditMemoId", "invoiceId", "paidAmount", "paymentId", "subscriptionId", "success", "totalDeltaMrr", "totalDeltaTcv", "orderNumber", "status", "accountNumber", "subscriptionNumbers", "subscriptions"]
