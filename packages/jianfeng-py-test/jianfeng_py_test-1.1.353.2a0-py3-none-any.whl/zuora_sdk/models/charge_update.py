...
class ChargeUpdate(BaseModel):
    ...
    new_rate_plan_charge_id: Optional[StrictStr] = Field(default=None, description="The ID of the new rate plan charge.", alias="newRatePlanChargeId")
    ...
    pricing: Optional[PricingUpdate] = Field(default=None, description="Pricing information about the charge. ")
    unique_token: Optional[StrictStr] = Field(default=None, description="description: |   A unique string to represent the rate plan charge in the order. The unique token is used to perform multiple actions against a newly added rate plan charge. For example, if you want to add and update a product in the same order, assign a unique token to the newly added rate plan charge and use that token in future order actions. ", alias="uniqueToken")
    __properties: ClassVar[List[str]] = ["billing", "chargeNumber", "newRatePlanChargeId", "customFields", "description", "effectiveDate", "pricing", "uniqueToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newRatePlanChargeId": obj.get("newRatePlanChargeId"),
            ...
            "pricing": PricingUpdate.from_dict(obj["pricing"]) if obj.get("pricing") is not None else None,
