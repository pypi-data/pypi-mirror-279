...
class InvoiceFilesResponse(BaseModel):
    ...
    invoice_files: Optional[List[InvoiceFile]] = Field(default=None, description="Container for invoice PDF files. ", alias="invoiceFiles")
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "invoiceFiles", "nextPage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoiceFiles": [InvoiceFile.from_dict(_item) for _item in obj["invoiceFiles"]] if obj.get("invoiceFiles") is not None else None,
