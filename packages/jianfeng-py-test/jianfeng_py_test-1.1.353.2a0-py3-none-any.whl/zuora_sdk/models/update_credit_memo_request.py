...
class UpdateCreditMemoRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "Transaction__NS", "autoApplyUponPosting", "comment", "effectiveDate", "excludeFromAutoApplyRules", "items", "reasonCode", "transferredToAccounting"]
