...
class ReconcileRefundRequest(BaseModel):
    ...
    action_date: Optional[StrictStr] = Field(default=None, description="The date and time of the refund reconciliation action, in `yyyy-mm-dd hh:mm:ss` format. ", alias="actionDate")
    ...
    __properties: ClassVar[List[str]] = ["action", "actionDate", "gatewayReconciliationReason", "gatewayReconciliationStatus", "payoutId"]
