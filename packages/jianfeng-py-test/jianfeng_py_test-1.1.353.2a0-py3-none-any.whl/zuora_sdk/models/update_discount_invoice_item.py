...
class UpdateDiscountInvoiceItem(BaseModel):
    ...
    charge_name: Optional[StrictStr] = Field(default=None, description="The name of the charge associated with the discount item. This field is required if the `productRatePlanChargeId` field is not specified in the request. ", alias="chargeName")
