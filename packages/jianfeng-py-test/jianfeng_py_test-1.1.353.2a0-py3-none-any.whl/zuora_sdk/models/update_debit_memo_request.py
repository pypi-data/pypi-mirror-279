...
class UpdateDebitMemoRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "SyncDate__NS", "autoPay", "comment", "dueDate", "effectiveDate", "items", "reasonCode", "transferredToAccounting"]
