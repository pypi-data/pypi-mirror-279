...
class WriteOffBehavior(BaseModel):
    ...
    """ # noqa: E501
    finance_information: Optional[WriteOffBehaviorFinanceInformation] = Field(default=None, alias="financeInformation")
    __properties: ClassVar[List[str]] = ["financeInformation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "financeInformation": WriteOffBehaviorFinanceInformation.from_dict(obj["financeInformation"]) if obj.get("financeInformation") is not None else None
        })
        return _obj
