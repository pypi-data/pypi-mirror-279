...
class CreateCreditMemoFromCharge(BaseModel):
    ...
    charges: Optional[Annotated[List[CreditMemoItemFromChargeDetail], Field(max_length=1000)]] = Field(default=None, description="Container for product rate plan charges. The maximum number of items is 1,000. ")
    ...
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "Transaction__NS", "accountId", "accountNumber", "autoPost", "charges", "comment", "customRates", "effectiveDate", "excludeFromAutoApplyRules", "reasonCode", "currency", "number"]
