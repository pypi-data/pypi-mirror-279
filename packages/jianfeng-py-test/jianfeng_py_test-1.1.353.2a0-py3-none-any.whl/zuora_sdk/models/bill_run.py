...
class BillRun(BaseModel):
    ...
    charge_type_to_exclude: Optional[List[StrictStr]] = Field(default=None, description="The types of the charges to be excluded from the generation of billing documents. ", alias="chargeTypeToExclude")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "billRunNumber", "batches", "billCycleDay", "billRunFilters", "chargeTypeToExclude", "autoEmail", "autoPost", "autoRenewal", "noEmailForZeroAmountInvoice", "schedule", "scheduledExecutionTime", "status", "invoiceDate", "invoiceDateOffset", "invoiceDateMonthOffset", "invoiceDateDayOfMonth", "targetDate", "targetDateOffset", "targetDateMonthOffset", "targetDateDayOfMonth", "createdById", "createdDate", "updatedById", "updatedDate"]
