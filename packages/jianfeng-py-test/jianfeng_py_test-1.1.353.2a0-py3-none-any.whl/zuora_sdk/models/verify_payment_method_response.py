...
class VerifyPaymentMethodResponse(BaseModel):
    ...
    """ # noqa: E501
    payment_method_id: Optional[StrictStr] = Field(default=None, description="The ID of the verified payment method. ", alias="paymentMethodId")
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully. ")
    __properties: ClassVar[List[str]] = ["paymentMethodId", "success"]
