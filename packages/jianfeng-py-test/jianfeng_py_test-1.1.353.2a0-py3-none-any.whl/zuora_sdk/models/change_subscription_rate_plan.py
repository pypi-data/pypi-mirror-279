...
class ChangeSubscriptionRatePlan(BaseModel):
    ...
    new_product_rate_plan_id: Optional[StrictStr] = Field(default=None, description="ID of a product rate plan for this subscription.", alias="newProductRatePlanId")
