...
class CreateAuthorizationResponseReasons(BaseModel):
    ...
    message: Optional[StrictStr] = Field(default=None, description="Error message. It usually contains a combination of gateway response code and response message. ")
