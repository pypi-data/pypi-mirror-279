...
class BulkCreateInvoicesResponse(BaseModel):
    ...
    invoices: Optional[List[InvoiceResponse]] = Field(default=None, description="The container for a list of created invoices. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoices": [InvoiceResponse.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
