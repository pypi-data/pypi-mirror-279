...
class CreateOrderRatePlanUpdate(BaseModel):
    ...
    """ # noqa: E501
    charge_updates: Optional[List[CreateOrderChargeUpdate]] = Field(default=None, description="Array of the JSON objects containing the information for a charge update in the `updateProduct` type of order action. ", alias="chargeUpdates")
    ...
    __properties: ClassVar[List[str]] = ["chargeUpdates", "clearingExistingFeatures", "customFields", "externalCatalogPlanId", "productRatePlanNumber", "ratePlanId", "specificUpdateDate", "subscriptionProductFeatures", "subscriptionRatePlanNumber", "uniqueToken", "isAddingSubsetCharges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeUpdates": [CreateOrderChargeUpdate.from_dict(_item) for _item in obj["chargeUpdates"]] if obj.get("chargeUpdates") is not None else None,
