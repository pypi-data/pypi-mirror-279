...
class GetCustomExchangeRatesType(BaseModel):
    ...
    """ # noqa: E501
    inverse: Optional[StrictBool] = Field(default=None, description="- If `true`, the exchange rate in the response is an inverse exchange rate. - If `false`, the exchange rate in the response is not an inverse exchange rate. The value is determined by the **Use inverse rate** checkbox in your Zuora Finance Manage Currency Conversion settings. ")
    rates: Optional[List[GetCustomExchangeRatesDataType]] = Field(default=None, description="Container for exchange rate data. Contains a set of fields that provide exchange rate data for each day between the specified `startDate` and `endDate` (inclusive).  ")
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully. ")
    __properties: ClassVar[List[str]] = ["inverse", "rates", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rates": [GetCustomExchangeRatesDataType.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None,
