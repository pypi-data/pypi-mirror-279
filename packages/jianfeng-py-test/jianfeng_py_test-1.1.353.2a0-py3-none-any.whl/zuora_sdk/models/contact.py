...
class Contact(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "accountId", "accountNumber", "address1", "address2", "city", "contactDescription", "country", "county", "fax", "firstName", "homePhone", "lastName", "mobilePhone", "nickname", "otherPhone", "otherPhoneType", "personalEmail", "state", "success", "taxRegion", "workEmail", "workPhone", "zipCode", "postalCode"]
