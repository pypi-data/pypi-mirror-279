...
class CreateTaxationItemForInvoiceRequest(BaseModel):
    ...
    """ # noqa: E501
    exempt_amount: Optional[Decimal] = Field(default=None, description="The calculated tax amount excluded due to the exemption. ", alias="exemptAmount")
    finance_information: Optional[TaxItemsFinanceInformation] = Field(default=None, alias="financeInformation")
    invoice_item_id: StrictStr = Field(description="The ID of the invoice associated with the taxation item. ", alias="invoiceItemId")
    ...
    tax_amount: Decimal = Field(description="The amount of the taxation item in the invoice item. ", alias="taxAmount")
    applicable_tax_un_rounded: Optional[Decimal] = Field(default=None, description="The unrounded amount of the tax. ", alias="applicableTaxUnRounded")
    country: Optional[StrictStr] = Field(default=None, description="The field which contains country code. ")
    tax_code: Optional[StrictStr] = Field(default=None, description="The tax code identifies which tax rules and tax rates to apply to a specific invoice item. ", alias="taxCode")
    ...
    __properties: ClassVar[List[str]] = ["exemptAmount", "financeInformation", "invoiceItemId", "jurisdiction", "locationCode", "name", "taxAmount", "applicableTaxUnRounded", "country", "taxCode", "taxCodeDescription", "taxDate", "taxMode", "taxRate", "taxRateDescription", "taxRateType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "financeInformation": TaxItemsFinanceInformation.from_dict(obj["financeInformation"]) if obj.get("financeInformation") is not None else None,
