...
class GetFulfillmentResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "fulfillment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fulfillment": GetFulfillment.from_dict(obj["fulfillment"]) if obj.get("fulfillment") is not None else None
        })
        return _obj
