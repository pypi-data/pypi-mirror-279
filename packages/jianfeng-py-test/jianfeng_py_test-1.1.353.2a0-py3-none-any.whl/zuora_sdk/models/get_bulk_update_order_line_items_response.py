...
class GetBulkUpdateOrderLineItemsResponse(BaseModel):
    ...
    order_line_items: Optional[List[GetOrderLineItem]] = Field(default=None, alias="orderLineItems")
    invoices: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "orderLineItems", "invoices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderLineItems": [GetOrderLineItem.from_dict(_item) for _item in obj["orderLineItems"]] if obj.get("orderLineItems") is not None else None,
