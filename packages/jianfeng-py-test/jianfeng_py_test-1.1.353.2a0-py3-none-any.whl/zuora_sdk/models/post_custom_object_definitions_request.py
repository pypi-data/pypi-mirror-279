...
class PostCustomObjectDefinitionsRequest(BaseModel):
    ...
    """ # noqa: E501
    definitions: Optional[Dict[str, PostCustomObjectDefinitionsRequestDefinition]] = Field(default=None, description="The custom object definitions. This object maps types to custom object definitions. ")
    __properties: ClassVar[List[str]] = ["definitions"]
