...
class PaymentScheduleBillingDocument(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the billing document.  **Note:**  If a billing document is specified, either `id` or `number` of the billing document must be specified. You cannot specify both of them or skip both. ")
    number: Optional[StrictStr] = Field(default=None, description="ID of the billing document.  **Note:**  If a billing document is specified, either `id` or `number` of the billing document must be specified. You cannot specify both of them or skip both. ")
    type: StrictStr
