...
class CreditMemoItemFromWriteOffInvoice(BaseModel):
    ...
    sku_name: Optional[StrictStr] = Field(default=None, description="The name of the charge associated with the invoice. ", alias="skuName")
    ...
    __properties: ClassVar[List[str]] = ["comment", "financeInformation", "invoiceItemId", "serviceEndDate", "serviceStartDate", "skuName", "unitOfMeasure"]
