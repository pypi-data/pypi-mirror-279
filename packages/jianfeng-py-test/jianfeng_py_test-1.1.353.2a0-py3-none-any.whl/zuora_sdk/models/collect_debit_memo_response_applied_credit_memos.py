...
class CollectDebitMemoResponseAppliedCreditMemos(BaseModel):
    ...
    """ # noqa: E501
    applied_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The applied amount of the credit memo to the debit memo. ", alias="appliedAmount")
    ...
    unapplied_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The unapplied amount of the credit memo after applied to the debit memo. ", alias="unappliedAmount")
