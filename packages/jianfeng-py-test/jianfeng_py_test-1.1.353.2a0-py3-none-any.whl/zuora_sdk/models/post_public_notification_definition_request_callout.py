...
class PostPublicNotificationDefinitionRequestCallout(BaseModel):
    ...
    """ # noqa: E501
    active: Optional[StrictBool] = Field(default=True, description="The status of the callout. The default is `true`.")
    ...
    __properties: ClassVar[List[str]] = ["active", "calloutAuth", "calloutBaseurl", "calloutParams", "calloutRetry", "description", "eventTypeName", "httpMethod", "name", "requiredAuth"]
