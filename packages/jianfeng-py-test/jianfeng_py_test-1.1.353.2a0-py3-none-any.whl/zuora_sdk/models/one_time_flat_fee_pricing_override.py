...
class OneTimeFlatFeePricingOverride(BaseModel):
    ...
    """ # noqa: E501
    list_price: Union[StrictFloat, StrictInt] = Field(description="Price of the charge. ", alias="listPrice")
    ...
    __properties: ClassVar[List[str]] = ["listPrice", "originalListPrice"]
