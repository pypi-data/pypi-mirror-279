...
class CreatePaymentScheduleRequestItems(BaseModel):
    ...
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount that needs to be collected by this payment schedule item. ")
    ...
    scheduled_date: Optional[date] = Field(default=None, description="The date to collect the payment. ", alias="scheduledDate")
