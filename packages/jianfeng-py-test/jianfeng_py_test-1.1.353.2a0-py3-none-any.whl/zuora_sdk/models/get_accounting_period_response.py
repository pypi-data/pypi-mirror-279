...
class GetAccountingPeriodResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "createdOn", "endDate", "fileIds", "fiscalYear", "fiscal_quarter", "id", "name", "notes", "runTrialBalanceEnd", "runTrialBalanceErrorMessage", "runTrialBalanceStart", "runTrialBalanceStatus", "startDate", "status", "success", "updatedBy", "updatedOn", "organizationLabels"]
