...
class CreateCreditMemoTaxationItemsRequest(BaseModel):
    ...
    """ # noqa: E501
    taxation_items: Optional[List[CreateTaxationItemForCreditMemoRequest]] = Field(default=None, description="Container for taxation items. ", alias="taxationItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "taxationItems": [CreateTaxationItemForCreditMemoRequest.from_dict(_item) for _item in obj["taxationItems"]] if obj.get("taxationItems") is not None else None
        })
        return _obj
