...
class InvoiceItemsResponse(BaseModel):
    ...
    invoice_items: Optional[List[InvoiceItem]] = Field(default=None, description="Container for invoice items. ", alias="invoiceItems")
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "invoiceItems", "nextPage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoiceItems": [InvoiceItem.from_dict(_item) for _item in obj["invoiceItems"]] if obj.get("invoiceItems") is not None else None,
