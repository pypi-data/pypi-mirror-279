...
class StoredCredentialProfilesResponse(BaseModel):
    ...
    """ # noqa: E501
    profiles: Optional[List[StoredCredentialProfileResponse]] = Field(default=None, description="Container for stored credential profiles. ")
    success: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["profiles", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "profiles": [StoredCredentialProfileResponse.from_dict(_item) for _item in obj["profiles"]] if obj.get("profiles") is not None else None,
