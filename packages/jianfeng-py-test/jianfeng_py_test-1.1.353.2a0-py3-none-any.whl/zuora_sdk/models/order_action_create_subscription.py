...
class OrderActionCreateSubscription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billToContactId", "invoiceGroupNumber", "invoiceSeparately", "invoiceTemplateId", "newSubscriptionOwnerAccount", "notes", "paymentTerm", "sequenceSetId", "soldToContactId", "subscribeToProducts", "subscribeToRatePlans", "subscriptionNumber", "subscriptionOwnerAccountNumber", "terms"]
