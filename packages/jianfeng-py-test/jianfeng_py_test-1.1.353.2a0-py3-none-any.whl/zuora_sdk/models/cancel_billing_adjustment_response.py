...
class CancelBillingAdjustmentResponse(BaseModel):
    ...
    debit_memo_number: Optional[StrictStr] = Field(default=None, description="The Debit Memo generated for the cancelled adjustment.        ", alias="debitMemoNumber")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "debitMemoNumber"]
