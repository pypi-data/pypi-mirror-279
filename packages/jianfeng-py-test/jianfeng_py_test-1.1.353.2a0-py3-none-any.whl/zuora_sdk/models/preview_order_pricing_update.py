...
class PreviewOrderPricingUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chargeModelData", "discount", "recurringFlatFee", "recurringPerUnit", "recurringTiered", "recurringVolume", "usageFlatFee", "usageOverage", "usagePerUnit", "usageTiered", "usageTieredWithOverage", "usageVolume"]
