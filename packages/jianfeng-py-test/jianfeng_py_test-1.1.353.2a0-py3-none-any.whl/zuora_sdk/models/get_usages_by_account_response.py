...
class GetUsagesByAccountResponse(BaseModel):
    ...
    usage: Optional[List[UsageItem]] = Field(default=None, description="Contains one or more usage items. ")
    __properties: ClassVar[List[str]] = ["nextPage", "success", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usage": [UsageItem.from_dict(_item) for _item in obj["usage"]] if obj.get("usage") is not None else None
        })
        return _obj
