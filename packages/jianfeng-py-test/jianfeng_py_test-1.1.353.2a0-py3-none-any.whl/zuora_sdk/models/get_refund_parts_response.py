...
class GetRefundPartsResponse(BaseModel):
    ...
    """ # noqa: E501
    parts: Optional[List[RefundPart]] = Field(default=None, description="Container for refund parts. ")
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully.")
    __properties: ClassVar[List[str]] = ["parts", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parts": [RefundPart.from_dict(_item) for _item in obj["parts"]] if obj.get("parts") is not None else None,
