...
class RemoveSubscriptionRatePlan(BaseModel):
    ...
    contract_effective_date: date = Field(description="Effective date of the new subscription, as yyyy-mm-dd. ", alias="contractEffectiveDate")
    ...
    service_activation_date: Optional[date] = Field(default=None, description="The date when the remove amendment is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the `serviceActivationDate` field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate <= serviceActivationDate <= contractAcceptanceDate ", alias="serviceActivationDate")
    ...
    __properties: ClassVar[List[str]] = ["bookingDate", "contractEffectiveDate", "customerAcceptanceDate", "externalCatalogPlanId", "externalIdSourceSystem", "productRatePlanNumber", "ratePlanId", "serviceActivationDate", "subscriptionRatePlanNumber"]
