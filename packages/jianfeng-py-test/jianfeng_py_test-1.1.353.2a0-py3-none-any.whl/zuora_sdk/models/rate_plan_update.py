...
class RatePlanUpdate(BaseModel):
    ...
    """ # noqa: E501
    charge_updates: Optional[List[ChargeUpdate]] = Field(default=None, description="Array of the JSON objects containing the information for a charge update in the `updateProduct` type of order action. ", alias="chargeUpdates")
    ...
    rate_plan_id: Optional[StrictStr] = Field(default=None, description="Internal identifier of the rate plan that was updated. It can be the latest version or any history version id. ", alias="ratePlanId")
    ...
    __properties: ClassVar[List[str]] = ["chargeUpdates", "clearingExistingFeatures", "customFields", "externallyManagedPlanId", "newRatePlanId", "productRatePlanNumber", "productRatePlanId", "ratePlanId", "specificUpdateDate", "subscriptionProductFeatures", "subscriptionRatePlanNumber", "uniqueToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeUpdates": [ChargeUpdate.from_dict(_item) for _item in obj["chargeUpdates"]] if obj.get("chargeUpdates") is not None else None,
