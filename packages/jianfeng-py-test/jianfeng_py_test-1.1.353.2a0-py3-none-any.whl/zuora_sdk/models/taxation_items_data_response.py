...
class TaxationItemsDataResponse(BaseModel):
    ...
    data: Optional[List[InvoiceTaxationItem]] = Field(default=None, description="Container for the taxation items of the invoice item. ")
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "data", "nextPage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [InvoiceTaxationItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
