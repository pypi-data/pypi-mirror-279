...
class CreateRefundwithAutoUnapply(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["comment", "debitMemos", "financeInformation", "gatewayOptions", "invoices", "methodType", "reasonCode", "referenceId", "refundDate", "secondRefundReferenceId", "softDescriptor", "softDescriptorPhone", "totalAmount", "type", "refundTransactionType"]
