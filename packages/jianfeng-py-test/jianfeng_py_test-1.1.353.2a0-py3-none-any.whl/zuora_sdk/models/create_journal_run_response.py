...
class CreateJournalRunResponse(BaseModel):
    ...
    """ # noqa: E501
    journal_run_number: Optional[StrictStr] = Field(default=None, description="Journal run number. ", alias="journalRunNumber")
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully. ")
    __properties: ClassVar[List[str]] = ["journalRunNumber", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "journalRunNumber": obj.get("journalRunNumber"),
