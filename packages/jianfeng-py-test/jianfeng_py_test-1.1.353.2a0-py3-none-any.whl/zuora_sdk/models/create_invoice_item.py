...
class CreateInvoiceItem(BaseModel):
    ...
    amount: Decimal = Field(description="The amount of the invoice item.   - For tax-inclusive invoice items, the amount indicates the invoice item amount including tax.  - For tax-exclusive invoice items, the amount indicates the invoice item amount excluding tax. ")
    ...
    discount_items: Optional[List[CreateDiscountItem]] = Field(default=None, description="Container for discount items. The maximum number of discount items is 10. ", alias="discountItems")
    ...
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=1, description="The number of units for the invoice item.")
    ...
    service_start_date: date = Field(description="The service start date of the invoice item. ", alias="serviceStartDate")
    ...
    tax_code: Optional[StrictStr] = Field(default=None, description="The tax code identifies which tax rules and tax rates to apply to the invoice item.  **Note**: This field is only available only if you have Taxation enabled. ", alias="taxCode")
    ...
    unit_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The per-unit price of the invoice item. To pass Level 3 data to the gateway, this field is required and must be greater than zero. ", alias="unitPrice")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "discountItems": [CreateDiscountItem.from_dict(_item) for _item in obj["discountItems"]] if obj.get("discountItems") is not None else None,
