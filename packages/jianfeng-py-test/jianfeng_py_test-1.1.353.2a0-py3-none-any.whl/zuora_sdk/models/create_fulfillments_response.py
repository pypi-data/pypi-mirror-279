...
class CreateFulfillmentsResponse(BaseModel):
    ...
    credit_memo_numbers: Optional[List[StrictStr]] = Field(default=None, description="An array of the credit memo numbers generated in this request. The credit memo is only available if you have the Invoice Settlement feature enabled. ", alias="creditMemoNumbers")
    fulfillments: Optional[List[CreateFulfillmentResponse]] = None
    invoice_numbers: Optional[List[StrictStr]] = Field(default=None, description="An array of the invoice numbers generated in this request. Normally it includes one invoice number only. ", alias="invoiceNumbers")
    paid_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total amount collected in this request. ", alias="paidAmount")
    payment_number: Optional[StrictStr] = Field(default=None, description="The payment number collected in this request. ", alias="paymentNumber")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "creditMemoNumbers", "fulfillments", "invoiceNumbers", "paidAmount", "paymentNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fulfillments": [CreateFulfillmentResponse.from_dict(_item) for _item in obj["fulfillments"]] if obj.get("fulfillments") is not None else None,
