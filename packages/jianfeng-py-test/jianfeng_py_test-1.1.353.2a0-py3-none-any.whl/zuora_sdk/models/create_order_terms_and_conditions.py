...
class CreateOrderTermsAndConditions(BaseModel):
    ...
    invoice_separately: Optional[StrictBool] = Field(default=None, description="Specifies whether the subscription appears on a separate invoice when generates invoices.", alias="invoiceSeparately")
    ...
    last_term: Optional[LastTerm] = Field(default=None, alias="lastTerm")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastTerm": LastTerm.from_dict(obj["lastTerm"]) if obj.get("lastTerm") is not None else None,
