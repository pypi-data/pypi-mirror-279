...
class PreviewOrderResultInvoices(BaseModel):
    ...
    invoice_items: Optional[List[InvoiceItemPreviewResult]] = Field(default=None, alias="invoiceItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoiceItems": [InvoiceItemPreviewResult.from_dict(_item) for _item in obj["invoiceItems"]] if obj.get("invoiceItems") is not None else None,
