...
class OrderActionCreateSubscriptionTerms(BaseModel):
    """
    ...
    renewal_terms: List[RenewalTerm] = Field(description="List of renewal terms of the subscription. Only applicable if the type of the first term is `TERMED` and the value of the `renewalSetting` field is `RENEW_WITH_SPECIFIC_TERM`. ", alias="renewalTerms")
