...
class ProcessingOptionsWithDelayedCapturePayment(BaseModel):
    ...
    electronic_payment_options: Optional[ElectronicPaymentOptionsWithDelayedCapturePayment] = Field(default=None, alias="electronicPaymentOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "electronicPaymentOptions": ElectronicPaymentOptionsWithDelayedCapturePayment.from_dict(obj["electronicPaymentOptions"]) if obj.get("electronicPaymentOptions") is not None else None,
