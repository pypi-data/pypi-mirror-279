...
class OrderActionRatePlanRecurringFlatFeePricingOverride(BaseModel):
    ...
    specific_list_price_base: Optional[Annotated[int, Field(le=200, strict=True, ge=1)]] = Field(default=None, description="The number of months for the list price base of the charge. The value of this field is `null` if you do not set the value of the `listPriceBase` field to `Per_Specific_Months`. ", alias="specificListPriceBase")
    __properties: ClassVar[List[str]] = ["priceChangeOption", "priceIncreasePercentage", "listPrice", "listPriceBase", "specificListPriceBase"]
