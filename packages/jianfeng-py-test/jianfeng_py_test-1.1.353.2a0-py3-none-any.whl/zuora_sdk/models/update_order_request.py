...
class UpdateOrderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["category", "customFields", "description", "existingAccountNumber", "externallyManagedBy", "newAccount", "orderDate", "orderLineItems", "orderNumber", "processingOptions", "reasonCode", "schedulingOptions", "status", "subscriptions"]
