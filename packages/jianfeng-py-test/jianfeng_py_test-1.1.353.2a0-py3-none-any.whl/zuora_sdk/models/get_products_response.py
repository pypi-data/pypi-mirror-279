...
class GetProductsResponse(BaseModel):
    ...
    products: Optional[List[Product]] = Field(default=None, description="Container for one or more products: ")
    ...
    __properties: ClassVar[List[str]] = ["success", "products", "nextPage"]
