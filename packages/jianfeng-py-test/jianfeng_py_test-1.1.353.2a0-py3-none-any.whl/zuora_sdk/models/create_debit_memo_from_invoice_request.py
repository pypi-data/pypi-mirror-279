...
class CreateDebitMemoFromInvoiceRequest(BaseModel):
    ...
    invoice_id: Optional[StrictStr] = Field(default=None, description="The ID of the invoice that the debit memo is created from. * If this field is specified, its value must be the same as the value of the `invoiceId` path parameter. Otherwise, its value overrides the value of the `invoiceId` path parameter.  * If this field is not specified, the value of the `invoiceId` path parameter is used.  ", alias="invoiceId")
    ...
    __properties: ClassVar[List[str]] = ["IntegrationId__NS", "IntegrationStatus__NS", "SyncDate__NS", "autoPay", "autoPost", "comment", "effectiveDate", "invoiceId", "items", "reasonCode", "taxAutoCalculation"]
