...
class UploadFileResponse(BaseModel):
    ...
    UploadFileResponse
    """ # noqa: E501
    file_id: Optional[StrictStr] = Field(default=None, description="The unique ID of the uploaded PDF file. ", alias="fileId")
    success: Optional[StrictBool] = Field(default=None, description="Indicates whether the call succeeded. ")
    __properties: ClassVar[List[str]] = ["fileId", "success"]
