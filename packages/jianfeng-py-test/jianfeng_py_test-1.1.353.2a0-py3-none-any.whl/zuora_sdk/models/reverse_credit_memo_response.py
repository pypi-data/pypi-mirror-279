...
class ReverseCreditMemoResponse(BaseModel):
    ...
    credit_memo: Optional[ReverseCreditMemoResponseCreditMemo] = Field(default=None, alias="creditMemo")
    debit_memo: Optional[ReverseCreditMemoResponseDebitMemo] = Field(default=None, alias="debitMemo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "creditMemo": ReverseCreditMemoResponseCreditMemo.from_dict(obj["creditMemo"]) if obj.get("creditMemo") is not None else None,
            "debitMemo": ReverseCreditMemoResponseDebitMemo.from_dict(obj["debitMemo"]) if obj.get("debitMemo") is not None else None
        })
        return _obj
