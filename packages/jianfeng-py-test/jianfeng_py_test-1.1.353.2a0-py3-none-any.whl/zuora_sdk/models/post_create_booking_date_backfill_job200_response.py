...
class POSTCreateBookingDateBackfillJob200Response(BaseModel):
    ...
    job_id: Optional[StrictStr] = Field(default=None, description="String of 32 characters that identifies the BookingDate Backfill job.  The id is generated before the backfill job is processed.  You can use the id to get the BookingDate Backfill job result.", alias="jobId")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "jobId"]
