...
class CreditMemoItemsResponse(BaseModel):
    ...
    items: Optional[List[CreditMemoItem]] = Field(default=None, description="Container for credit memo items. ")
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "items", "nextPage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [CreditMemoItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
