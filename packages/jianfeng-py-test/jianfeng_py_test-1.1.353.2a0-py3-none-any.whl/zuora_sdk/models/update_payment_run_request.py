...
class UpdatePaymentRunRequest(BaseModel):
    ...
    """ # noqa: E501
    account_id: Optional[StrictStr] = Field(default=None, description="The ID of the customer account associated with the payment run.  This field conflicts with each of the `batch`, `billCycleDay`, `currency`, `paymentGatewayId`, and `billingRunId` fields. If there are such conflicts, an error occurs and an error message is returned. ", alias="accountId")
    ...
    billing_run_id: Optional[StrictStr] = Field(default=None, description="The ID of a bill run.  This field conflicts with the `accountId` field. If they are both specified in the request body, an error occurs and an error message is returned. ", alias="billingRunId")
    ...
    payment_gateway_id: Optional[StrictStr] = Field(default=None, description="The ID of the gateway instance that processes the payment.  This field conflicts with the `accountId` field. If they are both specified in the request body, an error occurs and an error message is returned. ", alias="paymentGatewayId")
    ...
    run_date: Optional[datetime] = Field(default=None, description="The date and time when the scheduled payment run is to be executed, in `yyyy-mm-dd hh:mm:ss` format. The backend will ignore mintues and seconds in the field value. For example, if you specify `2017-03-01 11:30:37` for this value, this payment run will be run at 2017-03-01 11:00:00. ", alias="runDate")
    target_date: Optional[date] = Field(default=None, description="The target date used to determine which receivables to be paid in the payment run. The payments are collected for all receivables with the due date no later than the target date. ", alias="targetDate")
    __properties: ClassVar[List[str]] = ["accountId", "applyCreditBalance", "autoApplyCreditMemo", "autoApplyUnappliedPayment", "batch", "billCycleDay", "billingRunId", "collectPayment", "consolidatedPayment", "currency", "paymentGatewayId", "processPaymentWithClosedPM", "runDate", "targetDate"]
