...
class CustomObjectBulkJobErrorResponseCollection(BaseModel):
    ...
    """ # noqa: E501
    errors: List[CustomObjectBulkJobErrorResponse] = Field(description="All errors for a custom object bulk job.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [CustomObjectBulkJobErrorResponse.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
