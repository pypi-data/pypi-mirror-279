...
class GetRampsBySubscriptionKeyResponse(BaseModel):
    ...
    ramps: Optional[List[RampResponse]] = None
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "ramps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ramps": [RampResponse.from_dict(_item) for _item in obj["ramps"]] if obj.get("ramps") is not None else None
        })
        return _obj
