...
class DebitMemoItemFromInvoiceItemRequest(BaseModel):
    ...
    finance_information: Optional[DebitMemoItemFromInvoiceItemFinanceInformation] = Field(default=None, alias="financeInformation")
    invoice_item_id: Optional[StrictStr] = Field(default=None, description="The ID of the invoice item.", alias="invoiceItemId")
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of units for the debit memo item.")
    service_end_date: Optional[date] = Field(default=None, description="The service end date of the debit memo item.", alias="serviceEndDate")
    service_start_date: Optional[date] = Field(default=None, description="The service start date of the debit memo item.  ", alias="serviceStartDate")
    sku_name: StrictStr = Field(description="The name of the charge associated with the invoice.", alias="skuName")
    tax_items: Optional[List[DebitMemoTaxItemFromInvoiceTaxItemRequest]] = Field(default=None, description="Container for taxation items.", alias="taxItems")
    ...
    __properties: ClassVar[List[str]] = ["amount", "comment", "description", "financeInformation", "invoiceItemId", "quantity", "serviceEndDate", "serviceStartDate", "skuName", "taxItems", "taxMode", "unitOfMeasure", "excludeItemBillingFromRevenueAccounting"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "financeInformation": DebitMemoItemFromInvoiceItemFinanceInformation.from_dict(obj["financeInformation"]) if obj.get("financeInformation") is not None else None,
            ...
            "taxItems": [DebitMemoTaxItemFromInvoiceTaxItemRequest.from_dict(_item) for _item in obj["taxItems"]] if obj.get("taxItems") is not None else None,
