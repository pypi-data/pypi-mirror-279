...
class DebitMemosResponse(BaseModel):
    ...
    debitmemos: Optional[List[DebitMemo]] = Field(default=None, description="Container for debit memos. ")
    ...
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "debitmemos", "nextPage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "debitmemos": [DebitMemo.from_dict(_item) for _item in obj["debitmemos"]] if obj.get("debitmemos") is not None else None,
