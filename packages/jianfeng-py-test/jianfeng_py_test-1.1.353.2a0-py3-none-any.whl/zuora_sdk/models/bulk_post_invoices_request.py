...
class BulkPostInvoicesRequest(BaseModel):
    ...
    """ # noqa: E501
    invoices: Optional[List[PostInvoiceRequest]] = Field(default=None, description="The container for invoices to be posted. The maximum number of invoices to be posted is 50 in one request. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices": [PostInvoiceRequest.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
