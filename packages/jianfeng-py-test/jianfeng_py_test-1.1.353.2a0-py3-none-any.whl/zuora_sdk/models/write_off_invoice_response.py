...
class WriteOffInvoiceResponse(BaseModel):
    ...
    """ # noqa: E501
    credit_memo: Optional[WriteOffInvoiceResponseCreditMemo] = Field(default=None, alias="creditMemo")
    success: Optional[StrictBool] = Field(default=None, description="Returns `true` if the request was processed successfully. ")
    __properties: ClassVar[List[str]] = ["creditMemo", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "creditMemo": WriteOffInvoiceResponseCreditMemo.from_dict(obj["creditMemo"]) if obj.get("creditMemo") is not None else None,
