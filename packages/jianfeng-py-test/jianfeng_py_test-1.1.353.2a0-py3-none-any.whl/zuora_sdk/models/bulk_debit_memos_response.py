...
class BulkDebitMemosResponse(BaseModel):
    ...
    memos: Optional[Annotated[List[DebitMemoResponse], Field(max_length=50)]] = Field(default=None, description="The container for a list of debit memos. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "memos": [DebitMemoResponse.from_dict(_item) for _item in obj["memos"]] if obj.get("memos") is not None else None
        })
        return _obj
