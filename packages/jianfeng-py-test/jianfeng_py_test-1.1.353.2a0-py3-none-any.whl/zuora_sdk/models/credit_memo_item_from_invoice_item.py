...
class CreditMemoItemFromInvoiceItem(BaseModel):
    ...
    invoice_item_id: StrictStr = Field(description="The ID of the invoice item.", alias="invoiceItemId")
    ...
    tax_items: Optional[List[CreditMemoTaxItemFromInvoiceTaxItemRequest]] = Field(default=None, description="Container for taxation items.", alias="taxItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxItems": [CreditMemoTaxItemFromInvoiceTaxItemRequest.from_dict(_item) for _item in obj["taxItems"]] if obj.get("taxItems") is not None else None,
