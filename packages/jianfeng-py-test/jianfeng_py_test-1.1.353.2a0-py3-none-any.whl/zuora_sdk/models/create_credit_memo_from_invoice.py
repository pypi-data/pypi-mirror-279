...
class CreateCreditMemoFromInvoice(BaseModel):
    ...
    invoice_id: Optional[StrictStr] = Field(default=None, description="The ID of the invoice that the credit memo is created from. ", alias="invoiceId")
    ...
    __properties: ClassVar[List[str]] = ["autoApplyToInvoiceUponPosting", "autoPost", "comment", "effectiveDate", "excludeFromAutoApplyRules", "invoiceId", "items", "reasonCode", "taxAutoCalculation", "IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "Transaction__NS"]
