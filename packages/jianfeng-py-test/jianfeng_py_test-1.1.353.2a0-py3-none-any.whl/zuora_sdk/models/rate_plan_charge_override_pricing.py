...
class RatePlanChargeOverridePricing(BaseModel):
    ...
    """ # noqa: E501
    charge_model_data: Optional[OrderActionRatePlanChargeModelDataOverride] = Field(default=None, alias="chargeModelData")
    ...
    recurring_delivery: Optional[OrderActionRatePlanRecurringDeliveryPricingOverride] = Field(default=None, alias="recurringDelivery")
    recurring_flat_fee: Optional[OrderActionRatePlanRecurringFlatFeePricingOverride] = Field(default=None, alias="recurringFlatFee")
    recurring_per_unit: Optional[OrderActionRatePlanRecurringPerUnitPricingOverride] = Field(default=None, alias="recurringPerUnit")
    recurring_tiered: Optional[OrderActionRatePlanRecurringTieredPricingOverride] = Field(default=None, alias="recurringTiered")
    recurring_volume: Optional[OrderActionRatePlanRecurringVolumePricingOverride] = Field(default=None, alias="recurringVolume")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeModelData": OrderActionRatePlanChargeModelDataOverride.from_dict(obj["chargeModelData"]) if obj.get("chargeModelData") is not None else None,
            ...
            "recurringDelivery": OrderActionRatePlanRecurringDeliveryPricingOverride.from_dict(obj["recurringDelivery"]) if obj.get("recurringDelivery") is not None else None,
            "recurringFlatFee": OrderActionRatePlanRecurringFlatFeePricingOverride.from_dict(obj["recurringFlatFee"]) if obj.get("recurringFlatFee") is not None else None,
            "recurringPerUnit": OrderActionRatePlanRecurringPerUnitPricingOverride.from_dict(obj["recurringPerUnit"]) if obj.get("recurringPerUnit") is not None else None,
            "recurringTiered": OrderActionRatePlanRecurringTieredPricingOverride.from_dict(obj["recurringTiered"]) if obj.get("recurringTiered") is not None else None,
            "recurringVolume": OrderActionRatePlanRecurringVolumePricingOverride.from_dict(obj["recurringVolume"]) if obj.get("recurringVolume") is not None else None,
