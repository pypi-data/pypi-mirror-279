...
class CreateAccountRequest(BaseModel):
    ...
    account_number: Optional[StrictStr] = Field(default=None, description="A unique account number, up to 50 characters that do not begin with the default account number prefix.  If no account number is specified, one is generated. ", alias="accountNumber")
    ...
    communication_profile_name: Optional[StrictStr] = Field(default=None, description="communicationProfileName ", alias="communicationProfileName")
    payment_gateway_number: Optional[StrictStr] = Field(default=None, description="paymentGatewayNumber ", alias="paymentGatewayNumber")
    payment_gateway_name: Optional[StrictStr] = Field(default=None, description="paymentGatewayName ", alias="paymentGatewayName")
    organization_id: Optional[StrictStr] = Field(default=None, description="organizationId ", alias="organizationId")
    organization_name: Optional[StrictStr] = Field(default=None, description="organizationName ", alias="organizationName")
    ...
    parent_account_number: Optional[StrictStr] = Field(default=None, description="parentAccountNumber ", alias="parentAccountNumber")
    summary_statement_template_id: Optional[StrictStr] = Field(default=None, description="summaryStatementTemplateId ", alias="summaryStatementTemplateId")
    sequence_set_name: Optional[StrictStr] = Field(default=None, description="sequenceSetName ", alias="sequenceSetName")
