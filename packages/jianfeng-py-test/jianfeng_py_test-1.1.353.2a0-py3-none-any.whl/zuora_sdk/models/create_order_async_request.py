...
class CreateOrderAsyncRequest(BaseModel):
    ...
    custom_fields: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Container for custom fields of an Order object. ", alias="customFields")
    ...
    processing_options: Optional[AsyncOrderProcessingOptions] = Field(default=None, alias="processingOptions")
    ...
    __properties: ClassVar[List[str]] = ["category", "customFields", "description", "existingAccountNumber", "externallyManagedBy", "newAccount", "orderDate", "orderLineItems", "orderNumber", "processingOptions", "reasonCode", "subscriptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "processingOptions": AsyncOrderProcessingOptions.from_dict(obj["processingOptions"]) if obj.get("processingOptions") is not None else None,
