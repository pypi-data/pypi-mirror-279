...
class SuspendSubscriptionResponse(BaseModel):
    ...
    resume_date: Optional[date] = Field(default=None, description="The date when subscription resumption takes effect, in the format yyyy-mm-dd. It is available for Orders Harmonization and Subscribe/Amend Tenants. ", alias="resumeDate")
    ...
    suspend_date: Optional[date] = Field(default=None, description="The date when subscription suspension takes effect, in the format yyyy-mm-dd. It is available for Orders Harmonization and Subscribe/Amend Tenants. ", alias="suspendDate")
    term_end_date: Optional[date] = Field(default=None, description="The date when the new subscription term ends, in the format yyyy-mm-dd. It is available for Orders Harmonization and Subscribe/Amend Tenants. ", alias="termEndDate")
    ...
    __properties: ClassVar[List[str]] = ["creditMemoId", "invoiceId", "paidAmount", "paymentId", "resumeDate", "subscriptionId", "success", "suspendDate", "termEndDate", "totalDeltaTcv", "orderNumber", "status", "accountNumber", "subscriptionNumbers", "subscriptions"]
