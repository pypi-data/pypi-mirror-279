...
class CancelOrderResponse(BaseModel):
    ...
    cancel_reason: Optional[StrictStr] = Field(default=None, description="The reason for cancelling the order.", alias="cancelReason")
    order_number: Optional[StrictStr] = Field(default=None, description="The order number of the order created.", alias="orderNumber")
    status: Optional[StrictStr] = Field(default=None, description="Status of the order. `Cancelled` is only valid value.")
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "accountNumber", "cancelReason", "orderNumber", "status"]
