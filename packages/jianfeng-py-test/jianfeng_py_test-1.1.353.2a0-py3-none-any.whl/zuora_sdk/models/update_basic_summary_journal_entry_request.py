...
class UpdateBasicSummaryJournalEntryRequest(BaseModel):
    ...
    """ # noqa: E501
    journal_entry_items: Optional[List[UpdateJournalEntryItemRequest]] = Field(default=None, description="Key name that represents the list of journal entry items. ", alias="journalEntryItems")
    ...
    __properties: ClassVar[List[str]] = ["journalEntryItems", "notes", "transferredToAccounting"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "journalEntryItems": [UpdateJournalEntryItemRequest.from_dict(_item) for _item in obj["journalEntryItems"]] if obj.get("journalEntryItems") is not None else None,
            "notes": obj.get("notes"),
