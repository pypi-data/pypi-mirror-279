...
class DiscountPricingUpdate(BaseModel):
    ...
    discount_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount of the discount as a percentage. This field is only used for percentage discounts. ", alias="discountPercentage")
    price_change_option: Optional[StrictStr] = Field(default=None, alias="priceChangeOption")
    __properties: ClassVar[List[str]] = ["applyDiscountTo", "discountLevel", "discountPercentage", "priceChangeOption"]
