...
class CreateSubscriptionRequest(BaseModel):
    ...
    initial_term: Optional[StrictInt] = Field(default=None, description="The length of the period for the first subscription term. If `termType` is `TERMED`, then this field is required, and the value must be greater than `0`. If `termType` is `EVERGREEN`, this field is ignored. ", alias="initialTerm")
    ...
    renewal_term: StrictInt = Field(description="The length of the period for the subscription renewal term. Default is `0`. ", alias="renewalTerm")
