...
class PostAsyncInvoiceRequest(BaseModel):
    ...
    """ # noqa: E501
    invoice_date: Optional[date] = Field(default=None, description="The new invoice date when posting the invoice. By default, it will use invoice date of the invoice. ", alias="invoiceDate")
