...
class CustomObjectDefinitionUpdateActionRequest(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["description", "enableCreateRecordAuditing", "enableDeleteRecordAuditing", "field", "label", "namespace", "object", "relationship", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "field": UpdateCustomObjectCusotmField.from_dict(obj["field"]) if obj.get("field") is not None else None,
            "label": obj.get("label"),
