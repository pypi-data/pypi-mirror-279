...
class TermInfo(BaseModel):
    ...
    """ # noqa: E501
    auto_renew: Optional[StrictBool] = Field(default=None, description="Specifies whether the subscription automatically renews at the end of the each term. Only applicable if the type of the first term is `TERMED`. ", alias="autoRenew")
    ...
    renewal_terms: Optional[RenewalTerm] = Field(default=None, alias="renewalTerms")
    __properties: ClassVar[List[str]] = ["autoRenew", "initialTerm", "renewalSetting", "renewalTerms"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of renewal_terms
        if self.renewal_terms:
            _dict['renewalTerms'] = self.renewal_terms.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "renewalTerms": RenewalTerm.from_dict(obj["renewalTerms"]) if obj.get("renewalTerms") is not None else None
        })
        return _obj
