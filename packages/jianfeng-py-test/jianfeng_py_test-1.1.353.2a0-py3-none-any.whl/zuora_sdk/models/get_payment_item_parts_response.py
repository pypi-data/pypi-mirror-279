...
class GetPaymentItemPartsResponse(BaseModel):
    ...
    """ # noqa: E501
    parts: Optional[List[PaymentItemPart]] = Field(default=None, description="Container for payment part items. ")
    ...
    __properties: ClassVar[List[str]] = ["parts", "nextPage", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parts": [PaymentItemPart.from_dict(_item) for _item in obj["parts"]] if obj.get("parts") is not None else None,
