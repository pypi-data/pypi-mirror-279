...
class BulkCreateDebitMemosFromInvoiceRequest(BaseModel):
    ...
    memos: Optional[Annotated[List[CreateDebitMemosFromInvoiceRequest], Field(max_length=50)]] = Field(default=None, description="The container for a list of debit memos. The maximum number of debit memos is 50. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sourceType": obj.get("sourceType") if obj.get("sourceType") is not None else 'Invoice',
            "memos": [CreateDebitMemosFromInvoiceRequest.from_dict(_item) for _item in obj["memos"]] if obj.get("memos") is not None else None
        })
        return _obj
