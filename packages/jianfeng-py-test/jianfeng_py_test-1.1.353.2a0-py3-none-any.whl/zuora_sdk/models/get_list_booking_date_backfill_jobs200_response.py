...
class GETListBookingDateBackfillJobs200Response(BaseModel):
    ...
    jobs: Optional[List[BookingDateJob]] = None
    __properties: ClassVar[List[str]] = ["processId", "requestId", "reasons", "success", "jobs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobs": [BookingDateJob.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None
        })
        return _obj
