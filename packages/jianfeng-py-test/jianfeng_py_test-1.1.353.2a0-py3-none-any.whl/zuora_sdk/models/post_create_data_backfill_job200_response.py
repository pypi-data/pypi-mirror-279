...
class POSTCreateDataBackfillJob200Response(BaseModel):
    ...
    job_id: Optional[StrictStr] = Field(default=None, description="String of 32 characters that identifies the Data Backfill job.  The id is generated before the job is processed.  You can use the id to get the Data Backfill job result.", alias="jobId")
