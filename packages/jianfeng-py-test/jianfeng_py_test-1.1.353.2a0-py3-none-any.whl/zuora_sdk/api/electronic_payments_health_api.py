...
class ElectronicPaymentsHealthApi:
    ...
    @validate_call
    def get_system_health_payment_volume_summary(
        self,
        ...
        payment_gateway_type: Annotated[Optional[StrictStr], Field(description="Filters the volume summary by payment gateway type. Example: `Adyen`. ")] = None,
        payment_method_type: Annotated[Optional[StrictStr], Field(description="Filters the volume summary by payment method type. Example: `CreditCard`. ")] = None,
        ...
        Returns a summary of electronic payments handled by your Zuora tenant within a specified time range.  You can filter the summary by payment gateway type and payment method type. 
        ...
        _param = self._get_system_health_payment_volume_summary_serialize(
    ...
    def get_system_health_payment_volume_summary_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPaymentVolumeSummaryResponse]:
        """List payment volume summary records
    ...
    @validate_call
    def get_system_health_payment_volume_summary_without_preload_content(
        self,
        start_time: Annotated[datetime, Field(description="Start time of the volume summary.  Format: `yyyy-MM-dd'T'HH:mmZ` Example: `2022-09-22T09:07+0800`. ")],
        end_time: Annotated[datetime, Field(description="End time of the volume summary.  Format: `yyyy-MM-dd'T'HH:mmZ` Example: `2022-09-22T09:07+0800`. ")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
    ...
    def _get_system_health_payment_volume_summary_serialize(
        self,
        start_time,
        end_time,
        accept_encoding,
        ...
        if payment_gateway_type is not None:
            ...
            _query_params.append(('paymentGatewayType', payment_gateway_type))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system-health/payments/volume-summary',
