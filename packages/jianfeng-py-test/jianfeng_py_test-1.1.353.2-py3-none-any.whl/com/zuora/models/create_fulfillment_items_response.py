...
class CreateFulfillmentItemsResponse(BaseModel):
    """
    ...
    __properties = ["processId", "requestId", "reasons", "success", "fulfillmentItems"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFulfillmentItemsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFulfillmentItemsResponse:
        """Create an instance of CreateFulfillmentItemsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFulfillmentItemsResponse.parse_obj(obj)

        _obj = CreateFulfillmentItemsResponse.parse_obj({
