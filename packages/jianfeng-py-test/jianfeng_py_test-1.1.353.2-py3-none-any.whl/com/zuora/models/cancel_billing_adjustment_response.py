...
class CancelBillingAdjustmentResponse(BaseModel):
    """
    ...
    debit_memo_number: Optional[StrictStr] = Field(None, alias="debitMemoNumber", description="The Debit Memo generated for the cancelled adjustment.        ")
    __properties = ["processId", "requestId", "reasons", "success", "debitMemoNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancelBillingAdjustmentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancelBillingAdjustmentResponse:
        """Create an instance of CancelBillingAdjustmentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancelBillingAdjustmentResponse.parse_obj(obj)

        _obj = CancelBillingAdjustmentResponse.parse_obj({
