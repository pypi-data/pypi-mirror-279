...
class GetAccountingPeriodResponse(BaseModel):
    ...
    updated_by: Optional[StrictStr] = Field(None, alias="updatedBy", description="ID of the user who last updated the accounting period. ")
    ...
    __properties = ["createdBy", "createdOn", "endDate", "fileIds", "fiscalYear", "fiscal_quarter", "id", "name", "notes", "runTrialBalanceEnd", "runTrialBalanceErrorMessage", "runTrialBalanceStart", "runTrialBalanceStatus", "startDate", "status", "success", "updatedBy", "updatedOn", "organizationLabels"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAccountingPeriodResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAccountingPeriodResponse:
        """Create an instance of GetAccountingPeriodResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAccountingPeriodResponse.parse_obj(obj)

        _obj = GetAccountingPeriodResponse.parse_obj({
