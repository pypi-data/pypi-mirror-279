...
class PreviewOrderAsyncRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreviewOrderAsyncRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreviewOrderAsyncRequest:
        """Create an instance of PreviewOrderAsyncRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreviewOrderAsyncRequest.parse_obj(obj)

        _obj = PreviewOrderAsyncRequest.parse_obj({
