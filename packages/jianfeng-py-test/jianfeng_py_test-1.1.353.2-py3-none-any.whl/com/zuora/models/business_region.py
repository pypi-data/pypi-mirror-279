...
class BusinessRegion(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BusinessRegion:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BusinessRegion:
        """Create an instance of BusinessRegion from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BusinessRegion.parse_obj(obj)

        _obj = BusinessRegion.parse_obj({
            "id": obj.get("id"),
