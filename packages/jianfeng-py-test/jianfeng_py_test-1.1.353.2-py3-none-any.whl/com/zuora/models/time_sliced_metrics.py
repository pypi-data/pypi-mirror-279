...
class TimeSlicedMetrics(BaseModel):
    """
    TimeSlicedMetrics
    """
    ...
    __properties = ["amount", "endDate", "generatedReason", "invoiceOwner", "orderItemId", "startDate", "subscriptionOwner", "termNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimeSlicedMetrics:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimeSlicedMetrics:
        """Create an instance of TimeSlicedMetrics from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimeSlicedMetrics.parse_obj(obj)

        _obj = TimeSlicedMetrics.parse_obj({
