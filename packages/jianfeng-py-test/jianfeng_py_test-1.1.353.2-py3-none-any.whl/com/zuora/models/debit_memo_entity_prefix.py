...
class DebitMemoEntityPrefix(BaseModel):
    """
    ...
    """
    prefix: Optional[StrictStr] = Field(None, description="The prefix of debit memos. ")
    start_number: Optional[StrictInt] = Field(None, alias="startNumber", description="The starting document number of debit memos. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DebitMemoEntityPrefix:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DebitMemoEntityPrefix:
        """Create an instance of DebitMemoEntityPrefix from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DebitMemoEntityPrefix.parse_obj(obj)

        _obj = DebitMemoEntityPrefix.parse_obj({
