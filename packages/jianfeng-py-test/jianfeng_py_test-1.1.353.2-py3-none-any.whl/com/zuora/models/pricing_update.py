...
class PricingUpdate(BaseModel):
    ...
    recurring_delivery: Optional[RecurringDeliveryPricingUpdate] = Field(None, alias="recurringDelivery")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PricingUpdate:
        """Create an instance of PricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PricingUpdate.parse_obj(obj)

        _obj = PricingUpdate.parse_obj({
            ...
            "recurring_delivery": RecurringDeliveryPricingUpdate.from_dict(obj.get("recurringDelivery")) if obj.get("recurringDelivery") is not None else None,
