...
class PreviewOrderOrderAction(BaseModel):
    ...
    """
    add_product: Optional[PreviewOrderRatePlanOverride] = Field(None, alias="addProduct")
    cancel_subscription: Optional[OrderActionCancelSubscription] = Field(None, alias="cancelSubscription")
    change_plan: Optional[CreateOrderChangePlan] = Field(None, alias="changePlan")
    ...
    create_subscription: Optional[PreviewOrderCreateSubscription] = Field(None, alias="createSubscription")
    ...
    terms_and_conditions: Optional[CreateOrderTermsAndConditions] = Field(None, alias="termsAndConditions")
    ...
    update_product: Optional[PreviewOrderRatePlanUpdate] = Field(None, alias="updateProduct")
    __properties = ["addProduct", "cancelSubscription", "changePlan", "changeReason", "createSubscription", "customFields", "ownerTransfer", "removeProduct", "renewSubscription", "resume", "suspend", "termsAndConditions", "triggerDates", "type", "updateProduct"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreviewOrderOrderAction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreviewOrderOrderAction:
        """Create an instance of PreviewOrderOrderAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreviewOrderOrderAction.parse_obj(obj)

        _obj = PreviewOrderOrderAction.parse_obj({
            "add_product": PreviewOrderRatePlanOverride.from_dict(obj.get("addProduct")) if obj.get("addProduct") is not None else None,
            ...
            "change_plan": CreateOrderChangePlan.from_dict(obj.get("changePlan")) if obj.get("changePlan") is not None else None,
            "change_reason": obj.get("changeReason"),
            "create_subscription": PreviewOrderCreateSubscription.from_dict(obj.get("createSubscription")) if obj.get("createSubscription") is not None else None,
            ...
            "resume": CreateOrderResume.from_dict(obj.get("resume")) if obj.get("resume") is not None else None,
            "suspend": CreateOrderSuspend.from_dict(obj.get("suspend")) if obj.get("suspend") is not None else None,
            "terms_and_conditions": CreateOrderTermsAndConditions.from_dict(obj.get("termsAndConditions")) if obj.get("termsAndConditions") is not None else None,
            ...
            "type": obj.get("type"),
            "update_product": PreviewOrderRatePlanUpdate.from_dict(obj.get("updateProduct")) if obj.get("updateProduct") is not None else None
        })
        return _obj
