...
class RecurringPerUnitPricingOverride(BaseModel):
    """
    ...
    __properties = ["priceChangeOption", "priceIncreasePercentage", "listPrice", "originalListPrice", "uom", "listPriceBase", "quantity", "specificListPriceBase"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecurringPerUnitPricingOverride:
        """Create an instance of RecurringPerUnitPricingOverride from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecurringPerUnitPricingOverride:
        """Create an instance of RecurringPerUnitPricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecurringPerUnitPricingOverride.parse_obj(obj)

        _obj = RecurringPerUnitPricingOverride.parse_obj({
