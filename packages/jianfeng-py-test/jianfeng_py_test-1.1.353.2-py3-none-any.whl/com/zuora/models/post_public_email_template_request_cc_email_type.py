...
class PostPublicEmailTemplateRequestCcEmailType(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostPublicEmailTemplateRequestCcEmailType:
        """Create an instance of PostPublicEmailTemplateRequestCcEmailType from a JSON string"""
        return PostPublicEmailTemplateRequestCcEmailType(json.loads(json_str))
