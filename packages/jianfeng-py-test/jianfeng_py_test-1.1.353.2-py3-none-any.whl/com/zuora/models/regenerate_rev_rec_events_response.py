...
class RegenerateRevRecEventsResponse(BaseModel):
    """
    ...
    __properties = ["success", "processId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegenerateRevRecEventsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegenerateRevRecEventsResponse:
        """Create an instance of RegenerateRevRecEventsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegenerateRevRecEventsResponse.parse_obj(obj)

        _obj = RegenerateRevRecEventsResponse.parse_obj({
