...
class SignUpCreatePaymentMethodPayPalAdaptive(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignUpCreatePaymentMethodPayPalAdaptive:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignUpCreatePaymentMethodPayPalAdaptive:
        """Create an instance of SignUpCreatePaymentMethodPayPalAdaptive from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignUpCreatePaymentMethodPayPalAdaptive.parse_obj(obj)

        _obj = SignUpCreatePaymentMethodPayPalAdaptive.parse_obj({
