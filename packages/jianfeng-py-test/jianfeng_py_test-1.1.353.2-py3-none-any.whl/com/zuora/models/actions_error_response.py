...
class ActionsErrorResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActionsErrorResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActionsErrorResponse:
        """Create an instance of ActionsErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActionsErrorResponse.parse_obj(obj)

        _obj = ActionsErrorResponse.parse_obj({
            "code": obj.get("Code"),
