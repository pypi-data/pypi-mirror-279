...
class CreateCreditMemoFromChargeRequest(BaseModel):
    ...
    __properties = ["accountId", "accountNumber", "autoPost", "charges", "comment", "customRates", "effectiveDate", "excludeFromAutoApplyRules", "reasonCode", "currency", "number", "IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "Transaction__NS"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCreditMemoFromChargeRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCreditMemoFromChargeRequest:
        """Create an instance of CreateCreditMemoFromChargeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCreditMemoFromChargeRequest.parse_obj(obj)

        _obj = CreateCreditMemoFromChargeRequest.parse_obj({
