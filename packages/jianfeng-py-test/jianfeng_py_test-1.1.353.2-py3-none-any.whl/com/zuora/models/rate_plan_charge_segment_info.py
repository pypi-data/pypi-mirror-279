...
class RatePlanChargeSegmentInfo(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RatePlanChargeSegmentInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RatePlanChargeSegmentInfo:
        """Create an instance of RatePlanChargeSegmentInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RatePlanChargeSegmentInfo.parse_obj(obj)

        _obj = RatePlanChargeSegmentInfo.parse_obj({
            "id": obj.get("id"),
