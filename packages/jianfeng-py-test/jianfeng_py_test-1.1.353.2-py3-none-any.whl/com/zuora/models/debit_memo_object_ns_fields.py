...
class DebitMemoObjectNSFields(BaseModel):
    """
    Container for Debit Memo fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DebitMemoObjectNSFields:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DebitMemoObjectNSFields:
        """Create an instance of DebitMemoObjectNSFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DebitMemoObjectNSFields.parse_obj(obj)

        _obj = DebitMemoObjectNSFields.parse_obj({
