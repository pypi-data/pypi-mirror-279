...
class GetPaymentMethodResponsePayPalForAccount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPaymentMethodResponsePayPalForAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPaymentMethodResponsePayPalForAccount:
        """Create an instance of GetPaymentMethodResponsePayPalForAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPaymentMethodResponsePayPalForAccount.parse_obj(obj)

        _obj = GetPaymentMethodResponsePayPalForAccount.parse_obj({
            "baid": obj.get("BAID"),
            "email": obj.get("email"),
