...
class CreateInvoiceScheduleRequest(BaseModel):
    ...
    """
    account_key: Optional[StrictStr] = Field(None, alias="accountKey", description="The ID or number of the account associated with the invoice schedule. ")
    ...
    schedule_items: Optional[conlist(CreateInvoiceScheduleItem)] = Field(None, alias="scheduleItems", description="Container for invoice schedule items. One invoice schedule can have at most 50 invoice schedule items. ")
    ...
    __properties = ["accountKey", "additionalSubscriptionsToBill", "invoiceSeparately", "notes", "orders", "scheduleItems", "specificSubscriptions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateInvoiceScheduleRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateInvoiceScheduleRequest:
        """Create an instance of CreateInvoiceScheduleRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateInvoiceScheduleRequest.parse_obj(obj)

        _obj = CreateInvoiceScheduleRequest.parse_obj({
            ...
            "schedule_items": [CreateInvoiceScheduleItem.from_dict(_item) for _item in obj.get("scheduleItems")] if obj.get("scheduleItems") is not None else None,
