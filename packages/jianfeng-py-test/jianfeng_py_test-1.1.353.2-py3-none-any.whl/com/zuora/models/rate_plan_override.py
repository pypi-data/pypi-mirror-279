...
class RatePlanOverride(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RatePlanOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RatePlanOverride:
        """Create an instance of RatePlanOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RatePlanOverride.parse_obj(obj)

        _obj = RatePlanOverride.parse_obj({
