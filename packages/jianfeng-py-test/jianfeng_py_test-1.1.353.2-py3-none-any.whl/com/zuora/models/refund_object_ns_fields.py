...
class RefundObjectNSFields(BaseModel):
    """
    Container for Refund fields provided by the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501
    """
    ...
    __properties = ["IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "SynctoNetSuite__NS"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RefundObjectNSFields:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RefundObjectNSFields:
        """Create an instance of RefundObjectNSFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RefundObjectNSFields.parse_obj(obj)

        _obj = RefundObjectNSFields.parse_obj({
