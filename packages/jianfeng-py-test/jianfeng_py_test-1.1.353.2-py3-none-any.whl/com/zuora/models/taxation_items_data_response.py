...
class TaxationItemsDataResponse(BaseModel):
    """
    ...
    __properties = ["processId", "requestId", "reasons", "success", "data", "nextPage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaxationItemsDataResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaxationItemsDataResponse:
        """Create an instance of TaxationItemsDataResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaxationItemsDataResponse.parse_obj(obj)

        _obj = TaxationItemsDataResponse.parse_obj({
