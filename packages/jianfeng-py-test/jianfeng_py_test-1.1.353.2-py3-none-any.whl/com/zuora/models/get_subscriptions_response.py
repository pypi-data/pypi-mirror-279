...
class GetSubscriptionsResponse(BaseModel):
    ...
    subscriptions: Optional[conlist(GetSubscriptionResponse)] = Field(None, description="Array of subscriptions. ")
    success: Optional[StrictBool] = Field(None, description="Returns `true` if the request was processed successfully. ")
    __properties = ["nextPage", "subscriptions", "success"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSubscriptionsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSubscriptionsResponse:
        """Create an instance of GetSubscriptionsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetSubscriptionsResponse.parse_obj(obj)

        _obj = GetSubscriptionsResponse.parse_obj({
            "next_page": obj.get("nextPage"),
            "subscriptions": [GetSubscriptionResponse.from_dict(_item) for _item in obj.get("subscriptions")] if obj.get("subscriptions") is not None else None,
