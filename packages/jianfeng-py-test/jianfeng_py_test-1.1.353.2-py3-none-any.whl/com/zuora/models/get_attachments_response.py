...
class GetAttachmentsResponse(BaseModel):
    ...
    attachments: Optional[conlist(GetAttachmentResponse)] = Field(None, description="Container for one or more attachments. ")
    ...
    __properties = ["processId", "requestId", "reasons", "success", "attachments", "nextPage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAttachmentsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAttachmentsResponse:
        """Create an instance of GetAttachmentsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAttachmentsResponse.parse_obj(obj)

        _obj = GetAttachmentsResponse.parse_obj({
            ...
            "attachments": [GetAttachmentResponse.from_dict(_item) for _item in obj.get("attachments")] if obj.get("attachments") is not None else None,
