...
from com.zuora.models.create_order_request import CreateOrderRequest  # noqa: E501
...
class TestCreateOrderRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateOrderRequest:
        ...
        """
        model = CreateOrderRequest()  # noqa: E501
        if include_optional:
            return CreateOrderRequest(
                ...
                order_number = '',
                processing_options = com.zuora.models.processing_options_with_delayed_capture_payment.ProcessingOptionsWithDelayedCapturePayment(
                    application_order = [
                        ''
                        ], 
                    apply_credit = True, 
                    ...
                    electronic_payment_options = com.zuora.models.electronic_payment_options_with_delayed_capture_payment.ElectronicPaymentOptionsWithDelayedCapturePayment(
                        payment_gateway_id = '', 
                        payment_method_id = '', 
                        auth_transaction_id = '', 
                        gateway_order_id = '', ), 
                ...
                status = 'Draft',
                subscriptions = [
                    com.zuora.models.create_order_subscription.CreateOrderSubscription(
                        custom_fields = {
                            'key' : None
                            }, 
                        order_actions = [
