...
from com.zuora.models.update_order_line_item import UpdateOrderLineItem  # noqa: E501

class TestUpdateOrderLineItem(unittest.TestCase):
    """UpdateOrderLineItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateOrderLineItem:
        """Test UpdateOrderLineItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateOrderLineItem`
        """
        model = UpdateOrderLineItem()  # noqa: E501
        if include_optional:
    ...
    def testUpdateOrderLineItem(self):
        """Test UpdateOrderLineItem"""
