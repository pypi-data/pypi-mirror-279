...
from com.zuora.models.create_order_async_request import CreateOrderAsyncRequest  # noqa: E501
...
class TestCreateOrderAsyncRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateOrderAsyncRequest:
        ...
        """
        model = CreateOrderAsyncRequest()  # noqa: E501
        if include_optional:
            return CreateOrderAsyncRequest(
                ...
                order_number = '',
                processing_options = com.zuora.models.async_order_processing_options.AsyncOrderProcessingOptions(
                    application_order = [
                        ''
                        ], 
                    apply_credit = True, 
