...
class Product(BaseModel):
    ...
    __properties = ["IntegrationId__NS", "IntegrationStatus__NS", "ItemType__NS", "SyncDate__NS", "id", "sku", "productNumber", "name", "category", "description", "effectiveStartDate", "effectiveEndDate", "productRatePlans", "productFeatures", "tags"]
