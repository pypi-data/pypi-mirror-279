...
class InvoiceFilesResponse(BaseModel):
    ...
    invoice_files: Optional[conlist(InvoiceFile)] = Field(None, alias="invoiceFiles", description="Container for invoice PDF files. ")
    ...
    __properties = ["processId", "requestId", "reasons", "success", "invoiceFiles", "nextPage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvoiceFilesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvoiceFilesResponse:
        """Create an instance of InvoiceFilesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvoiceFilesResponse.parse_obj(obj)

        _obj = InvoiceFilesResponse.parse_obj({
            ...
            "invoice_files": [InvoiceFile.from_dict(_item) for _item in obj.get("invoiceFiles")] if obj.get("invoiceFiles") is not None else None,
