...
class UpdateTaxationItemRequest(BaseModel):
    ...
    finance_information: Optional[UpdateTaxationItemForFinanceInformation] = Field(None, alias="financeInformation")
    ...
    name: Optional[StrictStr] = Field(None, description="The name of the taxation item to be updated. ")
    tax_amount: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="taxAmount", description="The amount of the tax applied to the credit or debit memo. ")
    ...
    tax_code: Optional[StrictStr] = Field(None, alias="taxCode", description="The tax code identifies which tax rules and tax rates to apply to a specific credit or debit memo. ")
    tax_code_description: Optional[StrictStr] = Field(None, alias="taxCodeDescription", description="The description of the tax code. ")
    tax_date: Optional[date] = Field(None, alias="taxDate", description="The date when the tax is applied to the credit or debit memo. ")
    tax_rate: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="taxRate", description="The tax rate applied to the credit or debit memo. ")
    ...
    __properties = ["exemptAmount", "financeInformation", "jurisdiction", "locationCode", "name", "taxAmount", "applicableTaxUnRounded", "country", "taxCode", "taxCodeDescription", "taxDate", "taxRate", "taxRateDescription", "taxRateType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateTaxationItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateTaxationItemRequest:
        """Create an instance of UpdateTaxationItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateTaxationItemRequest.parse_obj(obj)

        _obj = UpdateTaxationItemRequest.parse_obj({
            "exempt_amount": obj.get("exemptAmount"),
            "finance_information": UpdateTaxationItemForFinanceInformation.from_dict(obj.get("financeInformation")) if obj.get("financeInformation") is not None else None,
