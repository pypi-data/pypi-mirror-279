...
class ProxyBadRequestResponseErrorsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProxyBadRequestResponseErrorsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProxyBadRequestResponseErrorsInner:
        """Create an instance of ProxyBadRequestResponseErrorsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProxyBadRequestResponseErrorsInner.parse_obj(obj)

        _obj = ProxyBadRequestResponseErrorsInner.parse_obj({
            "code": obj.get("Code"),
