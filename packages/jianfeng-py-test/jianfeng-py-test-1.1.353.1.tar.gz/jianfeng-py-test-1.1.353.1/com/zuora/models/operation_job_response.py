...
class OperationJobResponse(BaseModel):
    ...
    id: Optional[StrictStr] = Field(None, description="The ID of the operation job to retrieve information about.")
    object_id: Optional[StrictStr] = Field(None, alias="objectId", description="The ID of the business object which is being operated.")
    ...
    __properties = ["processId", "requestId", "reasons", "success", "id", "objectId", "objectType", "operationType", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OperationJobResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OperationJobResponse:
        """Create an instance of OperationJobResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OperationJobResponse.parse_obj(obj)

        _obj = OperationJobResponse.parse_obj({
