...
class ProductRatePlanWithExternalId(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductRatePlanWithExternalId:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductRatePlanWithExternalId:
        """Create an instance of ProductRatePlanWithExternalId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductRatePlanWithExternalId.parse_obj(obj)

        _obj = ProductRatePlanWithExternalId.parse_obj({
