...
class ProcessingOptionsWithDelayedCapturePayment(BaseModel):
    ...
    electronic_payment_options: Optional[ElectronicPaymentOptionsWithDelayedCapturePayment] = Field(None, alias="electronicPaymentOptions")
    refund: Optional[StrictBool] = Field(None, description="Indicates whether to refund after subscription cancelation. Default is `false`.   **Note**: When refunding a subscription that is not invoiced separately, if you do not enable the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Invoice_Settlement/C_Invoice_Item_Settlement\" target=\"_blank\">Invoice Item Settlement</a> feature, you will encounter the following error during the cancel and refund process: “Cancellation/Refund failed because of the following reason: Invoice is linked to multiple subscriptions. Cancellation was not processed.” ")
    refund_amount: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="refundAmount", description="Indicates the amount to be refunded. Required if the `refund` field is `true`. ")
    refund_reason_code: Optional[StrictStr] = Field(None, alias="refundReasonCode", description="A code identifying the reason for the refund transaction. The value must be an existing payment refund reason code listed in **Payments Settings** > **Configure Reason Codes**. If you do not specify the field or leave the field with an empty value, Zuora uses the default payment refund reason code. ")
    ...
    write_off: Optional[StrictBool] = Field(None, alias="writeOff", description="Indicates whether to write off the outstanding balance on the invoice after refund. Default is `false`.  **Note**:  - When refunding a subscription that is not invoiced separately, if you do not enable the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Invoice_Settlement/C_Invoice_Item_Settlement\" target=\"_blank\">Invoice Item Settlement</a> feature, you will encounter the following error during the cancel and refund process: “Cancellation/Refund failed because of the following reason: Invoice is linked to multiple subscriptions. Cancellation was not processed.” - The <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Invoice_Settlement\" target=\"_blank\">Invoice Settlement</a> feature must have been enabled for write-off. ")
    write_off_behavior: Optional[WriteOffBehavior] = Field(None, alias="writeOffBehavior")
    __properties = ["applicationOrder", "applyCredit", "applyCreditBalance", "billingOptions", "collectPayment", "electronicPaymentOptions", "refund", "refundAmount", "refundReasonCode", "runBilling", "writeOff", "writeOffBehavior"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProcessingOptionsWithDelayedCapturePayment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProcessingOptionsWithDelayedCapturePayment:
        """Create an instance of ProcessingOptionsWithDelayedCapturePayment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProcessingOptionsWithDelayedCapturePayment.parse_obj(obj)

        _obj = ProcessingOptionsWithDelayedCapturePayment.parse_obj({
            ...
            "electronic_payment_options": ElectronicPaymentOptionsWithDelayedCapturePayment.from_dict(obj.get("electronicPaymentOptions")) if obj.get("electronicPaymentOptions") is not None else None,
            "refund": obj.get("refund"),
            "refund_amount": obj.get("refundAmount"),
            "refund_reason_code": obj.get("refundReasonCode"),
            "run_billing": obj.get("runBilling"),
            "write_off": obj.get("writeOff"),
            "write_off_behavior": WriteOffBehavior.from_dict(obj.get("writeOffBehavior")) if obj.get("writeOffBehavior") is not None else None
        })
        return _obj
