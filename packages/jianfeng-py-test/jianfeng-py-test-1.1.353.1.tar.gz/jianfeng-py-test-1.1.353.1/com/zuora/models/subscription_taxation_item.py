...
class SubscriptionTaxationItem(BaseModel):
    """
    ...
    __properties = ["exemptAmount", "jurisdiction", "locationCode", "name", "taxAmount", "taxCode", "taxCodeDescription", "taxDate", "taxRate", "taxRateDescription", "taxRateType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionTaxationItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionTaxationItem:
        """Create an instance of SubscriptionTaxationItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionTaxationItem.parse_obj(obj)

        _obj = SubscriptionTaxationItem.parse_obj({
