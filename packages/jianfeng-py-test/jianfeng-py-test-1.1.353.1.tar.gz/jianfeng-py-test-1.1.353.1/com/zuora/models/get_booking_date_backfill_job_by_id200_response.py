...
class GETBookingDateBackfillJobById200Response(BaseModel):
    """
    ...
    job: Optional[BookingDateJob] = None
    __properties = ["processId", "requestId", "reasons", "success", "job"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GETBookingDateBackfillJobById200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GETBookingDateBackfillJobById200Response:
        """Create an instance of GETBookingDateBackfillJobById200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GETBookingDateBackfillJobById200Response.parse_obj(obj)

        _obj = GETBookingDateBackfillJobById200Response.parse_obj({
            ...
            "job": BookingDateJob.from_dict(obj.get("job")) if obj.get("job") is not None else None
        })
        return _obj
