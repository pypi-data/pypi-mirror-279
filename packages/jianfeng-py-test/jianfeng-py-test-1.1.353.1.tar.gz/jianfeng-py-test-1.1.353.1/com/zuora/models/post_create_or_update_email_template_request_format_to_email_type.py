...
class PostCreateOrUpdateEmailTemplateRequestFormatToEmailType(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostCreateOrUpdateEmailTemplateRequestFormatToEmailType:
        """Create an instance of PostCreateOrUpdateEmailTemplateRequestFormatToEmailType from a JSON string"""
        return PostCreateOrUpdateEmailTemplateRequestFormatToEmailType(json.loads(json_str))
