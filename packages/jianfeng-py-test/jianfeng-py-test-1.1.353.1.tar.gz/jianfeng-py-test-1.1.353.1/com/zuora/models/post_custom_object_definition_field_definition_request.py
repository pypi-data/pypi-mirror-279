...
class PostCustomObjectDefinitionFieldDefinitionRequest(BaseModel):
    ...
    multiselect: Optional[StrictBool] = Field(None, description="Indicates whether this is a multiselect custom field.  This field applies only to the Picklist or Multiselect custom field types:  - The `type` field is `string`. - The `maxLength` field is specified. - The `enum` field is specified. ")
    type: StrictStr = Field(..., description="The data type of the custom field")
    __properties = ["displayName", "format", "label", "maxLength", "multiselect", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostCustomObjectDefinitionFieldDefinitionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostCustomObjectDefinitionFieldDefinitionRequest:
        """Create an instance of PostCustomObjectDefinitionFieldDefinitionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostCustomObjectDefinitionFieldDefinitionRequest.parse_obj(obj)

        _obj = PostCustomObjectDefinitionFieldDefinitionRequest.parse_obj({
