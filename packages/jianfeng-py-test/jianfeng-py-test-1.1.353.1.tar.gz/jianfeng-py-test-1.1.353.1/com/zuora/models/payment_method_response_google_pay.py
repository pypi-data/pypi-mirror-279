...
class PaymentMethodResponseGooglePay(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentMethodResponseGooglePay:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentMethodResponseGooglePay:
        """Create an instance of PaymentMethodResponseGooglePay from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentMethodResponseGooglePay.parse_obj(obj)

        _obj = PaymentMethodResponseGooglePay.parse_obj({
