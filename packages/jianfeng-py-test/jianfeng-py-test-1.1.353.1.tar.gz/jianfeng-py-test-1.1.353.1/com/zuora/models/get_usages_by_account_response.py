...
class GetUsagesByAccountResponse(BaseModel):
    """
    ...
    usage: Optional[conlist(UsageItem)] = Field(None, description="Contains one or more usage items. ")
    __properties = ["nextPage", "success", "usage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetUsagesByAccountResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetUsagesByAccountResponse:
        """Create an instance of GetUsagesByAccountResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetUsagesByAccountResponse.parse_obj(obj)

        _obj = GetUsagesByAccountResponse.parse_obj({
            "next_page": obj.get("nextPage"),
            "success": obj.get("success"),
            "usage": [UsageItem.from_dict(_item) for _item in obj.get("usage")] if obj.get("usage") is not None else None
        })
        return _obj
