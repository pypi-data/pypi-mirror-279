...
class PostCreateOrUpdateEmailTemplateRequestFormat(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(None, description="ID of an existing email template. Specify this field if you want to update an existing email template. ")
    ...
    __properties = ["active", "bccEmailAddress", "ccEmailAddress", "ccEmailType", "description", "emailBody", "emailSubject", "encodingType", "eventCategory", "eventTypeName", "eventTypeNamespace", "fromEmailAddress", "fromEmailType", "fromName", "id", "isHtml", "name", "replyToEmailAddress", "replyToEmailType", "toEmailAddress", "toEmailType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostCreateOrUpdateEmailTemplateRequestFormat:
        """Create an instance of PostCreateOrUpdateEmailTemplateRequestFormat from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostCreateOrUpdateEmailTemplateRequestFormat:
        """Create an instance of PostCreateOrUpdateEmailTemplateRequestFormat from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostCreateOrUpdateEmailTemplateRequestFormat.parse_obj(obj)

        _obj = PostCreateOrUpdateEmailTemplateRequestFormat.parse_obj({
