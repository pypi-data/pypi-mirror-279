...
from com.zuora.models.bulk_update_order_line_item import BulkUpdateOrderLineItem  # noqa: E501

class TestBulkUpdateOrderLineItem(unittest.TestCase):
    """BulkUpdateOrderLineItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkUpdateOrderLineItem:
        """Test BulkUpdateOrderLineItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkUpdateOrderLineItem`
        """
        model = BulkUpdateOrderLineItem()  # noqa: E501
        if include_optional:
            return BulkUpdateOrderLineItem(
                uom = '',
                accounting_code = '',
    ...
    def testBulkUpdateOrderLineItem(self):
        """Test BulkUpdateOrderLineItem"""
