...
from com.zuora.models.renew_subscription_response import RenewSubscriptionResponse  # noqa: E501
...
class TestRenewSubscriptionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RenewSubscriptionResponse:
        """Test RenewSubscriptionResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RenewSubscriptionResponse`
        """
        model = RenewSubscriptionResponse()  # noqa: E501
        if include_optional:
