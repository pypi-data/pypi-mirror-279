...
from com.zuora.models.preview_order_result_invoices import PreviewOrderResultInvoices  # noqa: E501

class TestPreviewOrderResultInvoices(unittest.TestCase):
    """PreviewOrderResultInvoices unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreviewOrderResultInvoices:
        """Test PreviewOrderResultInvoices
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreviewOrderResultInvoices`
        """
        model = PreviewOrderResultInvoices()  # noqa: E501
        if include_optional:
            return PreviewOrderResultInvoices(
                amount = 1.337,
    ...
    def testPreviewOrderResultInvoices(self):
        """Test PreviewOrderResultInvoices"""
