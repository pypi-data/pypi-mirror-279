...
from com.zuora.models.get_order_line_item import GetOrderLineItem  # noqa: E501

class TestGetOrderLineItem(unittest.TestCase):
    """GetOrderLineItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrderLineItem:
        """Test GetOrderLineItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrderLineItem`
        """
        model = GetOrderLineItem()  # noqa: E501
        if include_optional:
