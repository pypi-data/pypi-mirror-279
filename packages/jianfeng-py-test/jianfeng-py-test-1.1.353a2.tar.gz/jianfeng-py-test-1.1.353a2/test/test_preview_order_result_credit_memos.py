...
from com.zuora.models.preview_order_result_credit_memos import PreviewOrderResultCreditMemos  # noqa: E501

class TestPreviewOrderResultCreditMemos(unittest.TestCase):
    """PreviewOrderResultCreditMemos unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreviewOrderResultCreditMemos:
        """Test PreviewOrderResultCreditMemos
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreviewOrderResultCreditMemos`
        """
        model = PreviewOrderResultCreditMemos()  # noqa: E501
        if include_optional:
            return PreviewOrderResultCreditMemos(
                amount = 1.337,
    ...
    def testPreviewOrderResultCreditMemos(self):
        """Test PreviewOrderResultCreditMemos"""
