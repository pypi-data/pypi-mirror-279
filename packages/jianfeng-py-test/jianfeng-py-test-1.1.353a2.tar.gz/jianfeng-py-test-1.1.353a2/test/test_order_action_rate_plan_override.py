...
from com.zuora.models.order_action_rate_plan_override import OrderActionRatePlanOverride  # noqa: E501
...
class TestOrderActionRatePlanOverride(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderActionRatePlanOverride:
        """Test OrderActionRatePlanOverride
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderActionRatePlanOverride`
        """
        model = OrderActionRatePlanOverride()  # noqa: E501
        if include_optional:
            return OrderActionRatePlanOverride(
                charge_overrides = [
