...
class OrderExistingAccountDetails(BaseModel):
    ...
    __properties = ["basicInfo", "billToContact"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderExistingAccountDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderExistingAccountDetails:
        """Create an instance of OrderExistingAccountDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderExistingAccountDetails.parse_obj(obj)

        _obj = OrderExistingAccountDetails.parse_obj({
