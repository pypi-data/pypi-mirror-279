...
class AccountPMMandateInfo(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountPMMandateInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountPMMandateInfo:
        """Create an instance of AccountPMMandateInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountPMMandateInfo.parse_obj(obj)

        _obj = AccountPMMandateInfo.parse_obj({
