...
class GetPaymentMethodResponseApplePayForAccount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPaymentMethodResponseApplePayForAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPaymentMethodResponseApplePayForAccount:
        """Create an instance of GetPaymentMethodResponseApplePayForAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPaymentMethodResponseApplePayForAccount.parse_obj(obj)

        _obj = GetPaymentMethodResponseApplePayForAccount.parse_obj({
