...
class OneTimeFlatFeePricingOverride(BaseModel):
    """
    Pricing information about a one-time charge that uses the \"flat fee\" charge model. In this charge model, the charge has a fixed price.   # noqa: E501
    """
    list_price: Union[StrictFloat, StrictInt] = Field(..., alias="listPrice", description="Price of the charge. ")
    ...
    __properties = ["listPrice", "originalListPrice"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OneTimeFlatFeePricingOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OneTimeFlatFeePricingOverride:
        """Create an instance of OneTimeFlatFeePricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OneTimeFlatFeePricingOverride.parse_obj(obj)

        _obj = OneTimeFlatFeePricingOverride.parse_obj({
