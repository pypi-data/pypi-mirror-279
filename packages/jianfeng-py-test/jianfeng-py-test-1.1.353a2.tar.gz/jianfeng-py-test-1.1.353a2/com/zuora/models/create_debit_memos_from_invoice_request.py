...
class CreateDebitMemosFromInvoiceRequest(BaseModel):
    ...
    invoice_id: Optional[StrictStr] = Field(None, alias="invoiceId", description="The ID of the invoice that the debit memo is created from. ")
    ...
    __properties = ["autoPay", "autoPost", "comment", "effectiveDate", "invoiceId", "items", "reasonCode", "taxAutoCalculation", "IntegrationId__NS", "IntegrationStatus__NS", "SyncDate__NS"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDebitMemosFromInvoiceRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDebitMemosFromInvoiceRequest:
        """Create an instance of CreateDebitMemosFromInvoiceRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDebitMemosFromInvoiceRequest.parse_obj(obj)

        _obj = CreateDebitMemosFromInvoiceRequest.parse_obj({
