...
class OrderRampIntervalMetrics(BaseModel):
    ...
    interval_delta_metrics: Optional[conlist(RampIntervalChargeDeltaMetrics)] = Field(None, alias="intervalDeltaMetrics", description="Container for the delta metrics for each rate plan charge in each ramp interval. The delta is the difference of the subscription metrics between before and after the order.")
    ...
    __properties = ["description", "discountTcb", "discountTcv", "endDate", "grossTcb", "grossTcv", "intervalDeltaMetrics", "intervalMetrics", "name", "netTcb", "netTcv", "startDate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderRampIntervalMetrics:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderRampIntervalMetrics:
        """Create an instance of OrderRampIntervalMetrics from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderRampIntervalMetrics.parse_obj(obj)

        _obj = OrderRampIntervalMetrics.parse_obj({
            ...
            "interval_delta_metrics": [RampIntervalChargeDeltaMetrics.from_dict(_item) for _item in obj.get("intervalDeltaMetrics")] if obj.get("intervalDeltaMetrics") is not None else None,
