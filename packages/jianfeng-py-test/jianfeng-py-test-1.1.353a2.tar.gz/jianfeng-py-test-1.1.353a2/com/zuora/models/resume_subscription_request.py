...
class ResumeSubscriptionRequest(BaseModel):
    ...
    contract_effective_date: Optional[date] = Field(None, alias="contractEffectiveDate", description="The date when the customer notifies you that they want to resume their subscription. ")
    ...
    __properties = ["applicationOrder", "applyCredit", "applyCreditBalance", "bookingDate", "collect", "contractEffectiveDate", "creditMemoReasonCode", "documentDate", "extendsTerm", "invoice", "invoiceCollect", "invoiceTargetDate", "orderDate", "resumePeriods", "resumePeriodsType", "resumePolicy", "resumeSpecificDate", "runBilling", "targetDate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResumeSubscriptionRequest:
        """Create an instance of ResumeSubscriptionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResumeSubscriptionRequest:
        """Create an instance of ResumeSubscriptionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResumeSubscriptionRequest.parse_obj(obj)

        _obj = ResumeSubscriptionRequest.parse_obj({
