...
class GETListBookingDateBackfillJobs200Response(BaseModel):
    """
    ...
    jobs: Optional[conlist(BookingDateJob)] = None
    __properties = ["processId", "requestId", "reasons", "success", "jobs"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GETListBookingDateBackfillJobs200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GETListBookingDateBackfillJobs200Response:
        """Create an instance of GETListBookingDateBackfillJobs200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GETListBookingDateBackfillJobs200Response.parse_obj(obj)

        _obj = GETListBookingDateBackfillJobs200Response.parse_obj({
            ...
            "jobs": [BookingDateJob.from_dict(_item) for _item in obj.get("jobs")] if obj.get("jobs") is not None else None
        })
        return _obj
