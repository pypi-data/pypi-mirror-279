...
class GetDebitMemoItemFinanceInformation(BaseModel):
    ...
    revenue_schedule_number: Optional[StrictStr] = Field(None, alias="revenueScheduleNumber", description="The revenue schedule number. The revenue schedule number is always prefixed with \"RS\", for example, RS-00000001. ")
    __properties = ["deferredRevenueAccountingCode", "deferredRevenueAccountingCodeType", "recognizedRevenueAccountingCode", "recognizedRevenueAccountingCodeType", "revenueRecognitionRuleName", "revenueScheduleNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDebitMemoItemFinanceInformation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDebitMemoItemFinanceInformation:
        """Create an instance of GetDebitMemoItemFinanceInformation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDebitMemoItemFinanceInformation.parse_obj(obj)

        _obj = GetDebitMemoItemFinanceInformation.parse_obj({
