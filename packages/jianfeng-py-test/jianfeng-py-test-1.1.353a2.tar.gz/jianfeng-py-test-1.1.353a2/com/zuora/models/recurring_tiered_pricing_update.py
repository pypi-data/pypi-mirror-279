...
class RecurringTieredPricingUpdate(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecurringTieredPricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecurringTieredPricingUpdate:
        """Create an instance of RecurringTieredPricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecurringTieredPricingUpdate.parse_obj(obj)

        _obj = RecurringTieredPricingUpdate.parse_obj({
