...
class CreateCreditMemoFromCharge(BaseModel):
    """
    ...
    charges: Optional[conlist(CreditMemoItemFromChargeDetail, max_items=1000)] = Field(None, description="Container for product rate plan charges. The maximum number of items is 1,000. ")
    ...
    __properties = ["IntegrationId__NS", "IntegrationStatus__NS", "Origin__NS", "SyncDate__NS", "Transaction__NS", "accountId", "accountNumber", "autoPost", "charges", "comment", "customRates", "effectiveDate", "excludeFromAutoApplyRules", "reasonCode", "currency", "number"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCreditMemoFromCharge:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCreditMemoFromCharge:
        """Create an instance of CreateCreditMemoFromCharge from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCreditMemoFromCharge.parse_obj(obj)

        _obj = CreateCreditMemoFromCharge.parse_obj({
            ...
            "charges": [CreditMemoItemFromChargeDetail.from_dict(_item) for _item in obj.get("charges")] if obj.get("charges") is not None else None,
            ...
            "exclude_from_auto_apply_rules": obj.get("excludeFromAutoApplyRules") if obj.get("excludeFromAutoApplyRules") is not None else False,
