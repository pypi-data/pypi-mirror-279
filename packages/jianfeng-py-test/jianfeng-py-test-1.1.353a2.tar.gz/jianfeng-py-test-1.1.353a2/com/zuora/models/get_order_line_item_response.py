...
class GetOrderLineItemResponse(BaseModel):
    """
    ...
    order_line_item: Optional[GetOrderLineItem] = Field(None, alias="orderLineItem")
    __properties = ["processId", "requestId", "reasons", "success", "orderLineItem"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOrderLineItemResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOrderLineItemResponse:
        """Create an instance of GetOrderLineItemResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOrderLineItemResponse.parse_obj(obj)

        _obj = GetOrderLineItemResponse.parse_obj({
            ...
            "order_line_item": GetOrderLineItem.from_dict(obj.get("orderLineItem")) if obj.get("orderLineItem") is not None else None
        })
        return _obj
