...
class PostPublicNotificationDefinitionRequestFilterRule(BaseModel):
    """
      # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostPublicNotificationDefinitionRequestFilterRule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostPublicNotificationDefinitionRequestFilterRule:
        """Create an instance of PostPublicNotificationDefinitionRequestFilterRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostPublicNotificationDefinitionRequestFilterRule.parse_obj(obj)

        _obj = PostPublicNotificationDefinitionRequestFilterRule.parse_obj({
