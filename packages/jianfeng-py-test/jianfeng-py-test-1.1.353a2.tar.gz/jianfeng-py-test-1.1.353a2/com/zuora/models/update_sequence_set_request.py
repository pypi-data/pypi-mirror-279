...
class UpdateSequenceSetRequest(BaseModel):
    """
      # noqa: E501
    """
    ...
    name: Optional[StrictStr] = Field(None, description="The name of the sequence set configured for billing documents, payments, and refunds. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateSequenceSetRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateSequenceSetRequest:
        """Create an instance of UpdateSequenceSetRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateSequenceSetRequest.parse_obj(obj)

        _obj = UpdateSequenceSetRequest.parse_obj({
