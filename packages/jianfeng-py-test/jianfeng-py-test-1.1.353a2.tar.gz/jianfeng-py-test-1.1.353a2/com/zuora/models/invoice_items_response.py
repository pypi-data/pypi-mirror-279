...
class InvoiceItemsResponse(BaseModel):
    ...
    invoice_items: Optional[conlist(InvoiceItem)] = Field(None, alias="invoiceItems", description="Container for invoice items. ")
    ...
    __properties = ["processId", "requestId", "reasons", "success", "invoiceItems", "nextPage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvoiceItemsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvoiceItemsResponse:
        """Create an instance of InvoiceItemsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvoiceItemsResponse.parse_obj(obj)

        _obj = InvoiceItemsResponse.parse_obj({
            ...
            "invoice_items": [InvoiceItem.from_dict(_item) for _item in obj.get("invoiceItems")] if obj.get("invoiceItems") is not None else None,
