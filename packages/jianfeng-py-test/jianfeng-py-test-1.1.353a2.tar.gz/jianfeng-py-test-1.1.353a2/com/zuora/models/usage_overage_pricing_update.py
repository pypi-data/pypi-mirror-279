...
class UsageOveragePricingUpdate(BaseModel):
    """
    ...
    included_units: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="includedUnits", description="A certain quantity of units for free in the overage charge model. It cannot be negative. It must be 0 and above. Decimals are allowed. ")
    overage_price: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="overagePrice")
    __properties = ["priceChangeOption", "priceIncreasePercentage", "includedUnits", "overagePrice"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsageOveragePricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsageOveragePricingUpdate:
        """Create an instance of UsageOveragePricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsageOveragePricingUpdate.parse_obj(obj)

        _obj = UsageOveragePricingUpdate.parse_obj({
