...
class SubscribeToProduct(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscribeToProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscribeToProduct:
        """Create an instance of SubscribeToProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscribeToProduct.parse_obj(obj)

        _obj = SubscribeToProduct.parse_obj({
