...
class GetRampMetricsByOrderNumberResponse(BaseModel):
    """
    ...
    ramp_metrics: Optional[conlist(OrderRampMetrics)] = Field(None, alias="rampMetrics")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRampMetricsByOrderNumberResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRampMetricsByOrderNumberResponse:
        """Create an instance of GetRampMetricsByOrderNumberResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRampMetricsByOrderNumberResponse.parse_obj(obj)

        _obj = GetRampMetricsByOrderNumberResponse.parse_obj({
