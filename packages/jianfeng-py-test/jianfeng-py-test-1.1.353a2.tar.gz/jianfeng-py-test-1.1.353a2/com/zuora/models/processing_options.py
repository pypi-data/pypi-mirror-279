...
class ProcessingOptions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProcessingOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProcessingOptions:
        """Create an instance of ProcessingOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProcessingOptions.parse_obj(obj)

        _obj = ProcessingOptions.parse_obj({
