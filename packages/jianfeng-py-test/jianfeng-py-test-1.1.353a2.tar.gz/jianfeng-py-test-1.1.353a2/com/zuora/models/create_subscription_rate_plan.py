...
class CreateSubscriptionRatePlan(BaseModel):
    ...
    """
    charge_overrides: Optional[conlist(CreateSubscriptionComponent)] = Field(None, alias="chargeOverrides", description="This optional container is used to override the quantity of one or more product rate plan charges for this subscription. ")
    ...
    __properties = ["chargeOverrides", "externalCatalogPlanId", "externalIdSourceSystem", "externallyManagedPlanId", "productRatePlanId", "productRatePlanNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSubscriptionRatePlan:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSubscriptionRatePlan:
        """Create an instance of CreateSubscriptionRatePlan from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSubscriptionRatePlan.parse_obj(obj)

        _obj = CreateSubscriptionRatePlan.parse_obj({
            "charge_overrides": [CreateSubscriptionComponent.from_dict(_item) for _item in obj.get("chargeOverrides")] if obj.get("chargeOverrides") is not None else None,
