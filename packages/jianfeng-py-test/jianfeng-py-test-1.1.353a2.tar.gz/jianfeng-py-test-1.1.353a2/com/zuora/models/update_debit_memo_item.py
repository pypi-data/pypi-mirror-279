...
class UpdateDebitMemoItem(BaseModel):
    """
    UpdateDebitMemoItem
    """
    ...
    comment: Optional[StrictStr] = Field(None, description="Comments about the debit memo item.")
    ...
    id: constr(strict=True, max_length=32, min_length=32) = Field(..., description="The ID of the debit memo item.")
    ...
    tax_items: Optional[conlist(UpdateDebitMemoTaxItemRequest)] = Field(None, alias="taxItems", description="Container for debit memo taxation items.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDebitMemoItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDebitMemoItem:
        """Create an instance of UpdateDebitMemoItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateDebitMemoItem.parse_obj(obj)

        _obj = UpdateDebitMemoItem.parse_obj({
            ...
            "tax_items": [UpdateDebitMemoTaxItemRequest.from_dict(_item) for _item in obj.get("taxItems")] if obj.get("taxItems") is not None else None,
