...
class TermInfo(BaseModel):
    ...
    renewal_terms: Optional[RenewalTerm] = Field(None, alias="renewalTerms")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TermInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TermInfo:
        """Create an instance of TermInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TermInfo.parse_obj(obj)

        _obj = TermInfo.parse_obj({
            ...
            "renewal_terms": RenewalTerm.from_dict(obj.get("renewalTerms")) if obj.get("renewalTerms") is not None else None
        })
        return _obj
