...
class UpdateOrderLineItem(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateOrderLineItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateOrderLineItem:
        """Create an instance of UpdateOrderLineItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateOrderLineItem.parse_obj(obj)

        _obj = UpdateOrderLineItem.parse_obj({
            "uom": obj.get("UOM"),
