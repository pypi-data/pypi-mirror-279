...
class PutBusinessRegionRequest(BaseModel):
    """
    PutBusinessRegionRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PutBusinessRegionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PutBusinessRegionRequest:
        """Create an instance of PutBusinessRegionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PutBusinessRegionRequest.parse_obj(obj)

        _obj = PutBusinessRegionRequest.parse_obj({
