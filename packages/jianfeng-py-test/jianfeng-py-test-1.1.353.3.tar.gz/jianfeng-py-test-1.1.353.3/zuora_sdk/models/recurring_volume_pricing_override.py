...
class RecurringVolumePricingOverride(BaseModel):
    """
    ...
    __properties = ["priceChangeOption", "priceIncreasePercentage", "listPriceBase", "quantity", "specificListPriceBase", "tiers", "uom"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecurringVolumePricingOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecurringVolumePricingOverride:
        """Create an instance of RecurringVolumePricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecurringVolumePricingOverride.parse_obj(obj)

        _obj = RecurringVolumePricingOverride.parse_obj({
