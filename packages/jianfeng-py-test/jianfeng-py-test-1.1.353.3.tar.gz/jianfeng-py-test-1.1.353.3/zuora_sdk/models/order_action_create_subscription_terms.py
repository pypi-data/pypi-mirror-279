...
class OrderActionCreateSubscriptionTerms(BaseModel):
    ...
    renewal_terms: conlist(RenewalTerm) = Field(..., alias="renewalTerms", description="List of renewal terms of the subscription. Only applicable if the type of the first term is `TERMED` and the value of the `renewalSetting` field is `RENEW_WITH_SPECIFIC_TERM`. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderActionCreateSubscriptionTerms:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderActionCreateSubscriptionTerms:
        """Create an instance of OrderActionCreateSubscriptionTerms from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderActionCreateSubscriptionTerms.parse_obj(obj)

        _obj = OrderActionCreateSubscriptionTerms.parse_obj({
