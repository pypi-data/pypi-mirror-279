...
class RecurringTieredPricingOverride(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecurringTieredPricingOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecurringTieredPricingOverride:
        """Create an instance of RecurringTieredPricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecurringTieredPricingOverride.parse_obj(obj)

        _obj = RecurringTieredPricingOverride.parse_obj({
