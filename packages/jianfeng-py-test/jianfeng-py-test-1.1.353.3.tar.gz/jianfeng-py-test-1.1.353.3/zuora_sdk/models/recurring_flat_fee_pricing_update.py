...
class RecurringFlatFeePricingUpdate(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecurringFlatFeePricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecurringFlatFeePricingUpdate:
        """Create an instance of RecurringFlatFeePricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecurringFlatFeePricingUpdate.parse_obj(obj)

        _obj = RecurringFlatFeePricingUpdate.parse_obj({
