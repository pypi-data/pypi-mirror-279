...
class OrderCreateAccountContact(BaseModel):
    """
    Contact details associated with an account.   # noqa: E501
    """
    ...
    country: Optional[constr(strict=True, max_length=64)] = Field(None, description="Country; must be a valid country name or abbreviation. If using Zuora Tax, you must specify a country in the bill-to contact to calculate tax. ")
    ...
    last_name: constr(strict=True, max_length=100) = Field(..., alias="lastName", description="Last name of the contact. ")
    ...
    __properties = ["address1", "address2", "city", "contactDescription", "country", "county", "fax", "firstName", "homePhone", "lastName", "mobilePhone", "nickname", "otherPhone", "otherPhoneType", "personalEmail", "postalCode", "state", "taxRegion", "workEmail", "workPhone"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderCreateAccountContact:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderCreateAccountContact:
        """Create an instance of OrderCreateAccountContact from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderCreateAccountContact.parse_obj(obj)

        _obj = OrderCreateAccountContact.parse_obj({
