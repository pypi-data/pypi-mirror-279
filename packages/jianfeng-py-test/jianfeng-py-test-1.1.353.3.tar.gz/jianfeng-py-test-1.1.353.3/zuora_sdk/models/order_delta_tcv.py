...
class OrderDeltaTcv(BaseModel):
    """
    Order Delta Tcv. This is a metric that reflects the change to the TCV on Rate Plan Charge object, or the Total Contracted Value for an Order Line Item as the result of the order   # noqa: E501
    """
    ...
    order_line_item_id: Optional[StrictStr] = Field(None, alias="orderLineItemId", description="The sytem generated Id for the Order Line Item. This field can be null if the metric is generated for subscriptions. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderDeltaTcv:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderDeltaTcv:
        """Create an instance of OrderDeltaTcv from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderDeltaTcv.parse_obj(obj)

        _obj = OrderDeltaTcv.parse_obj({
