...
class CreateProductRatePlanRequest(BaseModel):
    ...
    name: constr(strict=True, max_length=255) = Field(..., alias="Name", description="The name of the product rate plan. The name doesn't have to be unique in a Product Catalog, but the name has to be unique within a product. ")
    product_id: constr(strict=True, max_length=32) = Field(..., alias="ProductId", description="The ID of the product that contains the product rate plan. ")
    ...
    external_rate_plan_ids: Optional[conlist(StrictStr)] = Field(None, alias="ExternalRatePlanIds", description="The unique identifier for the product rate plan in a third-party store. This field is used to represent a rate plan created through third-party stores. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateProductRatePlanRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateProductRatePlanRequest:
        """Create an instance of CreateProductRatePlanRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateProductRatePlanRequest.parse_obj(obj)

        _obj = CreateProductRatePlanRequest.parse_obj({
            ...
            "external_rate_plan_ids": obj.get("ExternalRatePlanIds"),
