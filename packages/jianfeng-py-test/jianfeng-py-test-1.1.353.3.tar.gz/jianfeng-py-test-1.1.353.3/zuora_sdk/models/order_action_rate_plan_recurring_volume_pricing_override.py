...
class OrderActionRatePlanRecurringVolumePricingOverride(BaseModel):
    """
    ...
    tiers: Optional[conlist(ChargeTier)] = Field(None, description="List of variable pricing tiers in the charge. ")
    __properties = ["priceChangeOption", "priceIncreasePercentage", "listPriceBase", "quantity", "specificListPriceBase", "tiers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderActionRatePlanRecurringVolumePricingOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderActionRatePlanRecurringVolumePricingOverride:
        """Create an instance of OrderActionRatePlanRecurringVolumePricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderActionRatePlanRecurringVolumePricingOverride.parse_obj(obj)

        _obj = OrderActionRatePlanRecurringVolumePricingOverride.parse_obj({
