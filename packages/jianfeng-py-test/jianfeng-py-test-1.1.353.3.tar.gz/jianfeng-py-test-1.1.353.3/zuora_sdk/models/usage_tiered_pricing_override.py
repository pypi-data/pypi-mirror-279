...
class UsageTieredPricingOverride(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsageTieredPricingOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsageTieredPricingOverride:
        """Create an instance of UsageTieredPricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsageTieredPricingOverride.parse_obj(obj)

        _obj = UsageTieredPricingOverride.parse_obj({
