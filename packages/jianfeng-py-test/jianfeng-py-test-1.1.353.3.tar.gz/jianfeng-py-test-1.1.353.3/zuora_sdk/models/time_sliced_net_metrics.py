...
class TimeSlicedNetMetrics(BaseModel):
    """
    ...
    __properties = ["amount", "discountChargeNumber", "endDate", "generatedReason", "invoiceOwner", "orderItemId", "startDate", "subscriptionOwner", "termNumber", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimeSlicedNetMetrics:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimeSlicedNetMetrics:
        """Create an instance of TimeSlicedNetMetrics from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimeSlicedNetMetrics.parse_obj(obj)

        _obj = TimeSlicedNetMetrics.parse_obj({
