...
class OrderActionRatePlanRecurringFlatFeePricingOverride(BaseModel):
    """
    ...
    specific_list_price_base: Optional[conint(strict=True, le=200, ge=1)] = Field(None, alias="specificListPriceBase", description="The number of months for the list price base of the charge. The value of this field is `null` if you do not set the value of the `listPriceBase` field to `Per_Specific_Months`. ")
    __properties = ["priceChangeOption", "priceIncreasePercentage", "listPrice", "listPriceBase", "specificListPriceBase"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderActionRatePlanRecurringFlatFeePricingOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderActionRatePlanRecurringFlatFeePricingOverride:
        """Create an instance of OrderActionRatePlanRecurringFlatFeePricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderActionRatePlanRecurringFlatFeePricingOverride.parse_obj(obj)

        _obj = OrderActionRatePlanRecurringFlatFeePricingOverride.parse_obj({
