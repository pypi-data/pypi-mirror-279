...
class UsageFlatFeePricingUpdate(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsageFlatFeePricingUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsageFlatFeePricingUpdate:
        """Create an instance of UsageFlatFeePricingUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsageFlatFeePricingUpdate.parse_obj(obj)

        _obj = UsageFlatFeePricingUpdate.parse_obj({
