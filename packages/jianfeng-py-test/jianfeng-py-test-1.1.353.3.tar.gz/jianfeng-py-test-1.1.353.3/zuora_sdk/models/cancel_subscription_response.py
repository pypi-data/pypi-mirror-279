...
class CancelSubscriptionResponse(BaseModel):
    ...
    """
    cancelled_date: Optional[date] = Field(None, alias="cancelledDate", description="The date that the subscription was canceled. It is available for Orders Harmonization and Subscribe/Amend tenants. ")
    ...
    invoice_id: Optional[StrictStr] = Field(None, alias="invoiceId", description="ID of the invoice, if one is generated. ")
    paid_amount: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="paidAmount", description="Amount paid. ")
    payment_id: Optional[StrictStr] = Field(None, alias="paymentId", description="ID of the payment, if a payment is collected. ")
    ...
    total_delta_mrr: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="totalDeltaMrr", description="Change in the subscription monthly recurring revenue as a result of the update. It is available for Orders Harmonization and Subscribe/Amend tenants. ")
    ...
    __properties = ["cancelledDate", "creditMemoId", "invoiceId", "paidAmount", "paymentId", "subscriptionId", "success", "totalDeltaMrr", "totalDeltaTcv", "orderNumber", "status", "accountNumber", "subscriptionNumbers", "subscriptions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancelSubscriptionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancelSubscriptionResponse:
        """Create an instance of CancelSubscriptionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancelSubscriptionResponse.parse_obj(obj)

        _obj = CancelSubscriptionResponse.parse_obj({
            "cancelled_date": obj.get("cancelledDate"),
