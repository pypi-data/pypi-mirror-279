...
class OrderActionRatePlanRecurringPerUnitPricingOverride(BaseModel):
    """
    ...
    list_price: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="listPrice", description="Per-unit price of the charge in each recurring period. ")
    ...
    specific_list_price_base: Optional[conint(strict=True, le=200, ge=1)] = Field(None, alias="specificListPriceBase", description="The number of months for the list price base of the charge. This field is required if you set the value of the `listPriceBase` field to `Per_Specific_Months`. ")
    __properties = ["priceChangeOption", "priceIncreasePercentage", "listPrice", "listPriceBase", "quantity", "specificListPriceBase"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderActionRatePlanRecurringPerUnitPricingOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderActionRatePlanRecurringPerUnitPricingOverride:
        """Create an instance of OrderActionRatePlanRecurringPerUnitPricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderActionRatePlanRecurringPerUnitPricingOverride.parse_obj(obj)

        _obj = OrderActionRatePlanRecurringPerUnitPricingOverride.parse_obj({
