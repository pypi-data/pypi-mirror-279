...
class PostCreateOrUpdateEmailTemplateRequestFormatCcEmailType(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostCreateOrUpdateEmailTemplateRequestFormatCcEmailType:
        """Create an instance of PostCreateOrUpdateEmailTemplateRequestFormatCcEmailType from a JSON string"""
        return PostCreateOrUpdateEmailTemplateRequestFormatCcEmailType(json.loads(json_str))
