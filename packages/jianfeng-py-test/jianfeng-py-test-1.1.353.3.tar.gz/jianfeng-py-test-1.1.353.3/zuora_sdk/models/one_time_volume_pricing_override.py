...
class OneTimeVolumePricingOverride(BaseModel):
    """
    Pricing information about a one-time charge that uses the \"volume pricing\" charge model. In this charge model, the charge has a variable price per unit, depending on how many units are purchased.   # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OneTimeVolumePricingOverride:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OneTimeVolumePricingOverride:
        """Create an instance of OneTimeVolumePricingOverride from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OneTimeVolumePricingOverride.parse_obj(obj)

        _obj = OneTimeVolumePricingOverride.parse_obj({
