...
class OrderDeltaTcb(BaseModel):
    """
    Order Delta Tcb. This is a metric that reflects the change to the estimated billing on Rate Plan Charge object, or the estimated billing for an Order Line Item as the result of the order   # noqa: E501
    """
    ...
    order_line_item_id: Optional[StrictStr] = Field(None, alias="orderLineItemId", description="The sytem generated Id for the Order Line Item. This field can be null if the metric is generated for a Rate Plan Charge. ")
    __properties = ["chargeNumber", "currency", "endDate", "grossAmount", "netAmount", "orderActionId", "orderActionSequence", "orderActionType", "orderLineItemNumber", "productRatePlanChargeId", "ratePlanChargeId", "startDate", "subscriptionNumber", "orderLineItemId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderDeltaTcb:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderDeltaTcb:
        """Create an instance of OrderDeltaTcb from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderDeltaTcb.parse_obj(obj)

        _obj = OrderDeltaTcb.parse_obj({
