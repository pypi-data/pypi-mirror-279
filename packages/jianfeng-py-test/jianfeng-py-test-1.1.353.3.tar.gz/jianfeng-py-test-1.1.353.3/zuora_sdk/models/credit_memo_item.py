...
class CreditMemoItem(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreditMemoItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreditMemoItem:
        """Create an instance of CreditMemoItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreditMemoItem.parse_obj(obj)

        _obj = CreditMemoItem.parse_obj({
