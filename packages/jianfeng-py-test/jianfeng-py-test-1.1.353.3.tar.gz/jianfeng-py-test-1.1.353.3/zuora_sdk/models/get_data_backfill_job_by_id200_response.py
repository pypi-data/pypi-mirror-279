...
class GETDataBackfillJobById200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GETDataBackfillJobById200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GETDataBackfillJobById200Response:
        """Create an instance of GETDataBackfillJobById200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GETDataBackfillJobById200Response.parse_obj(obj)

        _obj = GETDataBackfillJobById200Response.parse_obj({
