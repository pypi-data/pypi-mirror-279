...
class CreateBillingPreviewRunResponse(BaseModel):
    """
    ...
    billing_preview_run_id: Optional[StrictStr] = Field(None, alias="billingPreviewRunId", description="Id of the billing preview run. ")
    __properties = ["processId", "requestId", "reasons", "success", "billingPreviewRunId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateBillingPreviewRunResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateBillingPreviewRunResponse:
        """Create an instance of CreateBillingPreviewRunResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateBillingPreviewRunResponse.parse_obj(obj)

        _obj = CreateBillingPreviewRunResponse.parse_obj({
            ...
            "billing_preview_run_id": obj.get("billingPreviewRunId")
        })
        return _obj
