...
class SuspendSubscriptionResponse(BaseModel):
    """
    ...
    resume_date: Optional[date] = Field(None, alias="resumeDate", description="The date when subscription resumption takes effect, in the format yyyy-mm-dd. It is available for Orders Harmonization and Subscribe/Amend Tenants. ")
    ...
    suspend_date: Optional[date] = Field(None, alias="suspendDate", description="The date when subscription suspension takes effect, in the format yyyy-mm-dd. It is available for Orders Harmonization and Subscribe/Amend Tenants. ")
    term_end_date: Optional[date] = Field(None, alias="termEndDate", description="The date when the new subscription term ends, in the format yyyy-mm-dd. It is available for Orders Harmonization and Subscribe/Amend Tenants. ")
    ...
    __properties = ["creditMemoId", "invoiceId", "paidAmount", "paymentId", "resumeDate", "subscriptionId", "success", "suspendDate", "termEndDate", "totalDeltaTcv", "orderNumber", "status", "accountNumber", "subscriptionNumbers", "subscriptions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SuspendSubscriptionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SuspendSubscriptionResponse:
        """Create an instance of SuspendSubscriptionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SuspendSubscriptionResponse.parse_obj(obj)

        _obj = SuspendSubscriptionResponse.parse_obj({
