...
CREATE TABLE IF NOT EXISTS "EV_Charging_Stations" (
    ...
    Public_Flag BOOL DEFAULT 1, --@ Boolean describing if the charging station is meant for personal vehicles alone (1 = public) or for fleet-operated vehicles only (0 = private)
