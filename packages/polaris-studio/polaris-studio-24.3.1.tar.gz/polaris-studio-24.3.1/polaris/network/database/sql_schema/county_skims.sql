...
CREATE TABLE IF NOT EXISTS "County_Skims" (
    ...
    "gcd_miles"   REAL             DEFAULT 0, --@ The great circle distance between the two counties (miles)
    "hwy_miles"   REAL             DEFAULT 0  --@ The shortest routable highway distance between the two counties (miles)
);
