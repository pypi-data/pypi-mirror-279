...
SELECT
    ...
    pl1.value_enter_energy_level as initial_charge,
    pl2.value_enter_energy_level as final_charge,
...
where 
    ...
    t.mode = 0 and
    t.path = pp.id AND
    pl1.object_id = pp.id AND
    pl2.object_id = pp.id and
    pl1."index" = 0 AND
    pl2."index" = pp.num_links - 1 AND
