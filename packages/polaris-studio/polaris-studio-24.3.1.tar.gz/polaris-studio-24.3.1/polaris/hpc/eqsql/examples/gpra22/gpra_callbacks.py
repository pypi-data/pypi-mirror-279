...
from polaris.runs.convergence.convergence_config import ConvergenceConfig, ConvergenceIteration
...
def get_scenario_json_fn(config: ConvergenceConfig, current_iteration: ConvergenceIteration):
    ...
    mods["replan_mobility_options"] = is_first_normal or current_iteration.is_abm_init

    if config.num_outer_loops > 1:
        mods["replan_mobility_options"] = False
