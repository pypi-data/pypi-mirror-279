...
class GlobusLocation(FileLocation):  # pragma: no cover
    ...
    vms_endpoint_lookup = {
        ...
        "/mnt/q/FY22/2208 - SMART2.0 - GPRA Study Y2/": "b5e02a96-acc1-11ed-adfd-bfc1a406350a",
        "/mnt/q/FY23/2307 - SMART2.0 - GPRA Study Y3/": "43fad83c-2470-11ee-80c1-a3018385fcef",
        ...
        "/mnt/gpra23_results/": "17f7261a-3ae0-11ee-9209-5b20905a64b1",
...
def normalise_path(path) -> FileLocation:
    ...
    if where_am_i == WhereAmI.BEBOP_CLUSTER or where_am_i == WhereAmI.CROSSOVER_CLUSTER:
...
if __name__ == "__main__":
    ...
    # magic_copy(sys.argv[1], sys.argv[2])
