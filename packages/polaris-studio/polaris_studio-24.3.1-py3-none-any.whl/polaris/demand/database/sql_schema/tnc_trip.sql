...
CREATE TABLE "TNC_Trip" (
  ...
  "path" INTEGER NULL,                       --@ Path ID is not NULL if there exists Path-related information in the Path table referenced by this value (foreign key to the Path table)
