...
CREATE TABLE "Trip" (
  ...
  "path" INTEGER NULL,                                  --@ path is not NULL if there exists trajectory-related information in the Path table referenced by this value. (foreign key to the Path table)
