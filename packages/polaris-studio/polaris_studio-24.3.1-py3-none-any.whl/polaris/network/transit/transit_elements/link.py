...
from polaris.network.constants import constants, TRANSIT_LINK_RANGE
...
class Link:
    ...
    def build_geo(self, from_point: Point, to_point: Point, gtfs_shape: Optional[LineString], previous_end: Point):
