...
CREATE TABLE IF NOT EXISTS "Zone" (
    ...
    "area_type"                INTEGER NOT NULL    DEFAULT 100, --@ Area type of the zone. Default is 100.
    ...
    "percent_black"            REAL    NOT NULL    DEFAULT 0, --@ Percent of population within TAZ that is Afican-American. Not used except if needed in choice models.
