...
create TABLE IF NOT EXISTS "Timing" (
    ...
    "timing"    INTEGER NOT NULL DEFAULT 0, --@ index of the timing (within the same signal) of the tiing
    "type"      INTEGER NOT NULL DEFAULT 0, --@ type (TIMED, ACTUATED). Generally TIMED is used
    "cycle"     INTEGER NOT NULL DEFAULT 0, --@ cycle time (SET by POLARIS as the sum of green + intergreens across all nested records)
