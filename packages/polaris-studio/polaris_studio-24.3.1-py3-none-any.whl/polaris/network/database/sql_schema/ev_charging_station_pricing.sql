...
CREATE TABLE IF NOT EXISTS "EV_Charging_Station_Pricing"(
    ...
    unit_price REAL    NOT NULL, --@ the cost per kWh expressed in dollars.

    CONSTRAINT "fk_stat_id" FOREIGN KEY("station_id") REFERENCES EV_Charging_Stations("ID") DEFERRABLE INITIALLY DEFERRED
);
