...
CREATE TABLE IF NOT EXISTS "Electricity_Provider_Pricing"(
    ...
    start_seconds INTEGER NOT NULL, --@ Simulation time in seconds for when pricing strategy starts being enforced
    end_seconds INTEGER NOT NULL, --@ Simulation time in seconds for when pricing strategy stops being enforced
