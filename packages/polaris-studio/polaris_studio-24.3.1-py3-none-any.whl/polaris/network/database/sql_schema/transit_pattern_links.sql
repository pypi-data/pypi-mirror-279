...
CREATE TABLE IF NOT EXISTS "Transit_Pattern_Links" (
    pattern_id     INTEGER    NOT NULL, --@ ID of the pattern in the format AARRRRPPPP0000 (Agency, Route, Pattern)
    "index"        INTEGER    NOT NULL, --@ Sequence number of the link served by the pattern
    transit_link   INTEGER    NOT NULL, --@ ID of the transit link that the pattern serves at the given "index" sequence
