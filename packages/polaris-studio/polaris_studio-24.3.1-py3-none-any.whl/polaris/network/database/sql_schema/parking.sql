...
create TABLE IF NOT EXISTS "Parking" (
    ...
    "dir"          INTEGER NOT NULL,   --@ The direction of the link (ab or ba) that is closest to the parking. Can be used to infer which side of the link this location may lie (but not trivial)
