...
def export_pockets_to_gmns(gmns_folder: str, transformer, conn, path_to_file: PathLike):
    ...
    pockets = DataTableCache(path_to_file).get_table("Pocket", conn=conn).reset_index()
