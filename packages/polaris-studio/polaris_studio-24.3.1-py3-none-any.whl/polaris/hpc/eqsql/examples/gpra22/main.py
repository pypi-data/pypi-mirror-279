...
def example_json():
    return {
        "run-id": "001",
        "city": "Grid",
        "where-is-polaris-exe": f"/mnt/p/VMS_Software/15-CI-CD-Artifacts/Polaris/polaris-linux/develop/Integrated_Model.gcc",
        "where-are-models": "/mnt/p/VMS_Software/15-CI-CD-Artifacts/Polaris/models",
