...
METHOD_BUFFERED = make_flag("METHOD_BUFFERED", 0)
METHOD_IN_DIRECT = make_flag("METHOD_IN_DIRECT", 1)
METHOD_OUT_DIRECT = make_flag("METHOD_OUT_DIRECT", 2)
METHOD_NEITHER = make_flag("METHOD_NEITHER", 3)
METHOD_DIRECT_TO_HARDWARE = make_flag("METHOD_DIRECT_TO_HARDWARE", METHOD_IN_DIRECT)
METHOD_DIRECT_FROM_HARDWARE = make_flag("METHOD_DIRECT_FROM_HARDWARE", METHOD_OUT_DIRECT)
FILE_ANY_ACCESS = make_flag("FILE_ANY_ACCESS", 0)
FILE_SPECIAL_ACCESS = make_flag("FILE_SPECIAL_ACCESS", ( FILE_ANY_ACCESS ))
FILE_READ_ACCESS = make_flag("FILE_READ_ACCESS", ( 0x0001 ))
FILE_WRITE_ACCESS = make_flag("FILE_WRITE_ACCESS", ( 0x0002 ))
FILE_DISPOSITION_DO_NOT_DELETE = make_flag("FILE_DISPOSITION_DO_NOT_DELETE", 0x00000000)
FILE_DISPOSITION_DELETE = make_flag("FILE_DISPOSITION_DELETE", 0x00000001)
FILE_DISPOSITION_POSIX_SEMANTICS = make_flag("FILE_DISPOSITION_POSIX_SEMANTICS", 0x00000002)
FILE_DISPOSITION_FORCE_IMAGE_SECTION_CHECK = make_flag("FILE_DISPOSITION_FORCE_IMAGE_SECTION_CHECK", 0x00000004)
FILE_DISPOSITION_ON_CLOSE = make_flag("FILE_DISPOSITION_ON_CLOSE", 0x00000008)
FILE_DISPOSITION_IGNORE_READONLY_ATTRIBUTE = make_flag("FILE_DISPOSITION_IGNORE_READONLY_ATTRIBUTE", 0x00000010)
FSCTL_REQUEST_OPLOCK_LEVEL_1 = make_flag("FSCTL_REQUEST_OPLOCK_LEVEL_1", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 0 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REQUEST_OPLOCK_LEVEL_2 = make_flag("FSCTL_REQUEST_OPLOCK_LEVEL_2", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 1 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REQUEST_BATCH_OPLOCK = make_flag("FSCTL_REQUEST_BATCH_OPLOCK", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 2 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_OPLOCK_BREAK_ACKNOWLEDGE = make_flag("FSCTL_OPLOCK_BREAK_ACKNOWLEDGE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 3 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_OPBATCH_ACK_CLOSE_PENDING = make_flag("FSCTL_OPBATCH_ACK_CLOSE_PENDING", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 4 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_OPLOCK_BREAK_NOTIFY = make_flag("FSCTL_OPLOCK_BREAK_NOTIFY", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 5 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_LOCK_VOLUME = make_flag("FSCTL_LOCK_VOLUME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 6 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_UNLOCK_VOLUME = make_flag("FSCTL_UNLOCK_VOLUME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 7 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_DISMOUNT_VOLUME = make_flag("FSCTL_DISMOUNT_VOLUME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 8 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_IS_VOLUME_MOUNTED = make_flag("FSCTL_IS_VOLUME_MOUNTED", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 10 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_IS_PATHNAME_VALID = make_flag("FSCTL_IS_PATHNAME_VALID", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 11 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_MARK_VOLUME_DIRTY = make_flag("FSCTL_MARK_VOLUME_DIRTY", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 12 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_RETRIEVAL_POINTERS = make_flag("FSCTL_QUERY_RETRIEVAL_POINTERS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 14 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_GET_COMPRESSION = make_flag("FSCTL_GET_COMPRESSION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 15 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_COMPRESSION = make_flag("FSCTL_SET_COMPRESSION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 16 , METHOD_BUFFERED , FILE_READ_DATA | FILE_WRITE_DATA ))
FSCTL_SET_BOOTLOADER_ACCESSED = make_flag("FSCTL_SET_BOOTLOADER_ACCESSED", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 19 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_MARK_AS_SYSTEM_HIVE = make_flag("FSCTL_MARK_AS_SYSTEM_HIVE", FSCTL_SET_BOOTLOADER_ACCESSED)
FSCTL_OPLOCK_BREAK_ACK_NO_2 = make_flag("FSCTL_OPLOCK_BREAK_ACK_NO_2", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 20 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_INVALIDATE_VOLUMES = make_flag("FSCTL_INVALIDATE_VOLUMES", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 21 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_FAT_BPB = make_flag("FSCTL_QUERY_FAT_BPB", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 22 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REQUEST_FILTER_OPLOCK = make_flag("FSCTL_REQUEST_FILTER_OPLOCK", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 23 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_FILESYSTEM_GET_STATISTICS = make_flag("FSCTL_FILESYSTEM_GET_STATISTICS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 24 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_NTFS_VOLUME_DATA = make_flag("FSCTL_GET_NTFS_VOLUME_DATA", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 25 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_NTFS_FILE_RECORD = make_flag("FSCTL_GET_NTFS_FILE_RECORD", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 26 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_VOLUME_BITMAP = make_flag("FSCTL_GET_VOLUME_BITMAP", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 27 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_GET_RETRIEVAL_POINTERS = make_flag("FSCTL_GET_RETRIEVAL_POINTERS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 28 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_MOVE_FILE = make_flag("FSCTL_MOVE_FILE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 29 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_IS_VOLUME_DIRTY = make_flag("FSCTL_IS_VOLUME_DIRTY", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 30 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_ALLOW_EXTENDED_DASD_IO = make_flag("FSCTL_ALLOW_EXTENDED_DASD_IO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 32 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_FIND_FILES_BY_SID = make_flag("FSCTL_FIND_FILES_BY_SID", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 35 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_SET_OBJECT_ID = make_flag("FSCTL_SET_OBJECT_ID", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 38 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_GET_OBJECT_ID = make_flag("FSCTL_GET_OBJECT_ID", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 39 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_DELETE_OBJECT_ID = make_flag("FSCTL_DELETE_OBJECT_ID", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 40 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_SET_REPARSE_POINT = make_flag("FSCTL_SET_REPARSE_POINT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 41 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_GET_REPARSE_POINT = make_flag("FSCTL_GET_REPARSE_POINT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 42 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_DELETE_REPARSE_POINT = make_flag("FSCTL_DELETE_REPARSE_POINT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 43 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_ENUM_USN_DATA = make_flag("FSCTL_ENUM_USN_DATA", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 44 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_SECURITY_ID_CHECK = make_flag("FSCTL_SECURITY_ID_CHECK", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 45 , METHOD_NEITHER , FILE_READ_DATA ))
FSCTL_READ_USN_JOURNAL = make_flag("FSCTL_READ_USN_JOURNAL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 46 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_SET_OBJECT_ID_EXTENDED = make_flag("FSCTL_SET_OBJECT_ID_EXTENDED", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 47 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_CREATE_OR_GET_OBJECT_ID = make_flag("FSCTL_CREATE_OR_GET_OBJECT_ID", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 48 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_SPARSE = make_flag("FSCTL_SET_SPARSE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 49 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_SET_ZERO_DATA = make_flag("FSCTL_SET_ZERO_DATA", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 50 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_QUERY_ALLOCATED_RANGES = make_flag("FSCTL_QUERY_ALLOCATED_RANGES", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 51 , METHOD_NEITHER , FILE_READ_DATA ))
FSCTL_ENABLE_UPGRADE = make_flag("FSCTL_ENABLE_UPGRADE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 52 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_SET_ENCRYPTION = make_flag("FSCTL_SET_ENCRYPTION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 53 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_ENCRYPTION_FSCTL_IO = make_flag("FSCTL_ENCRYPTION_FSCTL_IO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 54 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_WRITE_RAW_ENCRYPTED = make_flag("FSCTL_WRITE_RAW_ENCRYPTED", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 55 , METHOD_NEITHER , FILE_SPECIAL_ACCESS ))
FSCTL_READ_RAW_ENCRYPTED = make_flag("FSCTL_READ_RAW_ENCRYPTED", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 56 , METHOD_NEITHER , FILE_SPECIAL_ACCESS ))
FSCTL_CREATE_USN_JOURNAL = make_flag("FSCTL_CREATE_USN_JOURNAL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 57 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_READ_FILE_USN_DATA = make_flag("FSCTL_READ_FILE_USN_DATA", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 58 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_WRITE_USN_CLOSE_RECORD = make_flag("FSCTL_WRITE_USN_CLOSE_RECORD", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 59 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_EXTEND_VOLUME = make_flag("FSCTL_EXTEND_VOLUME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 60 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_USN_JOURNAL = make_flag("FSCTL_QUERY_USN_JOURNAL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 61 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_DELETE_USN_JOURNAL = make_flag("FSCTL_DELETE_USN_JOURNAL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 62 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_MARK_HANDLE = make_flag("FSCTL_MARK_HANDLE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 63 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SIS_COPYFILE = make_flag("FSCTL_SIS_COPYFILE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 64 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SIS_LINK_FILES = make_flag("FSCTL_SIS_LINK_FILES", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 65 , METHOD_BUFFERED , FILE_READ_DATA | FILE_WRITE_DATA ))
FSCTL_RECALL_FILE = make_flag("FSCTL_RECALL_FILE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 69 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_READ_FROM_PLEX = make_flag("FSCTL_READ_FROM_PLEX", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 71 , METHOD_OUT_DIRECT , FILE_READ_DATA ))
FSCTL_FILE_PREFETCH = make_flag("FSCTL_FILE_PREFETCH", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 72 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_MAKE_MEDIA_COMPATIBLE = make_flag("FSCTL_MAKE_MEDIA_COMPATIBLE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 76 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_SET_DEFECT_MANAGEMENT = make_flag("FSCTL_SET_DEFECT_MANAGEMENT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 77 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_QUERY_SPARING_INFO = make_flag("FSCTL_QUERY_SPARING_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 78 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_ON_DISK_VOLUME_INFO = make_flag("FSCTL_QUERY_ON_DISK_VOLUME_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 79 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_VOLUME_COMPRESSION_STATE = make_flag("FSCTL_SET_VOLUME_COMPRESSION_STATE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 80 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_TXFS_MODIFY_RM = make_flag("FSCTL_TXFS_MODIFY_RM", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 81 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_TXFS_QUERY_RM_INFORMATION = make_flag("FSCTL_TXFS_QUERY_RM_INFORMATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 82 , METHOD_BUFFERED , FILE_READ_DATA ))
FSCTL_TXFS_ROLLFORWARD_REDO = make_flag("FSCTL_TXFS_ROLLFORWARD_REDO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 84 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_TXFS_ROLLFORWARD_UNDO = make_flag("FSCTL_TXFS_ROLLFORWARD_UNDO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 85 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_TXFS_START_RM = make_flag("FSCTL_TXFS_START_RM", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 86 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_TXFS_SHUTDOWN_RM = make_flag("FSCTL_TXFS_SHUTDOWN_RM", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 87 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_TXFS_READ_BACKUP_INFORMATION = make_flag("FSCTL_TXFS_READ_BACKUP_INFORMATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 88 , METHOD_BUFFERED , FILE_READ_DATA ))
FSCTL_TXFS_WRITE_BACKUP_INFORMATION = make_flag("FSCTL_TXFS_WRITE_BACKUP_INFORMATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 89 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_TXFS_CREATE_SECONDARY_RM = make_flag("FSCTL_TXFS_CREATE_SECONDARY_RM", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 90 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_TXFS_GET_METADATA_INFO = make_flag("FSCTL_TXFS_GET_METADATA_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 91 , METHOD_BUFFERED , FILE_READ_DATA ))
FSCTL_TXFS_GET_TRANSACTED_VERSION = make_flag("FSCTL_TXFS_GET_TRANSACTED_VERSION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 92 , METHOD_BUFFERED , FILE_READ_DATA ))
FSCTL_TXFS_SAVEPOINT_INFORMATION = make_flag("FSCTL_TXFS_SAVEPOINT_INFORMATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 94 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_TXFS_CREATE_MINIVERSION = make_flag("FSCTL_TXFS_CREATE_MINIVERSION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 95 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_TXFS_TRANSACTION_ACTIVE = make_flag("FSCTL_TXFS_TRANSACTION_ACTIVE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 99 , METHOD_BUFFERED , FILE_READ_DATA ))
FSCTL_SET_ZERO_ON_DEALLOCATION = make_flag("FSCTL_SET_ZERO_ON_DEALLOCATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 101 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_SET_REPAIR = make_flag("FSCTL_SET_REPAIR", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 102 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_REPAIR = make_flag("FSCTL_GET_REPAIR", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 103 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_WAIT_FOR_REPAIR = make_flag("FSCTL_WAIT_FOR_REPAIR", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 104 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_INITIATE_REPAIR = make_flag("FSCTL_INITIATE_REPAIR", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 106 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSC_INTERNAL = make_flag("FSCTL_CSC_INTERNAL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 107 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_SHRINK_VOLUME = make_flag("FSCTL_SHRINK_VOLUME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 108 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_SET_SHORT_NAME_BEHAVIOR = make_flag("FSCTL_SET_SHORT_NAME_BEHAVIOR", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 109 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_DFSR_SET_GHOST_HANDLE_STATE = make_flag("FSCTL_DFSR_SET_GHOST_HANDLE_STATE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 110 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_TXFS_LIST_TRANSACTION_LOCKED_FILES = make_flag("FSCTL_TXFS_LIST_TRANSACTION_LOCKED_FILES", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 120 , METHOD_BUFFERED , FILE_READ_DATA ))
FSCTL_TXFS_LIST_TRANSACTIONS = make_flag("FSCTL_TXFS_LIST_TRANSACTIONS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 121 , METHOD_BUFFERED , FILE_READ_DATA ))
FSCTL_QUERY_PAGEFILE_ENCRYPTION = make_flag("FSCTL_QUERY_PAGEFILE_ENCRYPTION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 122 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_RESET_VOLUME_ALLOCATION_HINTS = make_flag("FSCTL_RESET_VOLUME_ALLOCATION_HINTS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 123 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_DEPENDENT_VOLUME = make_flag("FSCTL_QUERY_DEPENDENT_VOLUME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 124 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SD_GLOBAL_CHANGE = make_flag("FSCTL_SD_GLOBAL_CHANGE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 125 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_TXFS_READ_BACKUP_INFORMATION2 = make_flag("FSCTL_TXFS_READ_BACKUP_INFORMATION2", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 126 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_LOOKUP_STREAM_FROM_CLUSTER = make_flag("FSCTL_LOOKUP_STREAM_FROM_CLUSTER", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 127 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_TXFS_WRITE_BACKUP_INFORMATION2 = make_flag("FSCTL_TXFS_WRITE_BACKUP_INFORMATION2", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 128 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_FILE_TYPE_NOTIFICATION = make_flag("FSCTL_FILE_TYPE_NOTIFICATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 129 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_FILE_LEVEL_TRIM = make_flag("FSCTL_FILE_LEVEL_TRIM", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 130 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_GET_BOOT_AREA_INFO = make_flag("FSCTL_GET_BOOT_AREA_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 140 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_RETRIEVAL_POINTER_BASE = make_flag("FSCTL_GET_RETRIEVAL_POINTER_BASE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 141 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_PERSISTENT_VOLUME_STATE = make_flag("FSCTL_SET_PERSISTENT_VOLUME_STATE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 142 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_PERSISTENT_VOLUME_STATE = make_flag("FSCTL_QUERY_PERSISTENT_VOLUME_STATE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 143 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REQUEST_OPLOCK = make_flag("FSCTL_REQUEST_OPLOCK", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 144 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSV_TUNNEL_REQUEST = make_flag("FSCTL_CSV_TUNNEL_REQUEST", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 145 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_IS_CSV_FILE = make_flag("FSCTL_IS_CSV_FILE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 146 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_FILE_SYSTEM_RECOGNITION = make_flag("FSCTL_QUERY_FILE_SYSTEM_RECOGNITION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 147 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSV_GET_VOLUME_PATH_NAME = make_flag("FSCTL_CSV_GET_VOLUME_PATH_NAME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 148 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSV_GET_VOLUME_NAME_FOR_VOLUME_MOUNT_POINT = make_flag("FSCTL_CSV_GET_VOLUME_NAME_FOR_VOLUME_MOUNT_POINT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 149 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSV_GET_VOLUME_PATH_NAMES_FOR_VOLUME_NAME = make_flag("FSCTL_CSV_GET_VOLUME_PATH_NAMES_FOR_VOLUME_NAME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 150 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_IS_FILE_ON_CSV_VOLUME = make_flag("FSCTL_IS_FILE_ON_CSV_VOLUME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 151 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CORRUPTION_HANDLING = make_flag("FSCTL_CORRUPTION_HANDLING", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 152 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_OFFLOAD_READ = make_flag("FSCTL_OFFLOAD_READ", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 153 , METHOD_BUFFERED , FILE_READ_ACCESS ))
FSCTL_OFFLOAD_WRITE = make_flag("FSCTL_OFFLOAD_WRITE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 154 , METHOD_BUFFERED , FILE_WRITE_ACCESS ))
FSCTL_CSV_INTERNAL = make_flag("FSCTL_CSV_INTERNAL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 155 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_PURGE_FAILURE_MODE = make_flag("FSCTL_SET_PURGE_FAILURE_MODE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 156 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_FILE_LAYOUT = make_flag("FSCTL_QUERY_FILE_LAYOUT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 157 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_IS_VOLUME_OWNED_BYCSVFS = make_flag("FSCTL_IS_VOLUME_OWNED_BYCSVFS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 158 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_INTEGRITY_INFORMATION = make_flag("FSCTL_GET_INTEGRITY_INFORMATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 159 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_INTEGRITY_INFORMATION = make_flag("FSCTL_SET_INTEGRITY_INFORMATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 160 , METHOD_BUFFERED , FILE_READ_DATA | FILE_WRITE_DATA ))
FSCTL_QUERY_FILE_REGIONS = make_flag("FSCTL_QUERY_FILE_REGIONS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 161 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_RKF_INTERNAL = make_flag("FSCTL_RKF_INTERNAL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 171 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_SCRUB_DATA = make_flag("FSCTL_SCRUB_DATA", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 172 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REPAIR_COPIES = make_flag("FSCTL_REPAIR_COPIES", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 173 , METHOD_BUFFERED , FILE_READ_DATA | FILE_WRITE_DATA ))
FSCTL_DISABLE_LOCAL_BUFFERING = make_flag("FSCTL_DISABLE_LOCAL_BUFFERING", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 174 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSV_MGMT_LOCK = make_flag("FSCTL_CSV_MGMT_LOCK", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 175 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSV_QUERY_DOWN_LEVEL_FILE_SYSTEM_CHARACTERISTICS = make_flag("FSCTL_CSV_QUERY_DOWN_LEVEL_FILE_SYSTEM_CHARACTERISTICS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 176 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_ADVANCE_FILE_ID = make_flag("FSCTL_ADVANCE_FILE_ID", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 177 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSV_SYNC_TUNNEL_REQUEST = make_flag("FSCTL_CSV_SYNC_TUNNEL_REQUEST", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 178 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSV_QUERY_VETO_FILE_DIRECT_IO = make_flag("FSCTL_CSV_QUERY_VETO_FILE_DIRECT_IO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 179 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_WRITE_USN_REASON = make_flag("FSCTL_WRITE_USN_REASON", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 180 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSV_CONTROL = make_flag("FSCTL_CSV_CONTROL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 181 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_REFS_VOLUME_DATA = make_flag("FSCTL_GET_REFS_VOLUME_DATA", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 182 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CSV_H_BREAKING_SYNC_TUNNEL_REQUEST = make_flag("FSCTL_CSV_H_BREAKING_SYNC_TUNNEL_REQUEST", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 185 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_STORAGE_CLASSES = make_flag("FSCTL_QUERY_STORAGE_CLASSES", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 187 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_REGION_INFO = make_flag("FSCTL_QUERY_REGION_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 188 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_USN_TRACK_MODIFIED_RANGES = make_flag("FSCTL_USN_TRACK_MODIFIED_RANGES", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 189 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_SHARED_VIRTUAL_DISK_SUPPORT = make_flag("FSCTL_QUERY_SHARED_VIRTUAL_DISK_SUPPORT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 192 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SVHDX_SYNC_TUNNEL_REQUEST = make_flag("FSCTL_SVHDX_SYNC_TUNNEL_REQUEST", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 193 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SVHDX_SET_INITIATOR_INFORMATION = make_flag("FSCTL_SVHDX_SET_INITIATOR_INFORMATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 194 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_EXTERNAL_BACKING = make_flag("FSCTL_SET_EXTERNAL_BACKING", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 195 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_GET_EXTERNAL_BACKING = make_flag("FSCTL_GET_EXTERNAL_BACKING", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 196 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_DELETE_EXTERNAL_BACKING = make_flag("FSCTL_DELETE_EXTERNAL_BACKING", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 197 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_ENUM_EXTERNAL_BACKING = make_flag("FSCTL_ENUM_EXTERNAL_BACKING", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 198 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_ENUM_OVERLAY = make_flag("FSCTL_ENUM_OVERLAY", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 199 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_ADD_OVERLAY = make_flag("FSCTL_ADD_OVERLAY", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 204 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_REMOVE_OVERLAY = make_flag("FSCTL_REMOVE_OVERLAY", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 205 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_UPDATE_OVERLAY = make_flag("FSCTL_UPDATE_OVERLAY", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 206 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_SHUFFLE_FILE = make_flag("FSCTL_SHUFFLE_FILE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 208 , METHOD_BUFFERED , FILE_READ_ACCESS | FILE_WRITE_ACCESS ))
FSCTL_DUPLICATE_EXTENTS_TO_FILE = make_flag("FSCTL_DUPLICATE_EXTENTS_TO_FILE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 209 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_SPARSE_OVERALLOCATE = make_flag("FSCTL_SPARSE_OVERALLOCATE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 211 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_STORAGE_QOS_CONTROL = make_flag("FSCTL_STORAGE_QOS_CONTROL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 212 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_INITIATE_FILE_METADATA_OPTIMIZATION = make_flag("FSCTL_INITIATE_FILE_METADATA_OPTIMIZATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 215 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_QUERY_FILE_METADATA_OPTIMIZATION = make_flag("FSCTL_QUERY_FILE_METADATA_OPTIMIZATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 216 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_SVHDX_ASYNC_TUNNEL_REQUEST = make_flag("FSCTL_SVHDX_ASYNC_TUNNEL_REQUEST", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 217 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_WOF_VERSION = make_flag("FSCTL_GET_WOF_VERSION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 218 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_HCS_SYNC_TUNNEL_REQUEST = make_flag("FSCTL_HCS_SYNC_TUNNEL_REQUEST", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 219 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_HCS_ASYNC_TUNNEL_REQUEST = make_flag("FSCTL_HCS_ASYNC_TUNNEL_REQUEST", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 220 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_EXTENT_READ_CACHE_INFO = make_flag("FSCTL_QUERY_EXTENT_READ_CACHE_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 221 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_QUERY_REFS_VOLUME_COUNTER_INFO = make_flag("FSCTL_QUERY_REFS_VOLUME_COUNTER_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 222 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_CLEAN_VOLUME_METADATA = make_flag("FSCTL_CLEAN_VOLUME_METADATA", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 223 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_INTEGRITY_INFORMATION_EX = make_flag("FSCTL_SET_INTEGRITY_INFORMATION_EX", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 224 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SUSPEND_OVERLAY = make_flag("FSCTL_SUSPEND_OVERLAY", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 225 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_VIRTUAL_STORAGE_QUERY_PROPERTY = make_flag("FSCTL_VIRTUAL_STORAGE_QUERY_PROPERTY", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 226 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_FILESYSTEM_GET_STATISTICS_EX = make_flag("FSCTL_FILESYSTEM_GET_STATISTICS_EX", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 227 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_VOLUME_CONTAINER_STATE = make_flag("FSCTL_QUERY_VOLUME_CONTAINER_STATE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 228 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_LAYER_ROOT = make_flag("FSCTL_SET_LAYER_ROOT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 229 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_DIRECT_ACCESS_EXTENTS = make_flag("FSCTL_QUERY_DIRECT_ACCESS_EXTENTS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 230 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_NOTIFY_STORAGE_SPACE_ALLOCATION = make_flag("FSCTL_NOTIFY_STORAGE_SPACE_ALLOCATION", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 231 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SSDI_STORAGE_REQUEST = make_flag("FSCTL_SSDI_STORAGE_REQUEST", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 232 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_DIRECT_IMAGE_ORIGINAL_BASE = make_flag("FSCTL_QUERY_DIRECT_IMAGE_ORIGINAL_BASE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 233 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_READ_UNPRIVILEGED_USN_JOURNAL = make_flag("FSCTL_READ_UNPRIVILEGED_USN_JOURNAL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 234 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_GHOST_FILE_EXTENTS = make_flag("FSCTL_GHOST_FILE_EXTENTS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 235 , METHOD_BUFFERED , FILE_WRITE_ACCESS ))
FSCTL_QUERY_GHOSTED_FILE_EXTENTS = make_flag("FSCTL_QUERY_GHOSTED_FILE_EXTENTS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 236 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_UNMAP_SPACE = make_flag("FSCTL_UNMAP_SPACE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 237 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_HCS_SYNC_NO_WRITE_TUNNEL_REQUEST = make_flag("FSCTL_HCS_SYNC_NO_WRITE_TUNNEL_REQUEST", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 238 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_START_VIRTUALIZATION_INSTANCE = make_flag("FSCTL_START_VIRTUALIZATION_INSTANCE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 240 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_FILTER_FILE_IDENTIFIER = make_flag("FSCTL_GET_FILTER_FILE_IDENTIFIER", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 241 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_STREAMS_QUERY_PARAMETERS = make_flag("FSCTL_STREAMS_QUERY_PARAMETERS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 241 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_STREAMS_ASSOCIATE_ID = make_flag("FSCTL_STREAMS_ASSOCIATE_ID", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 242 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_STREAMS_QUERY_ID = make_flag("FSCTL_STREAMS_QUERY_ID", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 243 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_RETRIEVAL_POINTERS_AND_REFCOUNT = make_flag("FSCTL_GET_RETRIEVAL_POINTERS_AND_REFCOUNT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 244 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_QUERY_VOLUME_NUMA_INFO = make_flag("FSCTL_QUERY_VOLUME_NUMA_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 245 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_DEALLOCATE_RANGES = make_flag("FSCTL_REFS_DEALLOCATE_RANGES", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 246 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_REFS_SMR_VOLUME_INFO = make_flag("FSCTL_QUERY_REFS_SMR_VOLUME_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 247 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_REFS_SMR_VOLUME_GC_PARAMETERS = make_flag("FSCTL_SET_REFS_SMR_VOLUME_GC_PARAMETERS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 248 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_REFS_FILE_STRICTLY_SEQUENTIAL = make_flag("FSCTL_SET_REFS_FILE_STRICTLY_SEQUENTIAL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 249 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_DUPLICATE_EXTENTS_TO_FILE_EX = make_flag("FSCTL_DUPLICATE_EXTENTS_TO_FILE_EX", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 250 , METHOD_BUFFERED , FILE_WRITE_DATA ))
FSCTL_QUERY_BAD_RANGES = make_flag("FSCTL_QUERY_BAD_RANGES", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 251 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_DAX_ALLOC_ALIGNMENT_HINT = make_flag("FSCTL_SET_DAX_ALLOC_ALIGNMENT_HINT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 252 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_DELETE_CORRUPTED_REFS_CONTAINER = make_flag("FSCTL_DELETE_CORRUPTED_REFS_CONTAINER", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 253 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SCRUB_UNDISCOVERABLE_ID = make_flag("FSCTL_SCRUB_UNDISCOVERABLE_ID", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 254 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_NOTIFY_DATA_CHANGE = make_flag("FSCTL_NOTIFY_DATA_CHANGE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 255 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_START_VIRTUALIZATION_INSTANCE_EX = make_flag("FSCTL_START_VIRTUALIZATION_INSTANCE_EX", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 256 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_ENCRYPTION_KEY_CONTROL = make_flag("FSCTL_ENCRYPTION_KEY_CONTROL", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 257 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_VIRTUAL_STORAGE_SET_BEHAVIOR = make_flag("FSCTL_VIRTUAL_STORAGE_SET_BEHAVIOR", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 258 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_REPARSE_POINT_EX = make_flag("FSCTL_SET_REPARSE_POINT_EX", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 259 , METHOD_BUFFERED , FILE_SPECIAL_ACCESS ))
FSCTL_REARRANGE_FILE = make_flag("FSCTL_REARRANGE_FILE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 264 , METHOD_BUFFERED , FILE_READ_ACCESS | FILE_WRITE_ACCESS ))
FSCTL_VIRTUAL_STORAGE_PASSTHROUGH = make_flag("FSCTL_VIRTUAL_STORAGE_PASSTHROUGH", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 265 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_GET_RETRIEVAL_POINTER_COUNT = make_flag("FSCTL_GET_RETRIEVAL_POINTER_COUNT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 266 , METHOD_NEITHER , FILE_ANY_ACCESS ))
FSCTL_ENABLE_PER_IO_FLAGS = make_flag("FSCTL_ENABLE_PER_IO_FLAGS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 267 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_ASYNC_DUPLICATE_EXTENTS_STATUS = make_flag("FSCTL_QUERY_ASYNC_DUPLICATE_EXTENTS_STATUS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 268 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SMB_SHARE_FLUSH_AND_PURGE = make_flag("FSCTL_SMB_SHARE_FLUSH_AND_PURGE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 271 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_STREAM_SNAPSHOT_MANAGEMENT = make_flag("FSCTL_REFS_STREAM_SNAPSHOT_MANAGEMENT", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 272 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_MANAGE_BYPASS_IO = make_flag("FSCTL_MANAGE_BYPASS_IO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 274 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_DEALLOCATE_RANGES_EX = make_flag("FSCTL_REFS_DEALLOCATE_RANGES_EX", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 275 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_SET_CACHED_RUNS_STATE = make_flag("FSCTL_SET_CACHED_RUNS_STATE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 276 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_SET_VOLUME_COMPRESSION_INFO = make_flag("FSCTL_REFS_SET_VOLUME_COMPRESSION_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 277 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_QUERY_VOLUME_COMPRESSION_INFO = make_flag("FSCTL_REFS_QUERY_VOLUME_COMPRESSION_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 278 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_DUPLICATE_CLUSTER = make_flag("FSCTL_DUPLICATE_CLUSTER", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 279 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CREATE_LCN_WEAK_REFERENCE = make_flag("FSCTL_CREATE_LCN_WEAK_REFERENCE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 280 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CLEAR_LCN_WEAK_REFERENCE = make_flag("FSCTL_CLEAR_LCN_WEAK_REFERENCE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 281 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_QUERY_LCN_WEAK_REFERENCE = make_flag("FSCTL_QUERY_LCN_WEAK_REFERENCE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 282 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CLEAR_ALL_LCN_WEAK_REFERENCES = make_flag("FSCTL_CLEAR_ALL_LCN_WEAK_REFERENCES", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 283 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_SET_VOLUME_DEDUP_INFO = make_flag("FSCTL_REFS_SET_VOLUME_DEDUP_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 284 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_QUERY_VOLUME_DEDUP_INFO = make_flag("FSCTL_REFS_QUERY_VOLUME_DEDUP_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 285 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_LMR_QUERY_INFO = make_flag("FSCTL_LMR_QUERY_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 286 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_CHECKPOINT_VOLUME = make_flag("FSCTL_REFS_CHECKPOINT_VOLUME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 287 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_QUERY_VOLUME_TOTAL_SHARED_LCNS = make_flag("FSCTL_REFS_QUERY_VOLUME_TOTAL_SHARED_LCNS", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 288 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_UPGRADE_VOLUME = make_flag("FSCTL_UPGRADE_VOLUME", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 289 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_SET_VOLUME_IO_METRICS_INFO = make_flag("FSCTL_REFS_SET_VOLUME_IO_METRICS_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 290 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_QUERY_VOLUME_IO_METRICS_INFO = make_flag("FSCTL_REFS_QUERY_VOLUME_IO_METRICS_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 291 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_SET_ROLLBACK_PROTECTION_INFO = make_flag("FSCTL_REFS_SET_ROLLBACK_PROTECTION_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 292 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_REFS_QUERY_ROLLBACK_PROTECTION_INFO = make_flag("FSCTL_REFS_QUERY_ROLLBACK_PROTECTION_INFO", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 293 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_FILE_SOV_CHECK_RANGE = make_flag("FSCTL_FILE_SOV_CHECK_RANGE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 294 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
FSCTL_CASCADES_REFS_SET_FILE_REMOTE = make_flag("FSCTL_CASCADES_REFS_SET_FILE_REMOTE", CTL_CODE ( FILE_DEVICE_FILE_SYSTEM , 295 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
MOUNTMGR_DEVICE_NAME = make_flag("MOUNTMGR_DEVICE_NAME", u"\\Device\\MountPointManager")
MOUNTMGR_DOS_DEVICE_NAME = make_flag("MOUNTMGR_DOS_DEVICE_NAME", u"\\\\.\\MountPointManager")
MOUNTMGRCONTROLTYPE = make_flag("MOUNTMGRCONTROLTYPE", 0x0000006D)
MOUNTDEVCONTROLTYPE = make_flag("MOUNTDEVCONTROLTYPE", 0x0000004D)
IOCTL_MOUNTMGR_CREATE_POINT = make_flag("IOCTL_MOUNTMGR_CREATE_POINT", CTL_CODE ( MOUNTMGRCONTROLTYPE , 0 , METHOD_BUFFERED , FILE_READ_ACCESS | FILE_WRITE_ACCESS ))
IOCTL_MOUNTMGR_DELETE_POINTS = make_flag("IOCTL_MOUNTMGR_DELETE_POINTS", CTL_CODE ( MOUNTMGRCONTROLTYPE , 1 , METHOD_BUFFERED , FILE_READ_ACCESS | FILE_WRITE_ACCESS ))
IOCTL_MOUNTMGR_QUERY_POINTS = make_flag("IOCTL_MOUNTMGR_QUERY_POINTS", CTL_CODE ( MOUNTMGRCONTROLTYPE , 2 , METHOD_BUFFERED , FILE_ANY_ACCESS ))
IOCTL_MOUNTMGR_DELETE_POINTS_DBONLY = make_flag("IOCTL_MOUNTMGR_DELETE_POINTS_DBONLY", CTL_CODE ( MOUNTMGRCONTROLTYPE , 3 , METHOD_BUFFERED , FILE_READ_ACCESS | FILE_WRITE_ACCESS ))
IOCTL_MOUNTMGR_NEXT_DRIVE_LETTER = make_flag("IOCTL_MOUNTMGR_NEXT_DRIVE_LETTER", CTL_CODE ( MOUNTMGRCONTROLTYPE , 4 , METHOD_BUFFERED , FILE_READ_ACCESS | FILE_WRITE_ACCESS ))
IOCTL_MOUNTMGR_AUTO_DL_ASSIGNMENTS = make_flag("IOCTL_MOUNTMGR_AUTO_DL_ASSIGNMENTS", CTL_CODE ( MOUNTMGRCONTROLTYPE , 5 , METHOD_BUFFERED , FILE_READ_ACCESS | FILE_WRITE_ACCESS ))
IOCTL_MOUNTMGR_VOLUME_MOUNT_POINT_CREATED = make_flag("IOCTL_MOUNTMGR_VOLUME_MOUNT_POINT_CREATED", CTL_CODE ( MOUNTMGRCONTROLTYPE , 6 , METHOD_BUFFERED , FILE_READ_ACCESS | FILE_WRITE_ACCESS ))
IOCTL_MOUNTMGR_VOLUME_MOUNT_POINT_DELETED = make_flag("IOCTL_MOUNTMGR_VOLUME_MOUNT_POINT_DELETED", CTL_CODE ( MOUNTMGRCONTROLTYPE , 7 , METHOD_BUFFERED , FILE_READ_ACCESS | FILE_WRITE_ACCESS ))
IOCTL_MOUNTMGR_CHANGE_NOTIFY = make_flag("IOCTL_MOUNTMGR_CHANGE_NOTIFY", CTL_CODE ( MOUNTMGRCONTROLTYPE , 8 , METHOD_BUFFERED , FILE_READ_ACCESS ))
IOCTL_MOUNTMGR_KEEP_LINKS_WHEN_OFFLINE = make_flag("IOCTL_MOUNTMGR_KEEP_LINKS_WHEN_OFFLINE", CTL_CODE ( MOUNTMGRCONTROLTYPE , 9 , METHOD_BUFFERED , FILE_READ_ACCESS | FILE_WRITE_ACCESS ))
IOCTL_MOUNTMGR_CHECK_UNPROCESSED_VOLUMES = make_flag("IOCTL_MOUNTMGR_CHECK_UNPROCESSED_VOLUMES", CTL_CODE ( MOUNTMGRCONTROLTYPE , 10 , METHOD_BUFFERED , FILE_READ_ACCESS ))
IOCTL_MOUNTMGR_VOLUME_ARRIVAL_NOTIFICATION = make_flag("IOCTL_MOUNTMGR_VOLUME_ARRIVAL_NOTIFICATION", CTL_CODE ( MOUNTMGRCONTROLTYPE , 11 , METHOD_BUFFERED , FILE_READ_ACCESS ))
