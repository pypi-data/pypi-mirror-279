windef = {'ABOVE_NORMAL_PRIORITY_CLASS',
...
'FSCTL_QUERY_LCN_WEAK_REFERENCE',
...
errors = {'APPMODEL_ERROR_DYNAMIC_PROPERTY_INVALID',
...
'_PEB',
'_PEB_LDR_DATA',
'_PFW_MINIMAL_KUSER_SHARED_DATA',
