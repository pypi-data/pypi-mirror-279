...
Refer to the Terraform Registry for docs: [`data_hcp_waypoint_add_on`](https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/data-sources/waypoint_add_on).
'''
...
class DataHcpWaypointAddOn(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/data-sources/waypoint_add_on hcp_waypoint_add_on}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/data-sources/waypoint_add_on hcp_waypoint_add_on} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param id: The ID of the Add-on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/data-sources/waypoint_add_on#id DataHcpWaypointAddOn#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param name: The name of the Add-on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/data-sources/waypoint_add_on#name DataHcpWaypointAddOn#name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataHcpWaypointAddOn that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/data-sources/waypoint_add_on#import import section} in the documentation of this resource for the id to use
    ...
    def terraform_no_code_module(
        self,
    ) -> "DataHcpWaypointAddOnTerraformNoCodeModuleOutputReference":
        return typing.cast("DataHcpWaypointAddOnTerraformNoCodeModuleOutputReference", jsii.get(self, "terraformNoCodeModule"))
...
class DataHcpWaypointAddOnConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/data-sources/waypoint_add_on#id DataHcpWaypointAddOn#id}
    ...
    def name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/data-sources/waypoint_add_on#name DataHcpWaypointAddOn#name}
        '''
...
@jsii.data_type(
    jsii_type="@cdktf/provider-hcp.dataHcpWaypointAddOn.DataHcpWaypointAddOnTerraformNoCodeModule",
    jsii_struct_bases=[],
    name_mapping={},
)
class DataHcpWaypointAddOnTerraformNoCodeModule:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "DataHcpWaypointAddOnTerraformNoCodeModule(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class DataHcpWaypointAddOnTerraformNoCodeModuleOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-hcp.dataHcpWaypointAddOn.DataHcpWaypointAddOnTerraformNoCodeModuleOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__691f997e7573ad5e5b75e347b66de52e2724abe2910d32a635624e155ba89aaf)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
    ...
    def internal_value(
        self,
    ) -> typing.Optional[DataHcpWaypointAddOnTerraformNoCodeModule]:
        return typing.cast(typing.Optional[DataHcpWaypointAddOnTerraformNoCodeModule], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[DataHcpWaypointAddOnTerraformNoCodeModule],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__41fedc3d600ec3e965990e441e56163183c678f65da81e24bda42c8b233a3a2a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
__all__ = [
    ...
    "DataHcpWaypointAddOnOutputValuesOutputReference",
    "DataHcpWaypointAddOnTerraformNoCodeModule",
    "DataHcpWaypointAddOnTerraformNoCodeModuleOutputReference",
]
...
def _typecheckingstub__691f997e7573ad5e5b75e347b66de52e2724abe2910d32a635624e155ba89aaf(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__41fedc3d600ec3e965990e441e56163183c678f65da81e24bda42c8b233a3a2a(
    value: typing.Optional[DataHcpWaypointAddOnTerraformNoCodeModule],
) -> None:
    """Type checking stubs"""
    pass
