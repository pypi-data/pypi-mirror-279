...
Refer to the Terraform Registry for docs: [`hcp_waypoint_add_on`](https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/resources/waypoint_add_on).
'''
...
class WaypointAddOn(
    ...
    def __init__(
        ...
        *,
        ...
        :param application_id: The ID of the Application that this Add-on is created for. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/resources/waypoint_add_on#application_id WaypointAddOn#application_id}
        :param definition_id: The ID of the Add-on Definition that this Add-on is created from. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/resources/waypoint_add_on#definition_id WaypointAddOn#definition_id}
        :param name: The name of the Add-on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/resources/waypoint_add_on#name WaypointAddOn#name}
        :param project_id: The ID of the HCP project where the Waypoint AddOn is located. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/resources/waypoint_add_on#project_id WaypointAddOn#project_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing WaypointAddOn that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/resources/waypoint_add_on#import import section} in the documentation of this resource for the id to use
    ...
    def terraform_no_code_module(
        self,
    ) -> "WaypointAddOnTerraformNoCodeModuleOutputReference":
        return typing.cast("WaypointAddOnTerraformNoCodeModuleOutputReference", jsii.get(self, "terraformNoCodeModule"))
    ...
    def definition_id(self, value: builtins.str) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "definitionId", value)
...
@jsii.data_type(
    jsii_type="@cdktf/provider-hcp.waypointAddOn.WaypointAddOnTerraformNoCodeModule",
    jsii_struct_bases=[],
    name_mapping={},
)
class WaypointAddOnTerraformNoCodeModule:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "WaypointAddOnTerraformNoCodeModule(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class WaypointAddOnTerraformNoCodeModuleOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-hcp.waypointAddOn.WaypointAddOnTerraformNoCodeModuleOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d8b051d207a15df004a3d5033d4885a47fda0bfa1a5dcab7592533ae30793d96)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
    ...
    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[WaypointAddOnTerraformNoCodeModule]:
        return typing.cast(typing.Optional[WaypointAddOnTerraformNoCodeModule], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[WaypointAddOnTerraformNoCodeModule],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__45c6f2317e509d41ee515c44f3b12ae9fe903d5c6b0588a3bee88b17cd93e252)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
__all__ = [
    ...
    "WaypointAddOnTerraformNoCodeModule",
    "WaypointAddOnTerraformNoCodeModuleOutputReference",
]
...
def _typecheckingstub__d8b051d207a15df004a3d5033d4885a47fda0bfa1a5dcab7592533ae30793d96(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__45c6f2317e509d41ee515c44f3b12ae9fe903d5c6b0588a3bee88b17cd93e252(
    value: typing.Optional[WaypointAddOnTerraformNoCodeModule],
) -> None:
    """Type checking stubs"""
    pass
