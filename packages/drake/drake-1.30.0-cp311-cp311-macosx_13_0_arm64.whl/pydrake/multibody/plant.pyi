...
@overload
def AddMultibodyPlant(plant_config: MultibodyPlantConfig, scene_graph_config: pydrake.geometry.SceneGraphConfig, builder: pydrake.systems.framework.DiagramBuilder) -> tuple: ...
@overload
