...
# ******************************************************************************
__all__ = ["compute_conv_output", "compute_onnx_conv_output"]
...
def compute_onnx_conv_output(qlayer, input_shape, apply_pool=True):
    ...
    output_shape = compute_conv_output(input_shape[2:], kernel.shape[2:], conv_strides, conv_pads)
