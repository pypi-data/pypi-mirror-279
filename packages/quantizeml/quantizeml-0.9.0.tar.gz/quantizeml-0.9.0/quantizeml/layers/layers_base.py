    ...
    def decorator(call):
        ...
        def check_inputs(self, inputs):
            ...
            if isinstance(inputs, tf.Tensor):
                ...
                # Default to 8bit but 16bit (16bits -1bit for the sign) possible with TENN
                # sequential models
                in_bits = 15 if inputs.dtype == tf.int16 else 8
...
def check_arg_constraints(layer, config):
    ...
    """
    for arg, arg_value in layer.arg_constraints.items():
