...
def measure_layer_quantization_error(fmodel, qmodel, target_layer=None, batch_size=16, seed=None):
    ...
    Returns a dictionary where the keys are the name of each layer
    and the values are a dictionary composed of the set of the following metrics:
        * Weighted Mean Absolute Percentage Error (wMAPE): :func:`tools.metrics.wmape`
    ...
    Example:
        ...
        >>> assert "wMAPE" in summary[a_layer_name]
