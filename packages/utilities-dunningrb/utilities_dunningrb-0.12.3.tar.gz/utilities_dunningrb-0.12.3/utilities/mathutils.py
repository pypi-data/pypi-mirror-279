...
def get_composites(limit: int) -> list:
    """Return a list of composite numbers up to and including the given limit.
    """
    return get_primes_and_composites(limit)["composites"]
...
def get_primes(limit: int) -> list:
    """Return a list of prime numbers up to and including the given limit.
    """
    return get_primes_and_composites(limit)["primes"]
...
def get_primes_and_composites(limit: int) -> dict:
    ...
    list of composite numbers up to and including the given limit, and "prime" which maps to a
    list of prime numbers up to and including the given limit.
    """
    r = {"composites": set(), "primes": set()}
    ...
    if limit < 2:
        ...
        for i in range(2, limit + 1):
            ...
            for j in range(2 * i, limit + 1, i):
                if j in r["composites"]:
                    continue
                else:
                    r["composites"].add(j)
            r["primes"].add(i)

        r["primes"] = list(r["primes"])
