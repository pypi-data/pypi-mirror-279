...
class H5_rad():
    """CGS unit system"""
    def __init__(self,pat,dt,maxpart,Nangsx,Nangsy,Nfreqs,fmin,fmax,bandwidth,detdist,nep,thxlim=None,thylim=None):
        self.pat = pat                  # h5 files directory path
        self.dt = dt                    # timestep between consecutive h5 files [s]
    ...
    def extract_files(self):    
        pat,dt,maxpart = self.pat,self.dt,self.maxpart
        files           = []
