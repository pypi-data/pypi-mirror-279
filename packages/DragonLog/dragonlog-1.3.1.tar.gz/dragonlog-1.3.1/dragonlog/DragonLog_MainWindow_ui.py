...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fDateFromLineEdit = QtWidgets.QLineEdit(parent=self.dockWidgetContents_2)
        ...
        self.fDateToLineEdit = QtWidgets.QLineEdit(parent=self.dockWidgetContents_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.fCallsignLineEdit = QtWidgets.QLineEdit(parent=self.dockWidgetContents_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.fBandComboBox = QtWidgets.QComboBox(parent=self.dockWidgetContents_2)
