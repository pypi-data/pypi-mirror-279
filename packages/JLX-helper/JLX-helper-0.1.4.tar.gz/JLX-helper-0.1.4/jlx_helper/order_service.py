...
class OrderService(object):
    ...
    def gen_jlx_order(self, ticket_channel: str, channel_user: str, order_id: str, departure_date: str,
        ...
        return dict(
            order_id=response_data.get("data").get("orderNo"), price=str(response_data.get("data").get("price")),
            order_context=response_data.get("data").get("orderContext"), code=response_data.get("code"),
            raw_order_id=response_data.get("data").get("yourOrderNo"), success=response_data.get("code"),
