...
class OrderService(object):
    ...
    def payment_jlx_order(self, ticket_channel: str, channel_user: str, pre_order_id: int, jlx_order_id: str,
        ...
        return dict(
            ch_order_id=response_data.get("data").get("orderNo"), payment_amount=response_data.get("data").get("price"),
            payment_context=response_data.get("data").get("orderContext"), code=response_data.get("code"),
            ...
            payment_time=get_current_dt_str(), payment_type=pay_type, payment_account=payment_account
        )
