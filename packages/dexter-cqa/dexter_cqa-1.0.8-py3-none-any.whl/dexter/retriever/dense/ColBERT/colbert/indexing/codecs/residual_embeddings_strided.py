...
import dexter.retriever.dense.ColBERT.colbert.indexing.codecs.residual_embeddings as residual_embeddings
...
class ResidualEmbeddingsStrided:
    def __init__(self, codec, embeddings, doclens):
        ...
        self.use_gpu = False #self.codec.use_gpu
    ...
    def lookup_pids(self, passage_ids, out_device='cuda'):
        ...
        embeddings_packed = self.codec.decompress(residual_embeddings.ResidualEmbeddings(codes_packed.cpu(), residuals_packed.cpu()))
