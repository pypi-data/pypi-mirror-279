# CDKTF prebuilt bindings for hashicorp/tfe provider version 0.56.0

This repo builds and publishes the [Terraform tfe provider](https://registry.terraform.io/providers/hashicorp/tfe/0.56.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform tfe provider](https://registry.terraform.io/providers/hashicorp/tfe/0.56.0)
