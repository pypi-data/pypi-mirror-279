...
Refer to the Terraform Registry for docs: [`data_tfe_saml_settings`](https://registry.terraform.io/providers/hashicorp/tfe/0.56.0/docs/data-sources/saml_settings).
'''
...
class DataTfeSamlSettings(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.56.0/docs/data-sources/saml_settings tfe_saml_settings}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.56.0/docs/data-sources/saml_settings tfe_saml_settings} Data Source.
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataTfeSamlSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.56.0/docs/data-sources/saml_settings#import import section} in the documentation of this resource for the id to use
