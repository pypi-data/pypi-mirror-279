...
"""
    ...
    The version of the OpenAPI document: 1.3.3807
...
class DefaultApi:
    ...
    @validate_arguments
    def v1_get_satellite_targets(self, offset : Optional[StrictInt] = None, limit : Optional[StrictInt] = None, orbit_type : Optional[OrbitType] = None, norad_id : Optional[StrictStr] = None, **kwargs) -> V1GetSatelliteTargetsResponse:  # noqa: E501
        ...
        >>> thread = api.v1_get_satellite_targets(offset, limit, orbit_type, norad_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.v1_get_satellite_targets_with_http_info(offset, limit, orbit_type, norad_id, **kwargs)  # noqa: E501

    @validate_arguments
    def v1_get_satellite_targets_with_http_info(self, offset : Optional[StrictInt] = None, limit : Optional[StrictInt] = None, orbit_type : Optional[OrbitType] = None, norad_id : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """v1_get_satellite_targets  # noqa: E501
        ...
        >>> thread = api.v1_get_satellite_targets_with_http_info(offset, limit, orbit_type, norad_id, async_req=True)
        >>> result = thread.get()
