...
from pybuild.unit_configs import UnitConfigs, CodeGenerators
...
class YamlSignalInterfaces(SignalInterfaces):
    ...
    def __init__(self, prj_cfg, unit_cfg, feature_cfg, user_defined_types, model_names=None):
        ...
        from pybuild.interface.generation_utils import get_interface, get_method_interface
        from pybuild.interface.hal import HALA
        from pybuild.interface.device_proxy import DPAL
        from pybuild.interface.zone_controller import ZCAL
