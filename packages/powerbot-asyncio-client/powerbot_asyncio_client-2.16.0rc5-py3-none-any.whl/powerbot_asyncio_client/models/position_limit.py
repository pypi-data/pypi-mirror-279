...
class PositionLimit(object):
    ...
    def __init__(self, exchange=None, delivery_area=None, min_netpos_limit=None, max_netpos_limit=None, abspos_limit=None, local_vars_configuration=None):  # noqa: E501
