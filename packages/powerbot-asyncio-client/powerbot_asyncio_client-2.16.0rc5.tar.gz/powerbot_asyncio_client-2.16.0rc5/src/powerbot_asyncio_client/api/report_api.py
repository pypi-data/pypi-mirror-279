...
class ReportApi(object):
    ...
    def get_report_for_period_with_http_info(self, delivery_area, delivery_day_from, delivery_day_to, **kwargs):  # noqa: E501
        ...
        # verify the required parameter 'delivery_day_from' is set
        if self.api_client.client_side_validation and local_var_params.get('delivery_day_from') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `delivery_day_from` when calling `get_report_for_period`")  # noqa: E501
        # verify the required parameter 'delivery_day_to' is set
        if self.api_client.client_side_validation and local_var_params.get('delivery_day_to') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `delivery_day_to` when calling `get_report_for_period`")  # noqa: E501
