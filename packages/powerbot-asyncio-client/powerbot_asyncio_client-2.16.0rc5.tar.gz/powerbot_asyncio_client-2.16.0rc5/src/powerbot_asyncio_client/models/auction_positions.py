...
class AuctionPositions(object):
    ...
    def __init__(self, net_pos=None, min_net_pos=None, max_net_pos=None, abs_pos=None, net_cash=None, trades_spending=None, trades_earnings=None, local_vars_configuration=None):  # noqa: E501
