...
"""
    ...
    The version of the OpenAPI document: 2.16.0-rc5
...
class PortfolioInformation(object):
    ...
    def __init__(self, portfolio_id=None, currency=None, exchange_otr=None, tenant_otr=None, portfolio_otr=None, net_cash_pos=None, trades_spending=None, trades_earnings=None, orders_spending=None, orders_earnings=None, net_pos=None, net_pos_aggregate=None, max_net_pos_buy_with_orders=None, min_net_pos_sell_with_orders=None, abs_pos=None, sell_abs_pos=None, buy_abs_pos=None, order_action_quota=None, auction_positions=None, local_vars_configuration=None):  # noqa: E501
    ...
    def exchange_otr(self):
        ...
        DEPRECATED: replaced by order action quota. The exchange order-to-trade-ratio for the timeframe of the particular contract. The scope is spanning across all portfolios and tenants for this exchange. Please note that the timeframe includes both XBID and LOCAL contracts.  # noqa: E501
    ...
    def tenant_otr(self):
        ...
        DEPRECATED: replaced by order action quota. The tenant order-to-trade-ratio for the timeframe of the particular contract. The scope is spanning across all portfolios for this exchange and tenant. Please note that the timeframe includes both XBID and LOCAL contracts.  # noqa: E501
    ...
    def portfolio_otr(self):
        ...
        DEPRECATED: replaced by order action quota. The portfolio order-to-trade-ratio for the timeframe of the particular contract. The scope is this portfolio for this exchange and tenant. Please note that the timeframe includes both XBID and LOCAL contracts.  # noqa: E501
