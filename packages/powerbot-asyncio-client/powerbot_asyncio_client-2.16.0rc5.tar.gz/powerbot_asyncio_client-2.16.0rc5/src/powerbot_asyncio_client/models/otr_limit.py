...
class OtrLimit(object):
    ...
    def __init__(self, exchange=None, delivery_area=None, otr_limit=None, local_vars_configuration=None):  # noqa: E501
        """OtrLimit - a model defined in OpenAPI"""  # noqa: E501
    ...
    def otr_limit(self):
        ...
        The order-to-trade-ratio limit for the particular exchange and delivery-area. It is calculated for each timeframe of a particular contract (XBID and LOCAL Contract).  # noqa: E501
    ...
    def otr_limit(self, otr_limit):
        ...
        :type otr_limit: float
        """
        if self.local_vars_configuration.client_side_validation and otr_limit is None:  # noqa: E501
