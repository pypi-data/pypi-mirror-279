        ...
        for blob in bucket.list_blobs(prefix=str(path)):
            ...
            if str(current_path) != str(path):
                ...
                if file_type == 'csv':
                    ...
                    raise "File not valid type! Invalid file in path: {}".format(full_path)
...
def upload_file_to_gcs(target_bucket_name, folder_path, file):
    ...
    file.to_csv(str(bucket_folder_path), index = False) # save dataframe object to GCS bucket folder
