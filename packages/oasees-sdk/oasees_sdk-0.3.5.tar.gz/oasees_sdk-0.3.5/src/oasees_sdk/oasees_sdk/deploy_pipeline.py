...
def create_load_job(ipfs_api_url,api_instance,ipfs_cid, app_name):
    container = client.V1Container(
        name="buildkit",
	    image="oasees-loader:oasees",
        #image="oasees-builder",
        #image_pull_policy="Never",
        security_context=client.V1SecurityContext(privileged=True),
        command=["/entrypoint.sh"],
    ...
    volume_b = client.V1Volume(
        ...
        host_path=client.V1HostPathVolumeSource(path="/home/localadmin/.oasees_sdk/template.yaml", type="File")
        )
