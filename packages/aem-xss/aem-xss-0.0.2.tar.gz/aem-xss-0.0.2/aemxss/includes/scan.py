...
"""
from aemxss.includes import bot
...
from aemxss.includes import writefile
        ...
        with requests.Session() as session:
            ...
            for endpoint in payreq.text.splitlines():
                ...
                try:
                    ...
                    if response.status_code == 200 and '<img src="x" data onerror="alert(domain)"/>' in response.text or '<br /><br />please authenticate<br /><br />' in response.text and 'data-coral-columnview-id' in response.text:
                        outputprint = (
