...
from oum.node import Node, NodeHeap
from oum.utils import gather_dict
...
class SpiderCrawl:
    ...
    def __init__(self, protocol, node, peers, ksize, alpha):
        ...
        Args:
            protocol: A :class:`~oum.protocol.OumProtocol` instance.
            node: A :class:`~oum.node.Node` representing the key we're
                  looking for
            peers: A list of :class:`~oum.node.Node` instances that
