...
class DisplayItemUI(TasksMode):
    ...
    def clear_all_displays(self):
        with Session(ENGINE) as session:
            ...
            print(f"{Fore.light_red}{check}{Fore.light_green} DisplayItem's remain!{Style.reset}")
...
{Fore.light_magenta}clear display|clear_display|cd{Style.reset} {Fore.light_steel_blue}clear display{Style.reset}
{Fore.light_magenta}del id|del_id|delid{Style.reset} {Fore.light_steel_blue}delete display by id{Style.reset}
{Fore.light_magenta}clear all|clear_all|clral{Style.reset} {Fore.light_steel_blue}clear all displays{Style.reset}
{Fore.light_magenta}show display|show_display|sd{Style.reset} {Fore.light_steel_blue}show display content{Style.reset}
