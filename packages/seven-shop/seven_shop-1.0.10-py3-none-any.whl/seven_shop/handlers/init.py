...
:LastEditTime: 2024-06-06 16:32:23
...
class InitHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        shop_model = ShopModel().get_dict_by_id(shop_id,"wait_pay_time,logistics_time,consignee,phone,address_info,shipping_method,remark,coupon_remark")
        if not shop_model:
            return self.reponse_json_error("初始化信息异常")
        self.reponse_json_success(shop_model)
