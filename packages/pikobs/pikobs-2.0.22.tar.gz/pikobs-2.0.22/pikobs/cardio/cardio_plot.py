...
def cardio_plot(pathwork,datestart, dateend, flag_type, family, fig_title, plot_type, channel, id_stn, varno, region):
 ...
 # channel   = LARG[2]
  ...
  path_output_work=f'{pathwork}/cardio_{datestart}_{dateend}_{flag_type}_{family}.db'
...
#  AvgOBS=[]
 ...
 # if ichannel != 0:
  ...
  ax1.yaxis.grid(b=True, which='major', linestyle='-', color='grey')
  ax1.yaxis.grid(b=True, which='minor', linestyle=':', color='grey')
  ax1.xaxis.grid(b=True, which='major', linestyle=':', color='grey')
  ax1.xaxis.grid(b=True, which='minor', linestyle=':', color='grey')
...
#  ax2.set_ylim(0, 5)
  ...
  ax2.yaxis.grid(b=True, which='major', linestyle='-', color='grey')
  ax2.yaxis.grid(b=True, which='minor', linestyle=':', color='grey')
  ax2.xaxis.grid(b=True, which='major', linestyle=':', color='grey')
  ax2.xaxis.grid(b=True, which='minor', linestyle=':', color='grey')
  ...
  ax3.xaxis.grid(b=True, which='major', linestyle=':', color='grey')
  ax3.xaxis.grid(b=True, which='minor', linestyle=':', color='grey')
  ...
  ax4.xaxis.grid(b=True, which='major', linestyle=':', color='grey')
  ax4.xaxis.grid(b=True, which='minor', linestyle=':', color='grey')
  ...
  plt.savefig(f'{pathwork}/cardio/serie_{TITLE}_{family}_{id_stn}_{region}_ch{channel}.png',format='png',dpi=100)
