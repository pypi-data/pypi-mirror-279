def family(famille):
    if famille in ('ua', 'ua_qc'):
        ...
        VCOCRIT = "      "
        elem = "12163"
    elif famille in ('to_amsub_qc', 'to_amsub'):
        FAM = "AMSUB"
        VCOTYP = 'CANAL'
        STATB = "BIAS_CORR"
        VCOORD = "  vcoord "
        VCOCRIT = " and vcoord in( 43,44,45,46,47) "
        elem = "12163"
        ...
        VCOCRIT = "and vcoord in ($VCOORDLIST) "
        elem = "12163"
    elif famille == 'ch':
        FAM = "OZONE"
        VCOTYP = 'LEVEL'
        ...
        elem = "12163"
        VCOCRIT = "    "
    elif famille in ('atms_allsky', 'atms_qc'):
        ...
        VCOTYP = 'CANAL'
        STATB = "BIAS_CORR"
        VCOCRIT = " and vcoord in( 2,3,4,5,6) "
        VCOORD = "  vcoord "
        elem = "12163"
    elif famille in ('ai', 'ai_qc'):
        FAM = "AIRCRAFTS"
        VCOTYP = 'PRESSION'
        VCOORD = " round(vcoord/20000.)*20000 "
        VCOORD = " round(vcoord/05000.)*05000 "
