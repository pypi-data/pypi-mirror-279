...
from bigeye_sdk.generated.com.bigeye.models.generated import (
    ...
    ObjectOwnerResponse, SendDbtCoreRunInfoResponse, SendDbtCoreRunInfoRequest, TableLineageV2Response,
...
def get_user_auth(auth: ApiAuth) -> UserAuth:
    ...
    if response.status_code < 200 or response.status_code >= 300:
        ...
        if response.status_code == 401:
            log.info(
                "Verify username and password or that you are logged in to Bigeye via a supported browser"
            )
