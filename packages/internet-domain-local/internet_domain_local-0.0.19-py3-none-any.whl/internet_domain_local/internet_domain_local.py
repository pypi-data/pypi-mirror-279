...
DEFAULT_COLUMN_NAME = "internet_domain_id"
...
class DomainLocal(GenericMapping):
    ...
    # TODO Please either create Sql2Code data structure from `internet_domain`.`internet_domain_table` (preferred) or query for `internet_domain_table`.`is_commercial_webmail` directly
    ...
    def link_contact_to_domain(self, contact_id: int, url: str) -> dict:
        ...
        try:
            ...
            data_to_insert = {
                ...
                'profile_id': logger.user_context.get_effective_profile_id(),   # TODO: is this profile_id correct? - I don't think so
            }
        ...
        insert_information = {
            ...
            'url': url,
            'profile_id': logger.user_context.get_effective_profile_id(),   # TODO: is this profile_id correct?
    ...
    def link_contact_to_url(self, contact_id: int, url: str, profiles_ids: list[int]) -> Optional[dict]:
        ...
        profile_id = profiles_ids[0] if len(profiles_ids) == 1 else None
