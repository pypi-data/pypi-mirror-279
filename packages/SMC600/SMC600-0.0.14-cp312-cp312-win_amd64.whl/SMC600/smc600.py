...
def get_card_version_list_e(CardNo, card_version_list):
    return _smc600.get_card_version_list_e(CardNo, card_version_list)

def get_equiv_e(CardNo, axis, equiv):
    return _smc600.get_equiv_e(CardNo, axis, equiv)
...
def get_position_e(CardNo, axis, pos):
    return _smc600.get_position_e(CardNo, axis, pos)

def set_position_e(CardNo, axis, current_position):
    return _smc600.set_position_e(CardNo, axis, current_position)

def get_encoder_unit_e(ConnectNo, axis, pos):
    return _smc600.get_encoder_unit_e(ConnectNo, axis, pos)

def set_encoder_unit_e(ConnectNo, axis, encoder_value):
    return _smc600.set_encoder_unit_e(ConnectNo, axis, encoder_value)

def get_counter_inmode_e(ConnectNo, axis, mode):
    return _smc600.get_counter_inmode_e(ConnectNo, axis, mode)

def set_counter_inmode_e(ConnectNo, axis, mode):
    return _smc600.set_counter_inmode_e(ConnectNo, axis, mode)

def get_backlash_unit_e(ConnectNo, axis, backlash):
    return _smc600.get_backlash_unit_e(ConnectNo, axis, backlash)
