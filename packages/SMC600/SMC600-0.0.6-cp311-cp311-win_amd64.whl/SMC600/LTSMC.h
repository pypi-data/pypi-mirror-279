...
SMC_API short __stdcall nmcs_clear_alarm_fieldbus(WORD ConnectNo,WORD PortNo);
...
SMC_API short __stdcall nmcs_get_consume_time_fieldbus(WORD ConnectNo,WORD PortNo,DWORD* Average_time, DWORD* Max_time,uint64* Cycles);
SMC_API short __stdcall nmcs_clear_consume_time_fieldbus(WORD ConnectNo,WORD PortNo);
...
//按节点操作扩展IO
SMC_API short __stdcall nmcs_read_inbit(WORD ConnectNo,WORD PortNo,WORD NodeID,WORD BitNo,WORD *IoValue);
SMC_API short __stdcall nmcs_read_inport(WORD ConnectNo,WORD PortNo,WORD NodeID,WORD IoPortNo,DWORD *IoValue);
SMC_API short __stdcall nmcs_write_outbit(WORD ConnectNo,WORD PortNo,WORD NodeID,WORD BitNo,WORD IoValue);
SMC_API short __stdcall nmcs_write_outport(WORD ConnectNo,WORD PortNo,WORD NodeID,WORD IoPortNo,DWORD IoValue);
SMC_API short __stdcall nmcs_read_outbit(WORD ConnectNo,WORD PortNo,WORD NodeID,WORD BitNo,WORD *IoValue);
SMC_API short __stdcall nmcs_read_outport(WORD ConnectNo,WORD PortNo,WORD NodeID,WORD IoPortNo,DWORD *IoValue);
