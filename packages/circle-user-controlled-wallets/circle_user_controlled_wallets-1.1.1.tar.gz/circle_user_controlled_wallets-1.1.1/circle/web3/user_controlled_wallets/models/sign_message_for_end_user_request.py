...
class SignMessageForEndUserRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignMessageForEndUserRequest:
        """Create an instance of SignMessageForEndUserRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignMessageForEndUserRequest:
        """Create an instance of SignMessageForEndUserRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignMessageForEndUserRequest.parse_obj(obj)

        _obj = SignMessageForEndUserRequest.parse_obj({
