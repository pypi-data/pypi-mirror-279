...
class RestorePinRequest(BaseModel):
    """
    RestorePinRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RestorePinRequest:
        """Create an instance of RestorePinRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RestorePinRequest:
        """Create an instance of RestorePinRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RestorePinRequest.parse_obj(obj)

        _obj = RestorePinRequest.parse_obj({
