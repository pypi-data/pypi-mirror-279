...
class ContractExecutionTxnPinCodeRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractExecutionTxnPinCodeRequest:
        """Create an instance of ContractExecutionTxnPinCodeRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractExecutionTxnPinCodeRequest:
        """Create an instance of ContractExecutionTxnPinCodeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractExecutionTxnPinCodeRequest.parse_obj(obj)

        _obj = ContractExecutionTxnPinCodeRequest.parse_obj({
