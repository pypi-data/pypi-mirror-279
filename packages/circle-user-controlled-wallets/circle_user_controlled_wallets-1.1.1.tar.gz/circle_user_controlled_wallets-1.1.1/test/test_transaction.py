...
from circle.web3.user_controlled_wallets.models.transaction import Transaction  # noqa: E501
...
class TestTransaction(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = circle.web3.user_controlled_wallets.models.transaction.Transaction()  # noqa: E501
        if include_optional :
            return Transaction(
                ...
                error_reason = '', 
                error_details = '', 
                estimated_fee = circle.web3.user_controlled_wallets.models.estimated_transaction_fee.EstimatedTransactionFee(
                    gas_limit = '21000', 
                    gas_price = '', 
                    max_fee = '5.935224468', 
