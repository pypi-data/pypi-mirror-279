...
class econometrics:
    ...
    def descriptives(data):
        ...
        pandas.DataFrame
            ...
            Pearson, Skewness, Coefficient of Quartile Deviation, Jarque-Bera, p-value) 
            and each column corresponds to a numeric column from the input DataFrame.
        """
    ...
    def adf(dataframe, maxlag=None, regression='c', autolag='AIC', store=False, regresults=False, handle_na='drop'):
        ...
        print(results_df.to_string(max_columns=results_df.shape[1]))
        print("\n--\n" + "Signif. codes:  0.001 '***', 0.01 '**', 0.05 '*', 0.1 '.'\n")
