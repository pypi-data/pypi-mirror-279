        ...
        for name in data.columns:
            if pd.api.types.is_numeric_dtype(data[name]):
                ...
                statistics_values = [
					...
					format(round(column_data.median(), 3), '.3f')[1:] if round(column_data.median(), 3) < 1 else format(round(column_data.median(), 3), '.3f'),
					format(round(column_data.min(), 3), '.3f')[1:] if round(column_data.min(), 3) < 1 else format(round(column_data.min(), 3), '.3f'),
					format(round(column_data.max(), 3), '.3f')[1:] if round(column_data.max(), 3) < 1 else format(round(column_data.max(), 3), '.3f'),
					format(round(column_data.std(), 3), '.3f')[1:] if round(column_data.std(), 3) < 1 else format(round(column_data.std(), 3), '.3f'),
					format(round((np.percentile(column_data, 75) - np.percentile(column_data, 25)) / 2, 3), '.3f')[1:] if round((np.percentile(column_data, 75) - np.percentile(column_data, 25)) / 2, 3) < 1 else format(round((np.percentile(column_data, 75) - np.percentile(column_data, 25)) / 2, 3), '.3f'),
					format(round(kurtosis(column_data, fisher=True, nan_policy='omit'), 3), '.3f')[1:] if round(kurtosis(column_data, fisher=True, nan_policy='omit'), 3) < 1 else format(round(kurtosis(column_data, fisher=True, nan_policy='omit'), 3), '.3f'),
					format(round(kurtosis(column_data, fisher=False, nan_policy='omit'), 3), '.3f')[1:] if round(kurtosis(column_data, fisher=False, nan_policy='omit'), 3) < 1 else format(round(kurtosis(column_data, fisher=False, nan_policy='omit'), 3), '.3f'),
					format(round(column_data.skew(), 4), '.4f')[1:] if round(column_data.skew(), 4) < 1 else format(round(column_data.skew(), 4), '.4f'),
					(format(round((np.percentile(column_data, 75) - np.percentile(column_data, 25)) / 2 / column_data.median(), 3), '.3f')[1:] if round((np.percentile(column_data, 75) - np.percentile(column_data, 25)) / 2 / column_data.median(), 3) < 1 else format(round((np.percentile(column_data, 75) - np.percentile(column_data, 25)) / 2 / column_data.median(), 3), '.3f')) if column_data.median() != 0 else '0.000',
					format(round(jb_value, 3), '.3f')[1:] if round(jb_value, 3) < 1 else format(round(jb_value, 3), '.3f'),
