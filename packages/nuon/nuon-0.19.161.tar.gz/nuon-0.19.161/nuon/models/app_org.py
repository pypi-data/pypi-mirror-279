...
class AppOrg(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by", "created_by_id", "custom_cert", "health_checks", "id", "latest_health_check", "name", "notifications_config", "sandbox_mode", "status", "status_description", "updated_at", "users", "vcs_connections"]
