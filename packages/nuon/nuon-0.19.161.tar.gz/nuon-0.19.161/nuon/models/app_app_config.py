...
class AppAppConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_id", "content", "created_at", "created_by", "created_by_id", "format", "generated_terraform", "id", "org_id", "status", "status_description", "updated_at", "version"]
