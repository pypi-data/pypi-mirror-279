from fastdup.utilities import _DOC_MSG
__doc__ = _DOC_MSG
...
def explore(work_dir: Union[str, Path], input_dir: Optional[Union[str, Path, List[str]]] = None,
            dataset_name: Optional[str] = None, overwrite: bool = False) -> None:
    do_visual_layer(work_dir, input_dir, dataset_name, overwrite)
