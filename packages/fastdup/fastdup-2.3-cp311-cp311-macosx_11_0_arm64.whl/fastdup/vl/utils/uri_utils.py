...
def get_image_serving_url(dataset_id: UUID, image_id: UUID, image_local_path: str):
...
def get_image_serving_file_path(dataset_id: UUID, image_id: UUID, image_local_path: str):
