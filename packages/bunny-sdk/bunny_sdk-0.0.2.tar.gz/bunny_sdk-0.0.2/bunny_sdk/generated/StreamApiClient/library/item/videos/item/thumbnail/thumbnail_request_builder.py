...
class ThumbnailRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/library/{libraryId}/videos/{videoId}/thumbnail?thumbnailUrl={thumbnailUrl}", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[ThumbnailRequestBuilderPostQueryParameters]] = None) -> Optional[StructuredSuccessResponse]:
        """
    ...
    def to_post_request_information(self,request_configuration: Optional[RequestConfiguration[ThumbnailRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        [SetThumbnail API Docs](https://docs.bunny.net/reference/video_setthumbnail)
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
