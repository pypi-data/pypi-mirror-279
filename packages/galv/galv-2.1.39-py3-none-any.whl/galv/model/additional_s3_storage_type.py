...
class AdditionalS3StorageType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "id", "lab", "quota", "bytes_used", "secret_key", "access_key", "permissions", "name", "priority", "enabled", "bucket_name", "location", "custom_domain", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "id", "lab", "quota", "bytes_used", "secret_key", "access_key", "permissions", "name", "priority", "enabled", "bucket_name", "location", "custom_domain", ], str]):
        return super().get_item_oapg(name)
