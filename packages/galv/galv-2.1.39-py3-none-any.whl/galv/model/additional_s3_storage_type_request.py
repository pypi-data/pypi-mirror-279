...
class AdditionalS3StorageTypeRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lab", "quota", "secret_key", "access_key", "name", "priority", "enabled", "bucket_name", "location", "custom_domain", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lab", "quota", "secret_key", "access_key", "name", "priority", "enabled", "bucket_name", "location", "custom_domain", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        quota: typing.Union[MetaOapg.properties.quota, decimal.Decimal, int, ],
    ...
    ) -> 'AdditionalS3StorageTypeRequest':
        return super().__new__(
            cls,
            *_args,
            secret_key=secret_key,
