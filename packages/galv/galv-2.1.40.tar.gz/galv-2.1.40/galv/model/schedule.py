...
The Meta.model must have a custom_properties JSONField.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "id", "family", "in_use", "team", "cycler_tests", "permissions", "schedule_file", "pybamm_schedule_variables", "read_access_level", "edit_access_level", "delete_access_level", "custom_properties", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "id", "family", "in_use", "team", "cycler_tests", "permissions", "schedule_file", "pybamm_schedule_variables", "read_access_level", "edit_access_level", "delete_access_level", "custom_properties", ], str]):
        return super().get_item_oapg(name)
