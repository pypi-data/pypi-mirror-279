...
class ArbitraryFile(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "id", "name", "file", "team", "permissions", "description", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "id", "name", "file", "team", "permissions", "description", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        file: typing.Union[MetaOapg.properties.file, None, str, ],
