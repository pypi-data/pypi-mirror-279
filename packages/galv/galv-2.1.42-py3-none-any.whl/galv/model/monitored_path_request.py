...
class MonitoredPathRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["path", "harvester", "team", "regex", "stable_time_s", "active", "max_partition_line_count", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["path", "harvester", "team", "regex", "stable_time_s", "active", "max_partition_line_count", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
