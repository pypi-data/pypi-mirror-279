...
class GalvStorageType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "id", "lab", "quota", "bytes_used", "permissions", "name", "priority", "enabled", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "id", "lab", "quota", "bytes_used", "permissions", "name", "priority", "enabled", ], str]):
        return super().get_item_oapg(name)
