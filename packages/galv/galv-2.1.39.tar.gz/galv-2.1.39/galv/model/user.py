...
class User(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["username", "url", "id", "is_staff", "is_superuser", "is_lab_admin", "permissions", "email", "first_name", "last_name", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["username", "url", "id", "is_staff", "is_superuser", "is_lab_admin", "permissions", "email", "first_name", "last_name", ], str]):
        return super().get_item_oapg(name)
