    ...
    def test_first_of_month_success(self):
        ...
        for index, test in enumerate(tests):
            with self.subTest(
                ...
                self.assertEqual(
                    TemporalAdjuster.first_of_month(
                        test_input_weekday, test_input_date
                    ),
                    test_expected_output,
                )
    ...
    def test_first_of_next_month_success(self):
        ...
        for index, test in enumerate(tests):
            with self.subTest(
                ...
                self.assertEqual(
                    TemporalAdjuster.first_of_next_month(
                        test_input_weekday, test_input_date
                    ),
                    test_expected_output,
                )
    ...
    def test_first_of_last_month_success(self):
        ...
        for index, test in enumerate(tests):
            with self.subTest(
                ...
                self.assertEqual(
                    TemporalAdjuster.first_of_last_month(
                        test_input_weekday, test_input_date
                    ),
                    test_expected_output,
                )
    ...
    def test_last_of_next_month_success(self):
        ...
        for index, test in enumerate(tests):
            with self.subTest(
                ...
                self.assertEqual(
                    TemporalAdjuster.last_of_next_month(
                        test_input_weekday, test_input_date
                    ),
                    test_expected_output,
                )
    ...
    def test_last_of_last_month_success(self):
        ...
        for index, test in enumerate(tests):
            with self.subTest(
                ...
                self.assertEqual(
                    TemporalAdjuster.last_of_last_month(
                        test_input_weekday, test_input_date
                    ),
                    test_expected_output,
                )
    ...
    def test_first_of_last_year_success(self):
        ...
        for index, test in enumerate(tests):
            with self.subTest(
                ...
                self.assertEqual(
                    TemporalAdjuster.first_of_last_year(
                        test_input_weekday, test_input_date
                    ),
                    test_expected_output,
                )
    ...
    def test_first_of_next_year_success(self):
        ...
        for index, test in enumerate(tests):
            with self.subTest(
                ...
                self.assertEqual(
                    TemporalAdjuster.first_of_next_year(
                        test_input_weekday, test_input_date
                    ),
                    test_expected_output,
                )
    ...
    def test_last_of_next_year_success(self):
        ...
        for index, test in enumerate(tests):
            with self.subTest(
                ...
                self.assertEqual(
                    TemporalAdjuster.last_of_next_year(
                        test_input_weekday, test_input_date
                    ),
                    test_expected_output,
                )
    ...
    def test_last_of_last_year_success(self):
        ...
        for index, test in enumerate(tests):
            with self.subTest(
                ...
                self.assertEqual(
                    TemporalAdjuster.last_of_last_year(
                        test_input_weekday, test_input_date
                    ),
                    test_expected_output,
                )
