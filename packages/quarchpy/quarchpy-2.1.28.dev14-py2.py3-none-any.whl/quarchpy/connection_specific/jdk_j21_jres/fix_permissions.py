...
def main():
    ...
    java_path = os.path.join(java_path, "jdk_j21_jres")

    # OS dependency
    if current_os in "Windows":
        java_path = java_path + "\\win-amd64-jdk-21-jre\\"
    elif current_os in "Linux":
        java_path = java_path + "/lin-amd64-jdk-21-jre/"
    elif current_os in "Darwin":
        java_path = java_path + "/mac-amd64-jdk-21-jre/"
...
def find_java_permissions():
    ...
    # OS dependency
    if current_os in "Windows":
        java_path = os.path.join(java_path, "win-amd64-jdk-21-jre","bin","java.exe")
    elif current_os in "Linux":
        java_path = java_path + "/lin-amd64-jdk-21-jre/bin/java"
    elif current_os in "Darwin":
        java_path = java_path + "/mac-amd64-jdk-21-jre/bin/java"
    else:  # default to windows
        java_path = java_path + "\\win-amd64-jdk-21-jre\\bin\\java"
    # Get the file status
