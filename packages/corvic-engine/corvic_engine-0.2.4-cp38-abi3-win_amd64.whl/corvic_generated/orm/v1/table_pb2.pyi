...
class EmbeddingCoordinatesOp(_message.Message):
    __slots__ = ("table", "n_components", "metric")
    TABLE_FIELD_NUMBER: _ClassVar[int]
    ...
    n_components: int
    metric: str
    def __init__(self, table: _Optional[_Union[TableComputeOp, _Mapping]] = ..., n_components: _Optional[int] = ..., metric: _Optional[str] = ...) -> None: ...
...
class TableComputeResult(_message.Message):
    __slots__ = ("result_urls",)
    RESULT_URLS_FIELD_NUMBER: _ClassVar[int]
    result_urls: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, result_urls: _Optional[_Iterable[str]] = ...) -> None: ...

class ExecuteRequest(_message.Message):
    __slots__ = ("table", "output_url_prefix", "tables_to_compute")
    TABLE_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_URL_PREFIX_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, table: _Optional[_Union[TableComputeOp, _Mapping]] = ..., output_url_prefix: _Optional[str] = ..., tables_to_compute: _Optional[_Iterable[_Union[TableComputeContext, _Mapping]]] = ...) -> None: ...

class ExecuteResponse(_message.Message):
    __slots__ = ("table_results", "output_urls")
    ...
    def __init__(self, table_results: _Optional[_Iterable[_Union[TableComputeResult, _Mapping]]] = ..., output_urls: _Optional[_Iterable[str]] = ...) -> None: ...
