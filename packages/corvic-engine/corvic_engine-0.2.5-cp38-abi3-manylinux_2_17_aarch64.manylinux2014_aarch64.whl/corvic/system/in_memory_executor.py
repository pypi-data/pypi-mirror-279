...
class InMemoryExecutor:
    ...
    def _execute_combine_columns(
        ...
        source_df = _as_df(self._execute(op.source, context))
        match op.reduction:
        ...
        return _SchemaAndBatches.from_dataframe(result_df)
    ...
    def _execute_embed_column(
        ...
        return _SchemaAndBatches.from_dataframe(
            source_df.with_columns(result.embeddings.alias(op.embedding_column_name))
        )
