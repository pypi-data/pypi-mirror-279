...
from ..fable_modules.fable_library.list import (FSharpList, choose as choose_1, singleton, is_empty, of_array, empty, map as map_2, length, item, map_indexed, collect, try_pick as try_pick_1, head, sort_by, append as append_1, zip, initialize)
...
from ..fable_modules.fable_library.string_ import (to_text, printf, ends_with, to_fail, remove)
...
from .Process.component import (Component_create_4208F9FC, Component)
from .Process.factor import Factor
from .Process.factor_value import (FactorValue_create_29259B2C, FactorValue)
from .Process.material_attribute import (MaterialAttribute_create_A220A8A, MaterialAttribute)
from .Process.material_attribute_value import (MaterialAttributeValue_create_BE8DE56, MaterialAttributeValue)
...
from .Process.process_input import (ProcessInput_createSource_Z5E00540E, ProcessInput_createSample_Z598187B7, ProcessInput_createMaterial_4452CB4C, ProcessInput_createRawData_Z721C83C5, ProcessInput, ProcessInput__isSample, ProcessInput__isSource, ProcessInput__get_Name, ProcessInput_setCharacteristicValues, ProcessInput__isData, ProcessInput__isMaterial, ProcessInput_getCharacteristicValues_5B3D5BA9)
...
from .Process.value import Value as Value_2
...
def _arrow804(__unit: None=None) -> Callable[[str], str]:
    clo_1: Callable[[str], str] = to_text(printf("%s %s"))(Person_AssayIdentifierPrefix)
    return clo_1


Person_createAssayIdentifierKey: Callable[[str], str] = _arrow804()
...
def Person_getSourceAssayIdentifiersFromComments(person: Person) -> IEnumerable_1[str]:
    def chooser(c: Comment, person: Any=person) -> str | None:
        def mapping(n: str, c: Any=c) -> bool:
            return n.find(Person_AssayIdentifierPrefix) == 0
...
def Person_removeSourceAssayComments(person: Person) -> Array[Comment]:
    def f(c: Comment, person: Any=person) -> bool:
        if c.Name is not None:
            return not (value_10(c.Name).find(Person_AssayIdentifierPrefix) == 0)
...
def Person_setOrcidFromComments(person: Person) -> Person:
    ...
    def is_orcid_comment(c: Comment, person: Any=person) -> bool:
        if c.Name is not None:
            return ends_with(value_10(c.Name).upper(), Person_orcidKey)
...
def JsonTypes_composeComponent(header: CompositeHeader, value: CompositeCell) -> Component:
    ...
    return Component_create_4208F9FC(pattern_input[0], pattern_input[1], header.ToTerm())
...
def JsonTypes_composeFactorValue(header: CompositeHeader, value: CompositeCell) -> FactorValue:
    pattern_input: tuple[Value_2 | None, OntologyAnnotation | None] = JsonTypes_valueOfCell(value)
    return FactorValue_create_29259B2C(None, Factor.create(to_string(header), header.ToTerm()), pattern_input[0], pattern_input[1])


def JsonTypes_composeCharacteristicValue(header: CompositeHeader, value: CompositeCell) -> MaterialAttributeValue:
    pattern_input: tuple[Value_2 | None, OntologyAnnotation | None] = JsonTypes_valueOfCell(value)
    return MaterialAttributeValue_create_BE8DE56(None, MaterialAttribute_create_A220A8A(None, header.ToTerm()), pattern_input[0], pattern_input[1])
...
def ProcessParsing_tryComponentGetter(general_i: int, value_i: int, value_header: CompositeHeader) -> Callable[[Any, int], Component] | None:
    if value_header.tag == 0:
        ...
        def Value(matrix: Any, general_i: Any=general_i, value_i: Any=value_i, value_header: Any=value_header) -> Callable[[int], Component]:
            def _arrow820(i: int, matrix: Any=matrix) -> Component:
...
def ProcessParsing_tryParameterGetter(general_i: int, value_i: int, value_header: CompositeHeader) -> Callable[[Any, int], ProcessParameterValue] | None:
    if value_header.tag == 3:
        ...
        def Value(matrix: Any, general_i: Any=general_i, value_i: Any=value_i, value_header: Any=value_header) -> Callable[[int], ProcessParameterValue]:
            def _arrow821(i_1: int, matrix: Any=matrix) -> ProcessParameterValue:
...
def ProcessParsing_tryFactorGetter(general_i: int, value_i: int, value_header: CompositeHeader) -> Callable[[Any, int], FactorValue] | None:
    if value_header.tag == 2:
        ...
        def Value(matrix: Any, general_i: Any=general_i, value_i: Any=value_i, value_header: Any=value_header) -> Callable[[int], FactorValue]:
            def _arrow822(i_1: int, matrix: Any=matrix) -> FactorValue:
...
def ProcessParsing_tryCharacteristicGetter(general_i: int, value_i: int, value_header: CompositeHeader) -> Callable[[Any, int], MaterialAttributeValue] | None:
    if value_header.tag == 1:
        ...
        def Value(matrix: Any, general_i: Any=general_i, value_i: Any=value_i, value_header: Any=value_header) -> Callable[[int], MaterialAttributeValue]:
            def _arrow823(i_1: int, matrix: Any=matrix) -> MaterialAttributeValue:
...
def ProcessParsing_tryGetProtocolTypeGetter(general_i: int, header: CompositeHeader) -> Callable[[Any, int], OntologyAnnotation] | None:
    if header.tag == 4:
        def Value(matrix: Any, general_i: Any=general_i, header: Any=header) -> Callable[[int], OntologyAnnotation]:
            def _arrow824(i: int, matrix: Any=matrix) -> OntologyAnnotation:
...
def ProcessParsing_tryGetProtocolREFGetter(general_i: int, header: CompositeHeader) -> Callable[[Any, int], str] | None:
    if header.tag == 8:
        def Value(matrix: Any, general_i: Any=general_i, header: Any=header) -> Callable[[int], str]:
            def _arrow825(i: int, matrix: Any=matrix) -> str:
...
def ProcessParsing_tryGetProtocolDescriptionGetter(general_i: int, header: CompositeHeader) -> Callable[[Any, int], str] | None:
    if header.tag == 5:
        def Value(matrix: Any, general_i: Any=general_i, header: Any=header) -> Callable[[int], str]:
            def _arrow826(i: int, matrix: Any=matrix) -> str:
                return get_item_from_dict(matrix, (general_i, i)).AsFreeText
...
def ProcessParsing_tryGetProtocolURIGetter(general_i: int, header: CompositeHeader) -> Callable[[Any, int], str] | None:
    if header.tag == 6:
        def Value(matrix: Any, general_i: Any=general_i, header: Any=header) -> Callable[[int], str]:
            def _arrow827(i: int, matrix: Any=matrix) -> str:
                return get_item_from_dict(matrix, (general_i, i)).AsFreeText
...
def ProcessParsing_tryGetProtocolVersionGetter(general_i: int, header: CompositeHeader) -> Callable[[Any, int], str] | None:
    if header.tag == 7:
        def Value(matrix: Any, general_i: Any=general_i, header: Any=header) -> Callable[[int], str]:
            def _arrow828(i: int, matrix: Any=matrix) -> str:
                return get_item_from_dict(matrix, (general_i, i)).AsFreeText
...
def ProcessParsing_tryGetInputGetter(general_i: int, header: CompositeHeader) -> Callable[[Any, int], ProcessInput] | None:
    if header.tag == 11:
        def Value(matrix: Any, general_i: Any=general_i, header: Any=header) -> Callable[[int], ProcessInput]:
            def _arrow829(i: int, matrix: Any=matrix) -> ProcessInput:
...
def ProcessParsing_tryGetOutputGetter(general_i: int, header: CompositeHeader) -> Callable[[Any, int], ProcessOutput] | None:
    if header.tag == 12:
        def Value(matrix: Any, general_i: Any=general_i, header: Any=header) -> Callable[[int], ProcessOutput]:
            def _arrow830(i: int, matrix: Any=matrix) -> ProcessOutput:
...
def ProcessParsing_tryGetCommentGetter(general_i: int, header: CompositeHeader) -> Callable[[Any, int], Comment] | None:
    if header.tag == 14:
        def Value(matrix: Any, general_i: Any=general_i, header: Any=header) -> Callable[[int], Comment]:
            def _arrow831(i: int, matrix: Any=matrix) -> Comment:
...
def ProcessParsing_getProcessGetter(process_name_root: str, headers: IEnumerable_1[CompositeHeader]) -> Callable[[Any, int], Process]:
    ...
    if match_value is None:
        def _arrow833(matrix_1: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], FSharpList[ProcessInput]]:
            def _arrow832(i_1: int) -> FSharpList[ProcessInput]:
        ...
        input_getter_1 = _arrow833

    else: 
        input_getter: Callable[[Any, int], ProcessInput] = match_value
        def _arrow835(matrix: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], FSharpList[ProcessInput]]:
            def _arrow834(i: int) -> FSharpList[ProcessInput]:
    ...
    if match_value_1 is None:
        def _arrow837(matrix_3: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], FSharpList[ProcessOutput]]:
            def _arrow836(i_3: int) -> FSharpList[ProcessOutput]:
        ...
        output_getter_1 = _arrow837

    else: 
        output_getter: Callable[[Any, int], ProcessOutput] = match_value_1
        def _arrow839(matrix_2: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], FSharpList[ProcessOutput]]:
            def _arrow838(i_2: int) -> FSharpList[ProcessOutput]:
        ...
        output_getter_1 = _arrow839

    def _arrow841(matrix_4: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], Process]:
        def _arrow840(i_4: int) -> Process:
...
def ProcessParsing_groupProcesses(ps: FSharpList[Process]) -> FSharpList[tuple[str, FSharpList[Process]]]:
    ...
    class ObjectExpr843:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow842(x_1: str, y: str) -> bool:
                return x_1 == y
    ...
    return List_groupBy(projection, ps, ObjectExpr843())
...
def ProcessParsing_mergeIdenticalProcesses(processes: FSharpList[Process]) -> FSharpList[Process]:
    ...
    l: FSharpList[tuple[tuple[str, Any, Any | None, Any | None], FSharpList[Process]]] = List_groupBy(projection, processes, ObjectExpr844())
...
def ProcessParsing_processToRows(p: Process) -> FSharpList[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
    ...
    if match_value_1 is None:
        ...
        def _arrow849(__unit: None=None, p: Any=p) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
            def _arrow848(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                def _arrow847(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                    def _arrow846(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        def _arrow845(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                            return singleton_1((CompositeHeader(7), CompositeCell(1, value_10(prot_1.Version)))) if (prot_1.Version is not None) else empty_1()

                        return append(singleton_1((CompositeHeader(6), CompositeCell(1, value_10(prot_1.Uri)))) if (prot_1.Uri is not None) else empty_1(), delay(_arrow845))

                    return append(singleton_1((CompositeHeader(5), CompositeCell(1, value_10(prot_1.Description)))) if (prot_1.Description is not None) else empty_1(), delay(_arrow846))

                return append(singleton_1((CompositeHeader(4), CompositeCell(0, value_10(prot_1.ProtocolType)))) if (prot_1.ProtocolType is not None) else empty_1(), delay(_arrow847))

            return append(singleton_1((CompositeHeader(8), CompositeCell(1, value_10(prot_1.Name)))) if (prot_1.Name is not None) else empty_1(), delay(_arrow848))

        prot_vals = to_list(delay(_arrow849))
    ...
    def mapping_6(tupled_arg_1: tuple[tuple[str, str], FSharpList[tuple[ProcessInput, ProcessOutput]]], p: Any=p) -> FSharpList[tuple[CompositeHeader, CompositeCell]]:
        ...
        vals: FSharpList[tuple[CompositeHeader, CompositeCell]] = map_2(mapping_5, sort_by(projection_1, append_1(chars, append_1(components, append_1(pvs, map_2(mapping_4, ProcessOutput_getFactorValues_Z42C11600(output_for_factors))))), ObjectExpr850()))
        def _arrow855(__unit: None=None, tupled_arg_1: Any=tupled_arg_1) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
            def _arrow854(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                def _arrow853(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                    def _arrow852(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        def _arrow851(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                            return singleton_1(JsonTypes_decomposeProcessOutput(output_for_type))

                        return append(comments, delay(_arrow851))

                    return append(vals, delay(_arrow852))

                return append(prot_vals, delay(_arrow853))

            return append(singleton_1(JsonTypes_decomposeProcessInput(input_for_type)), delay(_arrow854))

        return to_list(delay(_arrow855))
    ...
    def _arrow856(__unit: None=None, p: Any=p) -> FSharpList[tuple[ProcessInput, ProcessOutput]]:
    ...
    return map_2(mapping_6, List_groupBy(projection, _arrow856(), ObjectExpr857()))
...
def ARCtrl_CompositeHeader__CompositeHeader_TryComponent(this: CompositeHeader) -> Component | None:
    if this.tag == 0:
        return Component_create_4208F9FC(None, None, this.fields[0])
...
def ARCtrl_CompositeCell__CompositeCell_fromValue_Static_6B24B5AD(value: Value_2, unit: OntologyAnnotation | None=None) -> CompositeCell:
...
def CompositeRow_toProtocol(table_name: str, row: IEnumerable_1[tuple[CompositeHeader, CompositeCell]]) -> Protocol:
    def folder(p: Protocol, hc: tuple[CompositeHeader, CompositeCell], table_name: Any=table_name, row: Any=row) -> Protocol:
        ...
        if pattern_matching_result == 0:
            ...
            return Protocol_addComponent(Component_create_4208F9FC(Value_2.from_string(v_4), unit, oa_2), p)

        elif pattern_matching_result == 7:
            return Protocol_addComponent(Component_create_4208F9FC(Value_2(0, t), None, oa_3), p)
    ...
    with get_enumerator(default_arg(p.Components, empty())) as enumerator_1:
        while enumerator_1.System_Collections_IEnumerator_MoveNext():
            ...
            def mapping(arg: Value_2, p: Any=p) -> Array[CompositeCell]:
                return singleton_2(ARCtrl_CompositeCell__CompositeCell_fromValue_Static_6B24B5AD(arg, c.ComponentUnit), None)
...
def ARCtrl_ArcTable__ArcTable_GetProtocols(this: ArcTable) -> FSharpList[Protocol]:
    if this.RowCount == 0:
        def _arrow858(__unit: None=None, this: Any=this) -> Protocol:
            ...
            def folder(p: Protocol, h: CompositeHeader) -> Protocol:
                if h.tag == 4:
                    ...
                    return Protocol_addComponent(Component_create_4208F9FC(None, None, h.fields[0]), p)
        ...
        return singleton(_arrow858())

    else: 
        def _arrow859(i: int, this: Any=this) -> Protocol:
        ...
        return List_distinct(initialize(this.RowCount, _arrow859), ObjectExpr860())
...
def ARCtrl_ArcTable__ArcTable_GetProcesses(this: ArcTable) -> FSharpList[Process]:
    if this.RowCount == 0:
        ...
        def _arrow861(arg: Any, this: Any=this) -> Callable[[int], Process]:
            clo_1: Callable[[int], Process] = clo(arg)
            return clo_1

        getter = _arrow861
        def _arrow863(__unit: None=None, this: Any=this) -> IEnumerable_1[Process]:
            def _arrow862(i: int) -> Process:
                return getter(this.Values)(i)

            return map_1(_arrow862, range_big_int(0, 1, this.RowCount - 1))

        return ProcessParsing_mergeIdenticalProcesses(to_list(delay(_arrow863)))
