...
def _arrow1518(Item: Sample) -> ProcessOutput:
    return ProcessOutput(0, Item)


def _arrow1519(Item_1: Data) -> ProcessOutput:
    return ProcessOutput(1, Item_1)


def _arrow1520(Item_2: Material) -> ProcessOutput:
    return ProcessOutput(2, Item_2)


ProcessOutput_ROCrate_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow1518, Sample_ROCrate_decoder), map(_arrow1519, Data_ROCrate_decoder), map(_arrow1520, Material_ROCrate_decoder)]))

def ProcessOutput_ISAJson_encoder(value: ProcessOutput) -> Json:
    if value.tag == 1:
...
def _arrow1522(Item: Sample) -> ProcessOutput:
    return ProcessOutput(0, Item)


def _arrow1523(Item_1: Data) -> ProcessOutput:
    return ProcessOutput(1, Item_1)


def _arrow1524(Item_2: Material) -> ProcessOutput:
    return ProcessOutput(2, Item_2)


ProcessOutput_ISAJson_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow1522, Sample_ISAJson_decoder), map(_arrow1523, Data_ISAJson_decoder), map(_arrow1524, Material_ISAJson_decoder)]))
...
def ARCtrl_Process_ProcessOutput__ProcessOutput_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ProcessOutput], str]:
    def _arrow1525(f: ProcessOutput, spaces: Any=spaces) -> str:
        value: Json = ProcessOutput_ISAJson_encoder(f)
        return to_string(default_spaces(spaces), value)

    return _arrow1525


def ARCtrl_Process_ProcessOutput__ProcessOutput_toISAJsonString_71136F3F(this: ProcessOutput, spaces: int | None=None) -> str:
    return ARCtrl_Process_ProcessOutput__ProcessOutput_toISAJsonString_Static_71136F3F(spaces)(this)
...
def ARCtrl_Process_ProcessOutput__ProcessOutput_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ProcessOutput], str]:
    def _arrow1526(f: ProcessOutput, spaces: Any=spaces) -> str:
...
__all__ = ["ProcessOutput_ROCrate_encoder", "ProcessOutput_ROCrate_decoder", "ProcessOutput_ISAJson_encoder", "ProcessOutput_ISAJson_decoder", "ARCtrl_Process_ProcessOutput__ProcessOutput_fromISAJsonString_Static_Z721C83C5", "ARCtrl_Process_ProcessOutput__ProcessOutput_toISAJsonString_Static_71136F3F", "ARCtrl_Process_ProcessOutput__ProcessOutput_toISAJsonString_71136F3F", "ARCtrl_Process_ProcessOutput__ProcessOutput_fromROCrateJsonString_Static_Z721C83C5", "ARCtrl_Process_ProcessOutput__ProcessOutput_toROCrateJsonString_Static_71136F3F", "ARCtrl_Process_ProcessOutput__ProcessOutput_toROCrateJsonString_71136F3F"]
