...
def Component_ISAJson_encoder(c: Component) -> Json:
    def chooser(tupled_arg: tuple[str, Json], c: Any=c) -> tuple[str, Json] | None:
        v: Json = tupled_arg[1]
        if equals(v, Json(3)):
            return None
    ...
    def _arrow1330(value: str, c: Any=c) -> Json:
        return Json(0, value)

    return Json(5, choose(chooser, of_array([try_include("componentName", _arrow1330, Component__get_ComponentName(c)), try_include("componentType", OntologyAnnotation_ISAJson_encoder, c.ComponentType)])))


def _arrow1332(get: IGetters) -> Component:
    name: str | None
    ...
    def _arrow1331(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("componentType", OntologyAnnotation_ISAJson_decoder)

    return Component(pattern_input_1[0], pattern_input_1[1], _arrow1331())


Component_ISAJson_decoder: Decoder_1[Component] = object(_arrow1332)
...
def ARCtrl_Process_Component__Component_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Component], str]:
    def _arrow1333(f: Component, spaces: Any=spaces) -> str:
        value: Json = Component_ISAJson_encoder(f)
...
def ARCtrl_Process_Component__Component_toISAJsonString_71136F3F(this: Component, spaces: int | None=None) -> str:
    return ARCtrl_Process_Component__Component_toISAJsonString_Static_71136F3F(spaces)(this)
...
def ARCtrl_Process_Component__Component_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Component], str]:
    def _arrow1334(f: Component, spaces: Any=spaces) -> str:
...
__all__ = ["Component_ROCrate_encoder", "Component_ROCrate_decoder", "Component_ISAJson_encoder", "Component_ISAJson_decoder", "ARCtrl_Process_Component__Component_fromISAJsonString_Static_Z721C83C5", "ARCtrl_Process_Component__Component_toISAJsonString_Static_71136F3F", "ARCtrl_Process_Component__Component_toISAJsonString_71136F3F", "ARCtrl_Process_Component__Component_fromROCrateJsonString_Static_Z721C83C5", "ARCtrl_Process_Component__Component_toROCrateJsonString_Static_71136F3F", "ARCtrl_Process_Component__Component_toROCrateJsonString_71136F3F"]
