...
def get_templates(url: str | None=None) -> Async[Array[Template]]:
    ...
    def _arrow1978(__unit: None=None, url: Any=url) -> Async[Array[Template]]:
        def _arrow1977(_arg: str) -> Async[Array[Template]]:
            map_result: Array[Template] = Templates_fromJsonString(_arg)
            return singleton.Return(map_result)

        return singleton.Bind(download_file(url_1), _arrow1977)

    return singleton.Delay(_arrow1978)
