...
def Publication_encoder(oa: Publication) -> Json:
    ...
    def _arrow1183(value: str, oa: Any=oa) -> Json:
        return Json(0, value)

    def _arrow1184(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1185(value_4: str, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1186(value_6: str, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1187(oa_1: OntologyAnnotation, oa: Any=oa) -> Json:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow1188(comment: Comment, oa: Any=oa) -> Json:
        return Comment_encoder(comment)

    return Json(5, choose(chooser, of_array([try_include("pubMedID", _arrow1183, oa.PubMedID), try_include("doi", _arrow1184, oa.DOI), try_include("authorList", _arrow1185, oa.Authors), try_include("title", _arrow1186, oa.Title), try_include("status", _arrow1187, oa.Status), try_include_seq("comments", _arrow1188, oa.Comments)])))


def _arrow1195(get: IGetters) -> Publication:
    ...
    def _arrow1193(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("status", OntologyAnnotation_decoder)

    def _arrow1194(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_decoder)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Publication(_arrow1189(), _arrow1190(), _arrow1191(), _arrow1192(), _arrow1193(), _arrow1194())


Publication_decoder: Decoder_1[Publication] = object(_arrow1195)
...
def Publication_ROCrate_encoder(oa: Publication) -> Json:
    ...
    def _arrow1198(author_list: str, oa: Any=oa) -> Json:
        return Person_ROCrate_encodeAuthorListString(author_list)

    def _arrow1199(value_6: str, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1200(oa_1: OntologyAnnotation, oa: Any=oa) -> Json:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow1201(comment: Comment, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoderDisambiguatingDescription(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Publication_ROCrate_genID(oa))), ("@type", Json(0, "Publication")), try_include("pubMedID", _arrow1196, oa.PubMedID), try_include("doi", _arrow1197, oa.DOI), try_include("authorList", _arrow1198, oa.Authors), try_include("title", _arrow1199, oa.Title), try_include("status", _arrow1200, oa.Status), try_include_seq("comments", _arrow1201, oa.Comments), ("@context", context_jsonvalue)])))


def _arrow1208(get: IGetters) -> Publication:
    ...
    def _arrow1206(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("status", OntologyAnnotation_ROCrate_decoderDefinedTerm)

    def _arrow1207(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_ROCrate_decoderDisambiguatingDescription)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Publication(_arrow1202(), _arrow1203(), _arrow1204(), _arrow1205(), _arrow1206(), _arrow1207())


Publication_ROCrate_decoder: Decoder_1[Publication] = object(_arrow1208)
...
def Publication_ISAJson_encoder(oa: Publication) -> Json:
    ...
    def _arrow1210(value: str, oa: Any=oa) -> Json:
        return Json(0, value)

    def _arrow1211(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1212(value_4: str, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1213(value_6: str, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1214(oa_1: OntologyAnnotation, oa: Any=oa) -> Json:
        return OntologyAnnotation_encoder(oa_1)

    return Json(5, choose(chooser, of_array([try_include("pubMedID", _arrow1210, oa.PubMedID), try_include("doi", _arrow1211, oa.DOI), try_include("authorList", _arrow1212, oa.Authors), try_include("title", _arrow1213, oa.Title), try_include("status", _arrow1214, oa.Status), try_include_seq("comments", Comment_ISAJson_encoder, oa.Comments)])))
...
def ARCtrl_Publication__Publication_toJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Publication], str]:
    def _arrow1215(obj: Publication, spaces: Any=spaces) -> str:
...
def ARCtrl_Publication__Publication_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Publication], str]:
    def _arrow1216(obj: Publication, spaces: Any=spaces) -> str:
...
def ARCtrl_Publication__Publication_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Publication], str]:
    def _arrow1217(obj: Publication, spaces: Any=spaces) -> str:
...
def ARCtrl_Publication__Publication_ToISAJsonString_71136F3F(this: Publication, spaces: int | None=None) -> str:
    return ARCtrl_Publication__Publication_toISAJsonString_Static_71136F3F(spaces)(this)


__all__ = ["Publication_encoder", "Publication_decoder", "Publication_ROCrate_genID", "Publication_ROCrate_encoder", "Publication_ROCrate_decoder", "Publication_ISAJson_encoder", "Publication_ISAJson_allowedFields", "Publication_ISAJson_decoder", "ARCtrl_Publication__Publication_fromJsonString_Static_Z721C83C5", "ARCtrl_Publication__Publication_toJsonString_Static_71136F3F", "ARCtrl_Publication__Publication_ToJsonString_71136F3F", "ARCtrl_Publication__Publication_fromROCrateJsonString_Static_Z721C83C5", "ARCtrl_Publication__Publication_toROCrateJsonString_Static_71136F3F", "ARCtrl_Publication__Publication_ToROCrateJsonString_71136F3F", "ARCtrl_Publication__Publication_fromISAJsonString_Static_Z721C83C5", "ARCtrl_Publication__Publication_toISAJsonString_Static_71136F3F", "ARCtrl_Publication__Publication_ToISAJsonString_71136F3F"]
