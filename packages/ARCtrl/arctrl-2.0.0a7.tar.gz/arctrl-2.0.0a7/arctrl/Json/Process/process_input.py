...
def _arrow1498(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow1499(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow1501(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow1502(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ProcessInput_ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow1498, Source_ROCrate_decoder), map(_arrow1499, Sample_ROCrate_decoder), map(_arrow1501, Data_ROCrate_decoder), map(_arrow1502, Material_ROCrate_decoder)]))
...
def _arrow1508(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow1509(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow1511(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow1513(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ProcessInput_ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow1508, Source_ISAJson_decoder), map(_arrow1509, Sample_ISAJson_decoder), map(_arrow1511, Data_ISAJson_decoder), map(_arrow1513, Material_ISAJson_decoder)]))
...
def ARCtrl_Process_ProcessInput__ProcessInput_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ProcessInput], str]:
    def _arrow1515(f: ProcessInput, spaces: Any=spaces) -> str:
...
def ARCtrl_Process_ProcessInput__ProcessInput_ToISAJsonString_71136F3F(this: ProcessInput, spaces: int | None=None) -> str:
    return ARCtrl_Process_ProcessInput__ProcessInput_toISAJsonString_Static_71136F3F(spaces)(this)


__all__ = ["ProcessInput_ROCrate_encoder", "ProcessInput_ROCrate_decoder", "ProcessInput_ISAJson_encoder", "ProcessInput_ISAJson_decoder", "ARCtrl_Process_ProcessInput__ProcessInput_fromISAJsonString_Static_Z721C83C5", "ARCtrl_Process_ProcessInput__ProcessInput_toISAJsonString_Static_71136F3F", "ARCtrl_Process_ProcessInput__ProcessInput_ToISAJsonString_71136F3F"]
