...
def Factor_ISAJson_encoder(value: Factor) -> Json:
    ...
    def _arrow1295(value_1: str, value: Any=value) -> Json:
        return Json(0, value_1)

    return Json(5, choose(chooser, of_array([try_include("factorName", _arrow1295, value.Name), try_include("factorType", OntologyAnnotation_ISAJson_encoder, value.FactorType), try_include_seq("comments", Comment_ISAJson_encoder, default_arg(value.Comments, []))])))


def _arrow1299(get: IGetters) -> Factor:
    def _arrow1296(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("factorName", string)

    def _arrow1297(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("factorType", OntologyAnnotation_ISAJson_decoder)

    def _arrow1298(__unit: None=None) -> Array[Comment] | None:
        arg_5: Decoder_1[Array[Comment]] = Decode_resizeArray(Comment_ISAJson_decoder)
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("comments", arg_5)

    return Factor(_arrow1296(), _arrow1297(), _arrow1298())


Factor_ISAJson_decoder: Decoder_1[Factor] = object(_arrow1299)
...
def ARCtrl_Process_Factor__Factor_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Factor], str]:
    def _arrow1300(f: Factor, spaces: Any=spaces) -> str:
        value: Json = Factor_ISAJson_encoder(f)
...
__all__ = ["Factor_ISAJson_encoder", "Factor_ISAJson_decoder", "ARCtrl_Process_Factor__Factor_fromISAJsonString_Static_Z721C83C5", "ARCtrl_Process_Factor__Factor_toISAJsonString_Static_71136F3F", "ARCtrl_Process_Factor__Factor_ToISAJsonString_71136F3F"]
