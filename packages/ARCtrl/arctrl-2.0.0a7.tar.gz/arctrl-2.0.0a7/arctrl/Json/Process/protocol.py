...
def Protocol_ROCrate_genID(study_name: str | None, assay_name: str | None, process_name: str | None, p: Protocol) -> str:
    ...
    if match_value is None:
        ...
        if match_value_1 is None:
            ...
            return "#Protocol_" + replace(match_value_1, " ", "_")
...
def Protocol_ROCrate_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, oa: Protocol) -> Json:
    ...
    def _arrow1346(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1347(oa_1: OntologyAnnotation, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow1348(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1349(value_6: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1350(value_8: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return Json(0, value_8)

    def _arrow1351(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> Json:
        return Comment_ROCrate_encoder(comment)

    return Json(5, choose(chooser, of_array([("@id", Json(0, Protocol_ROCrate_genID(study_name, assay_name, process_name, oa))), ("@type", list_1_1(singleton(Json(0, "Protocol")))), try_include("name", _arrow1346, oa.Name), try_include("protocolType", _arrow1347, oa.ProtocolType), try_include("description", _arrow1348, oa.Description), try_include("uri", _arrow1349, oa.Uri), try_include("version", _arrow1350, oa.Version), try_include_list_opt("components", Component_ROCrate_encoder, oa.Components), try_include_list_opt("comments", _arrow1351, oa.Comments), ("@context", context_jsonvalue)])))


def _arrow1363(get: IGetters) -> Protocol:
    def _arrow1355(__unit: None=None) -> FSharpList[Component]:
        list_4: FSharpList[Component]
        def _arrow1352(__unit: None=None) -> FSharpList[Component] | None:
            arg_1: Decoder_1[FSharpList[Component]] = list_1_2(Component_ROCrate_decoder)
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("components", arg_1)

        list_2: FSharpList[Component] = default_arg(_arrow1352(), empty())
        def _arrow1353(__unit: None=None) -> FSharpList[Component] | None:
            arg_3: Decoder_1[FSharpList[Component]] = list_1_2(Component_ROCrate_decoder)
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("reagents", arg_3)

        list_4 = append(default_arg(_arrow1353(), empty()), list_2)
        def _arrow1354(__unit: None=None) -> FSharpList[Component] | None:
        ...
        return append(default_arg(_arrow1354(), empty()), list_4)

    components: FSharpList[Component] | None = Option_fromValueWithDefault(empty(), _arrow1355())
    def _arrow1356(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("@id", Decode_uri)

    def _arrow1357(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("name", string)

    def _arrow1358(__unit: None=None) -> OntologyAnnotation | None:
    ...
    def _arrow1362(__unit: None=None) -> FSharpList[Comment] | None:
        arg_19: Decoder_1[FSharpList[Comment]] = list_1_2(Comment_ROCrate_decoder)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Protocol(_arrow1356(), _arrow1357(), _arrow1358(), _arrow1359(), _arrow1360(), _arrow1361(), None, components, _arrow1362())


Protocol_ROCrate_decoder: Decoder_1[Protocol] = object(_arrow1363)
...
def Protocol_ISAJson_encoder(oa: Protocol) -> Json:
    ...
    def _arrow1365(value: str, oa: Any=oa) -> Json:
        return Json(0, value)

    def _arrow1366(value_2: str, oa: Any=oa) -> Json:
        return Json(0, value_2)

    def _arrow1367(value_4: str, oa: Any=oa) -> Json:
        return Json(0, value_4)

    def _arrow1368(value_6: str, oa: Any=oa) -> Json:
        return Json(0, value_6)

    def _arrow1369(value_8: str, oa: Any=oa) -> Json:
        return Json(0, value_8)

    def _arrow1370(value_10: ProtocolParameter, oa: Any=oa) -> Json:
        return ProtocolParameter_ISAJson_encoder(value_10)

    def _arrow1371(c: Component, oa: Any=oa) -> Json:
        return Component_ISAJson_encoder(c)

    return Json(5, choose(chooser, of_array([try_include("@id", _arrow1365, oa.ID), try_include("name", _arrow1366, oa.Name), try_include("protocolType", OntologyAnnotation_ISAJson_encoder, oa.ProtocolType), try_include("description", _arrow1367, oa.Description), try_include("uri", _arrow1368, oa.Uri), try_include("version", _arrow1369, oa.Version), try_include_list_opt("parameters", _arrow1370, oa.Parameters), try_include_list_opt("components", _arrow1371, oa.Components), try_include_list_opt("comments", Comment_ISAJson_encoder, oa.Comments)])))


def _arrow1381(get: IGetters) -> Protocol:
    def _arrow1372(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
    ...
    def _arrow1374(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow1378(__unit: None=None) -> FSharpList[ProtocolParameter] | None:
    ...
    def _arrow1379(__unit: None=None) -> FSharpList[Component] | None:
        arg_15: Decoder_1[FSharpList[Component]] = list_1_2(Component_ISAJson_decoder)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("components", arg_15)

    def _arrow1380(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(Comment_ISAJson_decoder)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Protocol(_arrow1372(), _arrow1373(), _arrow1374(), _arrow1375(), _arrow1376(), _arrow1377(), _arrow1378(), _arrow1379(), _arrow1380())


Protocol_ISAJson_decoder: Decoder_1[Protocol] = object(_arrow1381)
...
def ARCtrl_Process_Protocol__Protocol_toISAJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Protocol], str]:
    def _arrow1382(f: Protocol, spaces: Any=spaces) -> str:
...
def ARCtrl_Process_Protocol__Protocol_ToISAJsonString_71136F3F(this: Protocol, spaces: int | None=None) -> str:
    return ARCtrl_Process_Protocol__Protocol_toISAJsonString_Static_71136F3F(spaces)(this)
...
def ARCtrl_Process_Protocol__Protocol_toROCrateString_Static_Z482224B9(study_name: str | None=None, assay_name: str | None=None, process_name: str | None=None, spaces: int | None=None) -> Callable[[Protocol], str]:
    def _arrow1383(f: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, spaces: Any=spaces) -> str:
