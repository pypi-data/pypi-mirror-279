...
from ...fable_modules.fable_library.array_ import (map as map_1, iterate_indexed, iterate as iterate_1, sort_descending, initialize, map_indexed, indexed, sort_by)
...
from ...fable_modules.fable_library.seq import (to_array, delay, map, remove_at, collect, singleton, empty, try_find_index, length, filter, choose, indexed as indexed_1, to_list, append as append_1, fold, item)
...
from ...fable_modules.fable_library.util import (ignore, equal_arrays, array_hash, IEnumerable_1, equals, compare_primitives, safe_hash, compare_arrays)
from ..Helper.hash_codes import (box_hash_array, box_hash_seq)
from ..ontology_annotation import OntologyAnnotation
from .arc_table_aux import (SanityChecks_validate, get_column_count, get_row_count, Unchecked_tryGetCellAt, SanityChecks_validateColumnIndex, SanityChecks_validateRowIndex, SanityChecks_validateColumn, Unchecked_setCellAt, try_find_duplicate_unique, Unchecked_addColumn, Unchecked_fillMissingCells, Unchecked_removeHeader, Unchecked_removeColumnCells, try_find_duplicate_unique_in_array, Unchecked_removeColumnCells_withIndexChange, Unchecked_moveColumnTo, Unchecked_getEmptyCellForHeader, Unchecked_addRow, Unchecked_addRows, Unchecked_removeRowCells_withIndexChange, Unchecked_extendToRowCount, Unchecked_alignByHeaders, box_hash_values)
...
class ArcTable:
    ...
    def init(name: str) -> ArcTable:
        ...
        return ArcTable(name, [], Dictionary([], ObjectExpr471()))
    ...
    def create_from_headers(name: str, headers: Array[CompositeHeader]) -> ArcTable:
        ...
        return ArcTable.create(name, headers, Dictionary([], ObjectExpr475()))
    ...
    def validate(raise_exception: bool | None=None) -> Callable[[ArcTable], bool]:
        def _arrow480(table: ArcTable) -> bool:
    ...
    def Columns(self, __unit: None=None) -> Array[CompositeColumn]:
        this: ArcTable = self
        def _arrow484(__unit: None=None) -> IEnumerable_1[CompositeColumn]:
            def _arrow483(i: int) -> CompositeColumn:
                return this.GetColumn(i)

            return map(_arrow483, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow484))
    ...
    def Copy(self, __unit: None=None) -> ArcTable:
        ...
        return ArcTable.create(this.Name, list(this.Headers), Dictionary(this.Values, ObjectExpr485()))
    ...
    def try_get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell | None]:
        def _arrow486(table: ArcTable) -> CompositeCell | None:
    ...
    def iter_columns(action: Callable[[CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow487(table: ArcTable) -> ArcTable:
    ...
    def iteri_columns(action: Callable[[int, CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow488(table: ArcTable) -> ArcTable:
            copy: ArcTable = table.Copy()
    ...
    def update_cell_at(column_index: int, row_index: int, cell: CompositeCell) -> Callable[[ArcTable], ArcTable]:
        def _arrow489(table: ArcTable) -> ArcTable:
    ...
    def update_header(index: int, header: CompositeHeader) -> Callable[[ArcTable], ArcTable]:
        def _arrow490(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def add_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None, index: int | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow492(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def update_column(column_index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow495(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def insert_column(index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow496(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def append_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow498(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def add_columns(columns: Array[CompositeColumn], index: int | None=None, skip_fill_missing: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow501(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def remove_column(index: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow502(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveColumns(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow503(index: int) -> None:
            SanityChecks_validateColumnIndex(index, this.ColumnCount, False)

        iterate_1(_arrow503, index_arr)
        def _arrow504(index_1: int) -> None:
        ...
        iterate_1(_arrow504, sort_descending(index_arr, ObjectExpr505()))

    @staticmethod
    def remove_columns(index_arr: Array[int]) -> Callable[[ArcTable], ArcTable]:
        def _arrow506(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def GetColumn(self, column_index: int) -> CompositeColumn:
        ...
        def _arrow508(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow507(i: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow507, range_big_int(0, 1, this.RowCount - 1))

        cells: Array[CompositeCell] = to_array(delay(_arrow508))
        return CompositeColumn.create(h, cells)

    @staticmethod
    def get_column(index: int) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow510(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow511(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow516(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow517(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow518(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow519(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow520(table: ArcTable) -> CompositeColumn:
    ...
    def move_column(start_col: int, end_col: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow522(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddRow(self, cells: Array[CompositeCell] | None=None, index: int | None=None) -> None:
        ...
        def _arrow525(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow524(column_index: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow524, range_big_int(0, 1, this.ColumnCount - 1))

        cells_1: Array[CompositeCell] = to_array(delay(_arrow525)) if (cells is None) else value_3(cells)
    ...
    def append_row(cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow528(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def add_rows(rows: Array[Array[CompositeCell]], index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow530(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddRowsEmpty(self, row_count: int, index: int | None=None) -> None:
        this: ArcTable = self
        def _arrow532(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow531(column_index: int) -> IEnumerable_1[CompositeCell]:
                return singleton(Unchecked_getEmptyCellForHeader(this.Headers[column_index], Unchecked_tryGetCellAt(column_index, 0, this.Values)))

            return collect(_arrow531, range_big_int(0, 1, this.ColumnCount - 1))

        row: Array[CompositeCell] = to_array(delay(_arrow532))
        def _arrow533(_arg: int) -> Array[CompositeCell]:
            return row

        rows: Array[Array[CompositeCell]] = initialize(row_count, _arrow533, None)
        this.AddRows(rows, index)

    @staticmethod
    def add_rows_empty(row_count: int, index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow534(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def remove_row(index: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow535(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveRows(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow536(index: int) -> None:
            SanityChecks_validateRowIndex(index, this.RowCount, False)

        iterate_1(_arrow536, index_arr)
        def _arrow537(index_1: int) -> None:
        ...
        iterate_1(_arrow537, sort_descending(index_arr, ObjectExpr538()))
    ...
    def GetRow(self, row_index: int, SkipValidation: bool | None=None) -> Array[CompositeCell]:
        ...
        def _arrow541(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow540(column_index: int) -> CompositeCell:
                return value_3(this.TryGetCellAt(column_index, row_index))

            return map(_arrow540, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow541))

    @staticmethod
    def get_row(index: int) -> Callable[[ArcTable], Array[CompositeCell]]:
        def _arrow542(table: ArcTable) -> Array[CompositeCell]:
    ...
    def join(table: ArcTable, index: int | None=None, join_options: str | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow543(this: ArcTable) -> ArcTable:
    ...
    def SplitByColumnValues(column_index: int) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow545(table: ArcTable) -> Array[ArcTable]:
            ...
            return map_indexed(mapping_3, map_1(mapping_1, Array_groupBy(projection, indexed(table.GetColumn(column_index).Cells), ObjectExpr544()), None), None)

        return _arrow545

    @staticmethod
    def SplitByColumnValuesByHeader(header: CompositeHeader) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow546(table: ArcTable) -> Array[ArcTable]:
            def predicate(x: CompositeHeader) -> bool:
                return equals(x, header)
    ...
    def SplitByProtocolREF() -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow547(table: ArcTable) -> Array[ArcTable]:
    ...
    def append(table1: ArcTable, table2: ArcTable) -> ArcTable:
        def get_list(t: ArcTable) -> FSharpList[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
            def _arrow551(__unit: None=None, t: Any=t) -> IEnumerable_1[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
                def _arrow550(row: int) -> FSharpList[tuple[CompositeHeader, CompositeCell]]:
                    def _arrow549(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        def _arrow548(col: int) -> tuple[CompositeHeader, CompositeCell]:
                            return (t.Headers[col], get_item_from_dict(t.Values, (col, row)))

                        return map(_arrow548, range_big_int(0, 1, t.ColumnCount - 1))

                    return to_list(delay(_arrow549))

                return map(_arrow550, range_big_int(0, 1, t.RowCount - 1))

            return to_list(delay(_arrow551))
    ...
    def __str__(self, __unit: None=None) -> str:
        ...
        def _arrow560(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow559(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow558(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow557(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow552(row_i: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i)))

                        def _arrow555(__unit: None=None) -> IEnumerable_1[str]:
                            def _arrow554(__unit: None=None) -> IEnumerable_1[str]:
                                def _arrow553(row_i_1: int) -> str:
                                    return join("\t|\t", map(to_string, this.GetRow(row_i_1)))

                                return map(_arrow553, range_big_int(row_count - 20, 1, row_count - 1))

                            return append_1(singleton("..."), delay(_arrow554))

                        def _arrow556(row_i_2: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i_2)))

                        return append_1(map(_arrow552, range_big_int(0, 1, 19)), delay(_arrow555)) if (row_count > 50) else (singleton("No rows") if (row_count == 0) else map(_arrow556, range_big_int(0, 1, row_count - 1)))

                    return append_1(singleton(join("\t|\t", map(to_string, this.Headers))), delay(_arrow557))

                return append_1(singleton("-------------"), delay(_arrow558))

            return append_1(singleton(("Table: " + this.Name) + ""), delay(_arrow559))

        return join("\n", to_list(delay(_arrow560)))
    ...
    def StructurallyEquals(self, other: ArcTable) -> bool:
        ...
        def sort(arg: Any) -> Array[Any]:
            ...
            return sort_by(projection, list(arg), ObjectExpr561())

        def _arrow564(__unit: None=None) -> bool:
            ...
            def _arrow563(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow562(i: int) -> bool:
                    return equals(item(i, a), item(i, b))

                return map(_arrow562, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow563))) if (length(a) == length(b)) else False

        if _arrow564() if (this.Name == other.Name) else False:
            ...
            def _arrow566(__unit: None=None) -> IEnumerable_1[bool]:
                ...
                return map(_arrow565, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow566))) if (length(a_1) == length(b_1)) else False
