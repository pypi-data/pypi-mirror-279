...
class Transcribe:
    ...
    def transcribe_process(self, upload_id: UUID, language_code: Optional[str] = None, webhook: Optional[str] = None):
        """
    ...
    def transcribe(self, file_path: str, language_code: Optional[str] = None, webhook: Optional[str] = None):
        """
        ...
        if upload_id:
            return upload_id, self.transcribe_process(upload_id, language_code, webhook)
        else:
