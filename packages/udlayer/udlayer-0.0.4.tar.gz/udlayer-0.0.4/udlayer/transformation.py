...
from UDLayer.gridlayer import GridLayer
from UDLayer.graphlayer import GraphLayer
from UDLayer.pointlayer import PointLayer
from UDLayer.linestringlayer import LinestringLayer
from UDLayer.polygonlayer import PolygonLayer
import json
import pandas as pd
...
def tif_to_grid(
    ...
    def dataset_to_griddata(
        ...
        lat_count, lon_count = (
            round((end_lat - start_lat) / step_lat),
            round((end_lon - start_lon) / step_lon),
        )
        if mode == "rand":
