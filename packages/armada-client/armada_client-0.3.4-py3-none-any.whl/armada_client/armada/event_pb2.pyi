...
class EventMessage(google.protobuf.message.Message):
    ...
    UNABLE_TO_SCHEDULE_FIELD_NUMBER: builtins.int
    ...
    @property
    def unable_to_schedule(self) -> global___JobUnableToScheduleEvent: ...
    @property
    ...
    @property
    def terminated(self) -> global___JobTerminatedEvent: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        unable_to_schedule: global___JobUnableToScheduleEvent | None = ...,
    ...
    def HasField(self, field_name: typing.Literal["cancelled", b"cancelled", "cancelling", b"cancelling", "events", b"events", "failed", b"failed", "ingress_info", b"ingress_info", "lease_expired", b"lease_expired", "lease_returned", b"lease_returned", "leased", b"leased", "pending", b"pending", "preempted", b"preempted", "preempting", b"preempting", "queued", b"queued", "reprioritized", b"reprioritized", "reprioritizing", b"reprioritizing", "running", b"running", "submitted", b"submitted", "succeeded", b"succeeded", "terminated", b"terminated", "unable_to_schedule", b"unable_to_schedule", "utilisation", b"utilisation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cancelled", b"cancelled", "cancelling", b"cancelling", "events", b"events", "failed", b"failed", "ingress_info", b"ingress_info", "lease_expired", b"lease_expired", "lease_returned", b"lease_returned", "leased", b"leased", "pending", b"pending", "preempted", b"preempted", "preempting", b"preempting", "queued", b"queued", "reprioritized", b"reprioritized", "reprioritizing", b"reprioritizing", "running", b"running", "submitted", b"submitted", "succeeded", b"succeeded", "terminated", b"terminated", "unable_to_schedule", b"unable_to_schedule", "utilisation", b"utilisation"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["events", b"events"]) -> typing.Literal["submitted", "queued", "leased", "lease_returned", "lease_expired", "pending", "running", "unable_to_schedule", "failed", "succeeded", "reprioritized", "cancelling", "cancelled", "terminated", "utilisation", "ingress_info", "reprioritizing", "preempted", "preempting"] | None: ...
