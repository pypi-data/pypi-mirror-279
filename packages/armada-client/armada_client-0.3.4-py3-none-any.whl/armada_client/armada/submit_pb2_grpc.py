...
class QueueService(object):
    ...
    def CreateQueue(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.QueueService/CreateQueue',
    ...
    def CreateQueues(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.QueueService/CreateQueues',
    ...
    def UpdateQueue(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.QueueService/UpdateQueue',
            armada_dot_submit__pb2.Queue.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdateQueues(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.QueueService/UpdateQueues',
            armada_dot_submit__pb2.QueueList.SerializeToString,
    ...
    def DeleteQueue(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.QueueService/DeleteQueue',
    ...
    def GetQueue(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.QueueService/GetQueue',
    ...
    def GetQueues(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/api.QueueService/GetQueues',
...
class Submit(object):
    ...
    def PreemptJobs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.Submit/PreemptJobs',
