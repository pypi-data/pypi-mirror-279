...
This is unavailable for category axis. Timestamp should be passed for [type](#zAxis3D.type): 'time' axis. Logged value should be passed for [type](#zAxis3D.type): 'log' axis.""").tag(sync=True)
