...
This is unavailable for category axis. Timestamp should be passed for [type](#yAxis.type): 'time' axis. Logged value should be passed for [type](#yAxis.type): 'log' axis.""").tag(sync=True)
