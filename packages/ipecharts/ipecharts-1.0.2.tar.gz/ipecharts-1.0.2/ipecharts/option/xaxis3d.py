...
This is unavailable for category axis. Timestamp should be passed for [type](#xAxis3D.type): 'time' axis. Logged value should be passed for [type](#xAxis3D.type): 'log' axis.""").tag(sync=True)
