...
**sample:** 
    ...
    _model_name = Unicode("FunnelModel").tag(sync=True)
    
    type = Unicode("funnel", allow_none=True, ).tag(sync=True)
...
* `'data'`: assigns colors in the palette according to data items, with each data item using a different color.""").tag(sync=True)
    ...
    min = Float(None, allow_none=True, help="""The specified minimum value.""").tag(sync=True)
    
    max = Float(None, allow_none=True, help="""The specified maximum value.""").tag(sync=True)
    
    minSize = Union([Float(default_value=None, allow_none=True),Unicode(default_value=None, allow_none=True),], default_value=None, allow_none=True, help="""The mapped width from minimum data value [min](#series-funnel.min).


It can be absolute pixel and also the percentage of [layout width](#series-funnel.width). If you don't want the graph of minimum value to be a triangle, you can set up this property larger than 0.""").tag(sync=True)
    
    maxSize = Union([Float(default_value=None, allow_none=True),Unicode(default_value=None, allow_none=True),], default_value=None, allow_none=True, help="""The mapped width from maximum data value [max](#series-funnel.max).


It can be absolute pixel and also the percentage of [layout width](#series-funnel.width).""").tag(sync=True)
    
    orient = Unicode(None, allow_none=True, help="""Orient of funnel，Can be `'vertical'` or `'horizontal'`.



> Since `v4.9.0`""").tag(sync=True)
    
    sort = Union([Unicode(default_value=None, allow_none=True),Any(default_value=None, allow_none=True),], default_value=None, allow_none=True, help="""Data sorting, which can be whether `'ascending'`, `'descending'`, `'none'`(in data order) or a function, which is the same as `Array.prototype.sort(function (a, b) { ... })`;""").tag(sync=True)
    
    gap = Float(None, allow_none=True, help="""Gap between each trapezoid.""").tag(sync=True)
    ...
    funnelAlign = Unicode(None, allow_none=True, help="""Horizontal align. Defaults to align center. Can be 'left', 'right', 'center'.""").tag(sync=True)
    
    label = Dict(default_value=None, allow_none=True, help="""Text label of funnel chart, to explain some data information about graphic item like value, name and so on. `label` is placed under `itemStyle` in ECharts 2.x. In ECharts 3, to make the configuration structure flatter, `label`is taken to be at the same level with `itemStyle`, and has `emphasis` as `itemStyle` does.""").tag(sync=True)
    
    labelLine = Dict(default_value=None, allow_none=True, help="""The visual guide line style of label. When [label position](#series-funnel.label.position) is set as `'left'`or`'right'`, the visual guide line will show.""").tag(sync=True)
...
Configurations of blur state. Available when [emphasis.focus](#series-funnel.emphasis.focus) is set.""").tag(sync=True)
    
    select = Dict(default_value=None, allow_none=True, help="""> Since `v5.0.0`


Configurations of select state. Available when [selectedMode](#series-funnel.selectedMode) is set.""").tag(sync=True)
...
`z` has a lower priority to `zlevel`, and will not create new Canvas.""").tag(sync=True)
    ...
    left = Union([Unicode(default_value=None, allow_none=True),Float(default_value=None, allow_none=True),], default_value=None, allow_none=True, help="""Distance between Funnel component and the left side of the container.
...
If the `left` value is set to be `'left'`, `'center'`, or `'right'`, then the component will be aligned automatically based on position.""").tag(sync=True)
    ...
    top = Union([Unicode(default_value=None, allow_none=True),Float(default_value=None, allow_none=True),], default_value=None, allow_none=True, help="""Distance between Funnel component and the top side of the container.
...
If the `top` value is set to be `'top'`, `'middle'`, or `'bottom'`, then the component will be aligned automatically based on position.""").tag(sync=True)
    ...
    right = Union([Unicode(default_value=None, allow_none=True),Float(default_value=None, allow_none=True),], default_value=None, allow_none=True, help="""Distance between Funnel component and the right side of the container.


`right` can be a pixel value like `20`; it can also be a percentage value relative to container width like `'20%'`.""").tag(sync=True)
    
    bottom = Union([Unicode(default_value=None, allow_none=True),Float(default_value=None, allow_none=True),], default_value=None, allow_none=True, help="""Distance between Funnel component and the bottom side of the container.


`bottom` can be a pixel value like `20`; it can also be a percentage value relative to container width like `'20%'`.""").tag(sync=True)
    
    width = Union([Unicode(default_value=None, allow_none=True),Float(default_value=None, allow_none=True),], default_value=None, allow_none=True, help="""Width of Funnel component. Adaptive by default.""").tag(sync=True)
    
    height = Union([Unicode(default_value=None, allow_none=True),Float(default_value=None, allow_none=True),], default_value=None, allow_none=True, help="""Height of Funnel component. Adaptive by default.""").tag(sync=True)
