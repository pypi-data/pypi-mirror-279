...
This is unavailable for category axis. Timestamp should be passed for [type](#radiusAxis.type): 'time' axis. Logged value should be passed for [type](#radiusAxis.type): 'log' axis.""").tag(sync=True)
