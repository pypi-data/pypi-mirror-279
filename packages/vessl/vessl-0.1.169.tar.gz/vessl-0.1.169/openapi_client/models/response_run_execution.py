...
class ResponseRunExecution(object):
    ...
    def status(self, status):
        ...
        :type status: str
        """
        allowed_values = ["queued", "pending", "running", "idle", "stopping", "failed", "completed", "terminated"]  # noqa: E501
