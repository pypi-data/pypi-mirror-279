...
def add_wifi_connection(ssid, password, connection_name, priority=1):
...
def set_wifi_priority(ssid, priority):
...
def back_up_connections(backup_file_path):
...
def restore_connections(backup_file_path):
