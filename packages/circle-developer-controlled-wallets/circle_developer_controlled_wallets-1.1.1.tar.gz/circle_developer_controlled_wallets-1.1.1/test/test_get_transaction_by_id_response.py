...
from circle.web3.developer_controlled_wallets.models.get_transaction_by_id_response import GetTransactionByIDResponse  # noqa: E501
from circle.web3.developer_controlled_wallets.rest import ApiException

class TestGetTransactionByIDResponse(unittest.TestCase):
    """GetTransactionByIDResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GetTransactionByIDResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTransactionByIDResponse`
        """
        model = circle.web3.developer_controlled_wallets.models.get_transaction_by_id_response.GetTransactionByIDResponse()  # noqa: E501
        if include_optional :
            return GetTransactionByIDResponse(
                transaction = circle.web3.developer_controlled_wallets.models.transaction.Transaction(
    ...
    def testGetTransactionByIDResponse(self):
        """Test GetTransactionByIDResponse"""
