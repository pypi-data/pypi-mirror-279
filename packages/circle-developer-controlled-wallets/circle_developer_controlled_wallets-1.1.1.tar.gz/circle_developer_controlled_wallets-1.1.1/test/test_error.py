...
from circle.web3.developer_controlled_wallets.models.error import Error  # noqa: E501
...
class TestError(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = circle.web3.developer_controlled_wallets.models.error.Error()  # noqa: E501
        if include_optional :
            return Error(
                code = 56, 
                message = ''
