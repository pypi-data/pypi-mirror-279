...
from circle.web3.developer_controlled_wallets.models.sca_wallet import SCAWallet  # noqa: E501
from circle.web3.developer_controlled_wallets.rest import ApiException

class TestSCAWallet(unittest.TestCase):
    """SCAWallet unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `SCAWallet`
        """
        model = circle.web3.developer_controlled_wallets.models.sca_wallet.SCAWallet()  # noqa: E501
        if include_optional :
            return SCAWallet(
