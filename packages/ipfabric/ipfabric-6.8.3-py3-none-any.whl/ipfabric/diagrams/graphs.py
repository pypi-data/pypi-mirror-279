...
class Diagram(BaseModel):
    ...
    def diagram_json(  # TODO: remove 6.9
        self,
        parameters: Union[Unicast, Multicast, Host2GW, Network],
        snapshot_id: str = None,
        overlay: Overlay = None,
    ...
    def diagram_svg(  # TODO: remove 6.9
        self,
        parameters: Union[Unicast, Multicast, Host2GW, Network],
        snapshot_id: str = None,
        overlay: Overlay = None,
    ...
    def diagram_png(  # TODO: remove 6.9
        self,
        parameters: Union[Unicast, Multicast, Host2GW, Network],
        snapshot_id: str = None,
        overlay: Overlay = None,
    ...
    def diagram_model(  # TODO: remove 6.9
        self,
        parameters: Union[Unicast, Multicast, Host2GW, Network],
        snapshot_id: str = None,
        overlay: Overlay = None,
...
class IPFDiagram(Diagram):  # TODO: remove 6.9
    def __init__(self, ipf=None, **kwargs):
        ...
        if ipf:
            super().__init__(ipf=ipf)
        else:
            kwargs["timeout"] = kwargs.get("timeout", 15)
            super().__init__(ipf=IPFabricAPI(**kwargs))
