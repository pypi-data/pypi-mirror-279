...
def _chainlet_logs_url(chain_id: str, chain_deployment_id: str, chainlet_id: str) -> str:
    pass
...
class RemoteChainService:
    ...
    def __init__(self, chain_id: str, chain_deployment_id: str, remote: b10_remote.BasetenRemote) -> None:
        self._remote = remote
    ...
    def get_info(self) -> list[tuple[str, str, str]]:
        ...
        chainlets = self._remote.get_chainlets(chain_deployment_id=self._chain_deployment_id)

        return [
            (chainlet["name"], chainlet["oracle_version"]["current_model_deployment_status"]["status"], _chainlet_logs_url(self._chain_id, self._chain_deployment_id, chainlet["id"]))
...
class ChainService:
    ...
    def set_remote_chain_service(self, chain_id: str, chain_deployment_id: str, remote: b10_remote.BasetenRemote) -> None:
        self._remote_chain_service = RemoteChainService(chain_id, chain_deployment_id, remote)
    ...
    def get_info(self) -> list[tuple[str, str, str]]:
        self._remote_chain_service.get_info()
...
def deploy_remotely(
    ...
    if isinstance(options, definitions.DeploymentOptionsBaseten):
        ...
        chain_service.set_remote_chain_service(chain_id, chain_deployment_id, options.remote_provider.api)
