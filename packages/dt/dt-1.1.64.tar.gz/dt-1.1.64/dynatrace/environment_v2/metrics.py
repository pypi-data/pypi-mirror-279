...
class MetricService:
    ...
    def get_units(self, unit_selector: Optional[str] = None, fields: Optional[str] = None) -> PaginatedList["Unit"]:
        response = self.__http_client.make_request(f"/api/v2/units").json()
        params = {
            "unitSelector": unit_selector,
            "fields": fields
        }
        return PaginatedList(Unit, self.__http_client, "/api/v2/units", params, list_item="units")
...
class UnitEnum(Enum):
    ...
    GIBIBIT = "GibiBit"
    GIBIBITPERHOUR = "GibiBitPerHour"
    GIBIBITPERMINUTE = "GibiBitPerMinute"
    GIBIBITPERSECOND = "GibiBitPerSecond"
    GIBIBYTE = "GibiByte"
    GIBIBYTEPERHOUR = "GibiBytePerHour"
    GIBIBYTEPERMINUTE = "GibiBytePerMinute"
    GIBIBYTEPERSECOND = "GibiBytePerSecond"
    GIGABIT = "GigaBit"
    GIGABITPERHOUR = "GigaBitPerHour"
    GIGABITPERMINUTE = "GigaBitPerMinute"
    GIGABITPERSECOND = "GigaBitPerSecond"
    GIGABYTE = "GigaByte"
    GIGABYTEPERHOUR = "GigaBytePerHour"
    GIGABYTEPERMINUTE = "GigaBytePerMinute"
    ...
    KELVIN = "Kelvin"
    KIBIBIT = "KibiBit"
    KIBIBITPERHOUR = "KibiBitPerHour"
    KIBIBITPERMINUTE = "KibiBitPerMinute"
    ...
    KILOBIT = "KiloBit"
    KILOBITPERHOUR = "KiloBitPerHour"
    KILOBITPERMINUTE = "KiloBitPerMinute"
    ...
    LITRE = "Litre"
    MEBIBIT = "MebiBit"
    MEBIBITPERHOUR = "MebiBitPerHour"
    MEBIBITPERMINUTE = "MebiBitPerMinute"
    ...
    MEGABIT = "MegaBit"
    MEGABITPERHOUR = "MegaBitPerHour"
    MEGABITPERMINUTE = "MegaBitPerMinute"
...
class MetricDescriptor(DynatraceObject):
    def _create_from_raw_data(self, raw_element):
        ...
        self.unit: Optional[UnitEnum] = UnitEnum(raw_element.get("unit"))
        self.warnings: Optional[List[str]] = raw_element.get("warnings")
...
class Unit(DynatraceObject):
    def _create_from_raw_data(self, raw_element):
        self.description: str = raw_element.get("description")
        self.display_name: str = raw_element.get("displayName")
        self.display_name_plural: str = raw_element.get("displayNamePlural")
        self.symbol: str = raw_element.get("symbol")
        self.unit_id: str = raw_element.get("unitId")