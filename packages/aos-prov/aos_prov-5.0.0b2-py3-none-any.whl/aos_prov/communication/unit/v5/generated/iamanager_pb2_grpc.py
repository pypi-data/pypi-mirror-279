...
from iamanager.v5 import iamanager_pb2 as iamanager_dot_v5_dot_iamanager__pb2
...
class IAMPublicServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAPIVersion = channel.unary_unary(
                '/iamanager.v5.IAMPublicService/GetAPIVersion',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=iamanager_dot_v5_dot_iamanager__pb2.APIVersion.FromString,
                )
...
def add_IAMPublicServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetAPIVersion': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=iamanager_dot_v5_dot_iamanager__pb2.APIVersion.SerializeToString,
            ),
...
class IAMPublicService(object):
    ...
    def GetAPIVersion(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iamanager.v5.IAMPublicService/GetAPIVersion',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            iamanager_dot_v5_dot_iamanager__pb2.APIVersion.FromString,
