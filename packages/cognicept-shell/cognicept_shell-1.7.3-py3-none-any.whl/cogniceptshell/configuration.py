...
class Configuration:
    ...
    def get_robot_config(object):
        ...
        # TODO: remove hardcoded value once bug with cognicept init overwriting COGNICEPT_API_URI with V1 API is fixed
        agent_api = "https://dev.cognicept.systems/api/agent/v2/"
    ...
    def update_robot_config(object):
        ...
        if config:
            ...
            print(bcolors.FAIL + "No config recieved from agent API, will not update runtime" + bcolors.ENDC)
            raise SystemExit()