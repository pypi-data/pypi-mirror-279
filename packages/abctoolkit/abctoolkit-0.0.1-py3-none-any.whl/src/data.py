...
import json
import re
from utils import (find_all_abc, remove_information_field, remove_bar_no_annotations, Quote_re, Barlines,
                   strip_empty_bars)
from convert import unidecode_abc_lines
from rotate import rotate_abc
...
def abc_processing_pipeline(ori_folder, des_folder):
    ...
    for abc_path in find_all_abc(ori_folder):
        ...
        des_path = os.path.join(ori_folder, os.path.split(abc_path)[-1])
