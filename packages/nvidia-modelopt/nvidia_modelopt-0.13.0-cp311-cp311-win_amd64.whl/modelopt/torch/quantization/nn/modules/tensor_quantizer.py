...
from modelopt.torch.quantization.qtensor import BaseQuantizedTensor, INT4QTensor, NF4QTensor
...
class TensorQuantizer(nn.Module):
    ...
    def __init__(
        ...
        self._dynamic = quant_desc.dynamic
    ...
    def set_from_attribute_dict(self, attribute_dict: Dict[str, Any]):
        ...
        if "type" in attribute_dict:
            if attribute_dict["type"] == "dynamic":
                assert not self._learn_amax
                self._dynamic = True
