...
def get_max_batch_size(model: torch.nn.Module, max_sample_length: int = 512):
    ...
    mem_diff_per_data_batch = max(
        (free_mem_before - free_mem_after), (max_allocated_after - max_allocated_before)
    )
