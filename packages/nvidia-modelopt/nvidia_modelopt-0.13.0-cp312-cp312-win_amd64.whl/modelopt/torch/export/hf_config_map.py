...
HF_CONFIG_MAP = [
    (["n_head", "num_attention_heads", "n_heads"], "num_attention_heads"),
    (
        [
            "num_key_value_heads",
            "num_kv_heads",
    ...
    (["n_positions", "max_position_embeddings"], "max_position_embeddings"),
    ...
    (["blocksparse_vertical_stride"], "blocksparse_vertical_stride"),  # Phi3-small
    (["dense_attention_every_n_layers"], "dense_attention_every_n_layers"),  # Phi3-small
    (["gegelu_limit"], "gegelu_limit"),  # Phi3-small
    (["num_local_experts"], "moe_num_experts"),  # Mixture of Experts
    (["num_experts_per_tok"], "moe_top_k"),  # Mixture of Experts
