...
# === START plot ===
def plot(y=None, x=None, yerr=None, xerr=None, type=None, xlabel='x', ylabel='y', label=None, marker=None, linestyle=None, linewidth=None, aspect=None, normalised_coords=False,
    ...
    ax = plt.gca()
    if normalised_coords: # set transform to accept normalised coordinates
...
def plot_map(image=None, xedges=None, yedges=None, dims=None, vmin=None, vmax=None, log=False, colorbar=True, cmap='magma', cmap_label=None,
             xlabel=None, ylabel=None, xlog=False, ylog=False, xlim=None, ylim=None, axes_format=[None,None], aspect='auto',
