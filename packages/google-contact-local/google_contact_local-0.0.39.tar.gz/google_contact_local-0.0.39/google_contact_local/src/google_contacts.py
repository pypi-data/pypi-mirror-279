...
# TODO As we don't have google_contact_table can we avoid inheriting GenericCRUD? Let's use designated Python Classes for almost each table and inherit GenericCrud there.
class GoogleContacts(GenericCRUD, metaclass=MetaLogger,
    ...
    def __init__(self):
        ...
        self.instances_names = ['contacts_local', 'organization_profile', 'contact_persons', 'contact_user_external',
                                'contact_profiles', 'contact_group', 'contact_email_addresses', 'contact_phones',
                                'contact_location', 'user_externals_local', 'organizations_local', 'domain', 'importer']
    ...
    # TODO Please move this method to google-account authenticate repo as it is relevant also to Google Calendar. How complicated is it to move the Google Authentication functions to https://github.com/circles-zone/google-account-local-python-package ?
            ...
            if self.creds and self.creds.expired and self.creds.refresh_token:
                ...
                if not self.creds and refresh_token:
                    ...
                    try:
                        ...
                        self.logger.exception("google-contact-local Google Refresh token failed.", object={"exception": exception})
    ...
    def __insert_link_contact_domains(self, contact_dict: dict) -> list[dict]:
        ...
        while website_url:
            if DomainLocal.is_domain(website_url):
                ...
                url_insert_information = self.domain.link_contact_to_url(contact_id=contact_id,
