...
class InviteUsersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_invite_endpoint = _Endpoint(
            settings={
                'response_type': (DeleteResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/tenantservice/v1/users/invites/{id}',
    ...
    def delete_invite(
        ...
        **kwargs
        ...
        """Delete the invited user  # noqa: E501

        Permanently deletes the invited user. Supply the unique id that was returned when you created the invited user and this will delete it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_invite(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.delete_invite_endpoint.call_with_http_info(**kwargs)
