...
class AdminDateWidget(forms.DateInput):
    ...
    @property
    def media(self):
        return vendor('datepicker.js', 'datepicker.css', 'fluke.widget.datetime.js')
...
class AdminTimeWidget(forms.TimeInput):
    ...
    @property
    def media(self):
        return vendor('datepicker.js', 'clockpicker.js', 'clockpicker.css', 'fluke.widget.datetime.js')
...
class AdminSelectWidget(forms.Select):
    ...
    @property
    def media(self):
        return vendor('select.js', 'select.css', 'fluke.widget.select.js')
