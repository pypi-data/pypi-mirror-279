...
from fluke.util import vendor, DJANGO_11
from fluke.views import BaseAdminPlugin, ModelFormAdminView
...
class SelectMultipleTransfer(forms.SelectMultiple):
    ...
    @property
    def media(self):
        return vendor('fluke.widget.select-transfer.js', 'fluke.widget.select-transfer.css')
    ...
    def render(self, name, value, attrs=None, choices=()):
        ...
        return mark_safe(loader.render_to_string('fluke/forms/transfer.html', context))
...
class SelectMultipleDropdown(forms.SelectMultiple):
    ...
    @property
    def media(self):
        return vendor('multiselect.js', 'multiselect.css', 'fluke.widget.multiselect.js')
...
fluke.site.register_plugin(M2MSelectPlugin, ModelFormAdminView)
