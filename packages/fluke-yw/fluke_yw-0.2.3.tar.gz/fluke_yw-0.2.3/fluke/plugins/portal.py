...
from fluke.views import BaseAdminPlugin, ModelFormAdminView, DetailAdminView
from fluke.layout import Fieldset, Column
...
class BasePortalPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        return media + self.vendor('fluke.plugin.portal.js')
