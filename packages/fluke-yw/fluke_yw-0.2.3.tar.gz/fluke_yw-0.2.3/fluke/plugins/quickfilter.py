...
from fluke.filters import manager,MultiSelectFieldListFilter
from fluke.plugins.filters import *
...
class QuickFilterMultiSelectFieldListFilter(MultiSelectFieldListFilter):
    ...
    """
    template = 'fluke/filters/quickfilter.html'
...
class QuickFilterPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        return media + self.vendor('fluke.plugin.quickfilter.js','fluke.plugin.quickfilter.css')
    ...
    def block_left_navbar(self, context, nodes):
        nodes.append(loader.render_to_string('fluke/blocks/modal_list.left_navbar.quickfilter.html',
