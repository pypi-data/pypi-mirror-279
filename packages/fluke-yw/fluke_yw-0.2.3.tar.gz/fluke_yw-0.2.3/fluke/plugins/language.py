...
from fluke.views import BaseAdminPlugin, CommAdminView, BaseAdminView
...
class SetLangNavPlugin(BaseAdminPlugin):
    ...
    def block_top_navmenu(self, context, nodes):
        ...
        nodes.append(loader.render_to_string('fluke/blocks/comm.top.setlang.html', context=context))
