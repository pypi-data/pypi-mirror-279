...
from fluke.layout import Fieldset, Main, Side, Row, FormHelper
from fluke.sites import site
from fluke.util import unquote
from fluke.views import BaseAdminPlugin, ModelFormAdminView, ModelAdminView, CommAdminView, csrf_protect_m
...
class ChangePasswordView(ModelAdminView):
    ...
    def get_media(self):
        ...
        media = media + self.vendor('fluke.form.css', 'fluke.page.form.js') + self.form.media
        return media
    ...
    def get_response(self):
        return TemplateResponse(self.request, [
            ...
            'fluke/auth/user/change_password.html'
        ], self.get_context())
