...
from fluke.util import DJANGO_11
...
class WizardFormPlugin(BaseAdminPlugin):
    ...
    def block_before_fieldsets(self, context, nodes):
        ...
        nodes.append(loader.render_to_string('fluke/blocks/model_form.before_fieldsets.wizard.html', context))
    ...
    def block_submit_line(self, context, nodes):
        ...
        nodes.append(loader.render_to_string('fluke/blocks/model_form.submit_line.wizard.html', context))
