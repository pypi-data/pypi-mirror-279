...
from fluke.layout import Field, render_field
from fluke.plugins.inline import Inline
from fluke.plugins.actions import BaseActionView
from fluke.plugins.inline import InlineModelAdmin
from fluke.sites import site
from fluke.util import unquote, quote, model_format_dict, is_related_field2
from fluke.views import BaseAdminPlugin, ModelAdminView, CreateAdminView, UpdateAdminView, DetailAdminView, ModelFormAdminView, DeleteAdminView, ListAdminView
from fluke.views.base import csrf_protect_m, filter_hook
from fluke.views.detail import DetailAdminUtil
...
class RevisionListView(BaseReversionView):
    ...
    @filter_hook
    def get_media(self):
        return super(RevisionListView, self).get_media() + self.vendor('fluke.plugin.revision.js', 'fluke.form.css')
...
class BaseRevisionView(ModelFormAdminView):
    ...
    @filter_hook
    def get_media(self):
        return super(BaseRevisionView, self).get_media() + self.vendor('fluke.plugin.revision.js')
