...
from fluke.util import is_related_field,is_related_field2
import datetime
...
class BaseFilter(object):
    title = None
    template = 'fluke/filters/list.html'
...
class TextFieldListFilter(FieldFilter):
    template = 'fluke/filters/char.html'
...
class NumberFieldListFilter(FieldFilter):
    template = 'fluke/filters/number.html'
...
class DateFieldListFilter(ListFieldFilter):
    template = 'fluke/filters/date.html'
...
class RelatedFieldSearchFilter(FieldFilter):
    template = 'fluke/filters/fk_search.html'
...
class MultiSelectFieldListFilter(ListFieldFilter):
    ...
    """
    template = 'fluke/filters/checklist.html'
