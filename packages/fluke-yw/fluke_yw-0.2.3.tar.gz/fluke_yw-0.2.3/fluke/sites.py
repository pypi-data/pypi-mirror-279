...
class AdminSite(object):
    ...
    def register_modelview(self, path, admin_view_class, name):
        from fluke.views.base import BaseAdminView
    ...
    def register_plugin(self, plugin_class, admin_view_class):
        from fluke.views.base import BaseAdminPlugin
    ...
    def get_plugins(self, admin_view_class, *option_classes):
        from fluke.views import BaseAdminView
        plugins = []
    ...
    def i18n_javascript(self, request):
        ...
        return javascript_catalog(request, packages=['django.conf', 'fluke'])
