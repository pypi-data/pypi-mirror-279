...
from fluke.forms import AdminAuthenticationForm
...
class LoginView(BaseAdminView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        defaults = {
            ...
            'template_name': self.login_template or 'fluke/views/login.html',
        }
...
class LogoutView(BaseAdminView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        defaults = {
            'extra_context': context,
            'current_app': self.admin_site.name,
            'template_name': self.logout_template or 'fluke/views/logged_out.html',
        }
