...
from fluke.views.edit import UpdateAdminView
from fluke.views.detail import DetailAdminView
from fluke.views.base import ModelAdminView, filter_hook, csrf_protect_m
