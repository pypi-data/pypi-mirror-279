...
from fluke.util import static, json, vendor, sortkeypicker

from fluke.models import Log
...
class CommAdminView(BaseAdminView):
    ...
    base_template = 'fluke/base_site.html'
    menu_template = 'fluke/includes/sitemenu_default.html'

    site_title = getattr(settings,"FLUKE_TITLE",_(u"Django Fluke"))
    site_footer = getattr(settings,"FLUKE_FOOTER_TITLE",_(u"my-company.inc"))
...
class ModelAdminView(CommAdminView):
    ...
    def get_template_list(self, template_name):
        ...
        return (
            ...
            "fluke/%s/%s" % (opts.app_label, template_name),
            "fluke/%s" % template_name,
        )
