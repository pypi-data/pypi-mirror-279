...
class DailyWeatherForecastItem(BaseModel):
    ...
    speed: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Wind speed")
    ...
    pop: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Probability of precipitation")
    rain: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Rain volume for the last 3 hours")
