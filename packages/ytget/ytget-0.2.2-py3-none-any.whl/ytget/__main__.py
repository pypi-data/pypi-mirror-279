...
class Search:
    ...
    def download(self, **download_kwargs):
        ...
        Download(self.results, use_threads=self._use_threads, threads=self._threads, kwargs=self._download_kwargs)
...
class Playlist:
    ...
    def download(self, _vids=None, **download_kwargs):
        ...
        Download(vids, use_threads=self._use_threads, threads=self._threads, kwargs=self._download_kwargs)
