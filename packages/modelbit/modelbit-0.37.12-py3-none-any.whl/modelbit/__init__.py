...
def get_models(prefix: Optional[str] = None, names: Optional[List[str]] = None):
  """
  https://doc.modelbit.com/api-reference/get_models
  """
  with tracing.trace(f"get_models(prefix='{prefix}')", False):
    import modelbit.internal.registry as m_registry
    return m_registry.getMany(_mbApi(), prefix=prefix, names=names)
