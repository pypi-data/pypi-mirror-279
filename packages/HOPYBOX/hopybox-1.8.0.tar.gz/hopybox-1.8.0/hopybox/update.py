...
update_log_add('1.7.6','Jun 16 2024','*Add some new commands\n* Code structure optimization\n* Fixed some known issues')
update_log_add('1.7.7','Jun 16 2024','* Fixed some known issues')
update_log_add('1.7.8','Jun 16 2024','* Fixed some known issues')
update_log_add('1.8.0','Jun 17 2024','* Fixed some known issues\n* Add some new commands')
