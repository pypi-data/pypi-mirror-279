...
class Player:
    ...
    async def search(self, search: str = None, filter_game: str = None, filter_online: bool = False, 
                     filter_servers: int = None, filter_organization: int = None, filter_public: bool = False, flag: str = None) -> dict:
