...
class MMRDNPModel(RingDownModel):
        ...
        def __init__(self, **kwargs):
            ...
            #Declare the modes for which the QNM frequencies and damping times interpolants will be constructed. Syntax: [(l,m,n)].
            self.modes = [(2, 2,0),(2 ,2,1),(2, 1,0),(3, 3,0),(3, 3,1),(3, 2,0),(4, 4,0),(4, 3,0)] + \
                         [(2,-2,0),(2,-2,1),(2,-1,0),(3,-3,0),(3,-3,1),(3,-2,0),(4,-4,0),(4,-3,0)]
