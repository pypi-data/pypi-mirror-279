...
from pyRing.utils      import compute_remnant_parameters_from_inspiral_aligned_spins_parameters, check_NR_dir, F_mrg_Nagar, import_datafile_path, print_section, review_warning, set_prefix
...
def read_injection_parameters(input_par, Config):
    ...
    if (input_par['injection-approximant']=='MMRDNP'):
        ...
        injection_parameters['Mf'], injection_parameters['af'] = compute_remnant_parameters_from_inspiral_aligned_spins_parameters(injection_parameters['m1'], injection_parameters['m2'], injection_parameters['chi1'], injection_parameters['chi2'])
...
to be intended as part of the default value.
       ...
       ***************************************************
               ...
               single-mode                Option to use a single mode in multi-modal NR waveforms ['MMRDNS', 'MMRDNP', 'KHS_2012']. Example of expected syntax: [(l,m)]. For MMRDNS it fixes the (l,m,0) mode. Default: None.
