...
class OperationsSearchBuilder(SearchBuilderBase, SearchBuilder):
    ...
    @set_method_call
    def with_format(self, format_data: str) -> 'OperationsSearchBuilder':
        """
        ...
        Returns:
            OperationsSearchBuilder: Returns itself to allow for method chaining.
        """
    ...
    def execute(self):
        ...
        """
        return self._search_request('operations', self.headers, self.body_data)
