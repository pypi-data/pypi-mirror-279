...
def read_process_dataframe_group(
    ...
    indices: np.ndarray,
    is_obs: bool,
    attrs: h5py.AttributeManager = None,
) -> pd.DataFrame:
    """
    ...
    Args:
        ...
        attrs (h5py.AttributeManager): HDF5 attributes manager for the dataframe.
    ...
    elif 'raw' in source_group.name:
        original_indices = (
            source_group[attrs["_index"]][indices]
        )
    else:
        original_indices = (
            source_group[source_group.attrs["_index"]][indices]
...
def read_process_raw_group(source_group: h5py.Group, row_indices: np.ndarray) -> dict:
    ...
    if 'var' in source_group:
        ...
        sliced_data['var'] = read_process_dataframe_group(
            ...
            slice(None),
            is_obs=False,
            attrs=source_group.parent.parent['var'].attrs
        )
