...
[![](https://img.shields.io/badge/Singularity-GalaxyProject-blue)](https://depot.galaxyproject.org/singularity/biobb_dna:4.2.1--pyhdfd78af_0)
...
* Installation:
        ...
        conda install -c bioconda "biobb_dna>=4.2.1"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_dna:4.2.1--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_dna:4.2.1--pyhdfd78af_0 <command>
...
* Installation:
        ...
        singularity pull --name biobb_dna.sif https://depot.galaxyproject.org/singularity/biobb_dna:4.2.1--pyhdfd78af_0
