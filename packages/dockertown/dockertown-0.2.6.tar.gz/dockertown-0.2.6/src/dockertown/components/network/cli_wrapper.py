...
from .models import NetworkContainer, NetworkInspectResult, NetworkIPAM
...
class NetworkCLI(DockerCLICaller):
    def connect(
        ...
        container: container_cli_wrapper.ValidContainer,
        alias: Optional[str] = None,
        driver_options: List[str] = [],
        ip: Optional[str] = None,
        ip6: Optional[str] = None,
        links: List[container_cli_wrapper.ValidContainer] = [],
    ) -> None:
