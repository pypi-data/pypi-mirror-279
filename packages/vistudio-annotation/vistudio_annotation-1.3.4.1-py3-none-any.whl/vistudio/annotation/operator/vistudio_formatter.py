...
class VistudioFormatter(object):
    ...
    def images_to_vistudio_v1(self, ds: "Dataset") -> "Dataset":
        ...
        logit.info("import vistudio flat image.original_image_ds count={}".format(ds.count()))
        ...
        logit.info("import vistudio flat image.final_image_ds count={}".format(image_ds.count()))
        return image_ds
    ...
    def annotations_to_vistudio_v1(self, ds: "Dataset") -> "Dataset":
        ...
        :return: Dataset
        """
        logit.info("import vistudio annotation.original_annotation_ds count={}".format(ds.count()))
        ...
        anno_ds = anno_ds.add_column('annotation_set_id', lambda df: self.annotation_set_id) \
            ...
            .add_column('image_id', lambda df: self._fill_image_id(df))
        logit.info("import vistudio annotation.final_annotation_ds count={}".format(anno_ds.count()))
        return anno_ds
