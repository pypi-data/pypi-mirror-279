...
class _Invocation:
    ...
    ) -> typing.AsyncIterator[modal_proto.api_pb2.FunctionGetOutputsItem]: ...
...
def _parse_retries(
    retries: typing.Union[int, modal.retries.Retries, None], raw_f: typing.Union[typing.Callable, None] = None
