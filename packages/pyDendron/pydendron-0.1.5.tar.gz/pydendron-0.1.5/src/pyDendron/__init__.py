...
from pyDendron.pyDendron_panel import lauch_panel
...
#from pyDendron.gui_panel.dataset_manager import DatasetManager
...
def lauch_app():
    from pyDendron.pyDendron_lauch import lauch_panel
    return lauch_panel()
