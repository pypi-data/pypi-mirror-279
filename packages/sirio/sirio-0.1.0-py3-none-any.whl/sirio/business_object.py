...
class ObjBusiness:
    ...
    subject = ""
    description = ""
    def __init__(self, businessKey: str, urlGetBO: str):
    ...
    def setValue(self, bind: str, id: str, value):
        ...
        if id not in self.jsonComplete['data'][bind]:
            self.jsonComplete['data'][bind][id] =  {"dataType": "string",  "description": "string",   "value": {"value": value }, "extendedValue": [] }
        ...
        if id not in self.businessObject['data'][bind]:
            self.businessObject['data'][bind][id] = {"dataType": "string",  "description": "string",   "value": {"value": value }, "extendedValue": [] }
