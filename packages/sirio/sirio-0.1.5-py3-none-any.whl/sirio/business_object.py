...
class BusinessObject:
    ...
    def getValue(self, bind:str, id:str):
        valReturn = ''
        try:
            if 'data' in self.businessObject['data'] and bind in self.businessObject['data'] and id in self.businessObject['data'][bind] and 'value' in self.businessObject['data'][bind][id] and 'value' in self.businessObject['data'][bind][id]['value']:
    ...
    def complete(self, domain, taskId, priority=None, owner=None):
        json_string = _to_json(self.jsonComplete)
