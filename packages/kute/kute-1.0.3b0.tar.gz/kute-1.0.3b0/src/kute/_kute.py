...
class GreenKuboIntegral():
    ...
    def get_isotropic_running_average(self):
        """
        Calculates the running average integral and its uncertainty, averaging
        ...
        return self._get_running_average(["11", "22", "33"])
        

    def get_anisotropic_running_average(self):
        """
        Calculates the running average integral and its uncertainty, averaging
        ...
        return self._get_running_average(["12", "13", "23"])


    def _get_average_correlation_function(self, keys):
    ...
    def get_isotropic_correlation_function(self):
        ...
        return self._get_average_correlation_function(["11", "22", "33"])
    
    def get_anisotropic_correlation_function(self):

        return self._get_average_correlation_function(["12", "13", "23"])
...
class IntegralEnsemble():
    ...
    def _get_average_over_components(self, keys: list) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        """
        ...
        for i, (integral, FACTOR) in enumerate(zip(self.gk_integrals, self.FACTORS)):
            ...
            integral.analyze()
            _, val, uval = integral._get_running_average(keys)
    ...
    def get_isotropic_average(self) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        ...
        return self._get_average_over_components(["11", "22", "33"])
    ...
    def get_anisotropic_average(self) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        ...
        return self._get_average_over_components(["12", "13", "23"])
