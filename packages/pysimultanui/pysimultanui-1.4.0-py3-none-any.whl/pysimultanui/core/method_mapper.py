...
class UnmappedMethod(object):
    ...
    async def run(self, *args, **kwargs):
        ...
        try:
            await run.io_bound(self.method, *args, *self.args, **kwargs, **self.kwargs)
            n.type = 'positive'
...
class MappedMethod(object):
    ...
    def __init__(self,
        ...
        self.kwargs: dict[str:str] = kwargs if kwargs is not None else {}       # dict with description of the keyword arguments
...
class MethodMapper(object):
    ...
    def copy(self):
        ...
        new_method_mapper.mapper = self.mapper.copy()
