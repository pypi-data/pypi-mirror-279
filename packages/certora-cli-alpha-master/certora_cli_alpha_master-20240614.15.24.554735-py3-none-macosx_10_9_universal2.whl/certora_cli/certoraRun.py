...
# temporary hack until we separate run_certora to 2 function (run as lib and run as app)
def run_certora_from_args(args: List[str]) -> Optional[CertoraRunResult]:
    return run_certora(args, True)
