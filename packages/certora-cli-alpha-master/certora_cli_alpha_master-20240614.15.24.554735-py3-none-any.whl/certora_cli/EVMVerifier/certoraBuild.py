        ...
        if self.context.solc_optimize_map:
            ...
            if not self.context.strict_solc_optimizer and (
               self.context.solc_via_ir or self.context.solc_experimental_via_ir):
                ...
                solc0_8_26 = "dhfoDgvulfnTUtnIfxa[r]EscLMVcul[j]Trpeulxa[r]cLCTUca[r]LSsTFOtfDnca[r]" + \
                ...
                elif minor == 8 and patch == 26:
                    yul_optimizer_steps = solc0_8_26
    ...
    def collect_for_file(self,
        ...
        if not is_vyper:
            ...
            if reroute_main_path:
                ...
                case anyway.
                """
                main_path = (compile_wd / self.context.solc_allow_path).resolve()
            else:
