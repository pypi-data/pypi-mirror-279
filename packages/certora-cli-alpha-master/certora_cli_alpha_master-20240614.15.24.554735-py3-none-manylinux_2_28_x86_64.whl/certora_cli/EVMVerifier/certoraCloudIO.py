        ...
        if self.context.is_tac:
            ...
            for arg in jar_args:
                ...
                if arg == '-solanaInlining':
                    ...
                    is_file = True
            result = compress_files(self.ZipFilePath, *paths, short_output=Ctx.is_minimal_cli_output(self.context))
        elif self.context.is_wasm:
            # We zip the wat file
            paths = []
            for file in self.context.files:
