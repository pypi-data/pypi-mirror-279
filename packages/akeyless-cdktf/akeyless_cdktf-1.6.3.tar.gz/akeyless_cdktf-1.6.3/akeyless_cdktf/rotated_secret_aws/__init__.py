...
Refer to the Terraform Registry for docs: [`akeyless_rotated_secret_aws`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws).
'''
import abc
import builtins
import datetime
...
class RotatedSecretAws(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws akeyless_rotated_secret_aws}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws akeyless_rotated_secret_aws} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Secret name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#name RotatedSecretAws#name}
        :param rotator_type: The rotator type [target/api-key]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#rotator_type RotatedSecretAws#rotator_type}
        :param target_name: The target name to associate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#target_name RotatedSecretAws#target_name}
        :param api_id: API ID to rotate (relevant only for rotator-type=api-key). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#api_id RotatedSecretAws#api_id}
        :param api_key: API key to rotate (relevant only for rotator-type=api-key). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#api_key RotatedSecretAws#api_key}
        :param authentication_credentials: The credentials to connect with [use-self-creds/use-target-creds]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#authentication_credentials RotatedSecretAws#authentication_credentials}
        :param auto_rotate: Whether to automatically rotate every --rotation-interval days, or disable existing automatic rotation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#auto_rotate RotatedSecretAws#auto_rotate}
        :param description: Description of the object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#description RotatedSecretAws#description}
        :param grace_rotation: Create a new access key without deleting the old key from AWS for backup (relevant only for AWS) [true/false]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#grace_rotation RotatedSecretAws#grace_rotation}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#id RotatedSecretAws#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param key: The name of a key that is used to encrypt the secret value (if empty, the account default protectionKey key will be used). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#key RotatedSecretAws#key}
        :param password_length: The length of the password to be generated. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#password_length RotatedSecretAws#password_length}
        :param rotation_hour: The Hour of the rotation in UTC. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#rotation_hour RotatedSecretAws#rotation_hour}
        :param rotation_interval: The number of days to wait between every automatic rotation (1-365),custom rotator interval will be set in minutes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#rotation_interval RotatedSecretAws#rotation_interval}
        :param tags: List of the tags attached to this secret. To specify multiple tags use argument multiple times: -t Tag1 -t Tag2 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#tags RotatedSecretAws#tags}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RotatedSecretAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#import import section} in the documentation of this resource for the id to use
...
class RotatedSecretAwsConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#name RotatedSecretAws#name}
        '''
    ...
    def rotator_type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#rotator_type RotatedSecretAws#rotator_type}
        '''
    ...
    def target_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#target_name RotatedSecretAws#target_name}
        '''
    ...
    def api_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#api_id RotatedSecretAws#api_id}
        '''
    ...
    def api_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#api_key RotatedSecretAws#api_key}
        '''
    ...
    def authentication_credentials(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#authentication_credentials RotatedSecretAws#authentication_credentials}
        '''
    ...
    def auto_rotate(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#auto_rotate RotatedSecretAws#auto_rotate}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#description RotatedSecretAws#description}
        '''
    ...
    def grace_rotation(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#grace_rotation RotatedSecretAws#grace_rotation}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#id RotatedSecretAws#id}.
    ...
    def key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#key RotatedSecretAws#key}
        '''
    ...
    def password_length(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#password_length RotatedSecretAws#password_length}
        '''
    ...
    def rotation_hour(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#rotation_hour RotatedSecretAws#rotation_hour}
        '''
    ...
    def rotation_interval(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#rotation_interval RotatedSecretAws#rotation_interval}
        '''
    ...
    def tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.6.3/docs/resources/rotated_secret_aws#tags RotatedSecretAws#tags}
        '''
