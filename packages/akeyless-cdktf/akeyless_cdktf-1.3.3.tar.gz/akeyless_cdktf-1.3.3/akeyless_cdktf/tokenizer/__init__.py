...
Refer to the Terraform Registry for docs: [`akeyless_tokenizer`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer).
'''
import abc
import builtins
import datetime
...
class Tokenizer(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer akeyless_tokenizer}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer akeyless_tokenizer} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Tokenizer name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#name Tokenizer#name}
        :param template_type: Which template type this tokenizer is used for [SSN,CreditCard,USPhoneNumber,Custom]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#template_type Tokenizer#template_type}
        :param alphabet: Alphabet to use in custom vaultless tokenization, such as '0123456789' for credit cards. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#alphabet Tokenizer#alphabet}
        :param decoding_template: The Decoding output template to use in custom vaultless tokenization. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#decoding_template Tokenizer#decoding_template}
        :param delete_protection: Protection from accidental deletion of this item, [true/false]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#delete_protection Tokenizer#delete_protection}
        :param description: Description of the object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#description Tokenizer#description}
        :param encoding_template: The Encoding output template to use in custom vaultless tokenization. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#encoding_template Tokenizer#encoding_template}
        :param encryption_key_name: AES key name to use in vaultless tokenization. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#encryption_key_name Tokenizer#encryption_key_name}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#id Tokenizer#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param metadata: A metadata about the tokenizer. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#metadata Tokenizer#metadata}
        :param pattern: Pattern to use in custom vaultless tokenization. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#pattern Tokenizer#pattern}
        :param tag: List of the tags attached to this key. To specify multiple tags use argument multiple times: --tag Tag1 --tag Tag2 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#tag Tokenizer#tag}
        :param tokenizer_type: Tokenizer type(vaultless). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#tokenizer_type Tokenizer#tokenizer_type}
        :param tweak_type: The tweak type to use in vaultless tokenization [Supplied, Generated, Internal, Masking]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#tweak_type Tokenizer#tweak_type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Tokenizer that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#import import section} in the documentation of this resource for the id to use
...
class TokenizerConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#name Tokenizer#name}
        '''
    ...
    def template_type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#template_type Tokenizer#template_type}
        '''
    ...
    def alphabet(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#alphabet Tokenizer#alphabet}
        '''
    ...
    def decoding_template(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#decoding_template Tokenizer#decoding_template}
        '''
    ...
    def delete_protection(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#delete_protection Tokenizer#delete_protection}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#description Tokenizer#description}
        '''
    ...
    def encoding_template(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#encoding_template Tokenizer#encoding_template}
        '''
    ...
    def encryption_key_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#encryption_key_name Tokenizer#encryption_key_name}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#id Tokenizer#id}.
    ...
    def metadata(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#metadata Tokenizer#metadata}
        '''
    ...
    def pattern(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#pattern Tokenizer#pattern}
        '''
    ...
    def tag(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#tag Tokenizer#tag}
        '''
    ...
    def tokenizer_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#tokenizer_type Tokenizer#tokenizer_type}
        '''
    ...
    def tweak_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/tokenizer#tweak_type Tokenizer#tweak_type}
        '''
