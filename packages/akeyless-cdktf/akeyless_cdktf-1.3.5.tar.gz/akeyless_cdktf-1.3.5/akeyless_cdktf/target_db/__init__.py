...
Refer to the Terraform Registry for docs: [`akeyless_target_db`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db).
'''
import abc
import builtins
import datetime
...
class TargetDb(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db akeyless_target_db}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db akeyless_target_db} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param db_type: Database type: mysql/mssql/postgres/mongodb/snowflake/oracle/cassandra/redshift. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#db_type TargetDb#db_type}
        :param name: Target name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#name TargetDb#name}
        :param comment: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#comment TargetDb#comment}.
        :param db_name: Database name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#db_name TargetDb#db_name}
        :param db_server_certificates: Set of root certificate authorities in base64 encoding used by clients to verify server certificates. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#db_server_certificates TargetDb#db_server_certificates}
        :param db_server_name: Server name is used to verify the hostname on the returned certificates unless InsecureSkipVerify is provided. It is also included in the client's handshake to support virtual hosting unless it is an IP address Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#db_server_name TargetDb#db_server_name}
        :param description: Description of the object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#description TargetDb#description}
        :param host: Database host. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#host TargetDb#host}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#id TargetDb#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param key: Key name. The key will be used to encrypt the target secret value. If key name is not specified, the account default protection key is used Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#key TargetDb#key}
        :param mongodb_atlas: Flag, set database type to mongodb and the flag to true to create Mongo Atlas target. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_atlas TargetDb#mongodb_atlas}
        :param mongodb_atlas_api_private_key: MongoDB Atlas private key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_atlas_api_private_key TargetDb#mongodb_atlas_api_private_key}
        :param mongodb_atlas_api_public_key: MongoDB Atlas public key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_atlas_api_public_key TargetDb#mongodb_atlas_api_public_key}
        :param mongodb_atlas_project_id: MongoDB Atlas project ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_atlas_project_id TargetDb#mongodb_atlas_project_id}
        :param mongodb_default_auth_db: MongoDB server default authentication database. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_default_auth_db TargetDb#mongodb_default_auth_db}
        :param mongodb_uri_options: MongoDB server URI options (e.g. replicaSet=mySet&authSource=authDB). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_uri_options TargetDb#mongodb_uri_options}
        :param oracle_service_name: oracle db service name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#oracle_service_name TargetDb#oracle_service_name}
        :param port: Database port. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#port TargetDb#port}
        :param pwd: Database password. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#pwd TargetDb#pwd}
        :param snowflake_account: Snowflake account name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#snowflake_account TargetDb#snowflake_account}
        :param user_name: Database user name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#user_name TargetDb#user_name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing TargetDb that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#import import section} in the documentation of this resource for the id to use
    ...
    def comment(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4df2147e0d498edf671f71c8a092d5c8469d7a9e9521532a51d30c332a5023ed)
...
class TargetDbConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def db_type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#db_type TargetDb#db_type}
        '''
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#name TargetDb#name}
        '''
    ...
    def comment(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#comment TargetDb#comment}.'''
    ...
    def db_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#db_name TargetDb#db_name}
        '''
    ...
    def db_server_certificates(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#db_server_certificates TargetDb#db_server_certificates}
        '''
    ...
    def db_server_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#db_server_name TargetDb#db_server_name}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#description TargetDb#description}
        '''
    ...
    def host(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#host TargetDb#host}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#id TargetDb#id}.
    ...
    def key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#key TargetDb#key}
        '''
    ...
    def mongodb_atlas(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_atlas TargetDb#mongodb_atlas}
        '''
    ...
    def mongodb_atlas_api_private_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_atlas_api_private_key TargetDb#mongodb_atlas_api_private_key}
        '''
    ...
    def mongodb_atlas_api_public_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_atlas_api_public_key TargetDb#mongodb_atlas_api_public_key}
        '''
    ...
    def mongodb_atlas_project_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_atlas_project_id TargetDb#mongodb_atlas_project_id}
        '''
    ...
    def mongodb_default_auth_db(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_default_auth_db TargetDb#mongodb_default_auth_db}
        '''
    ...
    def mongodb_uri_options(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#mongodb_uri_options TargetDb#mongodb_uri_options}
        '''
    ...
    def oracle_service_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#oracle_service_name TargetDb#oracle_service_name}
        '''
    ...
    def port(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#port TargetDb#port}
        '''
    ...
    def pwd(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#pwd TargetDb#pwd}
        '''
    ...
    def snowflake_account(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#snowflake_account TargetDb#snowflake_account}
        '''
    ...
    def user_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.3.6/docs/resources/target_db#user_name TargetDb#user_name}
        '''
...
def _typecheckingstub__4df2147e0d498edf671f71c8a092d5c8469d7a9e9521532a51d30c332a5023ed(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
