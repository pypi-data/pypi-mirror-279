from embedding_server_client.schema.zmq_message_header import ZmqMessageHeader


class EmbeddingClientError(Exception):
    """
    Custom exception class for BertClient errors.

    This exception class represents errors within the BertClient, including detailed
    ...
    def __init__(self, header: ZmqMessageHeader, additional_info: str = ""):
        """
        Initializes a new instance of the BertClientError.
