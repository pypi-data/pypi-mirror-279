            ...
            for i in value:
                ...
                for e in get_reg_names():
                    if not e in conf.envs['group'][i]:
                        names[i].append(e)
            add_parser.add_argument("src" , nargs='+', help="Source number/Source Number Range", metavar="Source number/Source Number Range", choices=names[i])
            delete_parser.add_argument("src" , nargs='+', help="Source number/Source Number Range", metavar="Source number/Source Number Range", choices=names[i])
