...
def data_import(args: Namespace):
    ...
    filter_invalid_data_rows_for_jsonl(args.train_file_path, args.output_dataset, mode="train")
    logger.info("Import completed")
    if args.validation_file_path is not None:
        logger.info(f"Import started for {args.validation_file_path}")
        filter_invalid_data_rows_for_jsonl(args.train_file_path, args.output_dataset, mode="validation")
        logger.info("Import completed")
