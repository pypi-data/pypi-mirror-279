...
Please adapt it, rename it to `.ghga_event_schemas.yaml`, and place it into one of the following locations:
- in the current working directory were you are execute the service (on unix: `./.ghga_event_schemas.yaml`)
- in your home directory (on unix: `~/.ghga_event_schemas.yaml`)
