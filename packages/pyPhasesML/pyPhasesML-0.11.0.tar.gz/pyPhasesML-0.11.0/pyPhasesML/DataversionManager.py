...
class DataversionManager:
    ...
    def groupDatasetBySplit(
        ...
        if isinstance(split, dict):
            ...
            # groups =
            # recordIds = [recordId for s in slicesForDataset for recordId in list(groupedRecords.keys())[s]]
    ...
    def getRecordIndexesForSplit(self, datasetName):
        ...
        return [i for i, r in enumerate(self.groupedRecords) if r in recordIds]
