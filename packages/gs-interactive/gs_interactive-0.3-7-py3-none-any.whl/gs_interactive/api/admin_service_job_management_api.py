...
class AdminServiceJobManagementApi:
    ...
    def get_job_by_id(
        self,
        job_id: Annotated[StrictStr, Field(description="The id of the job, returned from POST /v1/graph/{graph_id}/dataloading")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param job_id: The id of the job, returned from POST /v1/graph/{graph_id}/dataloading (required)
        :type job_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
