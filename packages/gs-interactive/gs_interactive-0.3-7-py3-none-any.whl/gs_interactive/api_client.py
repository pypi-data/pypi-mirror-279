...
from gs_interactive.api_response import ApiResponse, T as ApiResponseT
import gs_interactive.models
from gs_interactive import rest
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.3/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gs_interactive.models, klass)
