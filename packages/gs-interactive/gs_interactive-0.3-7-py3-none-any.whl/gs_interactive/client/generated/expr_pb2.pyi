...
class PathConcat(google.protobuf.message.Message):
    ...
    class _EndpointEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PathConcat._Endpoint.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class ConcatPathInfo(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["path_tag", b"path_tag"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["endpoint", b"endpoint", "path_tag", b"path_tag"]) -> None: ...
...
class ExprOpr(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["arith", b"arith", "brace", b"brace", "case", b"case", "const", b"const", "date_time_minus", b"date_time_minus", "extract", b"extract", "item", b"item", "logical", b"logical", "map", b"map", "node_type", b"node_type", "param", b"param", "path_concat", b"path_concat", "time_interval", b"time_interval", "var", b"var", "var_map", b"var_map", "vars", b"vars"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["arith", b"arith", "brace", b"brace", "case", b"case", "const", b"const", "date_time_minus", b"date_time_minus", "extract", b"extract", "item", b"item", "logical", b"logical", "map", b"map", "node_type", b"node_type", "param", b"param", "path_concat", b"path_concat", "time_interval", b"time_interval", "var", b"var", "var_map", b"var_map", "vars", b"vars"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["item", b"item"]) -> typing.Literal["logical", "arith", "const", "var", "brace", "vars", "var_map", "param", "case", "extract", "map", "time_interval", "date_time_minus", "path_concat"] | None: ...
