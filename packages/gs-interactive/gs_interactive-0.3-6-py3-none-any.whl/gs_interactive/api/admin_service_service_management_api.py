...
class AdminServiceServiceManagementApi:
    ...
    def _get_service_status_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/service/status',
    ...
    def _restart_service_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/service/restart',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def start_service(
        self,
        start_service_request: Annotated[Optional[StartServiceRequest], Field(description="Start service on a specified graph")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
