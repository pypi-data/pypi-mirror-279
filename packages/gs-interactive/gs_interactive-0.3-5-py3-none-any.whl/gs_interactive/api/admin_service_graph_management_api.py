...
from gs_interactive.api_client import ApiClient, RequestSerialized
...
class AdminServiceGraphManagementApi:
    ...
    def create_dataloading_job(
        self,
        graph_id: Annotated[StrictStr, Field(description="The name of graph to do bulk loading.")],
    ...
    def delete_graph(
        self,
        graph_id: Annotated[StrictStr, Field(description="The name of graph to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def get_graph_statistic(
        self,
        graph_id: Annotated[StrictStr, Field(description="The id of graph to get statistics")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param graph_id: The id of graph to get statistics (required)
        :type graph_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_graph_statistic_serialize(
            graph_id=graph_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetGraphStatisticsResponse",
            '500': "str",
            '404': "str",
            '503': "str",
        }
    ...
    @validate_call
    def get_graph_statistic_with_http_info(
        self,
        graph_id: Annotated[StrictStr, Field(description="The id of graph to get statistics")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetGraphStatisticsResponse]:
        """get_graph_statistic
    ...
    @validate_call
    def get_graph_statistic_without_preload_content(
        self,
        graph_id: Annotated[StrictStr, Field(description="The id of graph to get statistics")],
        _request_timeout: Union[
            None,
    ...
    def _get_graph_statistic_serialize(
        self,
        graph_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/graph/{graph_id}/statistics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
