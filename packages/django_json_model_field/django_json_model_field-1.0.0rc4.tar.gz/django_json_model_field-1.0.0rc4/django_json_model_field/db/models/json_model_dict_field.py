...
from django_json_model_field.db.models.migration_compat_field_mixin import MigrationCompatFieldMixin
...
class JSONModelDictField(JSONField, MigrationCompatFieldMixin):
    """
    ...
    def __init__(
        self,
        json_dict_model: Type[JSONModelDict | dict],
        verbose_name=None,
        name=None,
        null=True,
        blank=True,
        ...
        **kwargs
        ...
        self.json_dict_model = json_dict_model
    ...
    def deconstruct(self):
        ...
        kwargs["json_dict_model"] = self.json_dict_model
    ...
    def _deconstruct_compat_is_reconstructed(self) -> bool:
        return self._deconstruct_compat_model_is_reconstructed(self.json_dict_model)
