...
from .migrations_util import deconstruct, reconstruct
...
class ConditionalJSONModelField(BaseJSONModelField):
    ...
    def __init__(
        self,
        selector_field: str,
        model_map: dict[Any, Type[JSONModel] | tuple],
    ...
    def deconstruct(self):
        ...
        model_map = {key: deconstruct(value) for key, value in self._model_map.items()}
        args = [self.selector_field_name, model_map, *args]
