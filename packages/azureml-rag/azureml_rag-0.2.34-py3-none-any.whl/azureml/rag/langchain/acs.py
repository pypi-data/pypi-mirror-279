...
from azureml.rag.utils.requests import send_post_request
...
try:
    ...
    logger.warning("Failed to import interfaces from langchain.schema.")
    from azureml.rag.langchain.vendor.embeddings.base import Embeddings
    from azureml.rag.langchain.vendor.schema.document import Document
    from azureml.rag.langchain.vendor.vectorstores.base import VectorStore
