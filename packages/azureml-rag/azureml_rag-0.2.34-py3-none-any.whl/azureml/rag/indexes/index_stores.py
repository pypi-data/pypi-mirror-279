...
class AzureCognitiveSearchStore(IndexStore):
    ...
    def create_upload_payload_from_embedded_document(
        ...
        return acs_doc, _get_document_size(acs_doc)
...
class AzureCosmosMongoVcoreStore(IndexStore):
    ...
    def create_upload_payload_from_embedded_document(
        ...
        return UpdateOne(
            {"_id": doc_id_encoded}, {"$set": azure_cosmos_mongo_vcore_doc}, upsert=True
        ), _get_document_size(azure_cosmos_mongo_vcore_doc)
...
class MilvusStore(IndexStore):
    ...
    def create_upload_payload_from_embedded_document(
        ...
        return milvus_doc, _get_document_size(milvus_doc)
...
class PineconeStore(IndexStore):
    ...
    def create_upload_payload_from_embedded_document(
        ...
        return pinecone_doc, _get_document_size(pinecone_doc)


def _get_document_size(document: dict) -> int:
