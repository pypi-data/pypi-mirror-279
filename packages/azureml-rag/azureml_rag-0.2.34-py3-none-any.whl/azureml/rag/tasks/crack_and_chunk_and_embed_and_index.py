        ...
        if index_type == "acs":
            ...
            if index_connection is not None:
                ...
                if isinstance(index_connection, str):
                    ...
                    from azureml.rag.utils.connections import get_id_from_connection
            ...
            mlindex = embeddings_container.write_as_faiss_mlindex(
                output_path, engine="azureml.rag.indexes.faiss.FaissAndDocStore"
            )
            ...
            if index_connection is not None:
                ...
                from azureml.rag.utils.connections import get_metadata_from_connection
