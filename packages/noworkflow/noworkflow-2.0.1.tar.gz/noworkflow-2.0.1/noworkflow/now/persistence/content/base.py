...
class ContentDatabaseEngine(object):
    ...
    def should_use_safe_open(self):
        """Use default open instead of overloaded"""
        return safeopen.should_use_safe_open()

    def use_safe_open(self):
        return safeopen.use_safe_open()
