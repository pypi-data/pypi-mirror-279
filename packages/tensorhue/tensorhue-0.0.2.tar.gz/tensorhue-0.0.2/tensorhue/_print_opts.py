...
def set_printoptions(
    ...
    if accessible:
        raise NotImplementedError("Accessible mode is not implemented yet. If you have a vision impairment and can provide feedback or beta-test color schemes please let us know.")