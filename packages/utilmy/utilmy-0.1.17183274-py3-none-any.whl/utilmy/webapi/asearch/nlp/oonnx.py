...
Docs:
    ...
    #### Tests 
        python3 nlp/oonnx.py test_onnx_runtime --dironnx /home/tuenv2/export_onnx/ --query_str 'find restaurant neraby US'

        python3 nlp/oonnx.py test_onnx_create --dirmodel /home/tuenv2/export_onnx/ 
...
def test_onnx_create(dirmodel: str='tuenguyen/token_classification_model'):
...
def export_onnx(dirmodel: str=None,  dirout:str=None, 
    ...
    if model_wrapper ==  Wrapper.ner_softmax:     
        ...
        model_export = onnxModel_Softmax(model)
