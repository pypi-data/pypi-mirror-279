...
class AbacusWrapper(LCAOHamiltonian):
    def __init__(
        self, HR, SR, Rlist, nbasis=None, atoms=None, nspin=1, basis=None, HR_soc=None, HR_nosoc=None, nel=None
    ):

        super().__init__(HR, SR, Rlist, nbasis=nbasis, atoms=atoms, nspin=nspin, orbs=None, HR_soc=HR_soc, HR_nosoc=HR_nosoc, nel=nel)
        self._name = "ABACUS"
...
class AbacusParser:
    ...
    def get_models(self):
        if self.spin == "collinear":
            ...
            model_up = AbacusWrapper(HR=HR_up, SR=SR, Rlist=Rlist, nbasis=nbasis, nspin=1, atoms=self.atoms)
            model_dn = AbacusWrapper(HR=HR_dn, SR=SR, Rlist=Rlist, nbasis=nbasis, nspin=1, atoms=self.atoms)
            ...
            model = AbacusWrapper(HR=HR, SR=SR, Rlist=Rlist, nbasis=nbasis, nspin=2, atoms=self.atoms)
