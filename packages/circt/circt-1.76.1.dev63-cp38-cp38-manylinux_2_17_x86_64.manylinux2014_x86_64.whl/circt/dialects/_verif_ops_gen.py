...
class ClockedAssertOp(_ods_ir.OpView):
  ...
  def __init__(self, property, disable, edge, clock, *, label=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(property))
    operands.append(_get_op_result_or_value(disable))
...
def clocked_assert(property, disable, edge, clock, *, label=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ClockedAssertOp(property=property, disable=disable, edge=edge, clock=clock, label=label, loc=loc, ip=ip))
...
def clocked_assume(property, disable, edge, clock, *, label=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ClockedAssumeOp(property=property, disable=disable, edge=edge, clock=clock, label=label, loc=loc, ip=ip))
...
def clocked_cover(property, disable, edge, clock, *, label=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ClockedCoverOp(property=property, disable=disable, edge=edge, clock=clock, label=label, loc=loc, ip=ip))
