...
def goto_repeat(input, base, more, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GoToRepeatOp(input=input, base=base, more=more, loc=loc, ip=ip))
...
def intersect(inputs, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(IntersectOp(inputs=inputs, loc=loc, ip=ip))
...
def non_consecutive_repeat(input, base, more, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(NonConsecutiveRepeatOp(input=input, base=base, more=more, loc=loc, ip=ip))
