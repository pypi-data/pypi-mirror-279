...
class LimitOffsetPageBankAccountSchema(BaseModel):
    """
    LimitOffsetPageBankAccountSchema
    """ # noqa: E501
    items: List[BankAccountSchema]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [BankAccountSchema.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
