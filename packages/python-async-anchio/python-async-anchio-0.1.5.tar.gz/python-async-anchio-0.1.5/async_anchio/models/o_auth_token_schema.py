...
class OAuthTokenSchema(BaseModel):
    ...
    not_before_policy: StrictInt
    refresh_expires_in: StrictInt
    session_state: StrictStr
    __properties: ClassVar[List[str]] = ["refresh_token", "access_token", "id_token", "expires_in", "not_before_policy", "refresh_expires_in", "session_state"]
