...
class MeteredAlertSchema(BaseModel):
    """
    MeteredAlertSchema
    """ # noqa: E501
    ...
    period: StrictStr
    notification_channels: List[StrictStr]
    __properties: ClassVar[List[str]] = ["created_on", "updated_on", "id", "name", "service", "threshold", "period", "notification_channels"]
