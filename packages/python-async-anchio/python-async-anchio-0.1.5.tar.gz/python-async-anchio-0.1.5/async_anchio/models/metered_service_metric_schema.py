...
class MeteredServiceMetricSchema(BaseModel):
    """
    ...
    service: StrictStr
    name: StrictStr
    value_type: MeterValueTypeEnum
    currency_iso: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["created_on", "updated_on", "id", "service", "name", "value_type", "currency_iso"]
