...
CONTRACTAMOUNT_ANY_OF_SCHEMAS = ["float", "int", "str"]
...
class ContractAmount(BaseModel):
    ...
    any_of_schemas: List[str] = Literal[CONTRACTAMOUNT_ANY_OF_SCHEMAS]
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = ContractAmount.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ContractAmount with anyOf schemas: float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ContractAmount with anyOf schemas: float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
