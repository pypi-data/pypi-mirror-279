...
class ImsTool(MongoClientTradeGateway):
...
if __name__ == "__main__":
    ...
    description = "sync pos for ims_server"
    parser = argparse.ArgumentParser(description=description)

    _file_name = "C:\\Users\\Administrator\\Desktop\\ims_batandconfig\\ims_tool_setting.json"
    ...
    td = ImsTool(args.config_filename, args.date_change,end_time)
