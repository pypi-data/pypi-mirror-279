...
class Tables(Series, DataBase):
	...
	def rename(self,old_table:str,new_table:str) -> bool:
		try:
...
class Items(DataFrame):
	...
	def get(self,columns:list=None,condition:Condition=Condition(),distinct:bool=False,sql:bool=False) -> list:
	...
	def rename(self,new_name:str) -> bool:
		if not self.parent.rename(self.table,new_name):
			return False
		return True
