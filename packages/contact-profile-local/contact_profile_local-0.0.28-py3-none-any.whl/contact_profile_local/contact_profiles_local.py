...
class ContactProfilesLocal(GenericMapping, metaclass=MetaLogger,
    ...
    def __init__(self, lang_code: LangCode = None, is_test_data: bool = False) -> None:
        ...
        GenericMapping.__init__(self, default_schema_name=CONTACT_PROFILE_SCHEMA_NAME,
    ...
    def insert_and_link_contact_profile(self, *, contact_dict: dict, contact_id: int = None,
        ...
        self.logger.start("insert_and_link_contact_profile", object={
            "contact_dict": contact_dict, "contact_id": contact_id, "person_id": person_id,
            "visibility_id": visibility_id, "is_approved": is_approved, "stars": stars,
        ...
        if person_id is not None and person_id not in person_ids_list:
            self.logger.info("insert_and_link_contact_profile: person_id is not in person_ids, adding it to person_ids",
                             object={"person_id": person_id, "person_ids_list": person_ids_list})
            person_ids_list.insert(0, person_id)
        if person_ids_list:
            person_id = person_ids_list[0]
            self.logger.info("insert_and_link_contact_profile: person_id is set to the first element of person_ids_list",
                             object={"person_id": person_id, "person_ids_list": person_ids_list})
            ...
            self.logger.info("insert_and_link_contact_profile: profile_ids_tuples_list",
            ...
            if not profile_ids_tuples_list:
                ...
                if profile_id is None:
                    self.logger.error(
                        ...
                        object={"contact_id": contact_id, "profile_id": profile_id, "person_id": person_id})
                ...
                for profile_id_tuple in profile_ids_tuples_list:
                    ...
                    self.logger.info(
                        ...
                        object={"contact_id": contact_id, "profile_id": profile_id_tuple[0]})
            ...
            self.logger.end("insert_and_link_contact_profile", object={"insert_information": insert_information})
    ...
    def __insert_profile_profile_mappings(self, *, profile_ids: list[int], contact_dict: dict) -> list[int]:
        ...
        self.logger.start("__insert_profile_profile_mappings",
        ...
        self.logger.end("__insert_profile_profile_mappings",
                        object={"profile_profile_mappings_ids_list": profile_profile_mappings_ids_list})
