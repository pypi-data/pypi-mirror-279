...
required = ["torch==2.3.1", "pytorch_lightning==2.2.5", "torchinfo==1.8.0", "torchmetrics==1.4.0.post0",
            "overrides==7.7.0", "matplotlib==3.9.0", "pandas==2.2.2", "colorama>=0.4.6", "tensorboardX==2.6.2.2",
