...
class SpotinstProvider(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs spotinst}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs spotinst} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param account: Spotinst Account ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#account SpotinstProvider#account}
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#alias SpotinstProvider#alias}
        :param enabled: Enable or disable the Spotinst provider. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#enabled SpotinstProvider#enabled}
        :param feature_flags: Spotinst SDK Feature Flags. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#feature_flags SpotinstProvider#feature_flags}
        :param token: Spotinst Personal API Access Token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#token SpotinstProvider#token}
        '''
        if __debug__:
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SpotinstProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#import import section} in the documentation of this resource for the id to use
...
class SpotinstProviderConfig:
    ...
    def account(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#account SpotinstProvider#account}
        '''
    ...
    def alias(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#alias SpotinstProvider#alias}
        '''
    ...
    def enabled(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#enabled SpotinstProvider#enabled}
        '''
    ...
    def feature_flags(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#feature_flags SpotinstProvider#feature_flags}
        '''
    ...
    def token(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.177.0/docs#token SpotinstProvider#token}
        '''
