...
class Auction(object):
    ...
    def __init__(self, auction_id=None, name=None, delivery_start=None, delivery_end=None, delivery_areas=None, contracts=None, order_entry_start=None, order_entry_end=None, state=None, local_vars_configuration=None):  # noqa: E501
