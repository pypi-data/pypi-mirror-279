...
class AuctionTrade(object):
    ...
    def __init__(self, id=None, auction_id=None, contract_id=None, delivery_start=None, delivery_end=None, order_id=None, delivery_area=None, price=None, currency=None, quantity=None, state=None, user_id=None, local_vars_configuration=None):  # noqa: E501
