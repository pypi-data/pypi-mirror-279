...
class OrderModifyItem(object):
    ...
    def revision_no(self):
        ...
        The revision of the order that should be modified. If the exchange already has a newer revision, the modification will be rejected.  This field is optional if the order action is `DELE` or `DEAC`. In this case, the system will try to set the last known revision number.  # noqa: E501
