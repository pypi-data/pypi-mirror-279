...
class AuctionTradeApi(object):
    ...
    def find_auction_trades(self, exchange_id, portfolio_ids, **kwargs):  # noqa: E501
        ...
        >>> thread = api.find_auction_trades(exchange_id, portfolio_ids, async_req=True)
        >>> result = thread.get()
        ...
        return self.find_auction_trades_with_http_info(exchange_id, portfolio_ids, **kwargs)  # noqa: E501

    def find_auction_trades_with_http_info(self, exchange_id, portfolio_ids, **kwargs):  # noqa: E501
        """Find trades  # noqa: E501
        ...
        >>> thread = api.find_auction_trades_with_http_info(exchange_id, portfolio_ids, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and local_var_params.get('portfolio_ids') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `portfolio_ids` when calling `find_auction_trades`")  # noqa: E501
