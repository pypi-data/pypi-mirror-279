...
class Report(object):
    ...
    def __init__(self, api_timestamp=None, cl_ordr_id=None, txt=None, net_cash_position=None, currency=None, report_elements=None, local_vars_configuration=None):  # noqa: E501
