...
class RiskManagementSettings(object):
    ...
    def __init__(self, id=None, trading_areas=None, position_limits=None, cash_limits=None, otr_limits=None, order_action_quota_limit=None, order_count_limit=None, auction_limits=None, local_vars_configuration=None):  # noqa: E501
