...
class Repository(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository github_repository}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository github_repository} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: The name of the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#name Repository#name}
        :param allow_auto_merge: Set to 'true' to allow auto-merging pull requests on the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#allow_auto_merge Repository#allow_auto_merge}
        :param allow_merge_commit: Set to 'false' to disable merge commits on the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#allow_merge_commit Repository#allow_merge_commit}
        :param allow_rebase_merge: Set to 'false' to disable rebase merges on the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#allow_rebase_merge Repository#allow_rebase_merge}
        :param allow_squash_merge: Set to 'false' to disable squash merges on the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#allow_squash_merge Repository#allow_squash_merge}
        :param allow_update_branch: Set to 'true' to always suggest updating pull request branches. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#allow_update_branch Repository#allow_update_branch}
        :param archived: Specifies if the repository should be archived. Defaults to 'false'. NOTE Currently, the API does not support unarchiving. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#archived Repository#archived}
        :param archive_on_destroy: Set to 'true' to archive the repository instead of deleting on destroy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#archive_on_destroy Repository#archive_on_destroy}
        :param auto_init: Set to 'true' to produce an initial commit in the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#auto_init Repository#auto_init}
        :param default_branch: Can only be set after initial repository creation, and only if the target branch exists. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#default_branch Repository#default_branch}
        :param delete_branch_on_merge: Automatically delete head branch after a pull request is merged. Defaults to 'false'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#delete_branch_on_merge Repository#delete_branch_on_merge}
        :param description: A description of the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#description Repository#description}
        :param gitignore_template: Use the name of the template without the extension. For example, 'Haskell'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#gitignore_template Repository#gitignore_template}
        :param has_discussions: Set to 'true' to enable GitHub Discussions on the repository. Defaults to 'false'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#has_discussions Repository#has_discussions}
        :param has_downloads: Set to 'true' to enable the (deprecated) downloads features on the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#has_downloads Repository#has_downloads}
        :param has_issues: Set to 'true' to enable the GitHub Issues features on the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#has_issues Repository#has_issues}
        :param has_projects: Set to 'true' to enable the GitHub Projects features on the repository. Per the GitHub documentation when in an organization that has disabled repository projects it will default to 'false' and will otherwise default to 'true'. If you specify 'true' when it has been disabled it will return an error. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#has_projects Repository#has_projects}
        :param has_wiki: Set to 'true' to enable the GitHub Wiki features on the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#has_wiki Repository#has_wiki}
        :param homepage_url: URL of a page describing the project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#homepage_url Repository#homepage_url}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#id Repository#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param ignore_vulnerability_alerts_during_read: Set to true to not call the vulnerability alerts endpoint so the resource can also be used without admin permissions during read. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#ignore_vulnerability_alerts_during_read Repository#ignore_vulnerability_alerts_during_read}
        :param is_template: Set to 'true' to tell GitHub that this is a template repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#is_template Repository#is_template}
        :param license_template: Use the name of the template without the extension. For example, 'mit' or 'mpl-2.0'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#license_template Repository#license_template}
        :param merge_commit_message: Can be 'PR_BODY', 'PR_TITLE', or 'BLANK' for a default merge commit message. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#merge_commit_message Repository#merge_commit_message}
        :param merge_commit_title: Can be 'PR_TITLE' or 'MERGE_MESSAGE' for a default merge commit title. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#merge_commit_title Repository#merge_commit_title}
        :param pages: pages block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#pages Repository#pages}
        :param private: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#private Repository#private}.
        :param security_and_analysis: security_and_analysis block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#security_and_analysis Repository#security_and_analysis}
        :param squash_merge_commit_message: Can be 'PR_BODY', 'COMMIT_MESSAGES', or 'BLANK' for a default squash merge commit message. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#squash_merge_commit_message Repository#squash_merge_commit_message}
        :param squash_merge_commit_title: Can be 'PR_TITLE' or 'COMMIT_OR_PR_TITLE' for a default squash merge commit title. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#squash_merge_commit_title Repository#squash_merge_commit_title}
        :param template: template block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#template Repository#template}
        :param topics: The list of topics of the repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#topics Repository#topics}
        :param visibility: Can be 'public' or 'private'. If your organization is associated with an enterprise account using GitHub Enterprise Cloud or GitHub Enterprise Server 2.20+, visibility can also be 'internal'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#visibility Repository#visibility}
        :param vulnerability_alerts: Set to 'true' to enable security alerts for vulnerable dependencies. Enabling requires alerts to be enabled on the owner level. (Note for importing: GitHub enables the alerts on public repos but disables them on private repos by default). Note that vulnerability alerts have not been successfully tested on any GitHub Enterprise instance and may be unavailable in those settings. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#vulnerability_alerts Repository#vulnerability_alerts}
        :param web_commit_signoff_required: Require contributors to sign off on web-based commits. Defaults to 'false'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#web_commit_signoff_required Repository#web_commit_signoff_required}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Repository that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#import import section} in the documentation of this resource for the id to use
    ...
    def put_pages(
        ...
        *,
        ...
        '''
        :param build_type: The type the page should be sourced. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#build_type Repository#build_type}
        :param cname: The custom domain for the repository. This can only be set after the repository has been created. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#cname Repository#cname}
        :param source: source block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#source Repository#source}
        '''
    ...
    def put_security_and_analysis(
        ...
        *,
        ...
        '''
        :param advanced_security: advanced_security block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#advanced_security Repository#advanced_security}
        :param secret_scanning: secret_scanning block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#secret_scanning Repository#secret_scanning}
        :param secret_scanning_push_protection: secret_scanning_push_protection block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#secret_scanning_push_protection Repository#secret_scanning_push_protection}
        '''
    ...
    def put_template(
        ...
        *,
        ...
        '''
        :param owner: The GitHub organization or user the template repository is owned by. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#owner Repository#owner}
        :param repository: The name of the template repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#repository Repository#repository}
        :param include_all_branches: Whether the new repository should include all the branches from the template repository (defaults to 'false', which includes only the default branch from the template). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#include_all_branches Repository#include_all_branches}
        '''
...
class RepositoryConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#name Repository#name}
        '''
    ...
    def allow_auto_merge(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#allow_auto_merge Repository#allow_auto_merge}
        '''
    ...
    def allow_merge_commit(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#allow_merge_commit Repository#allow_merge_commit}
        '''
    ...
    def allow_rebase_merge(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#allow_rebase_merge Repository#allow_rebase_merge}
        '''
    ...
    def allow_squash_merge(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#allow_squash_merge Repository#allow_squash_merge}
        '''
    ...
    def allow_update_branch(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#allow_update_branch Repository#allow_update_branch}
        '''
    ...
    def archived(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#archived Repository#archived}
        '''
    ...
    def archive_on_destroy(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#archive_on_destroy Repository#archive_on_destroy}
        '''
    ...
    def auto_init(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#auto_init Repository#auto_init}
        '''
    ...
    def default_branch(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#default_branch Repository#default_branch}
        '''
    ...
    def delete_branch_on_merge(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#delete_branch_on_merge Repository#delete_branch_on_merge}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#description Repository#description}
        '''
    ...
    def gitignore_template(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#gitignore_template Repository#gitignore_template}
        '''
    ...
    def has_discussions(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#has_discussions Repository#has_discussions}
        '''
    ...
    def has_downloads(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#has_downloads Repository#has_downloads}
        '''
    ...
    def has_issues(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#has_issues Repository#has_issues}
        '''
    ...
    def has_projects(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#has_projects Repository#has_projects}
        '''
    ...
    def has_wiki(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#has_wiki Repository#has_wiki}
        '''
    ...
    def homepage_url(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#homepage_url Repository#homepage_url}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#id Repository#id}.
    ...
    def ignore_vulnerability_alerts_during_read(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#ignore_vulnerability_alerts_during_read Repository#ignore_vulnerability_alerts_during_read}
        '''
    ...
    def is_template(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#is_template Repository#is_template}
        '''
    ...
    def license_template(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#license_template Repository#license_template}
        '''
    ...
    def merge_commit_message(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#merge_commit_message Repository#merge_commit_message}
        '''
    ...
    def merge_commit_title(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#merge_commit_title Repository#merge_commit_title}
        '''
    ...
    def pages(self) -> typing.Optional["RepositoryPages"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#pages Repository#pages}
        '''
    ...
    def private(
        ...
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#private Repository#private}.'''
    ...
    def security_and_analysis(self) -> typing.Optional["RepositorySecurityAndAnalysis"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#security_and_analysis Repository#security_and_analysis}
        '''
    ...
    def squash_merge_commit_message(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#squash_merge_commit_message Repository#squash_merge_commit_message}
        '''
    ...
    def squash_merge_commit_title(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#squash_merge_commit_title Repository#squash_merge_commit_title}
        '''
    ...
    def template(self) -> typing.Optional["RepositoryTemplate"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#template Repository#template}
        '''
    ...
    def topics(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#topics Repository#topics}
        '''
    ...
    def visibility(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#visibility Repository#visibility}
        '''
    ...
    def vulnerability_alerts(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#vulnerability_alerts Repository#vulnerability_alerts}
        '''
    ...
    def web_commit_signoff_required(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#web_commit_signoff_required Repository#web_commit_signoff_required}
        '''
...
class RepositoryPages:
    ...
    def build_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#build_type Repository#build_type}
        '''
    ...
    def cname(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#cname Repository#cname}
        '''
    ...
    def source(self) -> typing.Optional["RepositoryPagesSource"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#source Repository#source}
        '''
...
class RepositoryPagesOutputReference(
    ...
    def put_source(
        ...
        *,
        ...
        '''
        :param branch: The repository branch used to publish the site's source files. (i.e. 'main' or 'gh-pages'). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#branch Repository#branch}
        :param path: The repository directory from which the site publishes (Default: '/'). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#path Repository#path}
        '''
...
class RepositoryPagesSource:
    ...
    def branch(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#branch Repository#branch}
        '''
    ...
    def path(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#path Repository#path}
        '''
...
class RepositorySecurityAndAnalysis:
    ...
    def advanced_security(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#advanced_security Repository#advanced_security}
        '''
    ...
    def secret_scanning(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#secret_scanning Repository#secret_scanning}
        '''
    ...
    def secret_scanning_push_protection(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#secret_scanning_push_protection Repository#secret_scanning_push_protection}
        '''
...
class RepositorySecurityAndAnalysisAdvancedSecurity:
    def __init__(self, *, status: builtins.str) -> None:
        '''
        :param status: Set to 'enabled' to enable advanced security features on the repository. Can be 'enabled' or 'disabled'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#status Repository#status}
        '''
        if __debug__:
    ...
    def status(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#status Repository#status}
        '''
...
class RepositoryTemplate:
    ...
    def owner(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#owner Repository#owner}
        '''
    ...
    def repository(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#repository Repository#repository}
        '''
    ...
    def include_all_branches(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.2/docs/resources/repository#include_all_branches Repository#include_all_branches}
        '''
