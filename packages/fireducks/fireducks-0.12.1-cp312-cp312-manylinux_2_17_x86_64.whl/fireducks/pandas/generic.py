...
class FireDucksPandasCompat(
    ...
    def sample(self, *args, **kwargs):
        ...
        return self._take(
            sampled_indices, axis=axis, ignore_index=ignore_index
        )
    ...
    def _take(self, indices, axis=0, ignore_index=False):
        ...
        return self.__class__._create(
            ir.take(self._value, input_indices, axis, ignore_index)
        )
