...
from overwatch_sayak.detection.utils import cross_product
from overwatch_sayak.draw.color import Color
from overwatch_sayak.draw.utils import draw_text
from overwatch_sayak.geometry.core import Point, Position, Vector
from overwatch_sayak.utils.internal import OverwatchWarnings
...
class LineZone:
    ...
    <video controls>
        <source
            src="https://media.roboflow.com/overwatch/cookbooks/count-objects-crossing-the-line-result-1280x720.mp4"
            type="video/mp4">
    </video>
    ...
    Example:
        ...
        tracker = ov.ByteTrack()
        frames_generator = ov.get_video_frames_generator(<SOURCE_VIDEO_PATH>)
        start, end = ov.Point(x=0, y=1080), ov.Point(x=3840, y=1080)
        line_zone = ov.LineZone(start=start, end=end)
    ...
    def __init__(
        ...
        Args:
            ...
            triggering_anchors (List[ov.Position]): A list of positions
    ...
    def trigger(self, detections: Detections) -> Tuple[np.ndarray, np.ndarray]:
        ...
        if detections.tracker_id is None:
            warnings.warn(
                ...
                "https://overwatch.roboflow.com/latest/trackers for more "
                "information.",
