...
from overwatch_sayak import Detections
from overwatch_sayak.detection.utils import clip_boxes, polygon_to_mask
from overwatch_sayak.draw.color import Color
from overwatch_sayak.draw.utils import draw_polygon, draw_text
from overwatch_sayak.geometry.core import Position
from overwatch_sayak.geometry.utils import get_polygon_center
from overwatch_sayak.utils.internal import OverwatchWarnings, deprecated_parameter
...
class PolygonZone:
    ...
    @deprecated_parameter(
        ...
        "be remove in  overwatch-0.23.0`. Use '{new_parameter}' "
        "instead.",
    )
    def __init__(
        self,
        ...
        if frame_resolution_wh is not None:
            warnings.warn(
                ...
                "dropped in version overwatch-0.24.0. The mask resolution is now "
