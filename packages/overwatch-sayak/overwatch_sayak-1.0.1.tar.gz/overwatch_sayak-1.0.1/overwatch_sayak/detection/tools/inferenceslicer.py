...
from overwatch_sayak.detection.overlap_filter import OverlapFilter, validate_overlap_filter
from overwatch_sayak.detection.utils import move_boxes, move_masks
from overwatch_sayak.utils.image import crop_image
...
def move_detections(
    ...
    """
    Args:
        detections (ov.Detections): Detections object to be moved.
    ...
    Returns:
        (ov.Detections) repositioned Detections object.
    """
...
class InferenceSlicer:
    ...
    def __call__(self, image: np.ndarray) -> Detections:
        ...
        Example:
            ...
            def callback(image_slice: np.ndarray) -> ov.Detections:
                result = model(image_slice)[0]
                return ov.Detections.from_ultralytics(result)

            slicer = ov.InferenceSlicer(
                callback=callback,
                overlap_filter_strategy=ov.OverlapFilter.NON_MAX_SUPPRESSION,
            )
