...
#define t _nt->_t
#define dt _nt->_dt
#define Ves _ml->template fpfield<0>(_iml)
#define Ves_columnindex 0
#define B _ml->template fpfield<1>(_iml)
#define B_columnindex 1
#define Ach _ml->template fpfield<2>(_iml)
...
#define DVes _ml->template fpfield<5>(_iml)
#define DVes_columnindex 5
#define DB _ml->template fpfield<6>(_iml)
#define DB_columnindex 6
#define DAch _ml->template fpfield<7>(_iml)
#define DAch_columnindex 7
#define DX _ml->template fpfield<8>(_iml)
#define DX_columnindex 8
#define b _ml->template fpfield<9>(_iml)
#define b_columnindex 9
#define kt _ml->template fpfield<10>(_iml)
#define kt_columnindex 10
#define kpow _ml->template fpfield<11>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"Ves"} /* 0 */,
                                       _nrn_mechanism_field<double>{"B"} /* 1 */,
                                       _nrn_mechanism_field<double>{"Ach"} /* 2 */,
                                       _nrn_mechanism_field<double>{"X"} /* 3 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 4 */,
                                       _nrn_mechanism_field<double>{"DVes"} /* 5 */,
                                       _nrn_mechanism_field<double>{"DB"} /* 6 */,
                                       _nrn_mechanism_field<double>{"DAch"} /* 7 */,
                                       _nrn_mechanism_field<double>{"DX"} /* 8 */,
                                       _nrn_mechanism_field<double>{"b"} /* 9 */,
                                       _nrn_mechanism_field<double>{"kt"} /* 10 */,
                                       _nrn_mechanism_field<double>{"kpow"} /* 11 */,
...
static int _reset;
static const char *modelname = "transmitter release";
...
/*static int _ode_matsol1(_internalthreadargsproto_);*/
 ...
 static int release (void* _so, double* _rhs, _internalthreadargsproto_);
...
{
  cai = _ion_cai;
 {  sparse_thread(&(_thread[_spth1].literal_value<void*>()), 4, _slist1, _dlist1, neuron::scopmath::row_view{_ml, _iml}, &t, dt, release, _linmat1, _threadargs_);
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 4; ++_i) {
...
static void _initlists(){
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = {Ach_columnindex, 0};  _dlist1[0] = {DAch_columnindex, 0};
 _slist1[1] = {B_columnindex, 0};  _dlist1[1] = {DB_columnindex, 0};
 _slist1[2] = {Ves_columnindex, 0};  _dlist1[2] = {DVes_columnindex, 0};
 _slist1[3] = {X_columnindex, 0};  _dlist1[3] = {DX_columnindex, 0};
_first = 0;
}
