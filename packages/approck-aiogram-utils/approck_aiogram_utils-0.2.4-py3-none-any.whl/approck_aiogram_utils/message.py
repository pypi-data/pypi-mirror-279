...
async def send_message(
    ...
    try:
        ...
        await callback_call(message=message, callback=on_forbidden_callback)
        ...
        if "USER_IS_BLOCKED" in exc.message:
            ...
            await callback_call(message=message, exc=exc, callback=on_failure_callback)
    ...
    await callback_call(message=message, callback=on_success_callback)
