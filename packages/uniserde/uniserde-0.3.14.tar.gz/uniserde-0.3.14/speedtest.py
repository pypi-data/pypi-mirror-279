...
def main():
    ...
    uniserde.from_json(as_json, ChildClass)
    ...
    print(
        "uniserde eager",
        timeit.timeit(
            lambda: uniserde.from_json(copy.deepcopy(RAW), Model, lazy=False),
            number=number,
        ),
    )
    ...
    print(
        "uniserde lazy",
        timeit.timeit(
            lambda: uniserde.from_json(copy.deepcopy(RAW), Model, lazy=True),
            number=number,
        ),
    )
