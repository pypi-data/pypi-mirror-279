...
def create_config_json(
    model_name: str, params: Dict, model_path: str = "./models"
) -> None:
    """
    ...
    Parameters:
        ...
        - params (Dict): A dictionary of model's parameters.
...
def read_config(model_name: str, model_path: str = "./models"):
    ...
    try:
        ...
        print(f"Error: The configuration file was not found. {fnf_error}")
        raise
