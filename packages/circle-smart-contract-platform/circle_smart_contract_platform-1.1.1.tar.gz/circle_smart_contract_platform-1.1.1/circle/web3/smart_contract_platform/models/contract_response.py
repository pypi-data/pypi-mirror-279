...
class ContractResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractResponse:
        """Create an instance of ContractResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractResponse.parse_obj(obj)
        ...
        _obj = ContractResponse.parse_obj({
