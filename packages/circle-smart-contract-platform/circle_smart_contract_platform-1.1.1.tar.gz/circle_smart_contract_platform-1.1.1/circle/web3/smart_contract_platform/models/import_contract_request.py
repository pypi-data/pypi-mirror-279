...
class ImportContractRequest(BaseModel):
    ...
    name: StrictStr = Field(..., description="The name for a contract.")
    description: Optional[StrictStr] = Field(None, description="The description for a contract.")
    address: StrictStr = Field(..., description="Address of the contract to import.")
    blockchain: Blockchain = Field(...)
    __properties = ["idempotencyKey", "name", "description", "address", "blockchain"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImportContractRequest:
        """Create an instance of ImportContractRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImportContractRequest:
        """Create an instance of ImportContractRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImportContractRequest.parse_obj(obj)
        ...
        _obj = ImportContractRequest.parse_obj({
