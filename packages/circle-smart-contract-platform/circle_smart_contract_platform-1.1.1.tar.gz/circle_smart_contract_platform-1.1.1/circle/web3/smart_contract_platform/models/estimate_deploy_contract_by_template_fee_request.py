...
class EstimateDeployContractByTemplateFeeRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateDeployContractByTemplateFeeRequest:
        """Create an instance of EstimateDeployContractByTemplateFeeRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateDeployContractByTemplateFeeRequest:
        """Create an instance of EstimateDeployContractByTemplateFeeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateDeployContractByTemplateFeeRequest.parse_obj(obj)
        ...
        _obj = EstimateDeployContractByTemplateFeeRequest.parse_obj({
