...
class ContractDeploymentEstimateFeeResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractDeploymentEstimateFeeResponse:
        """Create an instance of ContractDeploymentEstimateFeeResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractDeploymentEstimateFeeResponse:
        """Create an instance of ContractDeploymentEstimateFeeResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractDeploymentEstimateFeeResponse.parse_obj(obj)
        ...
        _obj = ContractDeploymentEstimateFeeResponse.parse_obj({
