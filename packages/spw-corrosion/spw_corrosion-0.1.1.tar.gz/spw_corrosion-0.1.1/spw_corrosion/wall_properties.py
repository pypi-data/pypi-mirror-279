...
if __name__ == "__main__":
    ...
    W_x = wall.reduce_thickness(C_grid)

    reduction_model_intercept = W_x[0]
    reduction_model_slope = (W_x[-1] - W_x[0]) / (C_grid[-1] - C_grid[0])
    W_X_model = reduction_model_intercept + reduction_model_slope * C_grid
