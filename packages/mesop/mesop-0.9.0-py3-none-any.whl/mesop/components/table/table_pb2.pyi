...
class TableHeader(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["sticky", b"sticky"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["sticky", b"sticky"]) -> None: ...
...
class TableType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["header", b"header", "on_table_click_event_handler_id", b"on_table_click_event_handler_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["columns", b"columns", "data_source", b"data_source", "displayed_columns", b"displayed_columns", "header", b"header", "on_table_click_event_handler_id", b"on_table_click_event_handler_id"]) -> None: ...
