...
class RadioType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["color", b"color", "disabled", b"disabled", "label_position", b"label_position", "name", b"name", "on_radio_change_event_handler_id", b"on_radio_change_event_handler_id", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["color", b"color", "disabled", b"disabled", "label_position", b"label_position", "name", b"name", "on_radio_change_event_handler_id", b"on_radio_change_event_handler_id", "options", b"options", "value", b"value"]) -> None: ...
