...
class InputType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["appearance", b"appearance", "autosize", b"autosize", "color", b"color", "disabled", b"disabled", "float_label", b"float_label", "hide_required_marker", b"hide_required_marker", "hint_label", b"hint_label", "id", b"id", "is_native_textarea", b"is_native_textarea", "is_textarea", b"is_textarea", "label", b"label", "max_rows", b"max_rows", "min_rows", b"min_rows", "on_enter_handler_id", b"on_enter_handler_id", "on_input_handler_id", b"on_input_handler_id", "placeholder", b"placeholder", "readonly", b"readonly", "required", b"required", "rows", b"rows", "subscript_sizing", b"subscript_sizing", "type", b"type", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["appearance", b"appearance", "autosize", b"autosize", "color", b"color", "disabled", b"disabled", "float_label", b"float_label", "hide_required_marker", b"hide_required_marker", "hint_label", b"hint_label", "id", b"id", "is_native_textarea", b"is_native_textarea", "is_textarea", b"is_textarea", "label", b"label", "max_rows", b"max_rows", "min_rows", b"min_rows", "on_enter_handler_id", b"on_enter_handler_id", "on_input_handler_id", b"on_input_handler_id", "placeholder", b"placeholder", "readonly", b"readonly", "required", b"required", "rows", b"rows", "subscript_sizing", b"subscript_sizing", "type", b"type", "value", b"value"]) -> None: ...
