...
# %% ../../nbs/google/GSheet.ipynb 4
def get_spreadsheet_by_id(spreadsheet_id, service):
    return (
...
def get_sheets(spreadsheet_id=None, service=None, spreadsheet=None):
    spreadsheet = (
        spreadsheet
...
class GSpreadsheet:
    ...
    def get_sheets(self, return_raw: bool = False):
        sheets = get_sheets(spreadsheet=self.spreadsheet)
