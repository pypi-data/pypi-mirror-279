...
import tempfile
import gradio as gr
from etao_ds_langchain.rag.qa_corpus.qa_generator import RagQAGenerator
...
unstructured_api_url = "https://etao_ds.dataelem.com/api/v1/etl4llm/predict"
...
with tempfile.TemporaryDirectory(dir=tmpdir) as tmpdir:
    with gr.Blocks(css='#margin-top {margin-top: 15px} #center {text-align: center;} #description {text-align: center}') as demo:
        with gr.Row(elem_id='center'):
            gr.Markdown('# etao_ds qa auto generation Demo')
