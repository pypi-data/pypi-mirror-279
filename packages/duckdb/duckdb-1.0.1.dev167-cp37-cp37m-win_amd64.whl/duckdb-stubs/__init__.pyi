...
class DuckDBPyConnection:
    ...
    def execute(self, query: object, parameters: object = None, multiple_parameter_sets: bool = False) -> DuckDBPyConnection: ...
    ...
    def get_table_names(self, query: str) -> List[str]: ...
...
def execute(query: object, parameters: object = None, multiple_parameter_sets: bool = False, *, connection: DuckDBPyConnection = ...) -> DuckDBPyConnection: ...
...
def get_table_names(query: str, *, connection: DuckDBPyConnection = ...) -> List[str]: ...
...
def write_csv(df: pandas.DataFrame, *args: Any, connection: DuckDBPyConnection = ...) -> None: ...
