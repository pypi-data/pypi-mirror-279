...
from montecarlodata.common.data import DcResourceProperties, AWSArn
...
class NetworkDiscoveryTest(TestCase):
    ...
    def test_recommend_network_dispatcher(self, rs_network_recommender_mock):
        ...
        self._cloud_resource_service_mock.get_dc_resource_props.return_value = (
            collector_props
        )

        self._service.recommend_network_dispatcher(
            resource_type=resource_type, dc_id=dc_id
        )
        ...
        rs_network_recommender_mock.assert_called_once_with(
    ...
    def test_rs_network_recommender_with_filtering(
        self, ip_filtering_mock, echo_mock, sg_mock
    ):
        filtering_body, sg = ["foo", "bar", "qux"], ["sg-1234", "sg-5678"]
        SAMPLE_DC_PROPS.resources_client.describe_vpc.return_value = Box(
    ...
    def test_get_rs_routes(self):
        ...
        props.resources_client.describe_routes.assert_called_once_with(
            filter_vals=["bar"]
        )
    ...
    def test_get_rs_requester_verbiage(self):
        ...
        self.assertEqual(
            ...
            [
                "- Deploy the  'Create Requester CloudFormation stack' with the following "
                "values -",
    ...
    def test_get_rs_accepter_verbiage(self):
        ...
        self.assertEqual(
            ...
            [
                "- Deploy the  'Create Accepter CloudFormation stack' with the following "
                "values -",
