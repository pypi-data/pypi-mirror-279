...
class SparkOnboardingTest(TestCase):
    ...
    def test_spark_binary_mode_flow(self, onboard_mock):
        ...
        self._assert_onboard(
            TEST_SPARK_BINARY_MODE_CRED_MUTATION, options, onboard_mock
        )
    ...
    def test_spark_http_mode_flow(self, onboard_mock):
        ...
        self._service.onboard_spark(
            SPARK_HTTP_MODE_CONFIG_TYPE, **options, **_SAMPLE_BASE_OPTIONS
        )
    ...
    def test_spark_databricks_flow(self, onboard_mock):
        ...
        self._service.onboard_spark(
            SPARK_DATABRICKS_CONFIG_TYPE, **options, **_SAMPLE_BASE_OPTIONS
        )
