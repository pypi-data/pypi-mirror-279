...
AMBIGUOUS_COLLECTOR_ERROR_MESSAGE = (
    "Multiple data collectors found. Please specify a collector."
)
...
def prompt_connection(message: str, skip_prompt: Optional[bool] = False) -> None:
    """
