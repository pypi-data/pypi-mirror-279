longtext = """# Audio2Vector: Audio to Vector Conversion Package
...
audio_data = processor.audio2Vec2DfProcessor('path_to_your_audio_file.wav')

# Convert audio to Python-list
list = processor.audio2ListProcessor('path_to_your_audio_file.wav')

# convert audio to raw Vectors
vector = processor.audio2VectorProcessor('path_to_your_audio_file.wav')
