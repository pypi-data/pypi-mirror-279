...
class Audio2Vec:
    ...
    def hashedString2Vec(self, hashedString):
        ...
        hashedStrings = self.hasher.transform([hashedString])
        hashedStrings = hashedStrings.toarray().tolist()[0]
...
if __name__ == "__main__":
    test = Audio2Vec().audio2ListProcessor("abuse_female_scream.wav")
    print(test)
    print(test)
