...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_disconnect_relay() != 63825:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_dislike() != 45018:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_file_metadata() != 184:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_get_events_from() != 26170:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_get_events_of() != 65200:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_gift_wrap() != 2702:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_handle_notifications() != 8916:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_like() != 15887:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_mute_public_keys() != 39159:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_reaction() != 22977:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_reconcile() != 20435:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_remove_relay() != 5421:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_repost() != 40218:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_direct_msg() != 1848:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event() != 21572:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event_builder() != 45356:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event_builder_to() != 10153:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event_to() != 46323:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_msg() != 23270:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_msg_to() != 33600:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_private_msg() != 36975:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_set_metadata() != 62641:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_signer() != 31951:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_start() != 56287:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_stop() != 5883:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_subscribe() != 42253:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_subscribe_to() != 52934:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_subscribe_with_id() != 40087:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_subscribe_with_id_to() != 23017:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_negentropyoptions_initial_timeout() != 40199:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_nip46signer_nostr_connect_uri() != 42112:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_nip46signer_signer_public_key() != 60994:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_nostrconnectremotesigner_nostr_connect_uri() != 15397:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_document() != 55628:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_get_events_of() != 45379:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_queue() != 23174:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_reconcile() != 28623:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_reconcile_with_items() != 36069:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_status() != 14630:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_stop() != 30140:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_support_negentropy() != 5020:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_terminate() != 14116:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_add_relay() != 60070:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_batch_event() != 42567:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_batch_event_to() != 41056:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_batch_msg() != 64663:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_batch_msg_to() != 28777:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_disconnect() != 51163:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_get_events_from() != 4190:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_get_events_of() != 43124:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_handle_notifications() != 30926:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_reconcile() != 23893:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_reconcile_with_items() != 24471:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_remove_relay() != 40859:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_send_event() != 42595:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_send_event_to() != 2470:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_send_msg() != 42206:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_send_msg_to() != 32868:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_shutdown() != 24603:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_start() != 5721:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_stop() != 12232:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_subscribe() != 14801:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_subscribe_to() != 43114:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_subscribe_with_id() != 64497:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_subscribe_with_id_to() != 64099:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_nostrdatabase_custom() != 63992:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_nostrdatabase_sqlite() != 42455:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD1 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_I8,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD2 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_I8,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD3 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_I8,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD4 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_I8,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD5 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_I8,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD6 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,_UniffiRustBuffer,UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD7 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_RUST_BUFFER,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD8 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UniffiRustBuffer,UNIFFI_FOREIGN_FUTURE_COMPLETE_U64,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD9 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UniffiRustBuffer,UNIFFI_FOREIGN_FUTURE_COMPLETE_RUST_BUFFER,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD10 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD11 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_HANDLE_NOTIFICATION_METHOD0 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UniffiRustBuffer,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_HANDLE_NOTIFICATION_METHOD1 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UniffiRustBuffer,_UniffiRustBuffer,ctypes.c_void_p,UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
UNIFFI_CALLBACK_INTERFACE_NOSTR_CONNECT_SIGNER_ACTIONS_METHOD0 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UniffiRustBufferNip46Request,ctypes.POINTER(ctypes.c_int8),
    ctypes.POINTER(_UniffiRustCallStatus),
)
class UniffiVTableCallbackInterfaceCustomNostrDatabase(ctypes.Structure):
    _fields_ = [
        ...
        ("count", UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD8),
        ("query", UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD9),
        ("delete", UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD10),
        ("wipe", UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD11),
...
class UniffiVTableCallbackInterfaceNostrConnectSignerActions(ctypes.Structure):
    _fields_ = [
        ("approve", UNIFFI_CALLBACK_INTERFACE_NOSTR_CONNECT_SIGNER_ACTIONS_METHOD0),
        ("uniffi_free", UNIFFI_CALLBACK_INTERFACE_FREE),
    ]
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_send_direct_msg.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_start.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_stop.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_stop.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_nip46signer_nostr_connect_uri.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_nostrconnectremotesigner_nostr_connect_uri.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_nostrconnectremotesigner_nostr_connect_uri.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_init_callback_vtable_nostrconnectsigneractions.argtypes = (
    ctypes.POINTER(UniffiVTableCallbackInterfaceNostrConnectSignerActions),
)
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relay_stop.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relay_terminate.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaypool_start.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaypool_stop.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaypool_stop.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_checksum_method_nostrconnectremotesigner_nostr_connect_uri.argtypes = (
)
_UniffiLib.uniffi_nostr_sdk_ffi_checksum_method_nostrconnectremotesigner_nostr_connect_uri.restype = ctypes.c_uint16
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def dislike(self, event: "Event") -> "EventId":
        """
        Disike event
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def file_metadata(self, description: "str",metadata: "FileMetadata") -> "EventId":
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def get_events_of(self, filters: "typing.List[Filter]",timeout: "typing.Optional[Duration]") -> "typing.List[Event]":
        _UniffiConverterSequenceTypeFilter.check_lower(filters)
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def gift_wrap(self, receiver: "PublicKey",rumor: "EventBuilder",expiration: "typing.Optional[Timestamp]") -> None:
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def like(self, event: "Event") -> "EventId":
        """
        Like event
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def reaction(self, event: "Event",reaction: "str") -> "EventId":
        """
        React to an [`Event`]
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def reconcile(self, filter: "Filter",opts: "NegentropyOptions") -> None:
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def repost(self, event: "Event",relay_url: "typing.Optional[str]") -> "EventId":
        """
        Repost
        """
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_direct_msg(self, receiver: "PublicKey",msg: "str",reply: "typing.Optional[EventId]") -> "EventId":
        """
        Encrypted direct msg
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_send_direct_msg(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypePublicKey.lower(receiver),
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_event_builder(self, builder: "EventBuilder") -> "EventId":
        """
        Take an [`EventBuilder`], sign it by using the [`NostrSigner`] and broadcast to all relays.
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_event_builder_to(self, urls: "typing.List[str]",builder: "EventBuilder") -> "EventId":
        """
        Take an [`EventBuilder`], sign it by using the [`NostrSigner`] and broadcast to specific relays.
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_event_to(self, urls: "typing.List[str]",event: "Event") -> "EventId":
        _UniffiConverterSequenceString.check_lower(urls)
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_msg(self, msg: "ClientMessage") -> None:
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_msg_to(self, urls: "typing.List[str]",msg: "ClientMessage") -> None:
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_private_msg(self, receiver: "PublicKey",message: "str",reply_to: "typing.Union[object, typing.Optional[EventId]]" = _DEFAULT) -> None:
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def set_metadata(self, metadata: "Metadata") -> "EventId":
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def start(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_start(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_void,
    ...
    async def stop(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_stop(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_void,
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def subscribe(self, filters: "typing.List[Filter]",opts: "typing.Union[object, typing.Optional[SubscribeAutoCloseOptions]]" = _DEFAULT) -> "str":
        """
        Subscribe to filters to all connected relays
    ...
    async def subscribe_to(self, urls: "typing.List[str]",filters: "typing.List[Filter]",opts: "typing.Union[object, typing.Optional[SubscribeAutoCloseOptions]]" = _DEFAULT) -> "str":
        """
        Subscribe to filters to specific relays
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def subscribe_with_id(self, id: "str",filters: "typing.List[Filter]",opts: "typing.Union[object, typing.Optional[SubscribeAutoCloseOptions]]" = _DEFAULT) -> None:
    ...
    async def subscribe_with_id_to(self, urls: "typing.List[str]",id: "str",filters: "typing.List[Filter]",opts: "typing.Union[object, typing.Optional[SubscribeAutoCloseOptions]]" = _DEFAULT) -> None:
...
class CustomNostrDatabaseImpl:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_free_customnostrdatabase, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_clone_customnostrdatabase, self._pointer)
    ...
    def backend(self, ) -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_customnostrdatabase_backend,self._uniffi_clone_pointer(),)
        )
...
class UniffiTraitImplCustomNostrDatabase:
    ...
    def save_event(
        ...
        uniffi_out_return[0] = uniffi_trait_interface_call_async_with_error(make_call, handle_success, handle_error, NostrSdkError, _UniffiConverterTypeNostrSdkError.lower)
...
class HandleNotificationImpl:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_free_handlenotification, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_clone_handlenotification, self._pointer)
...
class Nwc:
    ...
    def __init__(self, uri: "NostrWalletConnectUri"):
        ...
        self._pointer = _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_nwc_new,
    ...
    def with_opts(cls, uri: "NostrWalletConnectUri",opts: "NostrWalletConnectOptions"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_nwc_with_opts,
        _UniffiConverterTypeNostrWalletConnectURI.lower(uri),
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def nostr_connect_uri(self, ) -> "NostrConnectUri":
        """
        Get Nostr Connect URI in **bunker** format.
        """

        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_nip46signer_nostr_connect_uri(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_pointer,
...
class NostrConnectRemoteSigner:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_free_nostrconnectremotesigner, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_clone_nostrconnectremotesigner, self._pointer)
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def nostr_connect_uri(self, ) -> "NostrConnectUri":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_nostrconnectremotesigner_nostr_connect_uri(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_pointer,
...
class NostrConnectSignerActionsImpl:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_free_nostrconnectsigneractions, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_clone_nostrconnectsigneractions, self._pointer)
    ...
    def approve(self, req: "Nip46Request") -> "bool":
        ...
        return _UniffiConverterBool.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_nostrconnectsigneractions_approve,self._uniffi_clone_pointer(),
...
# Put all the bits inside a class to keep the top-level namespace clean
class UniffiTraitImplNostrConnectSignerActions:
    # For each method, generate a callback function to pass to Rust

    @UNIFFI_CALLBACK_INTERFACE_NOSTR_CONNECT_SIGNER_ACTIONS_METHOD0
    def approve(
            uniffi_handle,
            req,
            uniffi_out_return,
    ...
    # Generate the FFI VTable.  This has a field for each callback interface method.
    uniffi_vtable = UniffiVTableCallbackInterfaceNostrConnectSignerActions(
        approve,
        uniffi_free
    )
    # Send Rust a pointer to the VTable.  Note: this means we need to keep the struct alive forever,
    # or else bad things will happen when Rust tries to access it.
    _UniffiLib.uniffi_nostr_sdk_ffi_fn_init_callback_vtable_nostrconnectsigneractions(ctypes.byref(uniffi_vtable))
...
class NostrZapper:
    ...
    def nwc(cls, client: "Nwc"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_nostrzapper_nwc,
...
class Options:
    ...
    def automatic_authentication(self, enabled: "bool") -> "Options":
        ...
        return _UniffiConverterTypeOptions.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_options_automatic_authentication,self._uniffi_clone_pointer(),
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def reconcile_with_items(self, filter: "Filter",items: "typing.List[NegentropyItem]",opts: "NegentropyOptions") -> None:
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def stop(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relay_stop(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_void,
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def terminate(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relay_terminate(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_void,
...
class RelayLimits:
    ...
    def event_max_num_tags_per_kind(self, kind: "Kind",max_num_tags: "typing.Optional[int]") -> "RelayLimits":
        ...
        return _UniffiConverterTypeRelayLimits.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaylimits_event_max_num_tags_per_kind,self._uniffi_clone_pointer(),
    ...
    def event_max_size_per_kind(self, kind: "Kind",max_size: "typing.Optional[int]") -> "RelayLimits":
        ...
        return _UniffiConverterTypeRelayLimits.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaylimits_event_max_size_per_kind,self._uniffi_clone_pointer(),
        _UniffiConverterTypeKind.lower(kind),
        _UniffiConverterOptionalUInt32.lower(max_size))
        )
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def batch_event_to(self, urls: "typing.List[str]",events: "typing.List[Event]",opts: "RelaySendOptions") -> None:
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def batch_msg_to(self, urls: "typing.List[str]",msgs: "typing.List[ClientMessage]",opts: "RelaySendOptions") -> None:
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_event_to(self, urls: "typing.List[str]",event: "Event",opts: "RelaySendOptions") -> "EventId":
        """
        Send event to **specific relays** and wait for `OK` message
        """
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_msg_to(self, urls: "typing.List[str]",msg: "ClientMessage",opts: "RelaySendOptions") -> None:
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def start(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaypool_start(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_void,
    ...
    async def stop(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaypool_stop(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_void,
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def subscribe_to(self, urls: "typing.List[str]",filters: "typing.List[Filter]",opts: "SubscribeOptions") -> "str":
        """
        Subscribe to filters to specific relays
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def subscribe_with_id_to(self, urls: "typing.List[str]",id: "str",filters: "typing.List[Filter]",opts: "SubscribeOptions") -> None:
