...
class OperationModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, operation_id, status, percent_complete, *args, **kwargs):  # noqa: E501
        """OperationModel - a model defined in OpenAPI

        Args:
            operation_id (str):
            status (str): The status of the operation
            percent_complete (float): The progress made by the operation out of 100
    ...
    @convert_js_args_to_python_args
    def __init__(self, operation_id, status, percent_complete, *args, **kwargs):  # noqa: E501
        """OperationModel - a model defined in OpenAPI
