...
class ServerlessSpec(ModelNormal):
    ...
    def _from_openapi_data(cls, cloud, region, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            region (str): The region where you would like your index to be created.  Serverless indexes can be created only in the us-west-2 and us-east-1 regions of AWS at this time.
