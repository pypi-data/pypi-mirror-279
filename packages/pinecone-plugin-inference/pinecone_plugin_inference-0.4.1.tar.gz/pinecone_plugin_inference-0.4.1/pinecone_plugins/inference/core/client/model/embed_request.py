...
def lazy_import():
    ...
    globals()['EmbedRequestParameters'] = EmbedRequestParameters
...
class EmbedRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'model': (str,),  # noqa: E501
            'inputs': ([EmbedRequestInputs],),  # noqa: E501
            'parameters': (EmbedRequestParameters,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, model, inputs, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, model, inputs, *args, **kwargs):  # noqa: E501
        """EmbedRequest - a model defined in OpenAPI
