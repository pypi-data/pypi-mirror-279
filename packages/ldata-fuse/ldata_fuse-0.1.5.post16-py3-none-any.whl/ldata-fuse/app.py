...
class LDataFile:
    ...
    presigned_urls: dict[int, Coroutine[Any, Any, str]] = {}
    ...
    def _download(self):
        ...
        async def schedule_downloads(content_size: int):
            ...
            self.presigned_urls = {i: get_signed_url() for i in range(nrof_urls)}
        ...
        async def download_part(i: int):
            ...
            url = await self.presigned_urls[i % len(self.presigned_urls)]
