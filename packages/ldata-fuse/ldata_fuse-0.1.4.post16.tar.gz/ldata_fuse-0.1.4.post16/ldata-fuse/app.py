...
def syscall_impl(
    f: Callable[Concatenate[T, Context, P], R]
    ...
    def inner(self: T, *args: P.args, **kwargs: P.kwargs) -> R | int:
        ...
        curr_context = get_current()
        try:
            res = f(self, curr_context, *args, **kwargs)
            span.set_attribute("result", json.dumps(res))
...
class LDataFile:
    ...
    @syscall_impl
    def read(self, ctx: Context, size, offset):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
    ...
    @syscall_impl
    def write(self, ctx: Context, data: bytes, offset: int):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
...
class LDataFS(Fuse):
    ...
    @syscall_impl
    def getattr(self, ctx: Context, path: str):
    ...
    @syscall_impl
    def mkdir(self, ctx: Context, path: str, mode: int):
        span = get_current_span(ctx)
    ...
    @syscall_impl
    def rmdir(self, ctx: Context, path: str):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
                {
    ...
    @syscall_impl
    def unlink(self, ctx: Context, path: str):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
                {
    ...
    @syscall_impl
    def mknod(self, ctx: Context, path: str, mode: int, device: int):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
                {
    ...
    @syscall_impl
    def truncate(self, ctx: Context, path, size):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
                {"path": path, "size": size},
    ...
    @syscall_impl
    def chmod(self, ctx: Context, path: str, mode: int):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
                {"path": path, "mode": human_readable_mode(mode), "mode.raw": mode},
    ...
    @syscall_impl
    def chown(self, ctx: Context, path: str, uid: int, gid: int):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
    ...
    @syscall_impl
    def utimens(self, ctx: Context, path: str, a_time: float, m_time: float):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
    ...
    @syscall_impl
    def utime(self, ctx: Context, path: str, a_time: float, m_time: float):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
                {"path": path, "a_time": a_time, "m_time": m_time},
    ...
    @syscall_impl
    def rename(self, ctx: Context, src: str, dst: str):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
                {
    ...
    @syscall_impl
    def fallocate(self, ctx: Context, fd: int, mode: int, offset: int, len: int):
        span = get_current_span(ctx)
        span.set_attributes(
            dict_to_attrs(
