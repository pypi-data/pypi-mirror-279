...
def playground(
    ...
    response = backend_client.get_playground(
        ...
        auth_access_token)
    playground_id = response.playground_id
    llm_program_id = response.llm_program_id
    llm_program_snapshot_id = response.llm_program_snapshot_id
    ...
    with client.connect(
        **backend_client.get_playground_websocket_args(
        ...
        for message in websocket:
            ...
            websocket.send(response.model_dump_json())
