...
import contextlib
import datetime
from typing import Dict, Generator, Iterator, List, Literal, NamedTuple, Optional, Tuple, Union
    ...
    with futures.ProcessPoolExecutor(
        ...
        with progress.Progress() as progress_bar:
            ...
            for future in futures.as_completed(test_case_futures):
                ...
                invalid_quality_measures = test_case_result.invalid_quality_measures
