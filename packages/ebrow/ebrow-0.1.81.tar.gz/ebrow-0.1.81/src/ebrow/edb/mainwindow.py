...
class MainWindow(QMainWindow):
    ...
    def __init__(self, app: QApplication, isBatchRMOB: bool = False, isBatchReport: bool = False, verboseLog: bool = True):
        ...
        if not (isBatchRMOB or isBatchReport):
    ...
    def postInit(self):
        ...
        if self.isBatchRMOB or self.isBatchReport:
