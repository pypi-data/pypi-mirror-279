...
class Report:
    ...
    def _buildSiteInfosTable(self):
        ...
        if not self._ui.chkSiteInfosExc.isChecked():
            ...
            rdfDict['12'] = ['Software: ', 'Echoes v.', self._echoesVer, ' + Ebrow v.', self._parent.version]
    ...
    def _reportHTML(self):
        ...
        if self._parent.covID < 2 or self._totalDays < 2:
            ...
            if not self._parent.isBatchReport:
...
'''.format(df.loc['7', 'B'], df.loc['7', 'D'], df.loc['7', 'F'],
           ...
           df.loc['11', 'B'],
           df.loc['12', 'C'], df.loc['12', 'E'],
           df.loc['13', 'B'], df.loc['14', 'B'])
