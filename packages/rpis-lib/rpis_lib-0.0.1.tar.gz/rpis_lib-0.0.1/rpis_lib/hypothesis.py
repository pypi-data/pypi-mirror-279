...
from classes.results import IsUniformResult, IsPoissonResult
from rpis_lib import poisson_lambda
from classes.parts import MeanPart, ProportionMeanPart, VariationEstimatePart, VariationPart, DifferencePart
from classes.types import HypothesisPart, HypothesisResult


class Hypothesis:
    @staticmethod
    def is_uniform(values: list[float], alfa: float) -> HypothesisResult:
        """
    ...
    @staticmethod
    def is_poisson(values: list[float], lam: float, alfa: float) -> HypothesisResult:
        """
    ...
    @staticmethod
    def variation_estimate(values: list[float]) -> HypothesisPart:
        """
        Checks if the given values have some variation.
        :param values: values to check
        :return: Object that can be compared to float value
        """
        return VariationEstimatePart(values)

    @staticmethod
    def variation(n: int, var: float) -> HypothesisPart:
        """
