from .types import HypothesisResult, CompareHypothesisResult
...
class VariationResult(CompareHypothesisResult):
    ...
    def _str_left(self):
        return "Variation is " + ("equal to" if self.value else "less then") + f" {self.part2}"

    def _str_right(self):
        return "Variation is " + ("equal to" if self.value else "more then") + f" {self.part2}"
...
class DifferenceResult(CompareHypothesisResult):
    ...
    def _str_left(self):
        return "Mean difference is " + ("equal to" if self.value else "less then") + f" {self.part2}"

    def _str_right(self):
        return "Mean difference is " + ("equal to" if self.value else "more then") + f" {self.part2}"
...
class MeanResult(CompareHypothesisResult):
    ...
    def _str_left(self):
        return "Mean is " + ("equal to" if self.value else "less then") + f" {self.part2}"

    def _str_right(self):
        return "Mean is " + ("equal to" if self.value else "more then") + f" {self.part2}"
...
class CompareMeanResult(CompareHypothesisResult):
    ...
    def _str_left(self):
        return f"Mean of first ({self.part1}) is " + (
            "equal to" if self.value else "less then") + f" mean of second ({self.part2})"

    def _str_right(self):
        return f"Mean of first ({self.part1}) is " + (
            "equal to" if self.value else "more then") + f" mean of second ({self.part2})"
