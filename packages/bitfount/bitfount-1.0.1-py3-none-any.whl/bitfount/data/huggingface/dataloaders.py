...
class HuggingFaceBitfountDataLoader(_BaseHuggingFaceBitfountDataLoader):
    ...
    def expect_key_in_iter(self) -> bool:
        ...
        return isinstance(
            self.dataset,
            (_FileSystemHuggingFaceDataset, _FileIterableHuggingFaceDataset),
        )
...
class HuggingFaceIterableBitfountDataLoader(BitfountDataLoader):
    ...
    def _with_key_iter(
        ...
        # _FileSystemHuggingFaceDataset or _FileIterableHuggingFaceDataset.
        # In either case, this will return a type of _DataEntryAllowingTextWithKey in
        # its iteration
