...
from bitfount.config import BITFOUNT_DEFAULT_BATCHED_EXECUTION, BITFOUNT_TASK_BATCH_SIZE
                ...
                **kwargs: Any,
                ...
                try:
                    ...
                    if batched_execution and context == TaskContext.WORKER:
                        ...
                        if datasource.iterable and not isinstance(
                            datasource,
                        ...
                        # Check if datasource is of type DataView with
                        # FileSystemIterableSource or FileSystemIterableSource.ABC
                        # Only these two types of sources are supported
                        ...
                        if (
                            isinstance(
                                ...
                                (
                                    ...
                                    _DataViewFromFileIterableSource,
                                ),
                            )
                            ...
                            datasource._data_is_split = True
                    ...
                    for batch_num in range(num_batches):
                        ...
                        if batched_execution and context == TaskContext.WORKER:
                            ...
                            for algo in self.algorithms:
                                ...
                                algo.initialise_data(datasource=datasource)
