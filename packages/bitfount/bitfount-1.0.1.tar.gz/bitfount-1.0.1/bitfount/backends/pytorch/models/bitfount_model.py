...
from bitfount.backends.pytorch.models.base_models import _STEP_OUTPUT, _OptimizerType
...
from bitfount.types import T_DTYPE, EvaluateReturnType, PredictReturnType, _StrAnyDict
...
class PyTorchBitfountModel(
    ...
    def _expect_keys(
        self,
        dataloaders: Optional[Union[List[BitfountDataLoader], List[PyTorchDataLoader]]],
    ) -> bool:
