...
from bitfount.config import BITFOUNT_DATASET_CACHE_DIR, BITFOUNT_ENABLE_DATA_CACHE
...
def _setup_direct_datasource(
    ...
    # ensure that data caching support is available
        ...
        if "data_cache" in datasource_config.data_config.datasource_args:
        ...
        elif BITFOUNT_ENABLE_DATA_CACHE:
            ...
            logger.info(f"Data caching has been disabled; {BITFOUNT_ENABLE_DATA_CACHE}")
            data_persister = None
