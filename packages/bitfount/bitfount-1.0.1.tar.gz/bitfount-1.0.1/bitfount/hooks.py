...
from bitfount.config import LOG_HOOKS
...
class PodHookProtocol(HookProtocol, Protocol):
    ...
    def on_pod_init_progress(
        ...
        views_datasource_names: Optional[List[str]] = None,
...
HOOK_TYPE_TO_PROTOCOL_MAPPING: Dict[HookType, Type[HookProtocol]] = {
    ...
    HookType.MODELLER: ModellerHookProtocol,  # type: ignore[type-abstract] # Reason: see above # noqa: B950
    HookType.ALGORITHM: AlgorithmHookProtocol,  # type: ignore[type-abstract] # Reason: see above # noqa: B950
    HookType.PROTOCOL: ProtocolHookProtocol,  # type: ignore[type-abstract] # Reason: see above # noqa: B950
}
