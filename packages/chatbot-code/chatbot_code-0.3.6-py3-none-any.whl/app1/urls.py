...
from .views import index,chat,file_queries_log,chatbot_delete,chatbot_details,  upload_file,clear_all_sessions,upload_csv,custom_login_view,dashboard_view,qna_create,logout, qna_update,qna_delete,qna_delete_log,submit_feedback,verify_question,file_queries
