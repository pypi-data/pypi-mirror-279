...
class Activity(betterproto.Message):
    ...
    """
    The system-generated unique identifier for the user who created the
    activity.
    """
...
class SearchUsersRequest(betterproto.Message):
    ...
    """
    Filter is used to filter users returned in the list. Format: "username ==
    'frank'"
    """
...
class CreateUserAccessTokenRequest(betterproto.Message):
    ...
    description: str = betterproto.string_field(2)
    expires_at: Optional[datetime] = betterproto.message_field(
        3, optional=True, group="_expires_at"
    )
...
class Inbox(betterproto.Message):
    ...
    activity_id: Optional[int] = betterproto.int32_field(
        7, optional=True, group="_activity_id"
    )
...
class Resource(betterproto.Message):
    name: str = betterproto.string_field(1)
    """
    The name of the resource. Format: resources/{id} id is the system generated
    unique identifier.
    """
    ...
    memo: Optional[str] = betterproto.string_field(9, optional=True, group="_memo")
...
class Memo(betterproto.Message):
    ...
    parent_id: Optional[int] = betterproto.int32_field(
        13, optional=True, group="_parent_id"
    )
    ...
    parent: Optional[str] = betterproto.string_field(18, optional=True, group="_parent")
...
class ListMemosRequest(betterproto.Message):
    ...
    """
    A page token, received from a previous `ListMemos` call. Provide this to
    retrieve the subsequent page.
    """

    filter: str = betterproto.string_field(3)
    """
    Filter is used to filter memos returned in the list. Format: "creator ==
    'users/{uid}' && visibilities == ['PUBLIC', 'PROTECTED']"
    """
...
class SearchMemosRequest(betterproto.Message):
    filter: str = betterproto.string_field(1)
    """
    Filter is used to filter memos returned. Format: "creator == 'users/{uid}'
...
class ListMemoPropertiesRequest(betterproto.Message):
    name: str = betterproto.string_field(1)
    """
    The name of the memo. Format: memos/{id}. Use "memos/-" to list all
    properties.
    """
...
class RebuildMemoPropertyRequest(betterproto.Message):
    name: str = betterproto.string_field(1)
    """
    The name of the memo. Format: memos/{id}. Use "memos/-" to rebuild all
    memos.
    """
...
class ListMemoTagsRequest(betterproto.Message):
    ...
    """
    The parent, who owns the tags. Format: memos/{id}. Use "memos/-" to list
    all tags.
    """

    filter: str = betterproto.string_field(2)
    """
    Filter is used to filter memos. Format: "creator == 'users/{uid}' &&
    visibilities == ['PUBLIC', 'PROTECTED']"
    """
...
class ListMemoTagsResponse(betterproto.Message):
    ...
    """
    tag_amounts is the amount of tags. key is the tag name. e.g. "tag1". value
    is the amount of the tag.
    """
...
class RenameMemoTagRequest(betterproto.Message):
    parent: str = betterproto.string_field(1)
    """
    The parent, who owns the tags. Format: memos/{id}. Use "memos/-" to rename
    all tags.
    """
...
class DeleteMemoTagRequest(betterproto.Message):
    parent: str = betterproto.string_field(1)
    """
    The parent, who owns the tags. Format: memos/{id}. Use "memos/-" to delete
    all tags.
    """
...
class GetUserMemosStatsRequest(betterproto.Message):
    ...
    """
    timezone location Format: uses tz identifier
...
class GetUserMemosStatsResponse(betterproto.Message):
    ...
    """
    stats is the stats of memo creating/updating activities. key is the year-
    month-day string. e.g. "2020-01-01".
    """
