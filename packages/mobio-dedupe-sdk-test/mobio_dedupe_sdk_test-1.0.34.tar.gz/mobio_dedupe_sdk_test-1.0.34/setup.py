...
class Requirements(object):
    ...
    def get():
        ...
        requirements = ['m-singleton', 'asv', 'black', 'coverage[toml]', 'coveralls', 'flake8', 'mock', 'mypy',
                        ...
                        'python-dateutil==2.8.2', 'scikit-learn==1.5.0', 'scipy==1.10.1',
                        'simplecosine==1.2', 'six==1.16.0', 'threadpoolctl==3.1.0', 'toml==0.10.2',
                        'typing_extensions==4.5.0', 'zope.index==6.0', 'zope.interface==6.0', 'cython-npm==0.2.4']
        return requirements
    ...
    def get_link():
        ...
        :return:
        """
        requirements = ['git+https://github.com/fzimmermann89/pylbfgs.git@fzimmermann89-cython']
        return requirements


version_dev='1.0.34'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='1.0.34',  # Required, Phần này cũng không được format file.
    ...
    dependency_links=Requirements.get_link(),
