...
class Session:
    ...
    def start_session(self, request: operations.StartSessionRequestBody) -> operations.StartSessionResponse:
        r"""Start a new session"""
        hook_ctx = HookContext(operation_id='startSession', oauth2_scopes=[], security_source=self.sdk_configuration.security)
