...
class SidecarDaemon:
    ...
    def open(self, inst_id: str, stdout: IO = None) -> Selector:
        if not self.running:
            try:
...
def open_sidecar(inst_id: str, stdout: IO = None) -> Selector:
    return sidecar.open(inst_id, stdout)
