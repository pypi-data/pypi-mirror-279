...
class boligportalspiderSpider(scrapy.Spider):
    ...
    def parse_property_page(self,response, property_info= None, retry_attempt=0):
        ...
        try:
            property_info['property_rooms_amount'] = data['rooms']
        except :
            property_info['property_rooms_amount'] = None
        ...
        try:
            property_info['property_rent_currency'] = data['monthly_rent_currency']
        except :
            property_info['property_rent_currency'] = None
        ...
        try:
            property_info['longitude'] = data['location']['lon']
        except :
        ...
        try:
            property_info['address_neighborhood'] = data['city_level_3']
        except :
            property_info['address_neighborhood'] = None

        try:
            property_info['property_energy_label'] = data['energy_rating']
        except :
