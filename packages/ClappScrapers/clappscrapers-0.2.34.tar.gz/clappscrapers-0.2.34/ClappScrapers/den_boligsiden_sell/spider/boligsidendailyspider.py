...
class BoligsidendailyspiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        yield scrapy.Request(url = 'https://www.boligsiden.dk/tilsalg/villa,ejerlejlighed,raekkehus,andelsbolig,landejendom,villalejlighed?timeOnMarketMax=1',callback=self.parse_properties)
