...
class UserSession(VITAL_Node):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/vital-core#hasSessionType', 'prop_class': StringProperty}, 
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + UserSession._allowed_properties

    @classmethod
    def get_class_uri(self) -> str:
        return 'http://vital.ai/ontology/vital#UserSession'
