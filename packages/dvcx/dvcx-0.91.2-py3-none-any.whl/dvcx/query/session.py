...
from dvcx.error import TableMissingError
...
class Session:
    """
    Session is a context that keeps track of temporary DVCx datasets for a proper
    ...
    def _cleanup_temp_datasets(self) -> None:
        ...
        try:
            for dataset in self.catalog.metastore.list_datasets_by_prefix(prefix):
