...
try:
    ...
    version = snapbox.__version__
    project = snapbox.__title__
    copyright = snapbox.__copyright__
    author = snapbox.__author__
except ImportError:
    version = "0.1"
    project = "snapbox"
...
epub_identifier = "https://github.com/barseghyanartur/snapbox"  # URL or ISBN
epub_scheme = "URL"  # or "ISBN"
epub_uid = "https://github.com/barseghyanartur/snapbox"
