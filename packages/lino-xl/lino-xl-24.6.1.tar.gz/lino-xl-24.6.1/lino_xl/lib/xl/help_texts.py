...
help_texts = {
    'lino_xl.lib.accounting.fields.DcAmountField' : _("""An editable virtual PriceField to get and set both database fields amount and dc at once. It may be used only on models which also defines these two fields."""),
    ...
    'lino_xl.lib.vatless.PartnerDetailMixin' : _("""Defines a panel accounting, to be added as a tab panel to your layout’s main element."""),
    'lino_xl.lib.vatless.PartnerDetailMixin.accounting' : _("""Shows the tables vatless.VouchersByPartner and accounting.MovementsByPartner."""),
    ...
    'lino_xl.lib.accounting.AccountingPeriod' : _("""An accounting period is the smallest time slice to be observed (declare) in accounting reports. Usually it corresponds to one month. Except for some small companies which declare per quarter."""),
    ...
    'lino_xl.lib.accounting.FiscalYears' : _("""The fiscal years available in this database."""),
    ...
    'lino_xl.lib.accounting.VoucherItem.voucher' : _("""Pointer to the ledger voucher that contains this item."""),
    ...
    'lino_xl.lib.accounting.AccountingPeriodRange' : _("""A parameter panel with two fields:"""),
    'lino_xl.lib.accounting.AccountingPeriodRange.start_period' : _("""Start of observed period range."""),
    'lino_xl.lib.accounting.AccountingPeriodRange.end_period' : _("""Optional end of observed period range. Leave empty to consider only the Start period."""),
    ...
    'lino_xl.lib.trading.ProductDocItem' : _("""Model mixin for voucher items that potentially refer to a product."""),
    'lino_xl.lib.trading.ProductDocItem.product' : _("""The product that is being sold or purchased."""),
    'lino_xl.lib.trading.ProductDocItem.description' : _("""A multi-line rich text to be printed in the resulting printable document."""),
    'lino_xl.lib.trading.ProductDocItem.discount' : _("""The percentage to subtract from the price of this item."""),
    ...
    'lino_xl.lib.trading.SalesDocument' : _("""Common base class for lino_xl.lib.orders.Order and VatProductInvoice."""),
    'lino_xl.lib.trading.SalesDocument.intro' : _("""An optional introduction text to be printed on the document."""),
    'lino_xl.lib.trading.SalesDocument.print_items_table' : _("""The table (column layout) to use in the printed document."""),
