...
from .mixins import (SectorFunction, PersonHistoryEntry, HistoryByPerson,
                     CefLevel, HowWell, EducationEntryStates)
...
class StudyType(StudyOrTraining, mixins.BabelNamed):
    ...
    education_level = dd.ForeignKey('cv.EducationLevel', null=True, blank=True)
