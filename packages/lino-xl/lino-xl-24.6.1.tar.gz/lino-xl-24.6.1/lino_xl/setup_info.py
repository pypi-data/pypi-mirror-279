...
# add_package_data('lino_xl.lib.trading', 'config/trading/VatProductInvoice/*.html')
# add_package_data('lino_xl.lib.trading', 'config/trading/VatProductInvoice/*.odt')
...
# add_package_data('lino_xl.lib.accounting', 'config/contacts/Partner/*.html')
# add_package_data('lino_xl.lib.accounting', 'config/accounting/Situation/*.odt')
