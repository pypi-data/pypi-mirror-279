...
ref_model = RandomSurvivalForest(n_estimators=10, max_depth=9, random_state=2024)
...
print("Train IBS score: ", model.score(X_train, event_train, y_train), ", Test IBS score: ", model.score(X_test, event_test, y_test))
...
print("Train Harrell's c-index: ", harrell_c_index(event_train, y_train, estimates_train, times_train)[0], \
      ", Test Harrell's c-index: ", harrell_c_index(event_test, y_test, estimates_test, times_test)[0])

print("Train Uno's c-index: ", uno_c_index(event_train, y_train, event_train, y_train, estimates_train, times_train)[0],\
      ", Test Uno's c-index: ", uno_c_index(event_train, y_train, event_test, y_test, estimates_test, times_test)[0])

print("Train AUC: ", cumulative_dynamic_auc(event_train, y_train, event_train, y_train, estimates_train, times_train)[0],\
      ", Test AUC: ", cumulative_dynamic_auc(event_train, y_train, event_test, y_test, estimates_test, times_test)[0])
