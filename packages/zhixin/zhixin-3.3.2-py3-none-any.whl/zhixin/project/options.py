    ...
    [
        ...
        for option in [
            ...
            ConfigZhixinOption(
                group="generic",
                name="core",
                description="A name of Device core",
                type=click.Choice(["ARM M0+", "ARM M4"]),
                sysenvvar="ZHIXIN_DEFAULT_CORE",
            ),
            ConfigZhixinOption(
                group="generic",
                name="device",
                description="A name of development platform",
                type=click.Choice(["Z20K144M", "Z20K146M", "Z20K148M", "Z20K118N", "Z20K114M", "Z20K116M", "Z20K118M"]),
            ),
            ConfigZhixinOption(
                group="generic",
                name="default_envs",
            ...
            ConfigZhixinOption(
                ...
                multiple=True,
                sysenvvar="ZHIXIN_INCLUDE_FILES",
            ),
            ConfigZhixinOption(
                group="files",
                name="src_files",
                description=(
                    "the project C/C++ source files"
                ),
                multiple=True,
                sysenvvar="ZHIXIN_SRC_FILES",
            ),
            # Build
            ConfigZhixinOption(
                group="build",
            ...
            ConfigZhixinOption(
                ...
                name="core_dir",
                description=(
                    "ZhiXin Core location where it keeps installed development "
                    "platforms, packages, global libraries, "
                    "and other internal information"
                ),
                oldnames=["home_dir"],
                sysenvvar="ZHIXIN_CORE_DIR",
            ...
            ConfigZhixinOption(
                ...
                name="globallib_dir",
                description=(
                    "A library folder/storage where ZhiXin Library Dependency "
                    "Finder (LDF) looks for global libraries"
                ),
                sysenvvar="ZHIXIN_GLOBALLIB_DIR",
                default=os.path.join("${zhixin.core_dir}", "lib"),
                validate=validate_dir,
            ),
            ConfigZhixinOption(
                group="directory",
                name="platforms_dir",
                description=(
                    "A location where ZhiXin Core keeps installed development "
                    "platforms"
                ),
                sysenvvar="ZHIXIN_PLATFORMS_DIR",
                default=os.path.join("${zhixin.core_dir}", "platforms"),
                validate=validate_dir,
            ),
            ConfigZhixinOption(
                group="directory",
                name="packages_dir",
                description=(
                    "A location where ZhiXin Core keeps installed packages"
                ),
                sysenvvar="ZHIXIN_PACKAGES_DIR",
                default=os.path.join("${zhixin.core_dir}", "packages"),
                validate=validate_dir,
            ),
            ConfigZhixinOption(
                group="directory",
                name="cache_dir",
                description=(
                    "A location where ZhiXin Core stores caching information "
                    "(requests to ZhiXin Registry, downloaded packages and "
                    "other service information)"
                ),
                sysenvvar="ZHIXIN_CACHE_DIR",
                default=os.path.join("${zhixin.core_dir}", ".cache"),
                validate=validate_dir,
            ),
            ConfigZhixinOption(
                group="directory",
                ...
                description=(
                    "A location where ZhiXin Core keeps derived files from a "
                    "build system (objects, firmwares, ELFs) and caches them between "
                    "build environments"
                ),
                sysenvvar="ZHIXIN_BUILD_CACHE_DIR",
                validate=validate_dir,
            ),
            ConfigZhixinOption(
                group="directory",
                name="workspace_dir",
                description=(
                    "A path to a project workspace directory where ZhiXin keeps "
                    "by default compiled objects, static libraries, firmwares, and "
                    "external library dependencies"
                ),
                sysenvvar="ZHIXIN_WORKSPACE_DIR",
                default=os.path.join("${PROJECT_DIR}", ".zx"),
                validate=validate_dir,
            ),
            ConfigZhixinOption(
                group="directory",
            ...
            ConfigZhixinOption(
                ...
                sysenvvar="ZHIXIN_LIBDEPS_DIR",
                default=os.path.join("${zhixin.workspace_dir}", "libdeps"),
                validate=validate_dir,
            ),
            ConfigZhixinOption(
                group="directory",
            ...
            ConfigZhixinOption(
                ...
                name="test_dir",
                description=(
                    "A location where ZhiXin Unit Testing engine looks for "
                    "test source files"
                ),
                sysenvvar="ZHIXIN_TEST_DIR",
            ...
            ConfigZhixinOption(
                ...
                name="shared_dir",
                description=(
                    "A location which ZhiXin Remote Development service uses to "
                    "synchronize extra files between remote machines"
                ),
                sysenvvar="ZHIXIN_SHARED_DIR",
            ...
            ConfigEnvOption(
                ...
                multiple=True,
                sysenvvar="ZHIXIN_BUILD_SRC_FLAGS",
            ...
            ConfigEnvOption(
                ...
                multiple=True,
                sysenvvar="ZHIXIN_BUILD_UNFLAGS",
            ...
            ConfigEnvOption(
                ...
                multiple=True,
                sysenvvar="ZHIXIN_BUILD_SRC_FILTER",
            ...
            ConfigEnvOption(
                group="build",
                name="targets",
                description="A custom list of targets for ZhiXin Build System",
                multiple=True,
            ),
            # Upload
            ConfigEnvOption(
            ...
            ConfigEnvOption(
                ...
                multiple=True,
                sysenvvar="ZHIXIN_LIB_EXTRA_DIRS",
            ),
            ConfigEnvOption(
                group="library",
                name="lib_ldf_mode",
            ...
            ConfigEnvOption(
                ...
                description=(
                    "Allows one to control when ZhiXin should load debugging "
            ...
            ConfigEnvOption(
                ...
                multiple=True,
                sysenvvar="ZHIXIN_EXTRA_SCRIPTS",
            ),
        ]
    ]
)
