...
class BranchesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/groups/{groupId}/artifacts/{artifactId}/branches{?offset*,limit*}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[BranchesRequestBuilderGetRequestConfiguration] = None) -> Optional[BranchSearchResults]:
        """
    ...
    async def post(self,body: Optional[CreateBranch] = None, request_configuration: Optional[BranchesRequestBuilderPostRequestConfiguration] = None) -> Optional[BranchMetaData]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[BranchesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Returns a list of all branches in the artifact. Each branch is a list of version identifiers,ordered from the latest (tip of the branch) to the oldest.This operation can fail for the following reasons:* No artifact with this `groupId` and `artifactId` exists (HTTP error `404`)* A server error occurred (HTTP error `500`)
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[CreateBranch] = None, request_configuration: Optional[BranchesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Creates a new branch for the artifact.  A new branch consists of metadata and alist of versions.This operation can fail for the following reasons:* No artifact with this `groupId` and `artifactId` exists (HTTP error `404`)* A branch with the given `branchId` already exists (HTTP error `409`)* A server error occurred (HTTP error `500`)
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> BranchesRequestBuilder:
        """
    ...
    @dataclass
    class BranchesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[BranchesRequestBuilder.BranchesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class BranchesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
