...
class GroupsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[CreateGroup] = None, request_configuration: Optional[GroupsRequestBuilderPostRequestConfiguration] = None) -> Optional[GroupMetaData]:
        """
    ...
    def to_post_request_information(self,body: Optional[CreateGroup] = None, request_configuration: Optional[GroupsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Creates a new group.This operation can fail for the following reasons:* A server error occurred (HTTP error `500`)* The group already exist (HTTP error `409`)
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
