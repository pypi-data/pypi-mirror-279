...
class MeRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[MeRequestBuilderGetRequestConfiguration] = None) -> Optional[UserInfo]:
        """
        ...
        return await self.request_adapter.send_async(request_info, UserInfo, error_mapping)
