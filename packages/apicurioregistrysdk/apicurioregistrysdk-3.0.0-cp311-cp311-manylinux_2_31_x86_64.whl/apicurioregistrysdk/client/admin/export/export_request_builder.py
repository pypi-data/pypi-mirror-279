...
if TYPE_CHECKING:
    from ...models.download_ref import DownloadRef
...
class ExportRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/export{?forBrowser*}", path_parameters)
    
    async def get(self,request_configuration: Optional[ExportRequestBuilderGetRequestConfiguration] = None) -> Optional[DownloadRef]:
        """
        Exports registry data as a ZIP archive.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[DownloadRef]
        """
        ...
        return await self.request_adapter.send_async(request_info, DownloadRef, error_mapping)
