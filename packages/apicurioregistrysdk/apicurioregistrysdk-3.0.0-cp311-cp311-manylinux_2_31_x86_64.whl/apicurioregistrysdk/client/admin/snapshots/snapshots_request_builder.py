...
class SnapshotsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/snapshots", path_parameters)
    
    async def post(self,request_configuration: Optional[SnapshotsRequestBuilderPostRequestConfiguration] = None) -> Optional[SnapshotMetaData]:
        """
        ...
        Returns: Optional[SnapshotMetaData]
        """
        ...
        return await self.request_adapter.send_async(request_info, SnapshotMetaData, error_mapping)
    
    def to_post_request_information(self,request_configuration: Optional[SnapshotsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Triggers the creation of a snapshot of the internal database for compatible storages.This operation can fail for the following reasons:* A server error occurred (HTTP error `500`)
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
