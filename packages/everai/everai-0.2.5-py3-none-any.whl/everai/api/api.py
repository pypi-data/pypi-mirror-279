...
from generated.apps import (
    ...
    V1AppServiceCreateBody as AppServiceCreateBody,
    AppServiceUpdateBody as AppServiceUpdateBody,
    ApiException as AppApiException,
)
...
class API:
    ...
    def get_app(self, name: str, namespace: str = 'default') -> V1App:
        return self.app_service_api.get_app(namespace=namespace, name=name)

    def delete_app(self, name: str, namespace: str = 'default') -> None:
        self.app_service_api.delete_app(namespace=namespace, name=name)

    def list_apps(self, namespace: str = 'default', all_namespaces: bool = False) -> typing.List[V1App]:
        if all_namespaces:
    ...
    def pause_app(self, name: str, namespace: str = 'default') -> None:
        self.app_service_api.pause_app(namespace=namespace, name=name)

    def resume_app(self, name: str, namespace: str = 'default') -> None:
    ...
    def create_app(self, app: V1App) -> V1App:
        ...
        try:
            return self.app_service_api.create_app(
                namespace=namespace,
                body=AppServiceCreateBody(app=app),
            )
    ...
    def update_app(self, app: V1App):
        ...
        return self.app_service_api.update_app(
            ...
            body=AppServiceUpdateBody(app=app),
        )
