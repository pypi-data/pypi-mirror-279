...
class AppManager:
    ...
    def list(self, namespace: typing.Optional[str] = 'None', all_namespaces: bool = False) -> typing.List[App]:
    ...
    def list_queue(self, app_name: str, namespace: str) -> typing.List[QueuedRequest]:
        requests = self.api.list_queue(app_name, namespace=namespace)
