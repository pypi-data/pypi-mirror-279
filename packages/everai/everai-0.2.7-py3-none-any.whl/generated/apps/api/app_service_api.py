...
class AppServiceApi:
    ...
    def create_app(
        ...
        **kwargs,
        ...
        >>> thread = api.create_app(namespace, body, async_req=True)
        >>> result = thread.get()

        :param namespace: (required)
        :type namespace: str
        :param body: (required)
        :type body: V1AppServiceCreateBody
    ...
    def create_app_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.create_app_with_http_info(namespace, body, async_req=True)
        >>> result = thread.get()
    ...
    def update_app(
        ...
        **kwargs,
        ...
        >>> thread = api.update_app(namespace, name, body, async_req=True)
        >>> result = thread.get()
        ...
        :type name: str
        :param body: (required)
        :type body: AppServiceUpdateBody
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
    ...
    def update_app_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.update_app_with_http_info(namespace, name, body, async_req=True)
        >>> result = thread.get()
