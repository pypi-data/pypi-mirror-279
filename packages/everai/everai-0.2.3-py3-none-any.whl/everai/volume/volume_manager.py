...
class VolumeManager:
    ...
    def upload_multipart_file(self, volume_name: str, revision_name: str, file: V1File,
        ...
        while range_begin < int(file.size):
            ...
            resp = file_utils.upload_file_part(method, url, headers, range_begin, range_end)
            # get etag
            # resp.headers
    ...
    def upload_file(self, volume_name: str, revision_name: str, volume_path: str,
        ...
        if int(upload_file_metadata.size) > MAX_SINGLE_FILE_SIZE:
            should_commit, result = self.upload_multipart_file(volume_name, revision_name, upload_file_metadata,
                                                               file_utils)
        else:
    ...
    @regular_volume_name
    def from_name(self, name: str) -> typing.Optional[Volume]:
