...
class PersonsLocal(PeopleLocal, metaclass=MetaLogger, object=person_local_code_logger_init_object):
    ...
    def get_person_id_by_email_address_str(self, email_address: str) -> int or None:
        ...
        person_id = self.select_one_value_by_column_and_value(
            column_name='main_email_person', column_value=email_address,
    ...
    def insert(self, person: Person) -> int:  # noqa
        data_dict = {
            ...
            'main_email_person': self.email_addresses[0] if self.email_addresses else person.main_email_address,
