...
setup(
    name="customsignxml",
    version="3.2.3",
    url="https://github.com/datastyx-dev/signxml.git",
    license="Apache Software License",
    author="Andrey Kislyuk",
    author_email="dev@datastyx.com",
    description="Python XML Signature and XAdES library: Original work from Andrey Kislyuk, forked and targetted for pull request.",
