...
class CreateAssetResponseTransferApi_None(pydantic_v1.BaseModel):
    """
    Asset transfer API.
    """
...
class CreateAssetResponseTransferApi_PresignedUrl(pydantic_v1.BaseModel):
    """
    Asset transfer API.
    """
...
class CreateAssetResponseTransferApi_Sts(pydantic_v1.BaseModel):
    """
    Asset transfer API.
    """
