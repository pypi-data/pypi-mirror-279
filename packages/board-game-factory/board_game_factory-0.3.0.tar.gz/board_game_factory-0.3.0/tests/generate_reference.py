...
from tests.test_vertical_flow_layout import TestVerticalFlowLayout
from tests.test_vertical_flow_layout2 import TestVerticalFlowLayout2

if __name__ == '__main__':
    
    # TestVerticalFlowLayout.generate_reference()
    # TestVerticalFlowLayout2.generate_reference()
    # TestHorizontalFlowLayout2.generate_reference()
