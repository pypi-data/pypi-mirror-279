...
class Parallel_ODE_Solver(object):
    ...
    get_gsl_driver = _swig_new_instance_method(_RF_Track.Parallel_ODE_Solver_get_gsl_driver)
    init_gsl_drivers = _swig_new_instance_method(_RF_Track.Parallel_ODE_Solver_init_gsl_drivers)
    free_gsl_drivers = _swig_new_instance_method(_RF_Track.Parallel_ODE_Solver_free_gsl_drivers)
    use_analytic = _swig_new_instance_method(_RF_Track.Parallel_ODE_Solver_use_analytic)
    use_leapfrog = _swig_new_instance_method(_RF_Track.Parallel_ODE_Solver_use_leapfrog)
    use_gsl = _swig_new_instance_method(_RF_Track.Parallel_ODE_Solver_use_gsl)
...
class Absorber(ConstantField):
    ...
    enable_freuhhwirth_model = _swig_new_instance_method(_RF_Track.Absorber_enable_freuhhwirth_model)
    disable_freuhhwirth_model = _swig_new_instance_method(_RF_Track.Absorber_disable_freuhhwirth_model)
...
class Bunch6dT(object):
    ...
    set_sc_engine = _swig_new_instance_method(_RF_Track.Bunch6dT_set_sc_engine)
    get_sc_engine = _swig_new_instance_method(_RF_Track.Bunch6dT_get_sc_engine)
...
class Bunch6d(object):
    ...
    set_sc_engine = _swig_new_instance_method(_RF_Track.Bunch6d_set_sc_engine)
    get_sc_engine = _swig_new_instance_method(_RF_Track.Bunch6d_get_sc_engine)
...
make_bunch = _RF_Track.make_bunch
randu = _RF_Track.randu
qrand = _RF_Track.qrand
qrandn = _RF_Track.qrandn
gauss = _RF_Track.gauss
hgauss = _RF_Track.hgauss
uniform = _RF_Track.uniform
huniform = _RF_Track.huniform
plateau = _RF_Track.plateau
hplateau = _RF_Track.hplateau
parabola = _RF_Track.parabola
hparabola = _RF_Track.hparabola
randPDF = _RF_Track.randPDF
class Static_Electric_FieldMap(GenericField):
    ...
    get_field = _swig_new_instance_method(_RF_Track.Static_Electric_FieldMap_get_field)
...
class Static_Magnetic_FieldMap(GenericField):
    ...
    get_field = _swig_new_instance_method(_RF_Track.Static_Magnetic_FieldMap_get_field)
...
class TransportTable(object):
    ...
    append_bunch_info = _swig_new_instance_method(_RF_Track.TransportTable_append_bunch_info)
...
class Solenoid(Element, ):
    ...
    get_R = _swig_new_instance_method(_RF_Track.Solenoid_get_R)
...
class SpaceCharge_Field(GenericField, ):
    ...
    get_field = _swig_new_instance_method(_RF_Track.SpaceCharge_Field_get_field)
...
class BeamLoading(CollectiveEffect):
    ...
    get_rho = _swig_new_instance_method(_RF_Track.BeamLoading_get_rho)
    ...
    get_drho = _swig_new_instance_method(_RF_Track.BeamLoading_get_drho)
    get_Lcell = _swig_new_instance_method(_RF_Track.BeamLoading_get_Lcell)
    get_Ltotal = _swig_new_instance_method(_RF_Track.BeamLoading_get_Ltotal)
...
class LongRangeWakefield(CollectiveEffect):
    ...
    w_transv = _swig_new_instance_method(_RF_Track.LongRangeWakefield_w_transv)
...
class ShortRangeWakefield(CollectiveEffect):
    ...
    set_max_range = _swig_new_instance_method(_RF_Track.ShortRangeWakefield_set_max_range)
...
class MultipleCoulombScattering(CollectiveEffect):
    ...
    enable_freuhhwirth_model = _swig_new_instance_method(_RF_Track.MultipleCoulombScattering_enable_freuhhwirth_model)
    disable_freuhhwirth_model = _swig_new_instance_method(_RF_Track.MultipleCoulombScattering_disable_freuhhwirth_model)
...
class Wakefield_1d_CINT(CollectiveEffect):
    ...
    set_max_range = _swig_new_instance_method(_RF_Track.Wakefield_1d_CINT_set_max_range)
...
class Wakefield_1d(CollectiveEffect):
    ...
    set_max_range = _swig_new_instance_method(_RF_Track.Wakefield_1d_set_max_range)
