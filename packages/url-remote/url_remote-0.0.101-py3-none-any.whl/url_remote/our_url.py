...
class OurUrl:
    ...
    domain_mapping = {
        ...
        'auth.play1.circ.zone': 'nmxjjpyrv9',
        ...
        'logger.play1.circ.zone': 'fsujmjyfal',
        # 'event.play1.circ.zone': 'p89mpsr5m1',
        # 'event.play1.circ.zone': 'x8ql0j9cwf',
        'event.play1.circ.zone': 'g1u5iwrq0h',
        ...
        'smartlink.play1.circ.zone': 'ezt1n60if7',
        'smartlink.dvlp1.circ.zone': 'u5ohxnpxug',
        'dialogWorkflow.play1.circ.zone': '4djmf37gwl',
    ...
    def base_domain(*, brand_name: str = BrandName.CIRCLEZ.value, environment_name: str) -> str:
        """
        ...
        if brand_name == BrandName.CIRCLEZ.value:
            ...
            elif environment_name == EnvironmentName.LOCAL.value:
    ...
    @staticmethod
    def app_url(*, brand_name: str = BrandName.CIRCLEZ.value, environment_name: str,
                port: int = REACTJS_APP_DEFAULT_PORT) -> str:
    ...
    def endpoint_url(brand_name: str, environment_name: str, component_name: str, entity_name: str,
        ...
        base_url = OurUrl._base_url_builder(
            component_name=component_name, brand_name=brand_name, environment_name=environment_name,
            version=version, entity_name=entity_name, action_name=action_name)
        ...
        # TODO: send params
        new_url = OurUrl._convert_to_direct_url(direct_url=url_with_query_params)
        return new_url

    @staticmethod
    def _base_url_builder(*, component_name: str, brand_name: str = BrandName.CIRCLEZ.value, environment_name: str, version: int,
                          entity_name: str, action_name: str) -> str:
        """
        ...
        try:
            ...
            raise ValueError(
                f"Domain mapping not found for '{base_domain}' in brand '{brand_name}' and environment '{environment_name}' please update our_url.py domain_mapping data structure.")

        direct_url = f"https://{direct_domain}.{OurUrl.base_url}/{environment_name}/api/v{version}/{entity_name}/{action_name}"
        return direct_url

    @staticmethod
    def _convert_to_direct_url(*, direct_url: str, path_parameters: dict = None, query_parameters: dict = None) -> str:
        """
