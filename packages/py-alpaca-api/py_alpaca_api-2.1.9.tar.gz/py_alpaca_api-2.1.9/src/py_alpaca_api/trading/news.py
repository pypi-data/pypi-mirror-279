...
class News:
    ...
    def get_news(
        self, symbol: str, limit: int = 6, content_length: int = 5000
    ) -> List[Dict[str, str]]:
        """
        ...
        """
        benzinga_news = self._get_benzinga_news(
            symbol=symbol, limit=limit, content_length=content_length
        )
                ...
                yahoo_news.append(
                    {
                        ...
                        "url": news["link"],
                        "source": "yahoo",
                        "content": self.truncate(content, content_length),
            ...
            benzinga_news.append(
                {
                    ...
                    "content": self.truncate(
                        self.strip_html(news["content"]), content_length
                    )
                    if news["content"]
                    else None,
