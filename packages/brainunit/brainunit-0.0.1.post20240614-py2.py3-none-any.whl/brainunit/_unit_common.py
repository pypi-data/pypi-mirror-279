...
with allow_python_scalar():
  ...
  liter = Unit.create(unit=(meter ** 3).dim, name="liter", dispname="l", scale=-3)
  litre = Unit.create(unit=(meter ** 3).dim, name="litre", dispname="l", scale=-3)
  ...
  gram = Unit.create(unit=kilogram.dim, name="gram", dispname="g", scale=-3)
  gramme = Unit.create(unit=kilogram.dim, name="gramme", dispname="g", scale=-3)
...
del base_units, scaled_units, powered_units, additional_units, additional_unit_register, standard_unit_register
