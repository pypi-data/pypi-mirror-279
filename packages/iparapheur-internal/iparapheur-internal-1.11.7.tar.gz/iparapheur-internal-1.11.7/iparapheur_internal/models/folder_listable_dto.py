...
class FolderListableDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "dueDate", "metadata", "draftCreationDate", "type", "subtype", "originDesk", "finalDesk", "isReadByCurrentUser", "legacyId", "readByCurrentUser"]
