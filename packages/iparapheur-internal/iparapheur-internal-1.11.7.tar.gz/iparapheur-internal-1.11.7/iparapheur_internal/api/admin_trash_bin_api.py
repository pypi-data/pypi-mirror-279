...
class AdminTrashBinApi:
    ...
    @validate_call
    def list_trash_bin_listable_folders(
        self,
        ...
        _param = self._list_trash_bin_listable_folders_serialize(
            tenant_id=tenant_id,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    def list_trash_bin_listable_folders_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageFolderListableDto]:
        """List folders in the trash-bin
    ...
    @validate_call
    def list_trash_bin_listable_folders_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
    ...
    def _list_trash_bin_listable_folders_serialize(
        self,
        tenant_id,
        page,
        size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/internal/admin/tenant/{tenantId}/trash-bin',
