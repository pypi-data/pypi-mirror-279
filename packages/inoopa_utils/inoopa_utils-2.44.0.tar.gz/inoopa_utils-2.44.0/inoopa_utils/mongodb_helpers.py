...
class DbManagerMongo:
    ...
    :attribute website_content_collection: The website content collection object.
    ...
    def _create_indexes(self) -> None:
        ...
        for index in fields_to_index_delivery_memory:
            self._logger.debug(f"Creating index {index} in `delivery_memory` collection...")
            self.delivery_memory_collection.create_index(index, background=True)
