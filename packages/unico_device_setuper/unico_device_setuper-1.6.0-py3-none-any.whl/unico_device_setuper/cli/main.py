...
def get_default_skip_uninstall_packages():
...
class GlobalOptions:
    ...
    skip_uninstall_packages: bool | None = dataclasses.field(
        default_factory=get_default_skip_uninstall_packages
    )
...
def add_arguments(f: typing.Callable[[typer.Context], None]):
    ...
    default_skip_uninstall_packages: bool | None = GLOBAL_OPTIONS.skip_uninstall_packages
    ...
    def wrapper(
        ...
        *,
        ...
        no_sygic_product: bool = typer.Option(False, '--no-license'),
        uninav_version: typing.Optional[str] = None,
        device_owner: typing.Optional[str] = None,
        skip_uninstall_packages: typing.Optional[bool] = default_skip_uninstall_packages,
