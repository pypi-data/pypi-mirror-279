...
class Actuator:
    ...
    def read_register(self, register_address, num_registers):
    ...
    def write_registers(self, registers_start_address, register_data):
    ...
    def write_stream(self, registers_start_address, width, value):
    ...
    def read_stream(self,register_address,width):
        address_bytes = self._u16_to_bytes(register_address)
    ...
    def Tune_PID(self, saturation, p_gain, i_gain, dv_gain, de_gain):
    ...
    class _HapticMode:
        ...
        """ HAPTIC EFFECTS """
        def set_spring(self, ID:int, gain:int, center:int, deadzone:int, saturation:int, coupling: int=0, enable: bool=None):
