...
class MIDAS():
    ...
    def init_model(
        ...
        Args:
            ...
            reciprocal_from (str): Path to the model weights when using 'reciprocal' training mode (a ".pt" file). This is used only when train_mod == 'reciprocal'.
        """
    ...
    def train(
        ...
        if self.train_mod == 'reciprocal':
            ...
            current_datasets = list(datasets[self.batch_num_rep:])
