...
class GetDataInfo():
    ...
    def __init__(
        ...
        """
        The directory of data should orgnized as:
            --dir
                --feat
                    --feat_names_modality1.csv
                    --feat_names_modality2.csv
                    ...
                    --feat_names_modalitym.csv
                --subset_0
                    cell_names.csv
                    --vec
                        --modality1
                            --00001.csv # the data for an individual cell of modality1
                            --00002.csv
                            ...
                        --modality2
                            --00001.csv
                            ...
                            ...
                    --mask
                        modality1.csv  # 0 indicates missing featues
                        modality2.csv
                        ...
                        modalitym.csv
                ...
                --subset_n
        Args
            data_path (str): Path of directory containing data to be summarized. The directory should follow the format as:
            mods (:obj:'list', optional): Predefined modalities. If not given, read all modalities.
            print_info
                Print the sumarized information of the data.
        """
