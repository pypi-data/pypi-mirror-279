...
from uploader.urls import ENDPOINT_UPLOAD_RESULTS, TESTPULSE_RECEIVER, TESTPULSE_RECEIVER_STAGING
...
def upload_test_results(zip: Path, test_run: TestRun) -> Optional[str]:
    ...
    data = {
        ...
        "github_run_id": test_run.github_run_id,
        "github_workflow": test_run.github_workflow,
        "github_job": test_run.github_job
    }
