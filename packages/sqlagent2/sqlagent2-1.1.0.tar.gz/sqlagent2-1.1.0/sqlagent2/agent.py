...
from sqlagent2.components.sql_parser_component import sql_parser_component
...
import asyncio
from sqlagent2.ingestions import (
...
class SQLAgent:
    def __init__(
        ...
        embedding_model: OpenAIEmbeddingModelType = OpenAIEmbeddingModelType.TEXT_EMBED_ADA_002,
    ...
    def _table_parser_component(self):
        def get_table_context_and_rows_str(
            ...
            for table_schema_obj in table_schema_objs:
                # only process stock_info table
                if table_schema_obj.table_name != "stock_info":
                    continue
