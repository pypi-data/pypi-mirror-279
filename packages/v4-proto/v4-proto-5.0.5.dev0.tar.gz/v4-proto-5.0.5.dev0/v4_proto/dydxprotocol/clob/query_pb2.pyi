...
class StreamOrderbookUpdatesResponse(_message.Message):
    __slots__ = ("updates", "block_height", "exec_mode")
    ...
    block_height: int
    exec_mode: int
    def __init__(self, updates: _Optional[_Iterable[_Union[StreamUpdate, _Mapping]]] = ..., block_height: _Optional[int] = ..., exec_mode: _Optional[int] = ...) -> None: ...

class StreamUpdate(_message.Message):
    __slots__ = ("orderbook_update", "order_fill")
    ...
    def __init__(self, orderbook_update: _Optional[_Union[StreamOrderbookUpdate, _Mapping]] = ..., order_fill: _Optional[_Union[StreamOrderbookFill, _Mapping]] = ...) -> None: ...
