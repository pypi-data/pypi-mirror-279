...
class Dataset:
    ...
    def create(
        cls,
        request: CreateDatasetRequest = CreateDatasetRequest(),
    ...
    def query(
        ...
        while True:
            paginated_results = roboto_client.post(
                ...
                idempotent=True,
            ).from_paginated_list(DatasetRecord)
    ...
    def put_tags(
        ...
        self.update(
            UpdateDatasetRequest(metadata_changeset=MetadataChangeset(put_tags=tags)),
        )
    ...
    def update(self, request: UpdateDatasetRequest) -> "Dataset":
    ...
    def __list_files_page(
        ...
        return self.__roboto_client.post(
            ...
            query=query_params,
            idempotent=True,
        ).from_paginated_list(FileRecord)
