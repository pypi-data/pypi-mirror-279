...
def create(
    ...
    try:
        create_action_request = actions.CreateActionRequest(
        ...
        if updates:
            update_action_request = actions.UpdateActionRequest.model_validate(updates)
            action.update(update_action_request)
