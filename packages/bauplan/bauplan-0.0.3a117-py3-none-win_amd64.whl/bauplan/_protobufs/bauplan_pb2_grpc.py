...
class CommanderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateBranch = channel.unary_unary(
            '/bauplan.CommanderService/CreateBranch',
            request_serializer=bauplan__pb2.CreateBranchRequest.SerializeToString,
            response_deserializer=bauplan__pb2.CreateBranchResponse.FromString,
        )
        self.MergeBranch = channel.unary_unary(
            '/bauplan.CommanderService/MergeBranch',
            request_serializer=bauplan__pb2.MergeBranchRequest.SerializeToString,
            response_deserializer=bauplan__pb2.MergeBranchResponse.FromString,
        )
...
def add_CommanderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'CreateBranch': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=bauplan__pb2.CreateBranchRequest.FromString,
            response_serializer=bauplan__pb2.CreateBranchResponse.SerializeToString,
        ),
        'MergeBranch': grpc.unary_unary_rpc_method_handler(
            servicer.MergeBranch,
            request_deserializer=bauplan__pb2.MergeBranchRequest.FromString,
            response_serializer=bauplan__pb2.MergeBranchResponse.SerializeToString,
        ),
    }
...
class CommanderService(object):
    ...
    def CreateBranch(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/bauplan.CommanderService/CreateBranch',
            bauplan__pb2.CreateBranchRequest.SerializeToString,
            bauplan__pb2.CreateBranchResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def MergeBranch(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/bauplan.CommanderService/MergeBranch',
            bauplan__pb2.MergeBranchRequest.SerializeToString,
            bauplan__pb2.MergeBranchResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
