...
def resources(
    ...
    """
    Define the resources required by a Bauplan function (e.g. a model or expectation). It is used to
...
def pyspark(
    ...
    """
    Make pyspark session available. Add a spark=None parameter to the function model args
    """
