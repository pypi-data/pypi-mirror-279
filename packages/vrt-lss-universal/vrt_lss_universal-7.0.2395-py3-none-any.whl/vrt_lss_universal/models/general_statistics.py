...
class GeneralStatistics(BaseModel):
    ...
    stops_count: Annotated[int, Field(le=15001, strict=True, ge=0)] = Field(description="The total number of stops (non-unique locations).")
    locations_count: Annotated[int, Field(le=15001, strict=True, ge=0)] = Field(description="The total number of unique locations within one trip.")
