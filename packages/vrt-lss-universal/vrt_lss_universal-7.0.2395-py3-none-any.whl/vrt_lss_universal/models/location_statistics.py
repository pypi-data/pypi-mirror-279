...
class LocationStatistics(BaseModel):
    ...
    total_cargos_statistics: Optional[LocationCargosLimit]
    total_transports_statistics: Optional[LocationTransportsLimit]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if total_cargos_statistics (nullable) is None
        # and model_fields_set contains the field
        if self.total_cargos_statistics is None and "total_cargos_statistics" in self.model_fields_set:
            _dict['total_cargos_statistics'] = None

        # set to None if total_transports_statistics (nullable) is None
        # and model_fields_set contains the field
        if self.total_transports_statistics is None and "total_transports_statistics" in self.model_fields_set:
            _dict['total_transports_statistics'] = None
