...
class _WLFeatures:
    ...
    def collect(self, graphs: list[_wlplan.graph.Graph]) -> None:
        ...
    @typing.overload
    def embed(self, dataset: _wlplan.data.Dataset) -> numpy.ndarray[numpy.int32]:
        ...
    @typing.overload
    def embed(self, graphs: list[_wlplan.graph.Graph]) -> numpy.ndarray[numpy.int32]:
        ...
    @typing.overload
    def embed(self, state: list[_wlplan.planning.Atom]) -> numpy.ndarray[numpy.int32]:
        ...
