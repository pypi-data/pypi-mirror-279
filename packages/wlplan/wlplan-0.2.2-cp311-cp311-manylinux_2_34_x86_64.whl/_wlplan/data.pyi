...
class Dataset:
    ...
    """
    def __init__(self, domain: _wlplan.planning.Domain, data: list[ProblemStates]) -> None:
        ...
class ProblemStates:
    """
    ...
    """
    def __init__(self, problem: _wlplan.planning.Problem, states: list[list[_wlplan.planning.Atom]]) -> None:
        ...
