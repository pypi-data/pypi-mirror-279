...
if __name__ == '__main__':
    from pulp import *
    def solve_undirected_two_commodity_integral_flow(graph, demands, capacities):
        prob = LpProblem("Undirected Two-Commodity Flow", LpMaximize)
    ...
    objective_value, flow_dict = solve_undirected_two_commodity_integral_flow(graph, demands, capacities)
