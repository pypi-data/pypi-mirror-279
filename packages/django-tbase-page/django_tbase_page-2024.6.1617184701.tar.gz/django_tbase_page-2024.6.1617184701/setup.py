...
name = 'django_tbase_page'  # 修改包名字-
version = f'{year}.{month}.{day}' + str(time.time())[:8]
description = 'Terry django base post ,'
author = 'Terry Chan'
author_email = 'napoler2008@gmail.com'
url = 'https://terrychanorg.jetbrains.space/p/django-expand/repositories/tbase_page/files/README.md'
...
setup(
    ...
    # 依赖文件
    install_requires=[
        'django-tbase-theme-tailwind==2023.7.316883187',
        'martor==1.6.19',
