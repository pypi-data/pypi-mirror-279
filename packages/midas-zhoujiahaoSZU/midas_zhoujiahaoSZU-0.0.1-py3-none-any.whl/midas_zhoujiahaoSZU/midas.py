...
from modules.datasets import MultiDatasetSampler, MultimodalDataset, GetDataInfo
from modules.sample import BallTreeSubsample
...
class MIDAS():
    ...
    def __check_to_save__(self, epoch_id, epoch_num, save_path):
        if (epoch_id+1) % self.save_epochs == 0 or epoch_id+1 == epoch_num:
            self.__save_training_states__(epoch_id, "sp_%08"%(epoch_id+1), save_path)
