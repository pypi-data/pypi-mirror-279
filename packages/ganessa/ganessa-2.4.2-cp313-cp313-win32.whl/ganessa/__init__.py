...
#   Note that python 3.12 will be delayed due to significant change in build process
#
...
#   * Only recent Ganessa_SIM.dll versions can be used with this package, is not recent enough
#     import will fail and (try to) use an available PicWin32.dll.
...
#           (240xxx) release and upload (3.8 / 3.9 / 3.10 / 3.11 / 3.12)
#
#****
