...
from tensorkube.services.k8s_service import create_namespace, create_docker_registry_secret, apply_k8s_kaniko_configs
...
apply_k8s_kaniko_configs(bucket_name, service_account_name, args, namespace, region=region)
