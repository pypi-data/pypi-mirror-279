...
setuptools.setup(
    name='pollination-two-phase-daylight-coefficient', # will be used for package name unless it is overwritten using __queenbee__ info.
    ...
    url='https://github.com/pollination/two-phase-daylight-coefficient', # will be translated to home
    project_urls={
    ...
    description='Two phase daylight coefficient recipe for Pollination.', # will be used as package description
