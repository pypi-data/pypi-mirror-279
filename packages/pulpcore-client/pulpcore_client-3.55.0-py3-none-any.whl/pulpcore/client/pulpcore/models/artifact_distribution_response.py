...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, content_guard=None, pulp_labels=None, name=None, base_url=None, pulp_href=None, base_path=None, hidden=False, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
