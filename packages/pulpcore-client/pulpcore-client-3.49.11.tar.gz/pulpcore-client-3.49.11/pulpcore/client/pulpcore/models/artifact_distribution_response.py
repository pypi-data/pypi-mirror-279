...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_url=None, name=None, content_guard=None, hidden=False, pulp_last_updated=None, base_path=None, pulp_href=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
