...
from langchain.chains.llm import Chain

import logging
from abc import ABC, abstractmethod
from typing import Any, Dict, List, Optional, Type, Union, cast, Sequence
...
import os
class ChatAgent:
    def __init__(self, yaml_path, agent_id,llm,tools,prompt,memory=False):
    ...
    def load_config(yaml_path):
        ...
        for key, value in config['os_config'].items():
    ...
    def run(self, query):
        ...
        if self.memory:
            return self.history.invoke({"input":query},
