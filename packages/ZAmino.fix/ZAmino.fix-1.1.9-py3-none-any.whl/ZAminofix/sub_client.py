...
class SubClient(client.Client):
    def __init__(self, mainClient: client.Client, community_link: str = None, comId: str = None, aminoId: str = None, deviceId: str = None, autoDevice: bool = False, proxies: dict = None, certificatePath: str = None):
        ...
        try: self.profile: objects.UserProfile = self.get_user_info(userId=self.client.userId)
