            ...
            if fix:
                try:
                    ...
                    print(
                        ...
                        "  Details: http://docs.ocl.open.ac.uk/tm352/24j/faq/vce/postcss-config-js.html\n",
                    )
                except Exception:
                    print(
                        "[bold red]:x: postcss.config.js found in the home directory could not be removed. Please delete this file.\n"  # noqa: E501
                        "  [bold red]Details: http://docs.ocl.open.ac.uk/tm352/24j/faq/vce/postcss-config-js.html\n",
                    )
                    return False
            else:
                print(
