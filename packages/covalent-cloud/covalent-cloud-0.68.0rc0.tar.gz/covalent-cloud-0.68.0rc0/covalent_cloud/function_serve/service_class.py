...
class FunctionService:
    ...
    def _create_app(self, args, kwargs):
        ...
        """
        from fastapi import FastAPI  # NOTE: Importing here since Covalent Cloud doesn't have FastAPI as a dependency
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        ...
        if active_lattice is not None:
            ...
            deploy_electron_executor = cc.CloudExecutor(
                env=self.executor.env, time_limit=60 * 60, num_cpus=4, memory=8 * 1024
            )
