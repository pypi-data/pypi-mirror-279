...
def get_handler_logger_level_factory(handler_env_var_name: str = ""): 
    ...
    def get_handler_logger_level() -> str|int:
        ...
        # The level can be an str or an int but env variable are always read as
        ...
        try:
            logging._checkLevel(handler_level)
        except (ValueError, TypeError):
...
class LoggerHandler:
    ...
    def get_logger(self, logger_name: str = __name__) -> logging.Logger:
        ...
        # handlers' level will from WARNING (the default level assigned
        # to root logger)
