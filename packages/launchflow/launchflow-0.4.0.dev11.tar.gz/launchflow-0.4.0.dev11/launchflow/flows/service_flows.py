...
async def _execute_promote_plan(
    ...
    async with lock as lock_info:
        ...
        with logger.start_workflow(
            ...
            await plan.to_service_manager.save_service(new_service_state, lock_info)
            to_save = new_service_state.model_copy()
...
async def promote(
    *services: Service,
    ...
    return await _execute_promote_plans(selected_service_plans, to_environment_manager)
