...
user: "${local.user}"
connection_name: "${google_sql_database_instance.cloud_sql_instance.connection_name}"
password: "${local.password}"
public_ip_address: "${google_sql_database_instance.cloud_sql_instance.public_ip_address}"
private_ip_address: "${google_sql_database_instance.cloud_sql_instance.private_ip_address}"
public_ip_enabled: "${google_sql_database_instance.cloud_sql_instance.settings[0].ip_configuration[0].ipv4_enabled}"
EOF
}
