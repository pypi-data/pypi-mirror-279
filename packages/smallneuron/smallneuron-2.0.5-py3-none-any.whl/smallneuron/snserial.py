...
class SnSerial(serial.Serial):
    ...
    def watchEvent(self, event, event_args={}, data_pattern=None, mode="loop", period=1):
        return self.eventManager.watchEvent(event, event_args=event_args, data_pattern=data_pattern, 
