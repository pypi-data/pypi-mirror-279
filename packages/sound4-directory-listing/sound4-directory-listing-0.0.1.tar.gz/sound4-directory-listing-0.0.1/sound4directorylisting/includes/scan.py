...
"""
from sound4directorylisting.includes import bot
...
from sound4directorylisting.includes import writefile
        ...
        with requests.Session() as session:
            ...
            for endpoint in payreq.text.splitlines():
                ...
                try:
                    ...
                    if response.status_code == 200 and '<title>Index of /log</title>' in response.text and 'Parent Directory' in response.text:
                        outputprint = (
