#!/usr/bin/env python
"""
Package metadata for video_iframe.
"""
import os
import re
import sys
...
VERSION = get_version('video_iframe', '__init__.py')
...
setup(
    ...
    url='https://github.com/open-craft/xblock-video-iframe',
    packages=find_packages(
        include=['video_iframe', 'video_iframe.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        'xblock.v1': [
            'video_iframe = video_iframe:VideoIframeXBlock',
        ]
    },
    package_data=package_data("video_iframe", ["static", "public"]),
