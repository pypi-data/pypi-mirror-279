...
class EntidadesDeCenario():
    ...
    def cargo(self, cenario_code) -> Cargo:
        return Cargo(self.header_auth, cenario_code)
    ...
    def dias_uteis(self, cenario_code) -> DiasUteis:
        return DiasUteis(self.header_auth, cenario_code)
    ...
    def funcionario_plano(self, cenario_code) -> FuncionarioPlano:
        return FuncionarioPlano(self.header_auth, cenario_code)
    ...
    def funcionario_verba_especifica(self, cenario_code) -> FuncionarioVerbaEspecifica:
        return FuncionarioVerbaEspecifica(self.header_auth, cenario_code)
