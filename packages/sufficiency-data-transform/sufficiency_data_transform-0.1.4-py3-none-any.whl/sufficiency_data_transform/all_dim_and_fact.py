...
def create_dimONSArea():
    ...
    ons_area = open_file(fs_ext, "ONS_Area//ONS_Area.csv")
...
def create_dimOfstedProvider():
    ...
    providers_places_31Aug = open_file(
        fs_ext, "Ofsted_data//Providers_places_at_31_Aug_2023.csv"
    )
    closed_children_homes = open_file(
        fs_ext, "Ofsted_data//Closed_childrens_homes_31Mar23.csv"
    )
    ons_area = open_file(fs_out, "dimONSArea.csv")
...
def create_dimPostcode():
    ...
    postcodes = open_file(
        fs_ext, "Postcode_directory//ONSPD_reduced_to_postcode_sector.csv"
    )
    postcodes = postcodes[
...
def create_factOfstedInspection():
    ...
    provider_level_at_31Aug = open_file(
        fs_ext, "Ofsted_data//Provider_level_at_31_Aug_2023.csv"
    )
    ...
    encoding = check_encoding(fs_ext, "Ofsted_data//Provider_level_in_year_2022-23.csv")
    provider_level_in_year_2022_23 = open_file(
        fs_ext, "Ofsted_data//Provider_level_in_year_2022-23.csv", encoding=encoding
    )
