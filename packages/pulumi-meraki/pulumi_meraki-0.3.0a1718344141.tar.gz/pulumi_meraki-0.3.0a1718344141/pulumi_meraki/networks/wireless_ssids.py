...
class WirelessSsidsArgs:
    def __init__(__self__, *,
                 ...
                 adult_content_filtering_enabled: Optional[pulumi.Input[bool]] = None,
                 ...
                 availability_tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 available_on_all_aps: Optional[pulumi.Input[bool]] = None,
                 band_selection: Optional[pulumi.Input[str]] = None,
                 concentrator_network_id: Optional[pulumi.Input[str]] = None,
                 default_vlan_id: Optional[pulumi.Input[int]] = None,
                 disassociate_clients_on_vpn_failover: Optional[pulumi.Input[bool]] = None,
                 ...
                 enterprise_admin_access: Optional[pulumi.Input[str]] = None,
                 ...
                 per_client_bandwidth_limit_down: Optional[pulumi.Input[int]] = None,
                 per_client_bandwidth_limit_up: Optional[pulumi.Input[int]] = None,
                 per_ssid_bandwidth_limit_down: Optional[pulumi.Input[int]] = None,
                 per_ssid_bandwidth_limit_up: Optional[pulumi.Input[int]] = None,
                 ...
                 radius_guest_vlan_id: Optional[pulumi.Input[int]] = None,
                 radius_load_balancing_policy: Optional[pulumi.Input[str]] = None,
                 radius_override: Optional[pulumi.Input[bool]] = None,
                 radius_proxy_enabled: Optional[pulumi.Input[bool]] = None,
                 radius_server_attempts_limit: Optional[pulumi.Input[int]] = None,
                 radius_server_timeout: Optional[pulumi.Input[int]] = None,
                 ...
                 secondary_concentrator_network_id: Optional[pulumi.Input[str]] = None,
                 speed_burst: Optional[pulumi.Input['WirelessSsidsSpeedBurstArgs']] = None,
                 splash_guest_sponsor_domains: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 splash_page: Optional[pulumi.Input[str]] = None,
                 use_vlan_tagging: Optional[pulumi.Input[bool]] = None,
                 visible: Optional[pulumi.Input[bool]] = None,
                 vlan_id: Optional[pulumi.Input[int]] = None,
                 walled_garden_enabled: Optional[pulumi.Input[bool]] = None,
                 walled_garden_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 wpa_encryption_mode: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a WirelessSsids resource.
        :param pulumi.Input[str] network_id: networkId path parameter. Network ID
        :param pulumi.Input[int] number: Unique identifier of the SSID
        ...
        :param pulumi.Input[bool] adult_content_filtering_enabled: Boolean indicating whether or not adult content will be blocked
        ...
        :param pulumi.Input[str] auth_mode: The association control method for the SSID
        :param pulumi.Input[Sequence[pulumi.Input[str]]] availability_tags: List of tags for this SSID. If availableOnAllAps is false, then the SSID is only broadcast by APs with tags matching any of the tags in this list
        :param pulumi.Input[bool] available_on_all_aps: Whether all APs broadcast the SSID or if it's restricted to APs matching any availability tags
        :param pulumi.Input[str] band_selection: The client-serving radio frequencies of this SSID in the default indoor RF profile
        :param pulumi.Input[str] concentrator_network_id: The concentrator to use when the ipAssignmentMode is 'Layer 3 roaming with a concentrator' or 'VPN'.
        :param pulumi.Input[int] default_vlan_id: The default VLAN ID used for 'all other APs'. This param is only valid when the ipAssignmentMode is 'Bridge mode' or 'Layer 3 roaming'
        :param pulumi.Input[bool] disassociate_clients_on_vpn_failover: Disassociate clients when 'VPN' concentrator failover occurs in order to trigger clients to re-associate and generate new DHCP requests. This param is only valid if ipAssignmentMode is 'VPN'.
        ...
        :param pulumi.Input[bool] enabled: Whether or not the SSID is enabled
        :param pulumi.Input[str] encryption_mode: The psk encryption mode for the SSID
        :param pulumi.Input[str] enterprise_admin_access: Whether or not an SSID is accessible by 'enterprise' administrators ('access disabled' or 'access enabled')
        ...
        :param pulumi.Input[str] name: The name of the SSID
        ...
        :param pulumi.Input[int] per_client_bandwidth_limit_down: The download bandwidth limit in Kbps. (0 represents no limit.)
        :param pulumi.Input[int] per_client_bandwidth_limit_up: The upload bandwidth limit in Kbps. (0 represents no limit.)
        :param pulumi.Input[int] per_ssid_bandwidth_limit_down: The total download bandwidth limit in Kbps (0 represents no limit)
        :param pulumi.Input[int] per_ssid_bandwidth_limit_up: The total upload bandwidth limit in Kbps (0 represents no limit)
        :param pulumi.Input[str] psk: The passkey for the SSID. This param is only valid if the authMode is 'psk'
        ...
        :param pulumi.Input[int] radius_guest_vlan_id: VLAN ID of the RADIUS Guest VLAN. This param is only valid if the authMode is 'open-with-radius' and addressing mode is not set to 'isolated' or 'nat' mode
        :param pulumi.Input[str] radius_load_balancing_policy: Policy which determines which RADIUS server will be contacted first in an authentication attempt, and the ordering of any necessary retry attempts
        :param pulumi.Input[bool] radius_override: If true, the RADIUS response can override VLAN tag. This is not valid when ipAssignmentMode is 'NAT mode'.
        :param pulumi.Input[bool] radius_proxy_enabled: If true, Meraki devices will proxy RADIUS messages through the Meraki cloud to the configured RADIUS auth and accounting servers.
        :param pulumi.Input[int] radius_server_attempts_limit: The maximum number of transmit attempts after which a RADIUS server is failed over (must be between 1-5).
        :param pulumi.Input[int] radius_server_timeout: The amount of time for which a RADIUS client waits for a reply from the RADIUS server (must be between 1-10 seconds).
        ...
        :param pulumi.Input[bool] radius_testing_enabled: If true, Meraki devices will periodically send Access-Request messages to configured RADIUS servers using identity 'meraki*8021x*test' to ensure that the RADIUS servers are reachable.
        :param pulumi.Input[str] secondary_concentrator_network_id: The secondary concentrator to use when the ipAssignmentMode is 'VPN'. If configured, the APs will switch to using this concentrator if the primary concentrator is unreachable. This param is optional. ('disabled' represents no secondary concentrator.)
        :param pulumi.Input['WirelessSsidsSpeedBurstArgs'] speed_burst: The SpeedBurst setting for this SSID'
        :param pulumi.Input[Sequence[pulumi.Input[str]]] splash_guest_sponsor_domains: Array of valid sponsor email domains for sponsored guest splash type.
        :param pulumi.Input[str] splash_page: The type of splash page for the SSID
        :param pulumi.Input[bool] use_vlan_tagging: Whether or not traffic should be directed to use specific VLANs. This param is only valid if the ipAssignmentMode is 'Bridge mode' or 'Layer 3 roaming'
        :param pulumi.Input[bool] visible: Whether the SSID is advertised or hidden by the AP
        :param pulumi.Input[int] vlan_id: The VLAN ID used for VLAN tagging. This param is only valid when the ipAssignmentMode is 'Layer 3 roaming with a concentrator' or 'VPN'
        :param pulumi.Input[bool] walled_garden_enabled: Allow users to access a configurable list of IP ranges prior to sign-on
        :param pulumi.Input[Sequence[pulumi.Input[str]]] walled_garden_ranges: Domain names and IP address ranges available in Walled Garden mode
        :param pulumi.Input[str] wpa_encryption_mode: The types of WPA encryption
        """
    ...
    def adult_content_filtering_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def adult_content_filtering_enabled(self, value: Optional[pulumi.Input[bool]]):
    ...
    def availability_tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def availability_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "availability_tags", value)

    @property
    @pulumi.getter(name="availableOnAllAps")
    def available_on_all_aps(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def available_on_all_aps(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "available_on_all_aps", value)

    @property
    @pulumi.getter(name="bandSelection")
    def band_selection(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def band_selection(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "band_selection", value)

    @property
    @pulumi.getter(name="concentratorNetworkId")
    def concentrator_network_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def concentrator_network_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "concentrator_network_id", value)

    @property
    @pulumi.getter(name="defaultVlanId")
    def default_vlan_id(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def default_vlan_id(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "default_vlan_id", value)

    @property
    @pulumi.getter(name="disassociateClientsOnVpnFailover")
    def disassociate_clients_on_vpn_failover(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def disassociate_clients_on_vpn_failover(self, value: Optional[pulumi.Input[bool]]):
    ...
    def enterprise_admin_access(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def enterprise_admin_access(self, value: Optional[pulumi.Input[str]]):
    ...
    def ip_assignment_mode(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def ip_assignment_mode(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "ip_assignment_mode", value)

    @property
    @pulumi.getter(name="lanIsolationEnabled")
    def lan_isolation_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def lan_isolation_enabled(self, value: Optional[pulumi.Input[bool]]):
    ...
    def mandatory_dhcp_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def mandatory_dhcp_enabled(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "mandatory_dhcp_enabled", value)

    @property
    @pulumi.getter(name="minBitrate")
    def min_bitrate(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    @min_bitrate.setter
    def min_bitrate(self, value: Optional[pulumi.Input[int]]):
    ...
    def per_client_bandwidth_limit_down(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def per_client_bandwidth_limit_down(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "per_client_bandwidth_limit_down", value)

    @property
    @pulumi.getter(name="perClientBandwidthLimitUp")
    def per_client_bandwidth_limit_up(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def per_client_bandwidth_limit_up(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "per_client_bandwidth_limit_up", value)

    @property
    @pulumi.getter(name="perSsidBandwidthLimitDown")
    def per_ssid_bandwidth_limit_down(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def per_ssid_bandwidth_limit_down(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "per_ssid_bandwidth_limit_down", value)

    @property
    @pulumi.getter(name="perSsidBandwidthLimitUp")
    def per_ssid_bandwidth_limit_up(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def per_ssid_bandwidth_limit_up(self, value: Optional[pulumi.Input[int]]):
    ...
    def radius_accounting_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def radius_accounting_enabled(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "radius_accounting_enabled", value)

    @property
    @pulumi.getter(name="radiusAccountingInterimInterval")
    def radius_accounting_interim_interval(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def radius_accounting_interim_interval(self, value: Optional[pulumi.Input[int]]):
    ...
    def radius_attribute_for_group_policies(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "radius_attribute_for_group_policies", value)

    @property
    @pulumi.getter(name="radiusAuthenticationNasId")
    def radius_authentication_nas_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def radius_authentication_nas_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "radius_authentication_nas_id", value)

    @property
    @pulumi.getter(name="radiusCalledStationId")
    def radius_called_station_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def radius_called_station_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "radius_called_station_id", value)

    @property
    @pulumi.getter(name="radiusCoaEnabled")
    def radius_coa_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def radius_failover_policy(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def radius_failover_policy(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "radius_failover_policy", value)

    @property
    @pulumi.getter(name="radiusFallbackEnabled")
    def radius_fallback_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def radius_fallback_enabled(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "radius_fallback_enabled", value)

    @property
    @pulumi.getter(name="radiusGuestVlanEnabled")
    def radius_guest_vlan_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def radius_guest_vlan_enabled(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "radius_guest_vlan_enabled", value)

    @property
    @pulumi.getter(name="radiusGuestVlanId")
    def radius_guest_vlan_id(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def radius_guest_vlan_id(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "radius_guest_vlan_id", value)

    @property
    @pulumi.getter(name="radiusLoadBalancingPolicy")
    def radius_load_balancing_policy(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def radius_load_balancing_policy(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "radius_load_balancing_policy", value)

    @property
    @pulumi.getter(name="radiusOverride")
    def radius_override(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def radius_override(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "radius_override", value)

    @property
    @pulumi.getter(name="radiusProxyEnabled")
    def radius_proxy_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def radius_proxy_enabled(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "radius_proxy_enabled", value)

    @property
    @pulumi.getter(name="radiusServerAttemptsLimit")
    def radius_server_attempts_limit(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def radius_server_attempts_limit(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "radius_server_attempts_limit", value)

    @property
    @pulumi.getter(name="radiusServerTimeout")
    def radius_server_timeout(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def radius_server_timeout(self, value: Optional[pulumi.Input[int]]):
    ...
    def radius_testing_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def radius_testing_enabled(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "radius_testing_enabled", value)

    @property
    @pulumi.getter(name="secondaryConcentratorNetworkId")
    def secondary_concentrator_network_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def secondary_concentrator_network_id(self, value: Optional[pulumi.Input[str]]):
    ...
    def splash_guest_sponsor_domains(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def splash_guest_sponsor_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "splash_guest_sponsor_domains", value)

    @property
    @pulumi.getter(name="splashPage")
    def splash_page(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @splash_page.setter
    def splash_page(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "splash_page", value)

    @property
    @pulumi.getter(name="useVlanTagging")
    def use_vlan_tagging(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def use_vlan_tagging(self, value: Optional[pulumi.Input[bool]]):
    ...
    def walled_garden_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def walled_garden_enabled(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "walled_garden_enabled", value)

    @property
    @pulumi.getter(name="walledGardenRanges")
    def walled_garden_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def walled_garden_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "walled_garden_ranges", value)

    @property
    @pulumi.getter(name="wpaEncryptionMode")
    def wpa_encryption_mode(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def wpa_encryption_mode(self, value: Optional[pulumi.Input[str]]):
...
class _WirelessSsidsState:
    def __init__(__self__, *,
                 active_directory: Optional[pulumi.Input['WirelessSsidsActiveDirectoryArgs']] = None,
                 admin_splash_url: Optional[pulumi.Input[str]] = None,
                 adult_content_filtering_enabled: Optional[pulumi.Input[bool]] = None,
                 ap_tags_and_vlan_ids: Optional[pulumi.Input[Sequence[pulumi.Input['WirelessSsidsApTagsAndVlanIdArgs']]]] = None,
                 auth_mode: Optional[pulumi.Input[str]] = None,
                 availability_tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ...
                 splash_guest_sponsor_domains: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 splash_page: Optional[pulumi.Input[str]] = None,
                 splash_timeout: Optional[pulumi.Input[str]] = None,
                 ssid_admin_accessible: Optional[pulumi.Input[bool]] = None,
                 use_vlan_tagging: Optional[pulumi.Input[bool]] = None,
                 visible: Optional[pulumi.Input[bool]] = None,
                 vlan_id: Optional[pulumi.Input[int]] = None,
                 walled_garden_enabled: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] splash_guest_sponsor_domains: Array of valid sponsor email domains for sponsored guest splash type.
        :param pulumi.Input[str] splash_page: The type of splash page for the SSID
        :param pulumi.Input[str] splash_timeout: Splash page timeout
        :param pulumi.Input[bool] ssid_admin_accessible: SSID Administrator access status
        :param pulumi.Input[bool] use_vlan_tagging: Whether or not traffic should be directed to use specific VLANs. This param is only valid if the ipAssignmentMode is 'Bridge mode' or 'Layer 3 roaming'
        :param pulumi.Input[bool] visible: Whether the SSID is advertised or hidden by the AP
        :param pulumi.Input[int] vlan_id: The VLAN ID used for VLAN tagging. This param is only valid when the ipAssignmentMode is 'Layer 3 roaming with a concentrator' or 'VPN'
        :param pulumi.Input[bool] walled_garden_enabled: Allow users to access a configurable list of IP ranges prior to sign-on
    ...
    def admin_splash_url(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "admin_splash_url")

    @admin_splash_url.setter
    def admin_splash_url(self, value: Optional[pulumi.Input[str]]):
    ...
    def splash_timeout(self) -> Optional[pulumi.Input[str]]:
        """
        Splash page timeout
        """
    ...
    def splash_timeout(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "splash_timeout", value)

    @property
    @pulumi.getter(name="ssidAdminAccessible")
    def ssid_admin_accessible(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def ssid_admin_accessible(self, value: Optional[pulumi.Input[bool]]):
...
class WirelessSsids(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 active_directory: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsActiveDirectoryArgs']]] = None,
                 adult_content_filtering_enabled: Optional[pulumi.Input[bool]] = None,
                 ap_tags_and_vlan_ids: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WirelessSsidsApTagsAndVlanIdArgs']]]]] = None,
                 auth_mode: Optional[pulumi.Input[str]] = None,
                 availability_tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 available_on_all_aps: Optional[pulumi.Input[bool]] = None,
                 band_selection: Optional[pulumi.Input[str]] = None,
                 ...
                 default_vlan_id: Optional[pulumi.Input[int]] = None,
                 disassociate_clients_on_vpn_failover: Optional[pulumi.Input[bool]] = None,
                 dns_rewrite: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsDnsRewriteArgs']]] = None,
                 dot11r: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsDot11rArgs']]] = None,
                 dot11w: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsDot11wArgs']]] = None,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 encryption_mode: Optional[pulumi.Input[str]] = None,
                 enterprise_admin_access: Optional[pulumi.Input[str]] = None,
                 gre: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsGreArgs']]] = None,
                 ip_assignment_mode: Optional[pulumi.Input[str]] = None,
                 lan_isolation_enabled: Optional[pulumi.Input[bool]] = None,
                 ...
                 min_bitrate: Optional[pulumi.Input[int]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 named_vlans: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsNamedVlansArgs']]] = None,
                 network_id: Optional[pulumi.Input[str]] = None,
                 number: Optional[pulumi.Input[int]] = None,
                 oauth: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsOauthArgs']]] = None,
                 per_client_bandwidth_limit_down: Optional[pulumi.Input[int]] = None,
                 per_client_bandwidth_limit_up: Optional[pulumi.Input[int]] = None,
                 per_ssid_bandwidth_limit_down: Optional[pulumi.Input[int]] = None,
                 per_ssid_bandwidth_limit_up: Optional[pulumi.Input[int]] = None,
                 ...
                 radius_server_attempts_limit: Optional[pulumi.Input[int]] = None,
                 radius_server_timeout: Optional[pulumi.Input[int]] = None,
                 radius_servers: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WirelessSsidsRadiusServerArgs']]]]] = None,
                 radius_testing_enabled: Optional[pulumi.Input[bool]] = None,
                 secondary_concentrator_network_id: Optional[pulumi.Input[str]] = None,
                 speed_burst: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSpeedBurstArgs']]] = None,
                 splash_guest_sponsor_domains: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 splash_page: Optional[pulumi.Input[str]] = None,
                 use_vlan_tagging: Optional[pulumi.Input[bool]] = None,
                 visible: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['WirelessSsidsActiveDirectoryArgs']] active_directory: The current setting for Active Directory. Only valid if splashPage is 'Password-protected with Active Directory'
        :param pulumi.Input[bool] adult_content_filtering_enabled: Boolean indicating whether or not adult content will be blocked
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WirelessSsidsApTagsAndVlanIdArgs']]]] ap_tags_and_vlan_ids: The list of tags and VLAN IDs used for VLAN tagging. This param is only valid when the ipAssignmentMode is 'Bridge mode' or 'Layer 3 roaming'
        :param pulumi.Input[str] auth_mode: The association control method for the SSID
        :param pulumi.Input[Sequence[pulumi.Input[str]]] availability_tags: List of tags for this SSID. If availableOnAllAps is false, then the SSID is only broadcast by APs with tags matching any of the tags in this list
        :param pulumi.Input[bool] available_on_all_aps: Whether all APs broadcast the SSID or if it's restricted to APs matching any availability tags
        :param pulumi.Input[str] band_selection: The client-serving radio frequencies of this SSID in the default indoor RF profile
        ...
        :param pulumi.Input[int] default_vlan_id: The default VLAN ID used for 'all other APs'. This param is only valid when the ipAssignmentMode is 'Bridge mode' or 'Layer 3 roaming'
        :param pulumi.Input[bool] disassociate_clients_on_vpn_failover: Disassociate clients when 'VPN' concentrator failover occurs in order to trigger clients to re-associate and generate new DHCP requests. This param is only valid if ipAssignmentMode is 'VPN'.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsDnsRewriteArgs']] dns_rewrite: DNS servers rewrite settings
        :param pulumi.Input[pulumi.InputType['WirelessSsidsDot11rArgs']] dot11r: The current setting for 802.11r
        :param pulumi.Input[pulumi.InputType['WirelessSsidsDot11wArgs']] dot11w: The current setting for Protected Management Frames (802.11w).
        :param pulumi.Input[bool] enabled: Whether or not the SSID is enabled
        :param pulumi.Input[str] encryption_mode: The psk encryption mode for the SSID
        :param pulumi.Input[str] enterprise_admin_access: Whether or not an SSID is accessible by 'enterprise' administrators ('access disabled' or 'access enabled')
        :param pulumi.Input[pulumi.InputType['WirelessSsidsGreArgs']] gre: Ethernet over GRE settings
        :param pulumi.Input[str] ip_assignment_mode: The client IP assignment mode
        :param pulumi.Input[bool] lan_isolation_enabled: Boolean indicating whether Layer 2 LAN isolation should be enabled or disabled. Only configurable when ipAssignmentMode is 'Bridge mode'.
        ...
        :param pulumi.Input[int] min_bitrate: The minimum bitrate in Mbps of this SSID in the default indoor RF profile
        :param pulumi.Input[str] name: The name of the SSID
        :param pulumi.Input[pulumi.InputType['WirelessSsidsNamedVlansArgs']] named_vlans: Named VLAN settings.
        :param pulumi.Input[str] network_id: networkId path parameter. Network ID
        :param pulumi.Input[int] number: Unique identifier of the SSID
        :param pulumi.Input[pulumi.InputType['WirelessSsidsOauthArgs']] oauth: The OAuth settings of this SSID. Only valid if splashPage is 'Google OAuth'.
        :param pulumi.Input[int] per_client_bandwidth_limit_down: The download bandwidth limit in Kbps. (0 represents no limit.)
        :param pulumi.Input[int] per_client_bandwidth_limit_up: The upload bandwidth limit in Kbps. (0 represents no limit.)
        :param pulumi.Input[int] per_ssid_bandwidth_limit_down: The total download bandwidth limit in Kbps (0 represents no limit)
        :param pulumi.Input[int] per_ssid_bandwidth_limit_up: The total upload bandwidth limit in Kbps (0 represents no limit)
        ...
        :param pulumi.Input[int] radius_server_attempts_limit: The maximum number of transmit attempts after which a RADIUS server is failed over (must be between 1-5).
        :param pulumi.Input[int] radius_server_timeout: The amount of time for which a RADIUS client waits for a reply from the RADIUS server (must be between 1-10 seconds).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WirelessSsidsRadiusServerArgs']]]] radius_servers: The RADIUS 802.1X servers to be used for authentication. This param is only valid if the authMode is 'open-with-radius', '8021x-radius' or 'ipsk-with-radius'
        :param pulumi.Input[bool] radius_testing_enabled: If true, Meraki devices will periodically send Access-Request messages to configured RADIUS servers using identity 'meraki*8021x*test' to ensure that the RADIUS servers are reachable.
        :param pulumi.Input[str] secondary_concentrator_network_id: The secondary concentrator to use when the ipAssignmentMode is 'VPN'. If configured, the APs will switch to using this concentrator if the primary concentrator is unreachable. This param is optional. ('disabled' represents no secondary concentrator.)
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSpeedBurstArgs']] speed_burst: The SpeedBurst setting for this SSID'
        :param pulumi.Input[Sequence[pulumi.Input[str]]] splash_guest_sponsor_domains: Array of valid sponsor email domains for sponsored guest splash type.
        :param pulumi.Input[str] splash_page: The type of splash page for the SSID
        :param pulumi.Input[bool] use_vlan_tagging: Whether or not traffic should be directed to use specific VLANs. This param is only valid if the ipAssignmentMode is 'Bridge mode' or 'Layer 3 roaming'
        :param pulumi.Input[bool] visible: Whether the SSID is advertised or hidden by the AP
    ...
    def get(resource_name: str,
            ...
            radius_server_timeout: Optional[pulumi.Input[int]] = None,
            radius_servers: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WirelessSsidsRadiusServerArgs']]]]] = None,
            radius_servers_responses: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WirelessSsidsRadiusServersResponseArgs']]]]] = None,
            radius_testing_enabled: Optional[pulumi.Input[bool]] = None,
            secondary_concentrator_network_id: Optional[pulumi.Input[str]] = None,
            speed_burst: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSpeedBurstArgs']]] = None,
            splash_guest_sponsor_domains: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            ...
            walled_garden_enabled: Optional[pulumi.Input[bool]] = None,
            walled_garden_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            wpa_encryption_mode: Optional[pulumi.Input[str]] = None) -> 'WirelessSsids':
        """
        ...
        :param pulumi.Input[int] radius_server_timeout: The amount of time for which a RADIUS client waits for a reply from the RADIUS server (must be between 1-10 seconds).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WirelessSsidsRadiusServerArgs']]]] radius_servers: The RADIUS 802.1X servers to be used for authentication. This param is only valid if the authMode is 'open-with-radius', '8021x-radius' or 'ipsk-with-radius'
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WirelessSsidsRadiusServersResponseArgs']]]] radius_servers_responses: The RADIUS 802.1X servers to be used for authentication. This param is only valid if the authMode is 'open-with-radius', '8021x-radius' or 'ipsk-with-radius'
        :param pulumi.Input[bool] radius_testing_enabled: If true, Meraki devices will periodically send Access-Request messages to configured RADIUS servers using identity 'meraki*8021x*test' to ensure that the RADIUS servers are reachable.
        :param pulumi.Input[str] secondary_concentrator_network_id: The secondary concentrator to use when the ipAssignmentMode is 'VPN'. If configured, the APs will switch to using this concentrator if the primary concentrator is unreachable. This param is optional. ('disabled' represents no secondary concentrator.)
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSpeedBurstArgs']] speed_burst: The SpeedBurst setting for this SSID'
        :param pulumi.Input[Sequence[pulumi.Input[str]]] splash_guest_sponsor_domains: Array of valid sponsor email domains for sponsored guest splash type.
    ...
    @property
    @pulumi.getter(name="adminSplashUrl")
    def admin_splash_url(self) -> pulumi.Output[str]:
        return pulumi.get(self, "admin_splash_url")
    ...
    @property
    @pulumi.getter(name="availableOnAllAps")
    def available_on_all_aps(self) -> pulumi.Output[bool]:
        """
        Whether all APs broadcast the SSID or if it's restricted to APs matching any availability tags
        """
        return pulumi.get(self, "available_on_all_aps")
    ...
    @property
    @pulumi.getter(name="bandSelection")
    def band_selection(self) -> pulumi.Output[str]:
        """
        The client-serving radio frequencies of this SSID in the default indoor RF profile
        """
        return pulumi.get(self, "band_selection")
    ...
    @property
    @pulumi.getter(name="ipAssignmentMode")
    def ip_assignment_mode(self) -> pulumi.Output[str]:
        """
        The client IP assignment mode
        """
        return pulumi.get(self, "ip_assignment_mode")
    ...
    @property
    @pulumi.getter(name="mandatoryDhcpEnabled")
    def mandatory_dhcp_enabled(self) -> pulumi.Output[bool]:
        """
        Whether clients connecting to this SSID must use the IP address assigned by the DHCP server
        """
        return pulumi.get(self, "mandatory_dhcp_enabled")
    ...
    @property
    @pulumi.getter(name="minBitrate")
    def min_bitrate(self) -> pulumi.Output[int]:
        """
        The minimum bitrate in Mbps of this SSID in the default indoor RF profile
        """
        return pulumi.get(self, "min_bitrate")
    ...
    @property
    @pulumi.getter(name="perClientBandwidthLimitDown")
    def per_client_bandwidth_limit_down(self) -> pulumi.Output[int]:
        """
        The download bandwidth limit in Kbps. (0 represents no limit.)
        """
        return pulumi.get(self, "per_client_bandwidth_limit_down")
    ...
    @property
    @pulumi.getter(name="perClientBandwidthLimitUp")
    def per_client_bandwidth_limit_up(self) -> pulumi.Output[int]:
        """
        The upload bandwidth limit in Kbps. (0 represents no limit.)
        """
        return pulumi.get(self, "per_client_bandwidth_limit_up")
    ...
    @property
    @pulumi.getter(name="perSsidBandwidthLimitDown")
    def per_ssid_bandwidth_limit_down(self) -> pulumi.Output[int]:
        """
        The total download bandwidth limit in Kbps (0 represents no limit)
        """
        return pulumi.get(self, "per_ssid_bandwidth_limit_down")
    ...
    @property
    @pulumi.getter(name="perSsidBandwidthLimitUp")
    def per_ssid_bandwidth_limit_up(self) -> pulumi.Output[int]:
        """
        The total upload bandwidth limit in Kbps (0 represents no limit)
        """
        return pulumi.get(self, "per_ssid_bandwidth_limit_up")
    ...
    @property
    @pulumi.getter(name="radiusAttributeForGroupPolicies")
    def radius_attribute_for_group_policies(self) -> pulumi.Output[str]:
        """
        RADIUS attribute used to look up group policies
        """
        return pulumi.get(self, "radius_attribute_for_group_policies")
    ...
    @property
    @pulumi.getter(name="radiusFailoverPolicy")
    def radius_failover_policy(self) -> pulumi.Output[str]:
        """
        Policy which determines how authentication requests should be handled in the event that all of the configured RADIUS servers are unreachable
        """
        return pulumi.get(self, "radius_failover_policy")
    ...
    @property
    @pulumi.getter(name="radiusLoadBalancingPolicy")
    def radius_load_balancing_policy(self) -> pulumi.Output[str]:
        """
        Policy which determines which RADIUS server will be contacted first in an authentication attempt, and the ordering of any necessary retry attempts
        """
        return pulumi.get(self, "radius_load_balancing_policy")
    ...
    @property
    @pulumi.getter(name="splashGuestSponsorDomains")
    def splash_guest_sponsor_domains(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        Array of valid sponsor email domains for sponsored guest splash type.
        """
        return pulumi.get(self, "splash_guest_sponsor_domains")
    ...
    @property
    @pulumi.getter(name="splashPage")
    def splash_page(self) -> pulumi.Output[str]:
        """
        The type of splash page for the SSID
        """
        return pulumi.get(self, "splash_page")
    ...
    @property
    @pulumi.getter(name="splashTimeout")
    def splash_timeout(self) -> pulumi.Output[str]:
        """
        Splash page timeout
        """
        return pulumi.get(self, "splash_timeout")
    ...
    @property
    @pulumi.getter(name="ssidAdminAccessible")
    def ssid_admin_accessible(self) -> pulumi.Output[bool]:
        """
        SSID Administrator access status
        """
        return pulumi.get(self, "ssid_admin_accessible")
    ...
    @property
    @pulumi.getter(name="wpaEncryptionMode")
    def wpa_encryption_mode(self) -> pulumi.Output[str]:
        """
        The types of WPA encryption
        """
        return pulumi.get(self, "wpa_encryption_mode")
