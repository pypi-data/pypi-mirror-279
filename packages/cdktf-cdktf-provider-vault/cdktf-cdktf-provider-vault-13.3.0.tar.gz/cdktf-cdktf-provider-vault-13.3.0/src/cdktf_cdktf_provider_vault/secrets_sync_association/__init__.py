...
class SecretsSyncAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        :param mount: Specifies the mount where the secret is located. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.3.0/docs/resources/secrets_sync_association#mount SecretsSyncAssociation#mount}
        :param name: Name of the destination. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.3.0/docs/resources/secrets_sync_association#name SecretsSyncAssociation#name}
        :param secret_name: Specifies the name of the secret to synchronize. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.3.0/docs/resources/secrets_sync_association#secret_name SecretsSyncAssociation#secret_name}
        :param type: Type of sync destination. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.3.0/docs/resources/secrets_sync_association#type SecretsSyncAssociation#type}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.3.0/docs/resources/secrets_sync_association#id SecretsSyncAssociation#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param namespace: Target namespace. (requires Enterprise). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.3.0/docs/resources/secrets_sync_association#namespace SecretsSyncAssociation#namespace}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SecretsSyncAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.3.0/docs/resources/secrets_sync_association#import import section} in the documentation of this resource for the id to use
    ...
    def metadata(self) -> "SecretsSyncAssociationMetadataList":
        return typing.cast("SecretsSyncAssociationMetadataList", jsii.get(self, "metadata"))
...
@jsii.data_type(
    jsii_type="@cdktf/provider-vault.secretsSyncAssociation.SecretsSyncAssociationMetadata",
    jsii_struct_bases=[],
    name_mapping={},
)
class SecretsSyncAssociationMetadata:
    ...
    def __repr__(self) -> str:
        return "SecretsSyncAssociationMetadata(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class SecretsSyncAssociationMetadataList(
    _cdktf_9a9027ec.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-vault.secretsSyncAssociation.SecretsSyncAssociationMetadataList",
):
    def __init__(
        self,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8bcf2521b538b1b0f791e3b510ab99f3f83bc49ffa4d382c39a9598e6ff6add6)
    ...
    def get(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__970d52ea3f68abacd56765562814d0c71d68719bff778617c3c69b75a4be47ae)
            check_type(argname="argument index", value=index, expected_type=type_hints["index"])
        return typing.cast("SecretsSyncAssociationMetadataOutputReference", jsii.invoke(self, "get", [index]))
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__deda65a26d837defa8db01d1938b291c3b8c17c7f69391f0978888775102fc0f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9ff4bd6d72146792d9ff68ab426230b9b72a3f66d29b41013233f76ebf65908a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7d3952a50196ed832a33cddff1b7b5821fa921bfe9218e0ae3509d187fcdb9bc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "wrapsSet", value)


class SecretsSyncAssociationMetadataOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-vault.secretsSyncAssociation.SecretsSyncAssociationMetadataOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dda03f614182c946063a77e886c33b72013c1cbc06bafc9d5a4a31db7fbfb47c)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
    ...
    def sub_key(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "subKey"))
    ...
    def internal_value(self) -> typing.Optional[SecretsSyncAssociationMetadata]:
        return typing.cast(typing.Optional[SecretsSyncAssociationMetadata], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[SecretsSyncAssociationMetadata],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7b51792615ae4140b0952e005ed2110bb115ca6b523bbe1e66710d6d3b0800cf)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
__all__ = [
    ...
    "SecretsSyncAssociationMetadata",
    "SecretsSyncAssociationMetadataList",
    "SecretsSyncAssociationMetadataOutputReference",
]
...
def _typecheckingstub__8bcf2521b538b1b0f791e3b510ab99f3f83bc49ffa4d382c39a9598e6ff6add6(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
    wraps_set: builtins.bool,
) -> None:
...
def _typecheckingstub__970d52ea3f68abacd56765562814d0c71d68719bff778617c3c69b75a4be47ae(
    index: jsii.Number,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__deda65a26d837defa8db01d1938b291c3b8c17c7f69391f0978888775102fc0f(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9ff4bd6d72146792d9ff68ab426230b9b72a3f66d29b41013233f76ebf65908a(
    value: _cdktf_9a9027ec.IInterpolatingParent,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7d3952a50196ed832a33cddff1b7b5821fa921bfe9218e0ae3509d187fcdb9bc(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dda03f614182c946063a77e886c33b72013c1cbc06bafc9d5a4a31db7fbfb47c(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
    complex_object_index: jsii.Number,
    complex_object_is_from_set: builtins.bool,
...
def _typecheckingstub__7b51792615ae4140b0952e005ed2110bb115ca6b523bbe1e66710d6d3b0800cf(
    value: typing.Optional[SecretsSyncAssociationMetadata],
) -> None:
    """Type checking stubs"""
    pass
