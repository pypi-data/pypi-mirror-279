...
module_dir = os.path.join(__location__, "../src/parscival")
try:
...
project = "Parscival"
copyright = "2021-2024, CorTexT Platform, Cogniteva SAS"
...
try:
    from parscival import __version__ as version
except ImportError:
    version = ""
...
html_context = {
  "source_type": "gitlab",
  "source_user": "cortext",
  "source_repo": "cortext-methods/parscival",
...
# of the sidebar.
html_logo = "_static/parscival.png"
...
htmlhelp_basename = "parscival-doc"
...
latex_documents = [
    ("index", f"parscival-{version}.tex", "Parscival Documentation", "The Parscival Authors", "manual")
]
