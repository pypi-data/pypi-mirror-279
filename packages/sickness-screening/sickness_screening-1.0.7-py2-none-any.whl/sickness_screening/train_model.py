...
# cat_convert_functions = {
#     'White Blood Cells': convert_values,
#     'Another Column': some_other_conversion_function
# }
# trained_model = train_model(df_to_train=df, categorical_cols=['Large Platelets'], columns_to_train_on=['Amylase'], cat_convert_functions=cat_convert_functions)