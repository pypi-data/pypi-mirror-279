...
class TableFileProfile(FileProfile):
    ...
    def __init__(self, file_filter=None):
        ...
        super(TableFileProfile, self).__init__(packfile_type=self.name, file_filter=file_filter)
    ...
    def add_field(self, field):
        ...
        # fields
        if field.key != "remove" and not field.fieldname.startswith(self.filename_field_prefix):
