...
class Bot(ABC):
  ...
  def editMessageCaption(self, chat_id: int, msg_id: int, capt: str, **kwargs) -> Response:  # noqa: E501
  ...
  def editMessageReplyMarkup(self, chat_id: int, msg_id: int, markup: str, **kwargs) -> Response:  # noqa: E501
    """Edit reply markup"""
  ...
  def answerCallbackQuery(self, query_id, text :str|None =None, **kwargs) -> Response:  # noqa: E501
