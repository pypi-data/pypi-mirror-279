...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\jkern\PycharmProjects\quacs\venv-install'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\jkern\PycharmProjects\quacs\venv-install\Scripts\deactivate.nu'
