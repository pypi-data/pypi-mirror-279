...
from shuttleasgi.common.types import HeadersType, ParamsType
...
from shuttleasgi.server.routing import RouteFilter
from shuttleasgi.server.routing import RoutesRegistry as RoutesRegistry  # noqa
from shuttleasgi.server.routing import controllers_routes, normalize_filters
from shuttleasgi.utils import AnyStr, join_fragments
...
class Controller(metaclass=ControllerMeta):
    ...
    def pretty_orjson(self, data: Any, status: int = 200, headers: Optional[list[tuple[bytes, bytes]]] = None) -> Response:
        """
        Returns a response with indented application/json content,
        and given status (default HTTP 200 OK).
        """
