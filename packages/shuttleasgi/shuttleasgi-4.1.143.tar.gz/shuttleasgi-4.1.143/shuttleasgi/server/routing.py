...
class Router(RouterBase):
    ...
    def __init__(
        ...
        *,
        ...
        self.reversed_routes: Dict[Route, List[bytes]] = {}
    ...
    def add(
        ...
        print("Router.add", method_name, new_route.pattern, new_route.handler)
...
class RoutesRegistry(RouterBase):
    ...
    def add(
        ...
        print("RoutesRegistry.add", method, pattern, handler)
        self.mark_handler(handler)
