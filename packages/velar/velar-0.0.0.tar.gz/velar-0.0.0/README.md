...
This project consists of two main parts: [tgcalls](#tgcalls), [velar](#velar).
...
Temporarily, instead of documentation, you can use [an example](velar/velar)
along with MTProto.

<hr>
<p align="center">
    <a href="https://github.com/MarshalX/tgcalls">
        <img src="https://github.com/MarshalX/tgcalls/raw/main/.github/images/velar.png" alt="velar">
    </a>
    <br>
    <a href="https://tgcalls.org">
        Documentation
    ...
    •
    <a href="https://pypi.org/project/velar/">
        PyPi
    </a>
    •
    <a href="https://github.com/MarshalX/tgcalls/tree/main/velar">
        Sources
    </a>
</p>
...
`velar`'s documentation lives at [tgcalls.org](https://tgcalls.org).
