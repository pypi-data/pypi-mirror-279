...
setup(
  name = 'invoicing-excel-pdfs',         #* Your package will have this name
  ...
  author = 'Sai Pranitha Kotipalli',                   # Your name
  author_email = 'pranithatwitteracct@gmail.com',  # Your email
