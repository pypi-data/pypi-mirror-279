...
class SurveyInfo:
    """Returns basic information such as a list of supported surveys and their times"""
    ...
    def __init__(self):
        ...
        self.lightcurve_surveys = ["atlas", "ztf", "crts", "asassn", "gaia"]
...
class DataStruct(object):
    ...
    def __init__(
        self, survey, catalogue, source, pos, data, identifier=None, sub_kind="data"
    ):
        self.kind = "data"
