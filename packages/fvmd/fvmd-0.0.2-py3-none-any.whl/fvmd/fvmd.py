...
from datasets.video_datasets import VideoDataset, VideoDatasetNP
from keypoint_tracking import keypoint_tracking
from extract_motion_features import calc_hist
from frechet_distance import calculate_fd_given_vectors
...
def fvmd(log_dir: str, gen_path: str, gt_path: str):
    ...
    velo_gen, velo_gt, acc_gen, acc_gt = keypoint_tracking(log_dir=log_dir, gen_dataset=gen_dataset,
