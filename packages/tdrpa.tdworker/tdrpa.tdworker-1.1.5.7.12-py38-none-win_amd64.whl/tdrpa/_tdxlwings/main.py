"""
_tdxlwings - Make Excel fly with Python!
        ...
        if isinstance(name_or_index, numbers.Number):
            ...
            try:
                ...
                engine_to_product_name = {
                    "remote": "_tdxlwings Server",
                    "calamine": "_tdxlwings Reader",
                }
                if not xlwings.__pro__ and name_or_index != "excel":
                    raise LicenseError(
                        f"{engine_to_product_name.get(name_or_index, name_or_index)} "
                        "requires a license key. Install one by running '_tdxlwings "
...
class App:
    ...
    An app object is a member of the :meth:`apps <_tdxlwings.main.Apps>` collection:
    ...
    spec : str, default None
        ...
        On Windows, if you want to change the version of Excel that _tdxlwings talks to, go
        to ``Control Panel > Programs and Features`` and ``Repair`` the Office version
        that you want as default.


    .. note::
        On Mac, while _tdxlwings allows you to run multiple instances of Excel, it's a
    ...
    def startup_path(self):
        """
        Returns the path to ``XLSTART`` which is where the _tdxlwings add-in gets
        copied to by doing ``_tdxlwings addin install``.
    ...
    def render_template(self, template=None, output=None, book_settings=None, **data):
        """
        This function requires _tdxlwings :bdg-secondary:`PRO`.

        This is a convenience wrapper around :meth:`mysheet.render_template
        <_tdxlwings.Sheet.render_template>`
        ...
        book_settings: dict, default None
            A dictionary of ``_tdxlwings.Book`` parameters, for details see:
            :attr:`_tdxlwings.Book`.
    ...
    def alert(self, prompt, title=None, buttons="ok", mode=None, callback=None):
        ...
        the value of the pressed button. For _tdxlwings Server, instead of
        ...
        callback : str, default None
            Only used by _tdxlwings Server: you can provide the name of a
        ...
        button_value: str or None
            Returns ``None`` when used with _tdxlwings Server, otherwise the value
...
class Book:
    """
    A book object is a member of the :meth:`books <_tdxlwings.main.Books>` collection:
    ...
    json : dict
        ...
        _tdxlwings module but in a deserialized form, i.e., as dictionary.

        .. versionadded:: 0.26.0

    mode : str, default None
        Either ``"i"`` (interactive (default)) or ``"r"`` (read). In interactive mode,
        _tdxlwings opens the workbook in Excel, i.e., Excel needs to be installed. In read
        mode, _tdxlwings reads from the file directly, without requiring Excel to be
        installed. Read mode requires _tdxlwings :bdg-secondary:`PRO`.
    ...
    def json(self):
        ...
        Google Apps Script _tdxlwings module. Only available with book objects that have
    ...
    def set_mock_caller(self):
        ...
        ::
            ...
            def my_macro():
                ...
                sht.range('A1').value = 'Hello _tdxlwings!'
    ...
    def to_pdf(
        ...
        layout : str or path-like object, default None
            This argument requires _tdxlwings :bdg-secondary:`PRO`.
        ...
        See also :meth:`_tdxlwings.Sheet.to_pdf`
    ...
    def render_template(self, **data):
        """
        This method requires _tdxlwings :bdg-secondary:`PRO`.
...
class Sheet:
    """
    A sheet object is a member of the :meth:`sheets <_tdxlwings.main.Sheets>` collection:
    ...
    def to_pdf(self, path=None, layout=None, show=False, quality="standard"):
        ...
        See also :meth:`_tdxlwings.Book.to_pdf`
    ...
    def charts(self):
        """
        See :meth:`Charts <_tdxlwings.main.Charts>`
    ...
    def shapes(self):
        """
        See :meth:`Shapes <_tdxlwings.main.Shapes>`
    ...
    def tables(self):
        """
        See :meth:`Tables <_tdxlwings.main.Tables>`
    ...
    def pictures(self):
        """
        See :meth:`Pictures <_tdxlwings.main.Pictures>`
...
class Range:
    ...
    def raw_value(self):
        ...
        _tdxlwings' data cleaning/converting. This can be helpful if speed is an issue but
    ...
    def value(self):
        """
        Gets and sets the values for the given Range. See :meth:`_tdxlwings.Range.options`
        ...
        object : returned object depends on the converter being used,
                 see :meth:`_tdxlwings.Range.options`
        """
    ...
    def copy(self, destination=None):
        ...
        destination : xlwings.Range
            _tdxlwings Range to which the specified range will be copied. If omitted,
...
class Shape:
    """
    The shape object is a member of the :meth:`shapes <_tdxlwings.main.Shapes>` collection:
    ...
    def text(self, value):
        if xlwings.__pro__:
            from tdrpa. _tdxlwings.pro import Markdown
            from tdrpa. _tdxlwings.pro.reports.markdown import format_text, render_text
...
class Table:
    """
    The table object is a member of the :meth:`tables <_tdxlwings.main.Tables>` collection:
    ...
    def data_body_range(self):
        """Returns an _tdxlwings range object that represents the range of values,
    ...
    def header_row_range(self):
        """Returns an _tdxlwings range object that represents the range of the header row"""
    ...
    def insert_row_range(self):
        """Returns an _tdxlwings range object representing the row where data is going to
    ...
    @property
    def range(self):
        """Returns an _tdxlwings range object of the table."""
    ...
    def table_style(self):
        ...
        See :meth:`Tables.add <_tdxlwings.main.Tables.add>` for possible values.
        """
    ...
    def totals_row_range(self):
        """Returns an _tdxlwings range object representing the Total row"""
    ...
    def resize(self, range):
        """Resize a Table by providing an _tdxlwings range object
...
class Tables(Collection):
    ...
    def add(
        ...
        source : _tdxlwings range, default None
            An _tdxlwings range object, representing the data source.
        ...
        source_type : str, default None
            This currently defaults to ``xlSrcRange``, i.e. expects an _tdxlwings range
        ...
        destination : _tdxlwings range, default None
...
class Chart:
    """
    The chart object is a member of the :meth:`charts <_tdxlwings.main.Charts>` collection:
...
class Picture:
    """
    The picture object is a member of the :meth:`pictures <_tdxlwings.main.Pictures>`
    collection:
...
class Pictures(Collection):
    ...
    def add(
        ...
        anchor: xw.Range, default None
            The _tdxlwings Range object of where you want to insert the picture. If you use
...
class Name:
    """
    The name object is a member of the :meth:`names <_tdxlwings.main.Names>` collection:
...
def view(obj, sheet=None, table=True, chunksize=5000):
    ...
    See also: :meth:`load <_tdxlwings.load>`
...
def load(index=1, header=1, chunksize=5000):
    ...
    See also: :meth:`view <_tdxlwings.view>`
    ...
    def impl(self):
        if engines.active is None:
            if not (
                ...
                raise XlwingsError(
                    "The interactive mode of _tdxlwings is only supported on Windows and "
                    "macOS. On Linux, you can use _tdxlwings Server or _tdxlwings Reader."
                )
            elif sys.platform.startswith("darwin"):
                raise XlwingsError(
                    'Make sure to have "appscript" and "psutil", '
                    "dependencies of _tdxlwings, installed."
                )
            elif sys.platform.startswith("win"):
                raise XlwingsError(
                    'Make sure to have "pywin32", a dependency of _tdxlwings, installed.'
                )
