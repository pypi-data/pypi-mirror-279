"""
tdxlwings - Make Excel fly with Python!
...
class App:
    ...
    An app object is a member of the :meth:`apps <tdxlwings.main.Apps>` collection:
    ...
    spec : str, default None
        ...
        On Windows, if you want to change the version of Excel that tdxlwings talks to, go
        to ``Control Panel > Programs and Features`` and ``Repair`` the Office version
        that you want as default.


    .. note::
        On Mac, while tdxlwings allows you to run multiple instances of Excel, it's a
    ...
    def startup_path(self):
        """
        Returns the path to ``XLSTART`` which is where the tdxlwings add-in gets
        copied to by doing ``tdxlwings addin install``.
    ...
    def render_template(self, template=None, output=None, book_settings=None, **data):
        """
        This function requires tdxlwings :bdg-secondary:`PRO`.

        This is a convenience wrapper around :meth:`mysheet.render_template
        <tdxlwings.Sheet.render_template>`
        ...
        book_settings: dict, default None
            A dictionary of ``tdxlwings.Book`` parameters, for details see:
            :attr:`tdxlwings.Book`.
    ...
    def alert(self, prompt, title=None, buttons="ok", mode=None, callback=None):
        ...
        the value of the pressed button. For tdxlwings Server, instead of
        ...
        callback : str, default None
            Only used by tdxlwings Server: you can provide the name of a
        ...
        button_value: str or None
            Returns ``None`` when used with tdxlwings Server, otherwise the value
...
class Book:
    ...
    def json(self):
        ...
        Google Apps Script tdxlwings module. Only available with book objects that have
    ...
    def set_mock_caller(self):
        ...
        ::
            ...
            def my_macro():
                ...
                sht.range('A1').value = 'Hello tdxlwings!'
    ...
    def to_pdf(
        ...
        layout : str or path-like object, default None
            This argument requires tdxlwings :bdg-secondary:`PRO`.
        ...
        See also :meth:`tdxlwings.Sheet.to_pdf`
...
class Sheet:
    ...
    def to_pdf(self, path=None, layout=None, show=False, quality="standard"):
        ...
        See also :meth:`tdxlwings.Book.to_pdf`
    ...
    def charts(self):
        """
        See :meth:`Charts <tdxlwings.main.Charts>`
    ...
    def shapes(self):
        """
        See :meth:`Shapes <tdxlwings.main.Shapes>`
    ...
    def tables(self):
        """
        See :meth:`Tables <tdxlwings.main.Tables>`
    ...
    def pictures(self):
        """
        See :meth:`Pictures <tdxlwings.main.Pictures>`
...
class Range:
    ...
    def raw_value(self):
        ...
        tdxlwings' data cleaning/converting. This can be helpful if speed is an issue but
    ...
    def value(self):
        """
        Gets and sets the values for the given Range. See :meth:`tdxlwings.Range.options`
        ...
        object : returned object depends on the converter being used,
                 see :meth:`tdxlwings.Range.options`
        """
    ...
    def copy(self, destination=None):
        ...
        destination : xlwings.Range
            tdxlwings Range to which the specified range will be copied. If omitted,
...
class Shape:
    ...
    def text(self, value):
        if tdxlwings.__pro__:
            from tdxlwings.pro import Markdown
            from tdxlwings.pro.reports.markdown import format_text, render_text
...
class Table:
    ...
    def data_body_range(self):
        """Returns an tdxlwings range object that represents the range of values,
    ...
    def header_row_range(self):
        """Returns an tdxlwings range object that represents the range of the header row"""
    ...
    def insert_row_range(self):
        """Returns an tdxlwings range object representing the row where data is going to
    ...
    @property
    def range(self):
        """Returns an tdxlwings range object of the table."""
    ...
    def table_style(self):
        ...
        See :meth:`Tables.add <tdxlwings.main.Tables.add>` for possible values.
        """
    ...
    def totals_row_range(self):
        """Returns an tdxlwings range object representing the Total row"""
    ...
    def resize(self, range):
        """Resize a Table by providing an tdxlwings range object
    ...
    def impl(self):
        if engines.active is None:
            if not (
                ...
                raise XlwingsError(
                    "The interactive mode of tdxlwings is only supported on Windows and "
                    "macOS. On Linux, you can use tdxlwings Server or tdxlwings Reader."
                )
            elif sys.platform.startswith("darwin"):
                raise XlwingsError(
                    'Make sure to have "appscript" and "psutil", '
                    "dependencies of tdxlwings, installed."
                )
            elif sys.platform.startswith("win"):
                raise XlwingsError(
                    'Make sure to have "pywin32", a dependency of tdxlwings, installed.'
                )
