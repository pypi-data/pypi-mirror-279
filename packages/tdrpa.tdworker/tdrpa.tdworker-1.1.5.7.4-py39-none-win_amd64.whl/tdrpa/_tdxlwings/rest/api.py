...
# TODO: proper exception handling in _tdxlwings base package so it can be used here
import logging
import sys
...
from _tdxlwings.rest.serializers import (
    serialize_app,
    serialize_book,
    serialize_chart,
    serialize_name,
...
try:
    ...
    raise Exception(
        "To use the _tdxlwings REST API server, you need Flask>=1.0.0 installed."
    )
