...
from .comfort import get_from_list, BitManipulator, int_to_bool_list
...
class GroupGenerator:
    ...
    @staticmethod
    def ecc(blocks:Group, ecc: int, pin_day: int=0, pin_hour: int=0, pin_minute: int=0):
        ...
        return Group(
            ...
            (blocks.c | ecc) & 0xFFFF,
            (blocks.d | (pin_day << 11) | (pin_hour << 6) | pin_minute) & 0xFFFF,
            False
        )
    @staticmethod
    def lic(blocks:Group, lic: int, pin_day: int=0, pin_hour: int=0, pin_minute: int=0):
    ...
    @staticmethod
    def pin(blocks:Group, pin_day: int=0, pin_hour: int=0, pin_minute: int=0):
        ...
        return Group(
            blocks.a & 0xFFFF,
            (blocks.b | get_group(1,True)) & 0xFFFF,
            blocks.a & 0xFFFF,
            (blocks.d | (pin_day << 11) | (pin_hour << 6) | pin_minute) & 0xFFFF,
            True
        )
    @staticmethod
    def broadcasterdata_pin(blocks:Group, data: int, pin_day: int=0, pin_hour: int=0, pin_minute: int=0):
        ...
        return Group(
            blocks.a & 0xFFFF,
            (blocks.b | get_group(1)) & 0xFFFF,
            (blocks.c | ((data & 0b1111111111111) | 0b01100000000000000)) & 0xFFFF,
            (blocks.d | (pin_day << 11) | (pin_hour << 6) | pin_minute) & 0xFFFF,
            True
        )
    @staticmethod
    ...
    @staticmethod
    def ct(basic:Group, mjd: int, hour: int, minute: int, local_hour:int|None=None,local_minute:int|None=None):
    ...
    def tdc(blocks:Group, channel:int,data:list[int],segment:int):
        ...
        return Group(
            blocks.a & 0xFFFF,
            (blocks.b | get_group(5) | (channel & 0x1F)) & 0xFFFF,
    ...
    def tdc_b(blocks:Group, channel:int,data:list[int],segment:int):
        ...
        return Group(
            blocks.a & 0xFFFF,
            (blocks.b | get_group(5,True) | (channel & 0x1F)) & 0xFFFF,
            blocks.a & 0xFFFF,
            (get_from_list(data,segment+0,0)<<8 | get_from_list(data,segment+1,0)) & 0xFFFF,
            True
        )
    @staticmethod
    def in_house(blocks:Group, data:list[int],segment:int=0):
        ...
        return Group(
            blocks.a & 0xFFFF,
            (((blocks.b | get_group(6)) & ~0x1F) | (get_from_list(data,segment+0,0) & 0x1F)) & 0xFFFF,
            get_from_list(data,segment+1,0) & 0xFFFF,
            get_from_list(data,segment+2,0) & 0xFFFF,
            False
        )
    @staticmethod
    def in_house_b(blocks:Group, data:list[int],segment:int=0):
        ...
        return Group(
            blocks.a & 0xFFFF,
            (((blocks.b | get_group(6,True)) & ~0x1F) | (get_from_list(data,segment+0,0) & 0x1F)) & 0xFFFF,
            blocks.a & 0xFFFF,
            get_from_list(data,segment+1,0) & 0xFFFF,
            True
        )
    ...
    @staticmethod
    def custom(blocks:Group, group: GroupIdentifier, data:list):
        """This function will generate a xY group
        
        :param blocks: Basic block structure, which is generated by basic()
        :data group: The type of group this is
        :data data: Raw 16 bit data blocks (first int must be 5 bits or max 31)
        ...
        return Group(
            blocks.a & 0xFFFF,
            (((blocks.b | get_group(group.group_number,group.group_version)) & ~0x1F) | get_from_list(data,0,0) & 0x1F) & 0xFFFF,
            ((get_from_list(data,1,0) & 0xFFFF) if group.group_version == False else (blocks.a & 0xFFFF)),
            get_from_list(data,2,0) & 0xFFFF,
            group.group_version
        )
    @staticmethod
    def eon(blocks:Group, on_pi: int, on_tp: bool, variant_code: int, on_ps:str="", on_af:int=0, on_pty: int=0, on_ta: bool=False, on_broadcaster_data:int=0):
        ...
        group = Group(
            blocks.a & 0xFFFF,
            (((blocks.b | get_group(14,False) | BitManipulator.set_bit(0,11,on_tp)) & ~0xF) | (variant_code & 0xF)) & 0xFFFF,
            0,
            on_pi,
            False
        )
        ...
        return group
    @staticmethod
    def eon_b(blocks:Group, on_pi: int, on_tp: bool, on_ta:bool):
        ...
        return Group(
            blocks.a & 0xFFFF,
            (blocks.b | get_group(14,True) | BitManipulator.set_bit(0,11,on_tp) | BitManipulator.set_bit(0,12,on_ta)) & 0xFFFF,
            blocks.a & 0xFFFF,
            on_pi & 0xFFFF,
            True
        )
    @staticmethod
    def long_ps(blocks:Group,ps_text:str,segment:int):
        ...
        return Group(
            blocks.a & 0xFFFF,
            (blocks.b | get_group(15) | segment) & 0xFFFF,
    ...
    @staticmethod
    def fast_switching(blocks:Group, segment:int, ms:bool=True, ta:bool=False, di:int=1):
        """
        ...
        return Group(
            blocks.a & 0xFFFF,
            ( blocks.b | get_group(15,True) | int(ta) << 4 | int(ms) << 3 | ( ( di >> (3-segment) ) << 2) | segment ) & 0xFFFF,
            blocks.a & 0xFFFF,
            ( blocks.b | get_group(15,True) | int(ta) << 4 | int(ms) << 3 | ( ( di >> (3-segment) ) << 2) | segment ) & 0xFFFF,
            False
        )