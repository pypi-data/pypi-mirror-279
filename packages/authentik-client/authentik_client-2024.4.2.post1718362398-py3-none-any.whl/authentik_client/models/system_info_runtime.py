...
class SystemInfoRuntime(BaseModel):
    ...
    openssl_fips_mode: Optional[StrictBool]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if openssl_fips_mode (nullable) is None
        # and model_fields_set contains the field
        if self.openssl_fips_mode is None and "openssl_fips_mode" in self.model_fields_set:
            _dict['openssl_fips_mode'] = None
