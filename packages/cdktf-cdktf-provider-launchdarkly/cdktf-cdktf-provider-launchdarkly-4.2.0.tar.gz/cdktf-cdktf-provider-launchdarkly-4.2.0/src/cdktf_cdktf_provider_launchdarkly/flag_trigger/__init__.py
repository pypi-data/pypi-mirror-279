...
Refer to the Terraform Registry for docs: [`launchdarkly_flag_trigger`](https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger).
'''
...
class FlagTrigger(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger launchdarkly_flag_trigger}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger launchdarkly_flag_trigger} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param enabled: Whether the trigger is currently active or not. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#enabled FlagTrigger#enabled}
        :param env_key: The unique key of the environment the flag trigger will work in. A change in this field will force the destruction of the existing resource and the creation of a new one. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#env_key FlagTrigger#env_key}
        ...
        :param instructions: instructions block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#instructions FlagTrigger#instructions}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing FlagTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#import import section} in the documentation of this resource for the id to use
    ...
    def put_instructions(self, *, kind: builtins.str) -> None:
        '''
        :param kind: The action to perform when triggering. Currently supported flag actions are ``turnFlagOn`` and ``turnFlagOff``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#kind FlagTrigger#kind}
        '''
...
class FlagTriggerConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def enabled(self) -> typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#enabled FlagTrigger#enabled}
        '''
    ...
    def env_key(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#env_key FlagTrigger#env_key}
        '''
    ...
    def flag_key(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#flag_key FlagTrigger#flag_key}
        '''
    ...
    def instructions(self) -> "FlagTriggerInstructions":
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#instructions FlagTrigger#instructions}
        '''
    ...
    def integration_key(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#integration_key FlagTrigger#integration_key}
        '''
    ...
    def project_key(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#project_key FlagTrigger#project_key}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#id FlagTrigger#id}.
...
class FlagTriggerInstructions:
    ...
    def kind(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.19.0/docs/resources/flag_trigger#kind FlagTrigger#kind}
        '''
