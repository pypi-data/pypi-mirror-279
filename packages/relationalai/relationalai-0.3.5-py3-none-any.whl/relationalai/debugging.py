...
from relationalai.errors import InvalidIfWarning, InvalidLoopWarning, InvalidTryWarning, RAIException, RAIWarning
...
def ipy_exception_handler(shell, exc_type, exc_value, exc_traceback: TracebackType | None, tb_offset=1):
    ...
    if isinstance(exc_value, RAIException):
        ...
        exc_value = Exception(pprinted).with_traceback(exc_traceback)
