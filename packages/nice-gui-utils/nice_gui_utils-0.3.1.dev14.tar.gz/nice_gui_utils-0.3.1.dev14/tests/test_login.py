...
def test_login():
    with firefox_webdriver() as driver:
        ...
        gretting_label: WebElement = driver.find_element(By.ID, 'gretting_label')
        wait.until(lambda d: gretting_label.is_displayed())
        assert gretting_label.text == 'Hello NiceGUI!'
