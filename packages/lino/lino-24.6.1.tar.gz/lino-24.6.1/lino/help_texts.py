...
help_texts = {
    ...
    'lino.core.model.Model.as_summary_item' : _("""Return a HTML anchor that points to this database row."""),
    'lino.core.model.Model.as_summary_row' : _("""Return a safe HTML string that represents this database row in a data table in summary view."""),
    ...
    'lino.modlib.notify.Message.emit_notification' : _("""Emit a notification message to each the given recipients, respecting their individual user settings."""),
