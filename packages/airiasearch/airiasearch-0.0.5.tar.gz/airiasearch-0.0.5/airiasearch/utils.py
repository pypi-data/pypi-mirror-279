...
from pymilvus import connections, Collection, AnnSearchRequest, RRFRanker, DataType, FieldSchema, CollectionSchema, db
...
class Utilities:
    ...
    def fn():
        ...
        return connections, Collection, AnnSearchRequest, RRFRanker, DataType, FieldSchema, CollectionSchema, db
    ...
    def collection(collection_name: str = ""):
        ...
        """
        try:
            conn = Collection(name=collection_name)
            return conn
        except Exception as e:
