...
from typing import Any, Dict, NamedTuple, NewType, Callable, Tuple, Union, List
...
DataRowType = Dict[str, Union[datetime.datetime, int, float]]
ChartJSONType = NewType('ChartJSONType', Dict[str, Any])

StatType = Dict[str, Union[int, float]]
StatisticsDataType = Dict[str, Union[int, float, StatType]]
