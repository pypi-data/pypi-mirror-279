...
class AccessTokensApi:
    ...
    def create_access_token(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateAccessToken200Response",
            '401': "CreateAccessToken401Response",
        }
    ...
    def create_access_token_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateAccessToken200Response]:
        """Get an access token
    ...
    def _create_access_token_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/access_tokens/create',
    ...
    def refresh_access_token(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateAccessToken200Response",
            '401': "RefreshAccessToken401Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
