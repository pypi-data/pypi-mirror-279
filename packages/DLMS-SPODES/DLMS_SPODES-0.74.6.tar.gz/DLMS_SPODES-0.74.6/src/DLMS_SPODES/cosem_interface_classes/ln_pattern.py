...
INVOCATION_COUNTER_OBJECTS = LNPattern("0.b.43.1.e.255")  # 6.2.36
INFORMATION_SECURITY_RELATED = LNPatterns((
    LNPattern("0.0.43.(0,2).e.255"),
    INVOCATION_COUNTER_OBJECTS
))
...
DISCONNECT_CONTROL_OBJECTS = LNPattern("0.b.96.3.10.f")  # 6.2.46
ARBITRATOR_OBJECTS = LNPattern("0.b.96.3.(20-29).f")  # 6.2.47
