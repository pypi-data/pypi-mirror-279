...
from typing_extensions import Annotated
from wandelbots_api_client.models.list_devices200_response_inner import ListDevices200ResponseInner
...
class DeviceConfigurationApi:
    ...
    async def clear_devices(
        ...
        Deletes **all** devices from the cell
    ...
    async def create_device(
        self,
        cell: Annotated[StrictStr, Field(description="Unique identifier addressing a cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-'. * Start with an alphanumeric character. * End with an alphanumeric character. * A maximum length of 63 characters. * The identifier \"kube-system\", \"default\" and \"wandelbots\" are reserved and cannot be used. ")],
        list_devices200_response_inner: List[ListDevices200ResponseInner],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Overwrite existing devices in an existing robot cell. The devices are added to the robot cell in the order they are specified in the request body. Each device needs to have a unique identifier which is used to reference the device in Wandelscript. Devices which can be configured in the cell: - Robots - OPCUA devices ## Parameters - For more information about the available device configurations have a look at the **Schema** tab or in the provided examples.

        :param cell: Unique identifier addressing a cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-'. * Start with an alphanumeric character. * End with an alphanumeric character. * A maximum length of 63 characters. * The identifier \"kube-system\", \"default\" and \"wandelbots\" are reserved and cannot be used.  (required)
        :type cell: str
        :param list_devices200_response_inner: (required)
        :type list_devices200_response_inner: List[ListDevices200ResponseInner]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_device_serialize(
            cell=cell,
            list_devices200_response_inner=list_devices200_response_inner,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_device_serialize(
        self,
        cell,
        list_devices200_response_inner,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if list_devices200_response_inner is not None:
            _body_params = list_devices200_response_inner
    ...
    async def delete_device(
        ...
        Deletes a specific device from the cell.
    ...
    async def list_devices(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[ListDevices200ResponseInner]:
        """List All Devices

        Lists all devices which are configured in the cell: - Robots - Databases - OPCUA devices 
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ListDevices200ResponseInner]",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    async def list_devices_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ListDevices200ResponseInner]]:
        """List All Devices
