...
class VirtualRobotApi:
    ...
    async def list_ios(
        ...
        Lists all I/Os of the virtual controller. Every I/O contains the description and the value.  As a virtual robot can have up to thousand I/Os, be ready to handle a large response. Use [List Descriptions](List Descriptions) to get a detailed description of an I/O. 
