...
from wandelbots_api_client.models.stream_motion_group_state_request import StreamMotionGroupStateRequest
...
class MotionGroupInfosApi:
    ...
    @validate_call
    async def stream_motion_group_state(self, cell: Annotated[StrictStr, Field(description="Unique identifier addressing a cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-'. * Start with an alphanumeric character. * End with an alphanumeric character. * A maximum length of 63 characters. * The identifier \"kube-system\", \"default\" and \"wandelbots\" are reserved and cannot be used. ")], motion_group: Annotated[StrictStr, Field(description="The motion-group id.")], request: StreamMotionGroupStateRequest) -> AsyncGenerator[MotionGroupStateResponse, None]:  # noqa: E501
        ...
        async with websockets.connect(full_url.url, open_timeout=10) as websocket:
            try:
                async for response in websocket:
                    ...
                    yield MotionGroupStateResponse.from_dict(data)
