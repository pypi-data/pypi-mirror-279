...
class VirtualRobotBehaviorApi:
    ...
    @validate_call
    async def comply_with_cycle_time(
        self,
        ...
        """(Deprecated) Cycle Time Behavior

        Configures the compliance of the virtual robot with the normal ControllerState cycle time. If set to 'true', the virtual robot will act like a physical one, e.g. with a cycle time of 8ms. If set to 'false', the robot will respond and move as fast as possible, limited only by software execution speed. TIP:  This mode is recommended in simulations where the correctness of the movement has priority over the robot's real time behavior.  DEPRECATED! Note that this endpoint is deprecated. See also [behavior](behavior).
        ...
        """ # noqa: E501
        warnings.warn("PUT /cells/{cell}/controllers/{controller}/teach-pendant/realtime is deprecated.", DeprecationWarning)

        _param = self._comply_with_cycle_time_serialize(
            cell=cell,
    ...
    @validate_call
    async def comply_with_cycle_time_with_http_info(
        self,
        cell: Annotated[StrictStr, Field(description="Unique identifier addressing a cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-'. * Start with an alphanumeric character. * End with an alphanumeric character. * A maximum length of 63 characters. * The identifier \"kube-system\", \"default\" and \"wandelbots\" are reserved and cannot be used. ")],
        controller: Annotated[StrictStr, Field(description="Unique identifier addressing a controller in the cell.")],
        active: StrictBool,
    ...
    @validate_call
    async def comply_with_cycle_time_without_preload_content(
        self,
        cell: Annotated[StrictStr, Field(description="Unique identifier addressing a cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-'. * Start with an alphanumeric character. * End with an alphanumeric character. * A maximum length of 63 characters. * The identifier \"kube-system\", \"default\" and \"wandelbots\" are reserved and cannot be used. ")],
        controller: Annotated[StrictStr, Field(description="Unique identifier addressing a controller in the cell.")],
        active: StrictBool,
    ...
    def _comply_with_cycle_time_serialize(
        self,
        cell,
        controller,
        active,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/cells/{cell}/controllers/{controller}/teach-pendant/realtime',
    ...
    @validate_call
    async def external_joints_stream(self, cell: Annotated[StrictStr, Field(description="Unique identifier addressing a cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-'. * Start with an alphanumeric character. * End with an alphanumeric character. * A maximum length of 63 characters. * The identifier \"kube-system\", \"default\" and \"wandelbots\" are reserved and cannot be used. ")], controller: Annotated[StrictStr, Field(description="Unique identifier addressing a controller in the cell.")], client_request_generator: Callable[[AsyncGenerator[MotionGroupJoints, None]], AsyncGenerator[ExternalJointStreamDatapoint, None]]) -> None:  # noqa: E501
        ...
        async def iterate_responses(ws) -> AsyncGenerator[MotionGroupJoints, None]:
            async for response in ws:
                ...
                yield MotionGroupJoints.from_dict(data)
        ...
        full_url = furl(url_schema.format(self=self).replace("http://", ""))
    ...
    async def get_motion_group_behavior(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /cells/{cell}/controllers/{controller}/teach-pendant/motion-groups/{id}/behavior is deprecated.", DeprecationWarning)
