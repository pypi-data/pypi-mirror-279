...
class ControllerIOsApi:
    ...
    @validate_call
    async def stream_io_values(self, cell: Annotated[StrictStr, Field(description="Unique identifier addressing a cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-'. * Start with an alphanumeric character. * End with an alphanumeric character. * A maximum length of 63 characters. * The identifier \"kube-system\", \"default\" and \"wandelbots\" are reserved and cannot be used. ")], controller: Annotated[StrictStr, Field(description="Unique identifier addressing a controller in the cell.")], request: Optional[List[StrictStr]]) -> AsyncGenerator[ListIOValuesResponse, None]:  # noqa: E501
        ...
        async with websockets.connect(full_url.url, open_timeout=10) as websocket:
            try:
                async for response in websocket:
                    ...
                    yield ListIOValuesResponse.from_dict(data)
    ...
    async def wait_for_io_event(
        ...
        comparison_type: Optional[StrictStr] = None,
