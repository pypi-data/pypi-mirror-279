...
class VirtualRobotSetupApi:
    ...
    async def add_virtual_robot_tcp(
        ...
        Adds the new TCP or modifies the existing TCP of the motion group.  TIP: Ensure that the position of the TCP is reachable. Refer to the robot description or its data sheet, e.g. for robot joint limits or robot reach. 
