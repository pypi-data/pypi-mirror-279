...
from hansken_extraction_plugin.framework.PrimitiveMessages_pb2 import RpcBoolean, RpcBytes, RpcDouble, RpcDoubleList, \
    RpcEmptyList, RpcEmptyMap, RpcIsoDateString, RpcLatLong, RpcLong, RpcLongList, RpcMap, RpcString, RpcStringList, \
    RpcStringMap, RpcVector, RpcZonedDateTime
from hansken_extraction_plugin.framework.RpcCallMessages_pb2 import RpcBeginChild, RpcBeginDataStream, RpcEnrichTrace, \
    RpcFinishChild, RpcFinishDataStream, RpcPartialFinishWithError, RpcRead, RpcSearchRequest, RpcSearchScope, \
    RpcWriteDataStream
...
def rpc_search_request(query: str, count: int, scope: Union[str, SearchScope]) -> RpcSearchRequest:
    """
    ...
    return RpcSearchRequest(query=query, count=count, scope=rpc_search_scope)
