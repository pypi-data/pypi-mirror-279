...
class PageContentTypes(Enum):
    ...
    # Note that these may overlap with content type for obvious reasons
    FAQ = "FAQ"
    CONTACT = "CONTACT"
...
class GlobySiteDataModel:
    ...
    site_types: List[SiteTypes] = field(default_factory=list)
...
class GlobySite(GlobySiteDataModel):
    ...
    def as_dict(self) -> Dict[str, Any]:
        return {
            ...
            "site_types": [site_type.value for site_type in self.site_types],
