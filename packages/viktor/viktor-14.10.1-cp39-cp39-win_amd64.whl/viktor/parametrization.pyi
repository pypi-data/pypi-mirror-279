...
class _GeometryField(Field, ABC, metaclass=abc.ABCMeta):
    def __init__(self, ui_name: str, *, name: str = ..., default: str = ..., visible: VisibleType = ..., flex: int = ..., description: str = ..., view: str = ...) -> None: ...

class GeometrySelectField(_GeometryField): ...

class GeometryMultiSelectField(_GeometryField):
    def __init__(self, ui_name: str, *, name: str = ..., default: str = ..., visible: VisibleType = ..., flex: int = ..., description: str = ..., view: str = ..., min_select: int = ..., max_select: int = ...) -> None: ...
...
class _Group(_AttrGroup, metaclass=abc.ABCMeta):
    def __init__(self, title: str, description: str = ..., visible: Union[bool, BoolOperator, Lookup, FunctionLookup, Callable] = ...) -> None: ...

class Page(_Group):
    def __init__(self, title: str, *, views: Union[str, Sequence[str]] = ..., description: str = ..., visible: Union[bool, BoolOperator, Lookup, FunctionLookup, Callable] = ..., width: int = ...) -> None: ...

class Step(Page):
    def __init__(self, title: str, *, views: Union[str, Sequence[str]] = ..., description: str = ..., previous_label: str = ..., next_label: str = ..., on_next: Callable = ..., width: int = ...) -> None: ...
