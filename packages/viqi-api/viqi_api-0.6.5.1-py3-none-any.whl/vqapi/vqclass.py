...
class VQModule(VQResource):
    ...
    def run(
        ...
        **kwargs,
        ...
        Raises:
            BQApiError
        """
        return self.builds[0].run(_keep_log=_keep_log,
    ...
    def last_run(
        ...
        **kwargs,
        ...
        res = self._sess.find("mex", module_name=module_name, version=_last_run_version, status=_last_run_status, not_status=_last_run_not_status, _execute_options=_execute_options, **kwargs)
...
class VQBuild(VQModule):
    ...
    def last_run(
        ...
        **kwargs,
        ...
        return self.get_module().last_run(_keep_log=_keep_log,
                                          _extra_tags=_extra_tags,
                                          _execute_options=_execute_options,
                                          _merge_outputs=_merge_outputs,
