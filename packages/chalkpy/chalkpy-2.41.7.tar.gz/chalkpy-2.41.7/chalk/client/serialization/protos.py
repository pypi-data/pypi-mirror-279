...
class ChalkErrorConverter:
    _error_code_map: "BidirectionalMap[ErrorCode, chalk_error_pb2.ErrorCode]" = BidirectionalMap(
        [
            (ErrorCode.INTERNAL_SERVER_ERROR, chalk_error_pb2.ErrorCode.ERROR_CODE_INTERNAL_SERVER_ERROR_UNSPECIFIED),
            (ErrorCode.PARSE_FAILED, chalk_error_pb2.ErrorCode.ERROR_CODE_PARSE_FAILED),
            (ErrorCode.RESOLVER_NOT_FOUND, chalk_error_pb2.ErrorCode.ERROR_CODE_RESOLVER_NOT_FOUND),
            (ErrorCode.INVALID_QUERY, chalk_error_pb2.ErrorCode.ERROR_CODE_INVALID_QUERY),
            (ErrorCode.VALIDATION_FAILED, chalk_error_pb2.ErrorCode.ERROR_CODE_VALIDATION_FAILED),
            (ErrorCode.RESOLVER_FAILED, chalk_error_pb2.ErrorCode.ERROR_CODE_RESOLVER_FAILED),
            (ErrorCode.RESOLVER_TIMED_OUT, chalk_error_pb2.ErrorCode.ERROR_CODE_RESOLVER_TIMED_OUT),
            (ErrorCode.UPSTREAM_FAILED, chalk_error_pb2.ErrorCode.ERROR_CODE_UPSTREAM_FAILED),
            (ErrorCode.UNAUTHENTICATED, chalk_error_pb2.ErrorCode.ERROR_CODE_UNAUTHENTICATED),
            (ErrorCode.UNAUTHORIZED, chalk_error_pb2.ErrorCode.ERROR_CODE_UNAUTHORIZED),
            (ErrorCode.CANCELLED, chalk_error_pb2.ErrorCode.ERROR_CODE_CANCELLED),
            (ErrorCode.DEADLINE_EXCEEDED, chalk_error_pb2.ErrorCode.ERROR_CODE_DEADLINE_EXCEEDED),
        ]
    )

    _error_category_map: "BidirectionalMap[ErrorCodeCategory, chalk_error_pb2.ErrorCodeCategory]" = BidirectionalMap(
        [
            (ErrorCodeCategory.NETWORK, chalk_error_pb2.ErrorCodeCategory.ERROR_CODE_CATEGORY_NETWORK_UNSPECIFIED),
            (ErrorCodeCategory.FIELD, chalk_error_pb2.ErrorCodeCategory.ERROR_CODE_CATEGORY_FIELD),
            (ErrorCodeCategory.REQUEST, chalk_error_pb2.ErrorCodeCategory.ERROR_CODE_CATEGORY_REQUEST),
        ]
    )
    ...
    @staticmethod
    def _chalk_exception_decode(exception_proto: chalk_error_pb2.ChalkException) -> ChalkException:
    ...
    def chalk_error_encode(
        ...
        if error.exception:
            proto_error.exception.CopyFrom(ChalkErrorConverter._chalk_exception_encode(error.exception))
        if error.feature:
    ...
    def chalk_error_decode(
        ...
        if error_proto.HasField("exception"):
            chalk_exception = ChalkErrorConverter._chalk_exception_decode(error_proto.exception)
        else:
...
class OnlineQueryConverter:
    ...
    def online_query_request_decode(
        ...
        return OnlineQueryRequest(
            ...
            skip_cache_lookups=OnlineQueryConverter._options_bool_field(
                online_query_request.context, "skip_cache_lookups"
            ),
    ...
    def online_query_request_encode(request: OnlineQueryRequest) -> online_query_pb2.OnlineQueryRequest:
        ...
        context_options_dict: Dict[str, Any] = {
            ...
            "skip_cache_lookups": request.skip_cache_lookups,
    ...
    def online_query_multi_response_decode(
        response_proto: online_query_pb2.OnlineQueryMultiResponse,
    ) -> BulkOnlineQueryResponse:
        results = []
        for result_proto in response_proto.responses:
            if result_proto.HasField("single_response"):
                ...
                results.append(OnlineQueryConverter.online_query_bulk_response_decode(result_proto.bulk_response))
        global_errors = [ChalkErrorConverter.chalk_error_decode(e) for e in response_proto.errors]
        return BulkOnlineQueryResponse(results=results, global_errors=global_errors)
