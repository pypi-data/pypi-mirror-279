"""FGA event module with Classes of events and special events wrappers.
...
class EventOptions:
    ...
    Args:
        ...
        event_id (str, optional):  An incrementing counter to distinguish events with the same user_id and timestamp
            from each other.
    ...
    def get_event_key_mapping(self) -> dict:
        return EVENT_KEY_MAPPING
    ...
    def get_event_body(self) -> dict:
        ...
        event_body = {}
        for key, value in self.get_event_key_mapping().items():
    ...
    def _verify_property(self, key, value) -> bool:
        ...
        if key not in self.__dict__:
            ...
            return False
        if not isinstance(value, self.get_event_key_mapping()[key][1]):
            logger.error(
                f"Event property {key} expected {self.get_event_key_mapping()[key][1]} but received {type(value)}.")
            return False
...
class BaseEvent(EventOptions):
    ...
    def __init__(self, event_type: str,
        ...
        self.time = pydash.get(event_properties, 'time')
    ...
    def load_event_options(self, event_options: EventOptions):
        ...
        if not event_options:
            return
        for key in self.get_event_key_mapping():
...
class Event(BaseEvent):
    ...
    def __init__(self, event_type: str,
        ...
        super().__init__(user_id=user_id,
                         ...
                         partner_id=partner_id,
                         callback=callback)
        self.need_fields = ["event_id", "user_id", "event_type", "event_name"]
        self.field_types = {
            'event_id': str,
            'user_id': str,
            'event_type': str,
            ...
            'event_properties.device_id': str,
            'event_properties.event_device': str,
            'event_properties.event_source': str
        }
    ...
    def get_event_body(self) -> dict:
        ...
        return {
            ...
            "extra_data": "" if self.event_properties is None else json.dumps(self.event_properties),
            "device_id": self.device_id or pydash.get(self, "event_properties.device_id"),
            "event_device": pydash.get(self, "event_properties.event_device"),
            "event_source": pydash.get(self, "event_properties.event_source", "web2")
        }


class Account(IdentifyEvent):
    ...
    def __init__(self, user_id: str,
        ...
        self.need_fields = ['user_id', 'wallet_address']
        self.field_types = {
            'user_id': str,
            'wallet_address': str,
            'user_properties': dict,
            'user_properties.ecosystem_id': str,
            'user_properties.chain': str,
            'user_properties.wallet_linked_at': int,
            'user_properties.wallet_type': str,
            'user_properties.wallet_source': str,
            'user_properties.wallet_provider': str,
            'user_properties.login_method': str
        }
    ...
    def get_event_body(self) -> dict:
        ...
        return {
            ...
            "wallet_linked_at": pydash.get(self, "user_properties.wallet_linked_at"),
            "ecosystem_id": pydash.get(self, "user_properties.ecosystem_id"),
            "chain": pydash.get(self, "user_properties.chain"),
            "wallet_type": pydash.get(self, "user_properties.wallet_type", "EoA"),
            "wallet_source": pydash.get(self, "user_properties.wallet_source", "signup"),
            "wallet_provider": pydash.get(self, "user_properties.wallet_provider", "metamask"),
            "login_method": pydash.get(self, "user_properties.login_method"),
            "extra_data": "" if self.event_properties is None else json.dumps(self.event_properties)
        }


# class Asset(IdentifyEvent):
#
#     def get_event_body(self) -> dict:
#
#         return {
...
#             "event_id": self.event_id,
#             "user_id": self.user_id,
#             "wallet_address": pydash.get(self, "event_properties.wallet_address"),
#             "chain": pydash.get(self, "event_properties.chain"),
#             "item": pydash.get(self, "event_properties.item"),
#             "item_type": pydash.get(self, "event_properties.item_type"),
#             "item_identification_id": pydash.get(self, "event_properties.item_identification_id"),
#             "amount": pydash.get(self, "event_properties.amount"),
#             "counterparty": pydash.get(self, "event_properties.counterparty"),
#             "counterparty_type": pydash.get(self, "event_properties.counterparty_type"),
#             "timestamp": self.time,
#             "type": pydash.get(self, "event_properties.type"),
#             "business_type": pydash.get(self, "event_properties.business_type"),
#             "created_at": pydash.get(self, "event_properties.created_at"),
#             "updated_at": pydash.get(self, "event_properties.updated_at"),
#         }
#
#
# class Session(IdentifyEvent):
#
#     def get_event_body(self) -> dict:
#
#         return {
...
#             "chain": pydash.get(self, "event_properties.chain"),
#             "wallet_address": pydash.get(self, "event_properties.wallet_address"),
#             "session_mode": pydash.get(self, "event_properties.session_mode"),
#             "session_name": pydash.get(self, "event_properties.session_name"),
#             "user_id": self.user_id,
#             "timestamp": self.time,
#             "duration_s": pydash.get(self, "event_properties.duration_s"),
#             "result": pydash.get(self, "event_properties.result")
#         }


class User(IdentifyEvent):
    ...
    def __init__(self, user_id: str,
        ...
        self.need_fields = ["user_name", "user_id", "sign_up_at"]
        self.field_types = {
            'user_name': str,
            'user_id': str,
            'sign_up_at': int,
            'user_properties': dict,
            'user_properties.sign_up_device': str,
            'user_properties.account_type': str,
            'user_properties.idfa': str,
            'user_properties.udid': str,
            'user_properties.country': str,
            'user_properties.email': str,
            'user_properties.ip': str,
            'user_properties.twitter': str,
            'user_properties.discord': str,
        }
    ...
    def get_event_body(self) -> dict:
        return {
            ...
            "sign_up_device": pydash.get(self, "user_properties.sign_up_device"),
            "account_type": pydash.get(self, "user_properties.account_type"),
            "idfa": self.idfa or self.idfv or pydash.get(self, "user_properties.idfa"),
            "udid": pydash.get(self, "user_properties.udid"),
            "country": self.country or pydash.get(self, "user_properties.country"),
            "email": pydash.get(self, "user_properties.email"),
            "ip": self.ip or pydash.get(self, "user_properties.ip"),
            "twitter": pydash.get(self, "user_properties.twitter"),
            "discord": pydash.get(self, "user_properties.discord"),
            "sign_up_at": self.sign_up_at,
            "extra_data": "" if self.user_properties is None else json.dumps(self.user_properties),
        }
