...
class Event(BaseEvent):
    ...
    def get_event_body(self) -> dict:
        ...
        return {
            ...
            "event_device": self.platform or pydash.get(self, "event_properties.platform"),
            "event_source": "web2"
        }
...
class Account(IdentifyEvent):
    ...
    def get_event_body(self) -> dict:
        ...
        return {
            ...
            "ecosystem_id": pydash.get(self, "event_properties.ecosystem_id"),
            "chain": pydash.get(self, "event_properties.chain"),
            "wallet_type": pydash.get(self, "event_properties.wallet_type"),
...
class User(IdentifyEvent):
    ...
    def get_event_body(self) -> dict:
        return {
            ...
            "sign_up_at": pydash.get(self, "user_properties.sign_up_at", datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')),
