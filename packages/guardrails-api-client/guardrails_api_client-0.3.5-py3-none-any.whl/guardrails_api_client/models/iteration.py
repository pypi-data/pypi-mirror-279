...
class Iteration(BaseModel):
    ...
    Iteration
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for this Call.  Can be used as an identifier for a specific execution of a Guard.")
    index: StrictInt = Field(description="The zero-based index of this iteration within the current Call.")
    call_id: StrictStr = Field(description="The unique identifier for the Call that this iteration is a part of.")
    inputs: Optional[Inputs] = None
    outputs: Optional[Outputs] = None
    __properties: ClassVar[List[str]] = ["id", "index", "call_id", "inputs", "outputs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outputs": Outputs.from_dict(obj["outputs"]) if obj.get("outputs") is not None else None
        })
        return _obj
