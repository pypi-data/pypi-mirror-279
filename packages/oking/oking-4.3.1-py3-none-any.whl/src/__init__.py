...
try:
    ...
    if not is_dev:
        ...
        api_okinghub.post_log(Log(f'Oking inicializando {client_data["integracao_nome"]}', 'INICIALIZACAO',
                                  'INICIALIZACAO', f'{client_data.get("integracao_id")}', 'X'
        ...
        api_okinghub.post_log(Log(f'Oking inicializando cliente id {client_data["integracao_nome"]}', '',
                                  'INICIALIZACAO', {client_data["integracao_id"]}, 'X'
