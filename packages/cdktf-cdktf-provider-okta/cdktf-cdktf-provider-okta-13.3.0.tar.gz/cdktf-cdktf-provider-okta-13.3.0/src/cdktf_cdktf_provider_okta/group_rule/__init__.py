...
class GroupRule(
    ...
    def __init__(
        ...
        *,
        ...
        :param expression_value: The expression value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/group_rule#expression_value GroupRule#expression_value}
        :param group_assignments: The list of group ids to assign the users to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/group_rule#group_assignments GroupRule#group_assignments}
        :param name: The name of the Group Rule (min character 1; max characters 50). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/group_rule#name GroupRule#name}
        :param expression_type: The expression type to use to invoke the rule. The default is ``urn:okta:expression:1.0``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/group_rule#expression_type GroupRule#expression_type}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/group_rule#id GroupRule#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param remove_assigned_users: Remove users added by this rule from the assigned group after deleting this resource. Default is ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/group_rule#remove_assigned_users GroupRule#remove_assigned_users}
        :param status: Default to ``ACTIVE``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/group_rule#status GroupRule#status}
        :param users_excluded: The list of user IDs that would be excluded when rules are processed. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/group_rule#users_excluded GroupRule#users_excluded}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing GroupRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/group_rule#import import section} in the documentation of this resource for the id to use
...
class GroupRuleConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def group_assignments(self) -> typing.List[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/group_rule#group_assignments GroupRule#group_assignments}
        '''
