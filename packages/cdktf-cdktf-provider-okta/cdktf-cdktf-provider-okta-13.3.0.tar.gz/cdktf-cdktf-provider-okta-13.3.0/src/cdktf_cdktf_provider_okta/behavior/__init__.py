...
class Behavior(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior okta_behavior}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior okta_behavior} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Name of the behavior. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#name Behavior#name}
        :param type: Type of the behavior. Can be set to ``ANOMALOUS_LOCATION``, ``ANOMALOUS_DEVICE``, ``ANOMALOUS_IP`` or ``VELOCITY``. Resource will be recreated when the type changes.e Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#type Behavior#type}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#id Behavior#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param location_granularity_type: Determines the method and level of detail used to evaluate the behavior. Required for ``ANOMALOUS_LOCATION`` behavior type. Can be set to ``LAT_LONG``, ``CITY``, ``COUNTRY`` or ``SUBDIVISION``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#location_granularity_type Behavior#location_granularity_type}
        :param number_of_authentications: The number of recent authentications used to evaluate the behavior. Required for ``ANOMALOUS_LOCATION``, ``ANOMALOUS_DEVICE`` and ``ANOMALOUS_IP`` behavior types. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#number_of_authentications Behavior#number_of_authentications}
        :param radius_from_location: Radius from location (in kilometers). Should be at least 5. Required when ``location_granularity_type`` is set to ``LAT_LONG``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#radius_from_location Behavior#radius_from_location}
        :param status: Behavior status: ACTIVE or INACTIVE. Default: ``ACTIVE``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#status Behavior#status}
        :param velocity: Velocity (in kilometers per hour). Should be at least 1. Required for ``VELOCITY`` behavior. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#velocity Behavior#velocity}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Behavior that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#import import section} in the documentation of this resource for the id to use
...
class BehaviorConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#name Behavior#name}
        '''
    ...
    def type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#type Behavior#type}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#id Behavior#id}.
    ...
    def location_granularity_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#location_granularity_type Behavior#location_granularity_type}
        '''
    ...
    def number_of_authentications(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#number_of_authentications Behavior#number_of_authentications}
        '''
    ...
    def status(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#status Behavior#status}
        '''
    ...
    def velocity(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/behavior#velocity Behavior#velocity}
        '''
