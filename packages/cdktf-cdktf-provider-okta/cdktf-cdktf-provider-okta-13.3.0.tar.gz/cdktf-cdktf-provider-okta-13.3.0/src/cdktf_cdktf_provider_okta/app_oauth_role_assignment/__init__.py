...
Refer to the Terraform Registry for docs: [`okta_app_oauth_role_assignment`](https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment).
'''
...
class AppOauthRoleAssignment(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment okta_app_oauth_role_assignment}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment okta_app_oauth_role_assignment} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param client_id: Client ID for the role to be assigned to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment#client_id AppOauthRoleAssignment#client_id}
        :param type: Role type to assign. This can be one of the standard Okta roles, such as ``HELP_DESK_ADMIN``, or ``CUSTOM``. Using custom requires the ``resource_set`` and ``role`` attributes to be set. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment#type AppOauthRoleAssignment#type}
        :param resource_set: Resource set for the custom role to assign, must be the ID of the created resource set. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment#resource_set AppOauthRoleAssignment#resource_set}
        :param role: Custom Role ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment#role AppOauthRoleAssignment#role}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AppOauthRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment#import import section} in the documentation of this resource for the id to use
...
class AppOauthRoleAssignmentConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def client_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment#client_id AppOauthRoleAssignment#client_id}
        '''
    ...
    def type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment#type AppOauthRoleAssignment#type}
        '''
    ...
    def resource_set(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment#resource_set AppOauthRoleAssignment#resource_set}
        '''
    ...
    def role(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.9.0/docs/resources/app_oauth_role_assignment#role AppOauthRoleAssignment#role}
        '''
