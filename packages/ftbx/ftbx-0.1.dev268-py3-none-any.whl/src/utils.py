...
def get_variable(variable: str):
    """
    Retrieve a variable from the variables file.

    TEST STATUS: DOES NOT REQUIRE TESTING

    :param variable: variable to get from variables file separated by "."
    """

    with open(os.path.join(os.path.expanduser('~'), '.ftbx', 'variables'), 'r') as variables_file:
