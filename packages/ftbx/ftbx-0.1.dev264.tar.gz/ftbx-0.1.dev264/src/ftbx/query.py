...
from ftbx.utils import query, convert_to_native_type
...
def query_command_func(args):
    ...
    # query
    query_result = query(method=args.method, url=args.url, payload=payload, environment=args.from_, log=not args.stdout)
