...
from ftbx.encryption import encrypt_pwd
...
def add_or_update_environments_json(env, username, password, is_default: bool = False, alias: str = None,
                                    env_file_path: str = os.path.join(str(os.environ.get('FTBX')), 'environments.json'),
                                    key_path: str = os.path.join(str(os.environ.get('FTBX')), '.k')):
    """
...
def read_environments_json(env_file_path: str = os.path.join(str(os.environ.get('FTBX')), 'environments.json')):
    """
...
def get_default_env_alias(env_file_path: str = os.path.join(str(os.environ.get('FTBX')), 'environments.json')):
    """
