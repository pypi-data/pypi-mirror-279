...
from ftbx.env import get_default_env_alias
from ftbx.utils import push_item, get_items
...
def create_command_func(args):
    ...
    if FTBX:
        ...
        if not item_exist:
            ...
            if os.path.isdir(os.path.join(os.environ.get('FTBX'),"templates", args.config_item, args.plugin)):

                # get obj
                with open(os.path.join(os.environ.get('FTBX') ,"templates", args.config_item, args.plugin, '_object.json'), 'r') as config_file:
                ...
                push_item(
                    ...
                    item_config=data,
                    src_environment=os.path.join(os.environ.get('FTBX'), "templates"),
        ...
        print(f"Cannot find environment variable FTBX. Please use ftbx init first. ")
