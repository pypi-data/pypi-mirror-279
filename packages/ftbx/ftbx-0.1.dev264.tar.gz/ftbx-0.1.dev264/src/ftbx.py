...
from ftbx.create import create_command_func
from ftbx.compare import compare_command_func
from ftbx.connect import connect_command_func
from ftbx.env import env_command_func
from ftbx.init import init_command_func
from ftbx.launch import launch_command_func
from ftbx.list import list_command_func
from ftbx.pull import pull_command_func
from ftbx.push import push_command_func
from ftbx.query import query_command_func
from ftbx.restore import restore_command_func
from ftbx.retry import retry_command_func
from ftbx.setup import setup_command_func
from ftbx.update import update_command_func
from ftbx.workflow_designer import workflow_designer_command_func
from ftbx.metadata_designer import metadata_designer_command_func
from ftbx.utils import get_variable
...
def main():
    ...
    # update
    update_command = subparsers.add_parser('update', help='Fetches the newest version of the toolbox')
    ...
    list_command.add_argument('config_item', type=str, choices=get_variable('command_items.list'), help='Config item to list')
    ...
    pull_command.add_argument('config_item', type=str, choices=get_variable('command_items.pull'), help='Config item to pull')
    ...
    create_command.add_argument('config_item', type=str, choices=get_variable('command_items.create'), help='Config item to create')
    ...
    push_command.add_argument('config_item', type=str, choices=get_variable('command_items.push'), help='Config item to push')
    ...
    restore_command.add_argument('config_item', type=str, choices=get_variable('command_items.restore'), help='Config item to restore')
    ...
    compare_command.add_argument('config_item', type=str, choices=get_variable('command_items.compare'), help='Config item to compare')
    ...
    retry_command.add_argument('config_item', type=str, choices=get_variable('command_items.retry'), help='Config item')
    ...
    launch_command.add_argument('config_item', type=str, choices=get_variable('command_items.launch'), help='Config item to launch')
