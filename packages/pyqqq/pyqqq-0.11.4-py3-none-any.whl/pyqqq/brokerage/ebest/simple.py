    ...
    def _map_order_event(self, data: dict) -> OrderEvent:
        ...
        def __find_status(data: dict) -> str:
            ...
            if event_type == "accepted":
                ...
                fill_qty = data.get("execqty")
                ord_qty = data.get("ordqty")
                return "completed" if fill_qty == ord_qty else "partial"
        ...
        status = __find_status(data)
        filled_quantity = int(data["execqty"]) if "execqty" in data else None
        filled_price = int(data["execprc"]) if "execprc" in data else None
        filled_time = data.get("rcptexectime")
        org_order_no = data.get("orgordno")
