            ...
            if len(parts) == 2:
                ...
                if '[' in import_path and not import_path.startswith('['):
                    ...
                    if not os.path.exists(import_path):
                        ...
                        package_first_dir = os.path.dirname(os.path.abspath(__file__))
                        ...
                        version_dirs = [d for d in os.listdir(grimo_dir) if os.path.isdir(os.path.join(grimo_dir, d)) and d.count('.') == 2]
                        ...
                        import_path = os.path.join(grimo_dir, latest_version_dir, import_path)
