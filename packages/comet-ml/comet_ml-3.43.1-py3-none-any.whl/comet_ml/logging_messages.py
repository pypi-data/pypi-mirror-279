...
FAILED_TO_CREATE_EXPERIMENT_COMET_ERROR = (
    "Could not create experiment, common cause for this is an invalid project_name. "
    "Project_name must be an alphanumeric string, but got %r"
)

INVALID_API_KEY = (
    "The given API key %r is invalid on %s, please check it against the dashboard. "
    "Your experiment will not be logged" + GO_TO_DOCS_MSG
)
