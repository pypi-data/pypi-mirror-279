...
from .config_helpers import check_experiment_already_exists
...
def resume_online_experiment(
    ...
    exist_in_backend = check_experiment_already_exists(
    ...
    LOGGER.debug(
        "Resuming online experiment with effective experiment configuration: %r, init params: %r, exists in backend: %r",
        effective_config,
        init_parameters,
        exist_in_backend,
    )
