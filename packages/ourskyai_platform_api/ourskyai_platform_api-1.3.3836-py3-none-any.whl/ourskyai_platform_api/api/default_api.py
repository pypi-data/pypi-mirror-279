...
from ourskyai_platform_api.models.v1_get_embedded_query_url_request import V1GetEmbeddedQueryUrlRequest
from ourskyai_platform_api.models.v1_get_embedded_query_url_response import V1GetEmbeddedQueryUrlResponse
...
class DefaultApi:
    ...
    @validate_arguments
    def v1_get_embedded_query_url(self, v1_get_embedded_query_url_request : V1GetEmbeddedQueryUrlRequest, **kwargs) -> V1GetEmbeddedQueryUrlResponse:  # noqa: E501
        """v1_get_embedded_query_url  # noqa: E501

        Create an embedding URL for a dashboard or question  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v1_get_embedded_query_url(v1_get_embedded_query_url_request, async_req=True)
        >>> result = thread.get()

        :param v1_get_embedded_query_url_request: (required)
        :type v1_get_embedded_query_url_request: V1GetEmbeddedQueryUrlRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: V1GetEmbeddedQueryUrlResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the v1_get_embedded_query_url_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.v1_get_embedded_query_url_with_http_info(v1_get_embedded_query_url_request, **kwargs)  # noqa: E501

    @validate_arguments
    def v1_get_embedded_query_url_with_http_info(self, v1_get_embedded_query_url_request : V1GetEmbeddedQueryUrlRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """v1_get_embedded_query_url  # noqa: E501
        ...
        >>> thread = api.v1_get_embedded_query_url_with_http_info(v1_get_embedded_query_url_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1GetEmbeddedQueryUrlResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'v1_get_embedded_query_url_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_get_embedded_query_url" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['v1_get_embedded_query_url_request'] is not None:
            _body_params = _params['v1_get_embedded_query_url_request']
        ...
        _response_types_map = {
            '200': "V1GetEmbeddedQueryUrlResponse",
        }
