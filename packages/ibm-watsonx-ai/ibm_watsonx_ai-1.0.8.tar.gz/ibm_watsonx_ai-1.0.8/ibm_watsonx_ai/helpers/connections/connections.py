...
class DataConnection(BaseDataConnection):
    ...
    def read(
        ...
        **kwargs,
    ) -> Union["DataFrame", Tuple["DataFrame", "DataFrame"], bytes]:
        ...
        try:
            use_flight = kwargs.get(
                ...
                bool(
                    ...
                    and self._api_client.CPD_version
                ),
            )
        except:
            use_flight = False
        ...
        if self.type == DataConnectionTypes.S3:
            ...
            if self._check_if_connection_asset_is_s3():
                ...
                if (
                    ...
                    if remote_name is None and self._to_dict().get("location", {}).get(
                        "path"
                    ):
    ...
    def _init_cos_client(self) -> "resource":
        ...
        try:
            ...
            if not self.connection.endpoint_url.startswith("https://"):
                raise WMLClientError(
                    Messages.get_message(message_id="invalid_endpoint_url")
                )
