...
class ReverieLocalizationResult:
    class ReverieLocalizationResponseItem:
        def __init__(self, **data) -> None:
            ...
            self.outStrings: dict[str, str] = data.get("outStrings", None)
            self.api_statuses: dict[str, int] = data.get("api_statuses", None)
    ...
    def __init__(
        ...
        **resp,
        ...
        # print(resp)
        self.responseList: list[self.ReverieLocalizationResponseItem] = [
