...
class ReverieT13nResponse:
    class Result:
        def __init__(
            ...
            apiStatus: int = None,
            inString: str = None,
            outString: list[str] = None,
        ) -> None:
            self.apiStatus: int = apiStatus
            self.inString: str = inString
            self.outString: list[str] = outString
...
{outString}
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.responseList: list[ReverieT13nResponse.Result] = (
...
class ReverieT13N(BaseModel):
    ...
    def transliteration(
        ...
        :param data: List of input text for transliteration.
