...
import enum
from typing import Any, Any, ClassVar, Container, Dict, Dict, List, List, Optional, Sequence, Union, Union, overload
...
class QAxBase(Shiboken.Object):
    ...
    @overload
    def dynamicCall(self, name: Union[bytes, bytearray, memoryview], v1: Any = ..., v2: Any = ..., v3: Any = ..., v4: Any = ..., v5: Any = ..., v6: Any = ..., v7: Any = ..., v8: Any = ...) -> Any: ...
    @overload
    def dynamicCall(self, name: Union[bytes, bytearray, memoryview], vars: Sequence[Any]) -> Any: ...
    ...
    def propertyWritable(self, arg__1: Union[bytes, bytearray, memoryview]) -> bool: ...
    def qObject(self) -> PySide6.QtCore.QObject: ...
    @overload
    def querySubObject(self, name: Union[bytes, bytearray, memoryview], v1: Any = ..., v2: Any = ..., v3: Any = ..., v4: Any = ..., v5: Any = ..., v6: Any = ..., v7: Any = ..., v8: Any = ...) -> PySide6.QtAxContainer.QAxObject: ...
    @overload
    def querySubObject(self, name: Union[bytes, bytearray, memoryview], vars: Sequence[Any]) -> PySide6.QtAxContainer.QAxObject: ...
    ...
    def setPropertyWritable(self, arg__1: Union[bytes, bytearray, memoryview], arg__2: bool) -> None: ...
...
class QAxScript(PySide6.QtCore.QObject):
    ...
    finished                 : ClassVar[Signal] = ... # finished(); finished(QVariant); finished(int,QString,QString,QString)
...
class QAxWidget(PySide6.QtAxContainer.QAxBaseWidget, PySide6.QtAxContainer.QAxBase):
    ...
    @overload
    def createHostWindow(self, arg__1: bool, arg__2: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> bool: ...
    def doVerb(self, verb: str) -> bool: ...
