...
class B2CHelper:
    ...
    def get_user_by_email(self, email: str) -> dict:
        ...
        user = requests.get(
            f"https://graph.microsoft.com/beta/users?$select=displayName&$filter=identities/any(c:c/issuerAssignedId eq '{email}' and c/issuer eq 'eightam72045b2ctenant.onmicrosoft.com')", headers=self.get_auth_header(),
