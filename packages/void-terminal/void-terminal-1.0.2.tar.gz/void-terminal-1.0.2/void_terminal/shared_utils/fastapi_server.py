...
def _authorize_user(path_or_url, request, gradio_app):
    from void_terminal.toolbox import get_conf, default_user_name
...
def start_app(app_block, CONCURRENT_COUNT, AUTHENTICATION, PORT, SSL_KEYFILE, SSL_CERTFILE):
    ...
    app_block.auth_message = 'Please log in'
                ...
                try:
                    ...
                    if TTS_TYPE == "EDGE_TTS":
                        ...
                        try:
                            ...
                            raise RuntimeError("FFmpeg not installed，Unable to handle EdgeTTS audio。Installation method see`https://github.com/jiaaro/pydub#getting-ffmpeg-set-up`")
