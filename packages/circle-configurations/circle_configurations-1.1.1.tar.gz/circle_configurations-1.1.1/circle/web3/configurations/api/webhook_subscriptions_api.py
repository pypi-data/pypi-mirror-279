...
class WebhookSubscriptionsApi(object):
    ...
    def create_subscription_with_http_info(self, create_subscription_request : Annotated[CreateSubscriptionRequest, Field(..., description="Schema for the request payload to create a new subscription.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Subscription2, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def delete_subscription_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a notification subscription  # noqa: E501
    ...
    @validate_arguments
    def get_notification_signature(self, id : Annotated[StrictStr, Field(..., description="Universally unique identifier (UUID v4) of a resource.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> GetNotificationSignature:  # noqa: E501
        ...
        :param id: Universally unique identifier (UUID v4) of a resource. (required)
        :type id: str
        :param x_request_id: Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.
        :type x_request_id: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetNotificationSignature
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    @validate_arguments
    def get_notification_signature_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Universally unique identifier (UUID v4) of a resource.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get a notification signature public key  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetNotificationSignature, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def get_subscription(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> Subscription2:  # noqa: E501
    ...
    @validate_arguments
    def get_subscription_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve a notification subscription  # noqa: E501
    ...
    @validate_arguments
    def update_subscription(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], update_subscription_request : Annotated[UpdateSubscriptionRequest, Field(..., description="Schema for the request payload to update a new subscription.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> Subscription2:  # noqa: E501
    ...
    @validate_arguments
    def update_subscription_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The universally unique identifier (UUID v4) of the resource.")], update_subscription_request : Annotated[UpdateSubscriptionRequest, Field(..., description="Schema for the request payload to update a new subscription.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a notification subscription  # noqa: E501
