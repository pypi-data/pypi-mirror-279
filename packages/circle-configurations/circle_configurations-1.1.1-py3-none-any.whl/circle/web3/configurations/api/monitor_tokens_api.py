...
class MonitorTokensApi(object):
    ...
    @validate_arguments
    def create_monitored_tokens(self, post_monitored_tokens_request : Annotated[PostMonitoredTokensRequest, Field(..., description="Request body")], **kwargs) -> CreateMonitoredTokens200Response:  # noqa: E501
        ...
        >>> thread = api.create_monitored_tokens(post_monitored_tokens_request, async_req=True)
        >>> result = thread.get()

        :param post_monitored_tokens_request: Request body (required)
        :type post_monitored_tokens_request: PostMonitoredTokensRequest
        ...
        :rtype: CreateMonitoredTokens200Response
        """
        ...
        return self.create_monitored_tokens_with_http_info(post_monitored_tokens_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_monitored_tokens_with_http_info(self, post_monitored_tokens_request : Annotated[PostMonitoredTokensRequest, Field(..., description="Request body")], **kwargs) -> ApiResponse:  # noqa: E501
        """Set monitored tokens  # noqa: E501
        ...
        >>> thread = api.create_monitored_tokens_with_http_info(post_monitored_tokens_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateMonitoredTokens200Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'post_monitored_tokens_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        _body_params = None
        if _params['post_monitored_tokens_request'] is not None:
            _body_params = _params['post_monitored_tokens_request']
        ...
        _response_types_map = {
            '200': "CreateMonitoredTokens200Response",
            '201': "CreateMonitoredTokens200Response",
        }
    ...
    def list_monitored_tokens(self, blockchain : Annotated[Optional[Blockchain], Field(description="Filter by blockchain.")] = None, token_address : Optional[StrictStr] = None, symbol : Optional[StrictStr] = None, var_from : Annotated[Optional[datetime], Field(description="Queries items created since the specified date-time (inclusive) in ISO 8601 format.")] = None, to : Annotated[Optional[datetime], Field(description="Queries items created before the specified date-time (inclusive) in ISO 8601 format.")] = None, page_before : Annotated[Optional[StrictStr], Field(description="A collection ID value used for pagination.  It marks the exclusive end of a page. When provided, the collection resource will return the next n items before the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.   SHOULD NOT be used in conjunction with pageAfter. ")] = None, page_after : Annotated[Optional[StrictStr], Field(description="A collection ID value used for pagination.  It marks the exclusive begin of a page. When provided, the collection resource will return the next n items after the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.  SHOULD NOT be used in conjunction with pageBefore. ")] = None, page_size : Annotated[Optional[conint(strict=True, le=50, ge=1)], Field(description="Limits the number of items to be returned.  Some collections have a strict upper bound that will disregard this value. In case the specified value is higher than the allowed limit, the collection limit will be used.  If avoided, the collection will determine the page size itself. ")] = None, **kwargs) -> ListMonitoredTokens200Response:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListMonitoredTokens200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    @validate_arguments
    def list_monitored_tokens_with_http_info(self, blockchain : Annotated[Optional[Blockchain], Field(description="Filter by blockchain.")] = None, token_address : Optional[StrictStr] = None, symbol : Optional[StrictStr] = None, var_from : Annotated[Optional[datetime], Field(description="Queries items created since the specified date-time (inclusive) in ISO 8601 format.")] = None, to : Annotated[Optional[datetime], Field(description="Queries items created before the specified date-time (inclusive) in ISO 8601 format.")] = None, page_before : Annotated[Optional[StrictStr], Field(description="A collection ID value used for pagination.  It marks the exclusive end of a page. When provided, the collection resource will return the next n items before the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.   SHOULD NOT be used in conjunction with pageAfter. ")] = None, page_after : Annotated[Optional[StrictStr], Field(description="A collection ID value used for pagination.  It marks the exclusive begin of a page. When provided, the collection resource will return the next n items after the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.  SHOULD NOT be used in conjunction with pageBefore. ")] = None, page_size : Annotated[Optional[conint(strict=True, le=50, ge=1)], Field(description="Limits the number of items to be returned.  Some collections have a strict upper bound that will disregard this value. In case the specified value is higher than the allowed limit, the collection limit will be used.  If avoided, the collection will determine the page size itself. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Retreive existing monitored tokens.  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListMonitoredTokens200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _response_types_map = {
            '200': "ListMonitoredTokens200Response",
        }
    ...
    @validate_arguments
    def update_monitored_tokens(self, put_monitored_tokens_request : Annotated[PutMonitoredTokensRequest, Field(..., description="Request body")], **kwargs) -> UpdateMonitoredTokens200Response:  # noqa: E501
        """Update monitored tokens  # noqa: E501

        Edit the monitored token list.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_monitored_tokens(put_monitored_tokens_request, async_req=True)
        >>> result = thread.get()

        :param put_monitored_tokens_request: Request body (required)
        :type put_monitored_tokens_request: PutMonitoredTokensRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: UpdateMonitoredTokens200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
        ...
        return self.update_monitored_tokens_with_http_info(put_monitored_tokens_request, **kwargs)  # noqa: E501

    @validate_arguments
    def update_monitored_tokens_with_http_info(self, put_monitored_tokens_request : Annotated[PutMonitoredTokensRequest, Field(..., description="Request body")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update monitored tokens  # noqa: E501
        ...
        >>> thread = api.update_monitored_tokens_with_http_info(put_monitored_tokens_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UpdateMonitoredTokens200Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'put_monitored_tokens_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        # process the body parameter
        _body_params = None
        if _params['put_monitored_tokens_request'] is not None:
            _body_params = _params['put_monitored_tokens_request']
        ...
        _response_types_map = {
            '200': "UpdateMonitoredTokens200Response",
        }
    ...
    @validate_arguments
    def update_monitored_tokens_scope(self, put_monitored_tokens_scope_request : Annotated[PutMonitoredTokensScopeRequest, Field(..., description="Request body")], **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.update_monitored_tokens_scope(put_monitored_tokens_scope_request, async_req=True)
        >>> result = thread.get()

        :param put_monitored_tokens_scope_request: Request body (required)
        :type put_monitored_tokens_scope_request: PutMonitoredTokensScopeRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        return self.update_monitored_tokens_scope_with_http_info(put_monitored_tokens_scope_request, **kwargs)  # noqa: E501

    @validate_arguments
    def update_monitored_tokens_scope_with_http_info(self, put_monitored_tokens_scope_request : Annotated[PutMonitoredTokensScopeRequest, Field(..., description="Request body")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update monitored tokens scope  # noqa: E501
        ...
        >>> thread = api.update_monitored_tokens_scope_with_http_info(put_monitored_tokens_scope_request, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            'put_monitored_tokens_scope_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        # process the body parameter
        _body_params = None
        if _params['put_monitored_tokens_scope_request'] is not None:
            _body_params = _params['put_monitored_tokens_scope_request']
