...
from refractml.widgets.register_model import RegisterModel
from refractml.widgets.registered_output import ModelDescribe
from mosaic_utils.ai.decorators import scoring_func
from refractml.constants import MLModelFlavours
from refractml.utils import create_r_installation
import sklearn
from sklearn.model_selection import train_test_split
from sklearn.ensemble import RandomForestClassifier
from sklearn import datasets

@patch("refractml.api.get_headers")
@patch("refractml.api.register")
@patch("refractml.api.describe_model")
@patch("refractml.api.shutil.rmtree")
...
@patch("refractml.api.get_headers")
@patch("requests.put")
@patch("refractml.api.add_model_version")
@patch("requests.get")
@patch("refractml.api.shutil.rmtree")
...
@patch("refractml.utils.read_jwt")
@patch("requests.post")
...
@patch("refractml.api.get_headers")
@patch("requests.get")
@patch("refractml.api.extract_tar")
@patch("refractml.api.get_flavour_handler")
@patch("refractml.api.pickle_loads")
...
@patch("refractml.api.describe_model")
@patch("refractml.api.register")
@patch("refractml.api.create_artifacts")
@patch("refractml.api.store_model_profiling")
...
@patch("refractml.api.get_headers")
@patch("refractml.api.update_model_details")
@patch("refractml.api.update_version_details")
@patch("refractml.api.upload_model")
@patch("refractml.api.describe_model")
@patch("refractml.api.shutil.rmtree")
...
@patch("refractml.api.get_headers")
@patch("refractml.api.ensemble_model_list")
@patch("refractml.api.register")
@patch("refractml.api.describe_model")
@patch("refractml.api.create_artifacts")
...
@patch("refractml.api.describe_model")
@patch("refractml.api.register")
@patch("refractml.api.metrics_stats")
@patch("refractml.api.store_model_profiling")
@patch("refractml.api.missing_param")
@patch("refractml.api.shutil.rmtree")
...
def test_check_if_model_is_alredy_deployed(deployment_model_dict_deployed):
    from refractml.validators import check_if_model_is_alredy_deployed
...
def test_fetch_model_resources(mock_get,mock_get_headers):
    ...
    mock_get_headers.return_value = {"Authorization": "Token dcrtuv887tyg789h-uyg"}
    from refractml.api import fetch_model_resources
