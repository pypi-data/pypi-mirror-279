...
class TradeAPIRequester:
    ...
    # criar ordem
    def create_order(self, symbol:str, side:str, qty:str, account:str, execBroker:str, ordType:str, timeInForce:str, isDMA:str, entity:str, price:str, stopPx:str, strategy:str=None, strategyParameter = None):
...
class OrderController:
    ...
    def change_order(self, id:str, qty:str, price:str=None, stopPx:str=None, timeInForce:str=None, ordType:str=None, strategy:str=None, strategyParameter = None):
        """
        Change an order
