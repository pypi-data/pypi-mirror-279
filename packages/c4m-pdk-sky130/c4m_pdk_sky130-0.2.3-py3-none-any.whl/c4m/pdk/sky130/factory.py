...
class _NPN_05v5_W1u00L1u00(_cell.Cell):
    def __init__(self, *,
        ...
        inst = ckt.instantiate(_prims.npn_05v5_w1u00l1u00, name="npn")
...
class _NPN_05v5_W1u00L2u00(_cell.Cell):
    def __init__(self, *,
        ...
        ckt = self.new_circuit()
        inst = ckt.instantiate(_prims.npn_05v5_w1u00l2u00, name="npn")
        collector = ckt.new_net(
            name="collector", external=True, childports=inst.ports.collector,
        )
        base = ckt.new_net(
...
class _PNP_05v5_W0u68L0u68(_cell.Cell):
    def __init__(self, *,
        ...
        ckt = self.new_circuit()
        inst = ckt.instantiate(_prims.pnp_05v5_w0u68l0u68, name="pnp")
        collector = ckt.new_net(
            name="collector", external=True, childports=inst.ports.collector,
        )
        base = ckt.new_net(
...
class _PNP_05v5_W3u40L3u40(_cell.Cell):
    def __init__(self, *,
        ...
        ckt = self.new_circuit()
        inst = ckt.instantiate(_prims.pnp_05v5_w3u40l3u40, name="pnp")
        collector = ckt.new_net(
            name="collector", external=True, childports=inst.ports.collector,
        )
        base = ckt.new_net(
