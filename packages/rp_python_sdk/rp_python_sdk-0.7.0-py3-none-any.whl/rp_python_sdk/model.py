...
@dataclass
class AuthorisationServerCertification(JSONWizard):
...
@dataclass
class OrgDomainClaim(JSONWizard):
...
@dataclass
class AuthorisationServer(JSONWizard):
    authorisation_server_id: str
...
@dataclass
class OrgDomainRoleClaim(JSONWizard):
    status: str
...
@dataclass
class MtlsEndpointAliases(JSONWizard):
...
@dataclass
class IssuerMetadata(JSONWizard):
    issuer: str
    jwks_uri: str
    ...
    def get_preferred_token_endpoint(self) -> str:
        return self.mtls_endpoint_aliases.token_endpoint \
            if self.mtls_endpoint_aliases.token_endpoint \
    ...
    def get_preferred_pushed_authorization_request_endpoint(self) -> str:
        return self.mtls_endpoint_aliases.pushed_authorization_request_endpoint \
            if self.mtls_endpoint_aliases.pushed_authorization_request_endpoint \
    ...
    def get_preferred_authorization_endpoint(self) -> str:
        return self.mtls_endpoint_aliases.authorization_endpoint \
            if self.mtls_endpoint_aliases.authorization_endpoint \
    ...
    def get_preferred_userinfo_endpoint(self) -> str:
        return self.mtls_endpoint_aliases.userinfo_endpoint \
            if self.mtls_endpoint_aliases.userinfo_endpoint\
