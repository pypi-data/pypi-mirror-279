...
class RouteTask(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["waypoints", "transport_type", "geo_settings", "departure_time", "result_timezone", "detail", "full_segments", "polyline", "dataset_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "waypoints": [Waypoint.from_dict(_item) for _item in obj["waypoints"]] if obj.get("waypoints") is not None else None,
