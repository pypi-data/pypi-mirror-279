...
class GqlApi:
    ...
    def execute(self, query: DocumentNode, variables: Optional[Dict[str, Any]] = None):
        ...
        return self.client.execute(query, variables)  # pyright: ignore[reportUnknownMemberType]
