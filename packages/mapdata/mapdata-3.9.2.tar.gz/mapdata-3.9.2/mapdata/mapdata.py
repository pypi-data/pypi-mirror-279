...
class BivarStatsDialog(object):
	def __init__(self, parent, column_specs):
		...
		self.resid_nav = NavigationToolbar2Tk(self.residfig_canvas, resid_frame)
		...
		self.sen_nav = NavigationToolbar2Tk(self.senfig_canvas, sen_frame)
		...
		if self.dataset is not None:
			...
			if N > 1:
				...
				if ylen > 3:
					...
					self.sen_axes.set_xlim(ylims)
					self.sen_axes.set_ylim(ylims)
