...
params = [
    ...
    {'name': 'Signal', 'type': 'group', 'children': [
        ...
        {'name': 'img_dir', 'title': 'Directory', 'type': 'str', 'value': '', 'visible': True},
        NamedActionParameter(name='img_dir_browse', title='Browse...', visible=True),
        {'name': 'include_subdir', 'title': 'Subdirectories', 'type': 'bool', 'value': False, 'visible': True},
        {'name': 'img_ext', 'title': 'File Type  ', 'type': 'list',
         'values': ['tif', 'raw', 'h5', 'mar3450'], 'value': 'tif', 'visible': True},
        ...
        {'name': 'Filter', 'type': 'str', 'value': '', 'visible': True},
