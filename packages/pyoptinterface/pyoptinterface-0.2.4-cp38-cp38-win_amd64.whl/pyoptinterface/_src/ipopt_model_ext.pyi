...
class RawModel:
    ...
    @overload
    def add_linear_constraint(self, expr: pyoptinterface._src.core_ext.ScalarQuadraticFunction, sense: pyoptinterface._src.core_ext.ConstraintSense, lb: float, ub: float, name: str = '') -> pyoptinterface._src.core_ext.ConstraintIndex: ...
    ...
    @overload
    def add_nl_objective(self, arg0: pyoptinterface._src.nlcore_ext.FunctionIndex, arg1: Sequence[pyoptinterface._src.core_ext.VariableIndex], /) -> None: ...

    @overload
    def add_nl_objective(self, arg0: pyoptinterface._src.nlcore_ext.FunctionIndex, arg1: Sequence[pyoptinterface._src.core_ext.VariableIndex], arg2: Sequence[pyoptinterface._src.nlcore_ext.ParameterIndex], /) -> None: ...

    @overload
    def add_nl_objective(self, arg0: pyoptinterface._src.nlcore_ext.FunctionIndex, arg1: Sequence[pyoptinterface._src.core_ext.VariableIndex], arg2: Sequence[float], /) -> None: ...

    def clear_nl_objective(self) -> None: ...

    def register_function(self, arg0: pyoptinterface._src.nlcore_ext.ADFun, arg1: str, /) -> pyoptinterface._src.nlcore_ext.FunctionIndex: ...
