    ...
    for measurement in range(
        ...
        cumulative_distance.append(
            (
                ...
                + np.sqrt(
                    (
                        rfo_model.input_data.soil_moisture_data.x[start_time][
                            measurement + 1
                        ]
                        - rfo_model.input_data.oil_moisture_data.x[start_time][
                            measurement
                        ]
                    )
                    ** 2
                    + (
                        rfo_model.input_data.soil_moisture_data.y[start_time][
                            measurement + 1
                        ]
                        - rfo_model.input_data.soil_moisture_data.y[start_time][
                            measurement
...
def plot_measurements(rfo_model, time_step, output_dir=None, return_base64_img=False):
    ...
    x = rfo_model.input_data.soil_moisture_data.x[start_time] / 1000
    y = rfo_model.input_data.soil_moisture_data.y[start_time] / 1000
    sc = plt.scatter(
        x,
        y,
...
def plot_rfo_model_no_dispersion(
    ...
    plt.scatter(
        rfo_model.input_data.soil_moisture_data.x[start_time] / 1000,
        rfo_model.input_data.soil_moisture_data.y[start_time] / 1000,
        c="black",
        s=0.5,
    )
