...
def client(env: str, organization_id: int) -> KognicIOClient:
    ...
    if env == "development" or env is None:
        ...
        shape_integration_api_host = "http://kognic.test:8034"
    elif env == "staging":
        ...
        shape_integration_api_host = "https://shape-integration.staging.kognic.com"
    else:
    ...
    return KognicIOClient(
        ...
        shape_integration_api_host=shape_integration_api_host,
