...
class KbStr:
    def __init__(self, root_url: str, token: str, tmp_data_folder: str = 'tmp/', dummy_role: str = 'dummy_role'):
        """
    ...
    def auth_check(self, required_role_id: str):
        ...
        if 'X-Kbc-User-Email' in headers:
            ...
            user_roles = headers.get('X-Kbc-User-Roles', [self.dummy_role])
