...
class IsolationForestLearner(generic_learner.GenericLearner):
  ...
  Attributes:
    ...
    subsample_count: Number of examples used to grow each tree. Only one of
      ...
      "subsample_count" is assumed to be equal to 256. This is the default
      value recommended in the isolation forest paper. Default: 300.
    subsample_ratio: Ratio of number of training examples used to grow each
      tree. Only one of "subsample_ratio" and "subsample_count" can be set. If
      neither is set, "subsample_count" is assumed to be equal to 256. This is
      the default value recommended in the isolation forest paper. Default:
      300.
    uplift_min_examples_in_treatment: For uplift models only. Minimum number of
      examples per treatment in a node. Default: 5.
    uplift_split_score: For uplift models only. Splitter score i.e. score
  ...
  def __init__(self,
      ...
      sparse_oblique_weights: Optional[str] = None,
      split_axis: Optional[str] = "AXIS_ALIGNED",
      subsample_count: Optional[int] = 300,
      subsample_ratio: Optional[int] = 300,
      uplift_min_examples_in_treatment: Optional[int] = 5,
      uplift_split_score: Optional[str] = "KULLBACK_LEIBLER",
      num_threads: Optional[int] = None,
      working_dir: Optional[str] = None,
